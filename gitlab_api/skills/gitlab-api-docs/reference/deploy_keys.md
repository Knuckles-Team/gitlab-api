[Skip to main content](https://docs.gitlab.com/api/deploy_keys/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/deploy_keys/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/deploy_keys/)
    * [18.8](https://docs.gitlab.com/18.8/api/deploy_keys/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/deploy_keys/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/deploy_keys/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/deploy_keys.html)
...
/
  ...
  5. [Deploy keys](https://docs.gitlab.com/api/deploy_keys/)
...
Use this API to interact with [deploy keys](https://docs.gitlab.com/user/project/deploy_keys/).
## Deploy key fingerprints[](https://docs.gitlab.com/api/deploy_keys/#deploy-key-fingerprints "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/91302) `fingerprint_sha256` attribute in GitLab 15.2.


Some endpoints return public key fingerprints as part of the response. You can use these fingerprints to identify the user that created the deploy key. For more information, see [get user by deploy key fingerprint](https://docs.gitlab.com/api/keys/#retrieve-user-by-deploy-key-fingerprint).
...
## List all deploy keys[](https://docs.gitlab.com/api/deploy_keys/#list-all-deploy-keys "Permalink")
  * Tier: Free, Premium, Ultimate
...
## Add deploy key[](https://docs.gitlab.com/api/deploy_keys/#add-deploy-key "Permalink")
  * Tier: Free, Premium, Ultimate
  * Offering: GitLab Self-Managed, GitLab Dedicated
...
## List deploy keys for project[](https://docs.gitlab.com/api/deploy_keys/#list-deploy-keys-for-project "Permalink")
...
## List project deploy keys for user[](https://docs.gitlab.com/api/deploy_keys/#list-project-deploy-keys-for-user "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/88917) in GitLab 15.1.


Get a list of a specified user (requestee) and the authenticated user’s (requester) common [project deploy keys](https://docs.gitlab.com/user/project/deploy_keys/#scope). It lists only the **enabled project keys from the common projects of requester and requestee**.
```
...
## Retrieve a deploy key[](https://docs.gitlab.com/api/deploy_keys/#retrieve-a-deploy-key "Permalink")
...
## Add a deploy key for a project[](https://docs.gitlab.com/api/deploy_keys/#add-a-deploy-key-for-a-project "Permalink")
...
## Update a deploy key[](https://docs.gitlab.com/api/deploy_keys/#update-a-deploy-key "Permalink")
...
## Delete a deploy key[](https://docs.gitlab.com/api/deploy_keys/#delete-a-deploy-key "Permalink")
...
## Enable a deploy key[](https://docs.gitlab.com/api/deploy_keys/#enable-a-deploy-key "Permalink")
...
## Add deploy keys to multiple projects[](https://docs.gitlab.com/api/deploy_keys/#add-deploy-keys-to-multiple-projects "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/deploy_keys.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/deploy_keys.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Deploy key fingerprints](https://docs.gitlab.com/api/deploy_keys/#deploy-key-fingerprints)
  * [List all deploy keys](https://docs.gitlab.com/api/deploy_keys/#list-all-deploy-keys)
  * [Add deploy key](https://docs.gitlab.com/api/deploy_keys/#add-deploy-key)
  * [List deploy keys for project](https://docs.gitlab.com/api/deploy_keys/#list-deploy-keys-for-project)
  * [List project deploy keys for user](https://docs.gitlab.com/api/deploy_keys/#list-project-deploy-keys-for-user)
  * [Retrieve a deploy key](https://docs.gitlab.com/api/deploy_keys/#retrieve-a-deploy-key)
  * [Add a deploy key for a project](https://docs.gitlab.com/api/deploy_keys/#add-a-deploy-key-for-a-project)
  * [Update a deploy key](https://docs.gitlab.com/api/deploy_keys/#update-a-deploy-key)
  * [Delete a deploy key](https://docs.gitlab.com/api/deploy_keys/#delete-a-deploy-key)
  * [Enable a deploy key](https://docs.gitlab.com/api/deploy_keys/#enable-a-deploy-key)
  * [Add deploy keys to multiple projects](https://docs.gitlab.com/api/deploy_keys/#add-deploy-keys-to-multiple-projects)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/deploy_keys.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/deploy_keys.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fdeploy_keys%2F&_biz_t=1772174244282&_biz_i=Deploy%20keys%20API%20%7C%20GitLab%20Docs&_biz_n=34&rnd=580416&cdn_o=a&_biz_z=1772174244282)
