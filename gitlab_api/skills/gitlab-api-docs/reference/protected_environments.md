[Skip to main content](https://docs.gitlab.com/api/protected_environments/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/protected_environments/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/protected_environments/)
    * [18.8](https://docs.gitlab.com/18.8/api/protected_environments/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/protected_environments/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/protected_environments/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/protected_environments.html)
...
/
  ...
  6. [Protected environments](https://docs.gitlab.com/api/protected_environments/)
...
Use this API to interact with [protected environments](https://docs.gitlab.com/ci/environments/protected_environments/).
For group-level protected environments, see [group-level protected environments API](https://docs.gitlab.com/api/group_protected_environments/)
## Valid access levels[](https://docs.gitlab.com/api/protected_environments/#valid-access-levels "Permalink")
...
## Group inheritance types[](https://docs.gitlab.com/api/protected_environments/#group-inheritance-types "Permalink")
Group inheritance allows deploy access levels and access rules to take inherited group membership into account. The group inheritance types are defined by `ProtectedEnvironments::Authorizable::GROUP_INHERITANCE_TYPE`. The following types are recognized:
```
0 => Direct group membership only (default)
1 => All inherited groups
```

## List protected environments[](https://docs.gitlab.com/api/protected_environments/#list-protected-environments "Permalink")
...
## Get a single protected environment[](https://docs.gitlab.com/api/protected_environments/#get-a-single-protected-environment "Permalink")
...
## Protect a single environment[](https://docs.gitlab.com/api/protected_environments/#protect-a-single-environment "Permalink")
...
`approval_rules` | array | no | Array of access levels allowed to approve, with each described by a hash. See [Multiple approval rules](https://docs.gitlab.com/ci/environments/deployment_approvals/#add-multiple-approval-rules).
Elements in the `deploy_access_levels` and `approval_rules` array should be one of `user_id`, `group_id` or `access_level`, and take the form `{user_id: integer}`, `{group_id: integer}` or `{access_level: integer}`. Optionally, you can specify the `group_inheritance_type` on each as one of the [valid group inheritance types](https://docs.gitlab.com/api/protected_environments/#group-inheritance-types).
Each user must have access to the project and each group must [have this project shared](https://docs.gitlab.com/user/project/members/sharing_projects_groups/).
shell
```
...
## Update a protected environment[](https://docs.gitlab.com/api/protected_environments/#update-a-protected-environment "Permalink")
History
...
`approval_rules` | array | no | Array of access levels allowed to approve, with each described by a hash. See [Multiple approval rules](https://docs.gitlab.com/ci/environments/deployment_approvals/#add-multiple-approval-rules) for more information.
Elements in the `deploy_access_levels` and `approval_rules` array should be one of `user_id`, `group_id` or `access_level`, and take the form `{user_id: integer}`, `{group_id: integer}` or `{access_level: integer}`. Optionally you can specify the `group_inheritance_type` on each as one of the [valid group inheritance types](https://docs.gitlab.com/api/protected_environments/#group-inheritance-types).
To update:
  ...
  * **`group_id`**: Ensure the updated group[have this project shared](https://docs.gitlab.com/user/project/members/sharing_projects_groups/). You must also pass the `id` of either a `deploy_access_level` or `approval_rule` in the respective hash.
...
### Example: Create a `deploy_access_level` record[](https://docs.gitlab.com/api/protected_environments/#example-create-a-deploy_access_level-record "Permalink")
shell
```
curl --header 'Content-Type: application/json' \
     --request PUT \
...
### Example: Update a `deploy_access_level` record[](https://docs.gitlab.com/api/protected_environments/#example-update-a-deploy_access_level-record "Permalink")
shell
```
curl --header 'Content-Type: application/json' \
     --request PUT \
...
### Example: Delete a `deploy_access_level` record[](https://docs.gitlab.com/api/protected_environments/#example-delete-a-deploy_access_level-record "Permalink")
shell
```
curl --header 'Content-Type: application/json' \
     --request PUT \
...
### Example: Create an `approval_rule` record[](https://docs.gitlab.com/api/protected_environments/#example-create-an-approval_rule-record "Permalink")
shell
```
curl --header 'Content-Type: application/json' \
     --request PUT \
...
### Example: Update an `approval_rule` record[](https://docs.gitlab.com/api/protected_environments/#example-update-an-approval_rule-record "Permalink")
shell
```
curl --header 'Content-Type: application/json' \
     --request PUT \
...
### Example: Delete an `approval_rule` record[](https://docs.gitlab.com/api/protected_environments/#example-delete-an-approval_rule-record "Permalink")
shell
```
curl --header 'Content-Type: application/json' \
     --request PUT \
...
## Unprotect a single environment[](https://docs.gitlab.com/api/protected_environments/#unprotect-a-single-environment "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/protected_environments.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/protected_environments.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Valid access levels](https://docs.gitlab.com/api/protected_environments/#valid-access-levels)
  * [Group inheritance types](https://docs.gitlab.com/api/protected_environments/#group-inheritance-types)
  * [List protected environments](https://docs.gitlab.com/api/protected_environments/#list-protected-environments)
  * [Get a single protected environment](https://docs.gitlab.com/api/protected_environments/#get-a-single-protected-environment)
  * [Protect a single environment](https://docs.gitlab.com/api/protected_environments/#protect-a-single-environment)
  * [Update a protected environment](https://docs.gitlab.com/api/protected_environments/#update-a-protected-environment)
  * [Example: Create a deploy_access_level record](https://docs.gitlab.com/api/protected_environments/#example-create-a-deploy_access_level-record)
  * [Example: Update a deploy_access_level record](https://docs.gitlab.com/api/protected_environments/#example-update-a-deploy_access_level-record)
  * [Example: Delete a deploy_access_level record](https://docs.gitlab.com/api/protected_environments/#example-delete-a-deploy_access_level-record)
  * [Example: Create an approval_rule record](https://docs.gitlab.com/api/protected_environments/#example-create-an-approval_rule-record)
  * [Example: Update an approval_rule record](https://docs.gitlab.com/api/protected_environments/#example-update-an-approval_rule-record)
  * [Example: Delete an approval_rule record](https://docs.gitlab.com/api/protected_environments/#example-delete-an-approval_rule-record)
  * [Unprotect a single environment](https://docs.gitlab.com/api/protected_environments/#unprotect-a-single-environment)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/protected_environments.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/protected_environments.md)
