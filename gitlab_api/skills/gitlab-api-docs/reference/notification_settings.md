[Skip to main content](https://docs.gitlab.com/api/notification_settings/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/notification_settings/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/notification_settings/)
    * [18.8](https://docs.gitlab.com/18.8/api/notification_settings/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/notification_settings/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/notification_settings/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/notification_settings.html)
...
/
  ...
  5. [Notification settings](https://docs.gitlab.com/api/notification_settings/)
...
Use this API to manage notification settings in GitLab. For more information, see [notification emails](https://docs.gitlab.com/user/profile/notifications/).
## Notification levels[](https://docs.gitlab.com/api/notification_settings/#notification-levels "Permalink")
...
## Retrieve global notification settings[](https://docs.gitlab.com/api/notification_settings/#retrieve-global-notification-settings "Permalink")
...
## Update global notification settings[](https://docs.gitlab.com/api/notification_settings/#update-global-notification-settings "Permalink")
...
## Retrieve notification settings[](https://docs.gitlab.com/api/notification_settings/#retrieve-notification-settings "Permalink")
...
Attribute | Type | Required | Description
---|---|---|---
`id` | integer or string | Yes | ID or [URL-encoded path](https://docs.gitlab.com/api/rest/#namespaced-paths) of the group or project
If successful, returns [`200 OK`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and the following response attributes:
Attribute | Type | Description
---|---|---
...
## Update group or project notification settings[](https://docs.gitlab.com/api/notification_settings/#update-group-or-project-notification-settings "Permalink")
...
`reopen_merge_request` | boolean | No | Turn on notifications when a merge request is reopened
`success_pipeline` | boolean | No | Turn on notifications when a pipeline completes successfully
If successful, returns [`200 OK`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and one of the following response formats.
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/notification_settings.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/notification_settings.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Notification levels](https://docs.gitlab.com/api/notification_settings/#notification-levels)
  * [Retrieve global notification settings](https://docs.gitlab.com/api/notification_settings/#retrieve-global-notification-settings)
  * [Update global notification settings](https://docs.gitlab.com/api/notification_settings/#update-global-notification-settings)
  * [Retrieve notification settings](https://docs.gitlab.com/api/notification_settings/#retrieve-notification-settings)
  * [Update group or project notification settings](https://docs.gitlab.com/api/notification_settings/#update-group-or-project-notification-settings)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/notification_settings.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/notification_settings.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fnotification_settings%2F&_biz_t=1772174335521&_biz_i=Notification%20settings%20API%20%7C%20GitLab%20Docs&_biz_n=96&rnd=416093&cdn_o=a&_biz_z=1772174335522)
