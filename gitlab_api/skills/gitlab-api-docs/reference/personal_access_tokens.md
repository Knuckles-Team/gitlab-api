[Skip to main content](https://docs.gitlab.com/api/personal_access_tokens/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/personal_access_tokens/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/personal_access_tokens/)
    * [18.8](https://docs.gitlab.com/18.8/api/personal_access_tokens/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/personal_access_tokens/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/personal_access_tokens/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/personal_access_tokens.html)
...
/
  ...
  5. [Personal access tokens](https://docs.gitlab.com/api/personal_access_tokens/)
...
Use this API to interact with [personal access tokens](https://docs.gitlab.com/user/profile/personal_access_tokens/).
## List all personal access tokens[](https://docs.gitlab.com/api/personal_access_tokens/#list-all-personal-access-tokens "Permalink")
History
...
## Retrieve a personal access token[](https://docs.gitlab.com/api/personal_access_tokens/#retrieve-a-personal-access-token "Permalink")
History
...
### Self-inform[](https://docs.gitlab.com/api/personal_access_tokens/#self-inform "Permalink")
History
...
## Create a personal access token[](https://docs.gitlab.com/api/personal_access_tokens/#create-a-personal-access-token "Permalink")
  * Offering: GitLab Self-Managed, GitLab Dedicated


You can create personal access tokens with the user tokens API. For more information, see the following endpoints:
  * [Create a personal access token](https://docs.gitlab.com/api/user_tokens/#create-a-personal-access-token)
  * [Create a personal access token for a user](https://docs.gitlab.com/api/user_tokens/#create-a-personal-access-token-for-a-user)


## Rotate a personal access token[](https://docs.gitlab.com/api/personal_access_tokens/#rotate-a-personal-access-token "Permalink")
History
...
### Self-rotate[](https://docs.gitlab.com/api/personal_access_tokens/#self-rotate "Permalink")
History
...
Instead of rotating a specific personal access token, you can also rotate the same personal access token you used to authenticate the request. To self-rotate a personal access token, you must:
  * Rotate a personal access token with the [`api` or `self_rotate` scope](https://docs.gitlab.com/user/profile/personal_access_tokens/#personal-access-token-scopes).
...
### Automatic reuse detection[](https://docs.gitlab.com/api/personal_access_tokens/#automatic-reuse-detection "Permalink")
History
...
## Revoke a personal access token[](https://docs.gitlab.com/api/personal_access_tokens/#revoke-a-personal-access-token "Permalink")
...
### Self-revoke[](https://docs.gitlab.com/api/personal_access_tokens/#self-revoke "Permalink")
History
...
## List all token associations[](https://docs.gitlab.com/api/personal_access_tokens/#list-all-token-associations "Permalink")
History
...
## Related topics[](https://docs.gitlab.com/api/personal_access_tokens/#related-topics "Permalink")
  * [Token troubleshooting](https://docs.gitlab.com/security/tokens/token_troubleshooting/)


Was this page helpful?YesNo
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/personal_access_tokens.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/personal_access_tokens.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all personal access tokens](https://docs.gitlab.com/api/personal_access_tokens/#list-all-personal-access-tokens)
  * [Retrieve a personal access token](https://docs.gitlab.com/api/personal_access_tokens/#retrieve-a-personal-access-token)
  * [Self-inform](https://docs.gitlab.com/api/personal_access_tokens/#self-inform)
  * [Create a personal access token](https://docs.gitlab.com/api/personal_access_tokens/#create-a-personal-access-token)
  * [Rotate a personal access token](https://docs.gitlab.com/api/personal_access_tokens/#rotate-a-personal-access-token)
  * [Self-rotate](https://docs.gitlab.com/api/personal_access_tokens/#self-rotate)
  * [Automatic reuse detection](https://docs.gitlab.com/api/personal_access_tokens/#automatic-reuse-detection)
  * [Revoke a personal access token](https://docs.gitlab.com/api/personal_access_tokens/#revoke-a-personal-access-token)
  * [Self-revoke](https://docs.gitlab.com/api/personal_access_tokens/#self-revoke)
  * [List all token associations](https://docs.gitlab.com/api/personal_access_tokens/#list-all-token-associations)
  * [Related topics](https://docs.gitlab.com/api/personal_access_tokens/#related-topics)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/personal_access_tokens.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/personal_access_tokens.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpackages%2Frubygems%2F&_biz_t=1772174400303&_biz_i=Ruby%20gems%20API%20%7C%20GitLab%20Docs&_biz_n=117&rnd=969424&cdn_o=a&_biz_z=1772174400380)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpersonal_access_tokens%2F&_biz_t=1772174400379&_biz_i=Personal%20access%20tokens%20API%20%7C%20GitLab%20Docs&_biz_n=118&rnd=167146&cdn_o=a&_biz_z=1772174400381)
