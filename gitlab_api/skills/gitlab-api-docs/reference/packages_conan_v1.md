[Skip to main content](https://docs.gitlab.com/api/packages/conan_v1/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/packages/conan_v1/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/packages/conan_v1/)
    * [18.8](https://docs.gitlab.com/18.8/api/packages/conan_v1/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/packages/conan_v1/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/packages/conan_v1/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/packages/conan_v1.html)
...
/
  ...
  5. [Conan v1](https://docs.gitlab.com/api/packages/conan_v1/)
...
For Conan v2 operations, see [Conan v2 API](https://docs.gitlab.com/api/packages/conan_v2/).
Use this API to interact with the [Conan v1 package manager](https://docs.gitlab.com/user/packages/conan_1_repository/). These endpoints work for both projects and instances.
...
Generally, these endpoints are used by the [Conan 1 package manager client](https://docs.conan.io/en/latest/) and are not meant for manual consumption.
...
## Create an authentication token[](https://docs.gitlab.com/api/packages/conan_v1/#create-an-authentication-token "Permalink")
...
## Verify availability of a Conan repository[](https://docs.gitlab.com/api/packages/conan_v1/#verify-availability-of-a-conan-repository "Permalink")
...
## Search for a Conan package[](https://docs.gitlab.com/api/packages/conan_v1/#search-for-a-conan-package "Permalink")
...
## Verify authentication credentials[](https://docs.gitlab.com/api/packages/conan_v1/#verify-authentication-credentials "Permalink")
Verifies the validity of Basic Auth credentials or a specified Conan JWT generated from the [`/authenticate`](https://docs.gitlab.com/api/packages/conan_v1/#create-an-authentication-token) endpoint.
```
...
## Retrieve a recipe snapshot[](https://docs.gitlab.com/api/packages/conan_v1/#retrieve-a-recipe-snapshot "Permalink")
...
## Retrieve a package snapshot[](https://docs.gitlab.com/api/packages/conan_v1/#retrieve-a-package-snapshot "Permalink")
...
## Retrieve a recipe manifest[](https://docs.gitlab.com/api/packages/conan_v1/#retrieve-a-recipe-manifest "Permalink")
...
## Retrieve a package manifest[](https://docs.gitlab.com/api/packages/conan_v1/#retrieve-a-package-manifest "Permalink")
...
## List all recipe download URLs[](https://docs.gitlab.com/api/packages/conan_v1/#list-all-recipe-download-urls "Permalink")
Lists all files and associated download URLs for a specified recipe. Returns the same payload as the [recipe manifest](https://docs.gitlab.com/api/packages/conan_v1/#retrieve-a-recipe-manifest) endpoint.
```
...
## List all package download URLs[](https://docs.gitlab.com/api/packages/conan_v1/#list-all-package-download-urls "Permalink")
Lists all files and associated download URLs for a specified package. Returns the same payload as the [package manifest](https://docs.gitlab.com/api/packages/conan_v1/#retrieve-a-package-manifest) endpoint.
```
...
## List all recipe upload URLs[](https://docs.gitlab.com/api/packages/conan_v1/#list-all-recipe-upload-urls "Permalink")
...
## List all package upload URLs[](https://docs.gitlab.com/api/packages/conan_v1/#list-all-package-upload-urls "Permalink")
...
## Retrieve a recipe file[](https://docs.gitlab.com/api/packages/conan_v1/#retrieve-a-recipe-file "Permalink")
Retrieves a specified recipe file from the package registry. You must use the download URL returned from the [recipe download URLs](https://docs.gitlab.com/api/packages/conan_v1/#list-all-recipe-download-urls) endpoint.
```
...
## Upload a recipe file[](https://docs.gitlab.com/api/packages/conan_v1/#upload-a-recipe-file "Permalink")
Uploads a specified recipe file to the package registry. You must use the upload URL returned from the [recipe upload URLs](https://docs.gitlab.com/api/packages/conan_v1/#list-all-recipe-upload-urls) endpoint.
```
...
## Retrieve a package file[](https://docs.gitlab.com/api/packages/conan_v1/#retrieve-a-package-file "Permalink")
Retrieves a specified package file from the package registry. You must use the download URL returned from the [package download URLs](https://docs.gitlab.com/api/packages/conan_v1/#list-all-package-download-urls) endpoint.
```
...
## Upload a package file[](https://docs.gitlab.com/api/packages/conan_v1/#upload-a-package-file "Permalink")
Uploads a specified package file to the package registry. You must use the upload URL returned from the [package upload URLs](https://docs.gitlab.com/api/packages/conan_v1/#list-all-package-upload-urls) endpoint.
```
...
## Delete a recipe and package[](https://docs.gitlab.com/api/packages/conan_v1/#delete-a-recipe-and-package "Permalink")
...
## Retrieve package references metadata[](https://docs.gitlab.com/api/packages/conan_v1/#retrieve-package-references-metadata "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/conan_v1.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/conan_v1.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Create an authentication token](https://docs.gitlab.com/api/packages/conan_v1/#create-an-authentication-token)
  * [Verify availability of a Conan repository](https://docs.gitlab.com/api/packages/conan_v1/#verify-availability-of-a-conan-repository)
  * [Search for a Conan package](https://docs.gitlab.com/api/packages/conan_v1/#search-for-a-conan-package)
  * [Verify authentication credentials](https://docs.gitlab.com/api/packages/conan_v1/#verify-authentication-credentials)
  * [Retrieve a recipe snapshot](https://docs.gitlab.com/api/packages/conan_v1/#retrieve-a-recipe-snapshot)
  * [Retrieve a package snapshot](https://docs.gitlab.com/api/packages/conan_v1/#retrieve-a-package-snapshot)
  * [Retrieve a recipe manifest](https://docs.gitlab.com/api/packages/conan_v1/#retrieve-a-recipe-manifest)
  * [Retrieve a package manifest](https://docs.gitlab.com/api/packages/conan_v1/#retrieve-a-package-manifest)
  * [List all recipe download URLs](https://docs.gitlab.com/api/packages/conan_v1/#list-all-recipe-download-urls)
  * [List all package download URLs](https://docs.gitlab.com/api/packages/conan_v1/#list-all-package-download-urls)
  * [List all recipe upload URLs](https://docs.gitlab.com/api/packages/conan_v1/#list-all-recipe-upload-urls)
  * [List all package upload URLs](https://docs.gitlab.com/api/packages/conan_v1/#list-all-package-upload-urls)
  * [Retrieve a recipe file](https://docs.gitlab.com/api/packages/conan_v1/#retrieve-a-recipe-file)
  * [Upload a recipe file](https://docs.gitlab.com/api/packages/conan_v1/#upload-a-recipe-file)
  * [Retrieve a package file](https://docs.gitlab.com/api/packages/conan_v1/#retrieve-a-package-file)
  * [Upload a package file](https://docs.gitlab.com/api/packages/conan_v1/#upload-a-package-file)
  * [Delete a recipe and package](https://docs.gitlab.com/api/packages/conan_v1/#delete-a-recipe-and-package)
  * [Retrieve package references metadata](https://docs.gitlab.com/api/packages/conan_v1/#retrieve-package-references-metadata)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/conan_v1.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/conan_v1.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpackages%2Fconan_v1%2F&_biz_t=1772174388766&_biz_i=Conan%20v1%20API%20%7C%20GitLab%20Docs&_biz_n=114&rnd=307120&cdn_o=a&_biz_z=1772174388767)
