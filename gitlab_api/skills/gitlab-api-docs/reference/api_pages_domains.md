[Skip to main content](https://docs.gitlab.com/api/pages_domains/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/pages_domains/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/pages_domains/)
    * [18.8](https://docs.gitlab.com/18.8/api/pages_domains/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/pages_domains/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/pages_domains/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/pages_domains.html)
...
/
  ...
  5. [Pages domains](https://docs.gitlab.com/api/pages_domains/)
...
The GitLab Pages feature must be enabled to use these endpoints. Find out more about [administering](https://docs.gitlab.com/administration/pages/) and [using](https://docs.gitlab.com/user/project/pages/) the feature.
## List all Pages domains[](https://docs.gitlab.com/api/pages_domains/#list-all-pages-domains "Permalink")
Prerequisites:
...
`auto_ssl_enabled` | boolean | Indicates if [automatic generation](https://docs.gitlab.com/user/project/pages/custom_domains_ssl_tls_certification/lets_encrypt_integration/) of SSL certificates using Let’s Encrypt is enabled for this domain.
...
## List Pages domains[](https://docs.gitlab.com/api/pages_domains/#list-pages-domains "Permalink")
...
## Single Pages domain[](https://docs.gitlab.com/api/pages_domains/#single-pages-domain "Permalink")
...
## Create new Pages domain[](https://docs.gitlab.com/api/pages_domains/#create-new-pages-domain "Permalink")
...
`id` | integer or string | yes | The ID or [URL-encoded path of the project](https://docs.gitlab.com/api/rest/#namespaced-paths)
`domain` | string | yes | The custom domain indicated by the user
`auto_ssl_enabled` | boolean | no | Enables [automatic generation](https://docs.gitlab.com/user/project/pages/custom_domains_ssl_tls_certification/lets_encrypt_integration/) of SSL certificates issued by Let’s Encrypt for custom domains.
...
## Update Pages domain[](https://docs.gitlab.com/api/pages_domains/#update-pages-domain "Permalink")
...
`certificate.certificate` | string | The full SSL certificate in PEM format.
`certificate.certificate_text` | date | A human-readable text representation of the SSL certificate, including details such as issuer, validity period, subject, and other certificate information.
### Adding certificate[](https://docs.gitlab.com/api/pages_domains/#adding-certificate "Permalink")
...
### Enabling Let’s Encrypt integration for Pages custom domains[](https://docs.gitlab.com/api/pages_domains/#enabling-lets-encrypt-integration-for-pages-custom-domains "Permalink")
shell
```
curl --request PUT \
  --header "PRIVATE-TOKEN: <your_access_token>" \
...
### Removing certificate[](https://docs.gitlab.com/api/pages_domains/#removing-certificate "Permalink")
...
## Verify Pages domain[](https://docs.gitlab.com/api/pages_domains/#verify-pages-domain "Permalink")
History
...
## Delete Pages domain[](https://docs.gitlab.com/api/pages_domains/#delete-pages-domain "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/pages_domains.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/pages_domains.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all Pages domains](https://docs.gitlab.com/api/pages_domains/#list-all-pages-domains)
  * [List Pages domains](https://docs.gitlab.com/api/pages_domains/#list-pages-domains)
  * [Single Pages domain](https://docs.gitlab.com/api/pages_domains/#single-pages-domain)
  * [Create new Pages domain](https://docs.gitlab.com/api/pages_domains/#create-new-pages-domain)
  * [Update Pages domain](https://docs.gitlab.com/api/pages_domains/#update-pages-domain)
  * [Adding certificate](https://docs.gitlab.com/api/pages_domains/#adding-certificate)
  * [Enabling Let’s Encrypt integration for Pages custom domains](https://docs.gitlab.com/api/pages_domains/#enabling-lets-encrypt-integration-for-pages-custom-domains)
  * [Removing certificate](https://docs.gitlab.com/api/pages_domains/#removing-certificate)
  * [Verify Pages domain](https://docs.gitlab.com/api/pages_domains/#verify-pages-domain)
  * [Delete Pages domain](https://docs.gitlab.com/api/pages_domains/#delete-pages-domain)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/pages_domains.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/pages_domains.md)
