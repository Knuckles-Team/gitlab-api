[Skip to main content](https://docs.gitlab.com/api/packages/go_proxy/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/packages/go_proxy/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/packages/go_proxy/)
    * [18.8](https://docs.gitlab.com/18.8/api/packages/go_proxy/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/packages/go_proxy/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/packages/go_proxy/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/packages/go_proxy.html)
...
/
  ...
  5. [Go Proxy](https://docs.gitlab.com/api/packages/go_proxy/)
...
This API is used by the [`go` command](https://go.dev/ref/mod#go-get) and is generally not meant for manual consumption.
These endpoints do not adhere to the standard API authentication methods. See the [Go Proxy package documentation](https://docs.gitlab.com/user/packages/go_proxy/) for details on which headers and token types are supported. Undocumented authentication methods might be removed in the future.
## List[](https://docs.gitlab.com/api/packages/go_proxy/#list "Permalink")
...
## Version metadata[](https://docs.gitlab.com/api/packages/go_proxy/#version-metadata "Permalink")
Get all tagged versions for a given Go module:
```
...
## Download module file[](https://docs.gitlab.com/api/packages/go_proxy/#download-module-file "Permalink")
...
## Download module source[](https://docs.gitlab.com/api/packages/go_proxy/#download-module-source "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/go_proxy.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/go_proxy.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List](https://docs.gitlab.com/api/packages/go_proxy/#list)
  * [Version metadata](https://docs.gitlab.com/api/packages/go_proxy/#version-metadata)
  * [Download module file](https://docs.gitlab.com/api/packages/go_proxy/#download-module-file)
  * [Download module source](https://docs.gitlab.com/api/packages/go_proxy/#download-module-source)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/go_proxy.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/go_proxy.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpackages%2Fgo_proxy%2F&_biz_t=1771981625992&_biz_i=Go%20Proxy%20API%20%7C%20GitLab%20Docs&_biz_n=119&rnd=430731&cdn_o=a&_biz_z=1771981625993)
