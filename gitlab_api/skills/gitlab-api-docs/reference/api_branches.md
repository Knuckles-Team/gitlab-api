[Skip to main content](https://docs.gitlab.com/api/branches/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/branches/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/branches/)
    * [18.8](https://docs.gitlab.com/18.8/api/branches/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/branches/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/branches/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/branches.html)
...
/
  ...
  5. [Branches](https://docs.gitlab.com/api/branches/)
...
Use this API to manage [Git branches](https://docs.gitlab.com/user/project/repository/branches/).
To change the branch protections configured for a project, use the [protected branches API](https://docs.gitlab.com/api/protected_branches/).
## List all repository branches[](https://docs.gitlab.com/api/branches/#list-all-repository-branches "Permalink")
Lists all repository branches from a project, sorted by name alphabetically. Search by name, or use regular expressions to find specific branch patterns. Returns detailed information about the branch, including its protection status, merge status, and commit details.
...
## Retrieve a repository branch[](https://docs.gitlab.com/api/branches/#retrieve-a-repository-branch "Permalink")
...
---|---|---|---
`id` | integer or string | Yes | ID or [URL-encoded path of the project](https://docs.gitlab.com/api/rest/#namespaced-paths).
`branch` | string | Yes |  [URL-encoded name](https://docs.gitlab.com/api/rest/#namespaced-paths) of the branch.
If successful, returns [`200 OK`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and the following response attributes:
Attribute | Type | Description
---|---|---
...
## Protect repository branch[](https://docs.gitlab.com/api/branches/#protect-repository-branch "Permalink")
See [`POST /projects/:id/protected_branches`](https://docs.gitlab.com/api/protected_branches/#protect-repository-branches) for information on protecting repository branches.
## Unprotect repository branch[](https://docs.gitlab.com/api/branches/#unprotect-repository-branch "Permalink")
See [`DELETE /projects/:id/protected_branches/:name`](https://docs.gitlab.com/api/protected_branches/#unprotect-repository-branches) for information on unprotecting repository branches.
## Create repository branch[](https://docs.gitlab.com/api/branches/#create-repository-branch "Permalink")
...
## Delete repository branch[](https://docs.gitlab.com/api/branches/#delete-repository-branch "Permalink")
...
---|---|---|---
`id` | integer or string | Yes | ID or [URL-encoded path of the project](https://docs.gitlab.com/api/rest/#namespaced-paths).
`branch` | string | Yes |  [URL-encoded name](https://docs.gitlab.com/api/rest/#namespaced-paths) of the branch. Cannot delete the default branch or protected branches.
...
Deleting a branch does not completely erase all related data. Some information persists to maintain project history and to support recovery processes. For more information, see [Handle sensitive information](https://docs.gitlab.com/topics/git/undo/#handle-sensitive-information).
## Delete all merged branches[](https://docs.gitlab.com/api/branches/#delete-all-merged-branches "Permalink")
Deletes all branches that are merged into the project’s default branch.
[Protected branches](https://docs.gitlab.com/user/project/repository/branches/protected/) are not deleted as part of this operation.
```
...
## Related topics[](https://docs.gitlab.com/api/branches/#related-topics "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/branches.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/branches.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all repository branches](https://docs.gitlab.com/api/branches/#list-all-repository-branches)
  * [Retrieve a repository branch](https://docs.gitlab.com/api/branches/#retrieve-a-repository-branch)
  * [Protect repository branch](https://docs.gitlab.com/api/branches/#protect-repository-branch)
  * [Unprotect repository branch](https://docs.gitlab.com/api/branches/#unprotect-repository-branch)
  * [Create repository branch](https://docs.gitlab.com/api/branches/#create-repository-branch)
  * [Delete repository branch](https://docs.gitlab.com/api/branches/#delete-repository-branch)
  * [Delete all merged branches](https://docs.gitlab.com/api/branches/#delete-all-merged-branches)
  * [Related topics](https://docs.gitlab.com/api/branches/#related-topics)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/branches.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/branches.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fbranches%2F&_biz_t=1771981473843&_biz_i=Branches%20API%20%7C%20GitLab%20Docs&_biz_n=18&rnd=371427&cdn_o=a&_biz_z=1771981473843)
