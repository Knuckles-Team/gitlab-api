[Skip to main content](https://docs.gitlab.com/user/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/user/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/user/)
    * [18.8](https://docs.gitlab.com/18.8/user/)
    * [18.7](https://archives.docs.gitlab.com/18.7/user/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/user/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/user/index.html)
...
[Manage your organization Users, groups, namespaces, SSH keys.](https://docs.gitlab.com/topics/set_up_organization/)[Organize work with projects Project visibility, search, badges, layout.](https://docs.gitlab.com/user/project/organize_work_with_projects/)[Plan and track work Epics, issues, milestones, and labels.](https://docs.gitlab.com/topics/plan_and_track/)[Manage authentication and authorization User identity, authentication, permissions, access controls, and security best practices.](https://docs.gitlab.com/auth/)[Use Git Common Git commands and workflows.](https://docs.gitlab.com/topics/git/)[Manage your code Repositories, merge requests, remote development.](https://docs.gitlab.com/topics/manage_code/)[Use CI/CD to build your application Runners, jobs, pipelines, variables.](https://docs.gitlab.com/topics/build_your_application/)[Secure your application Container, dependency, and vulnerability scans.](https://docs.gitlab.com/user/application_security/secure_your_application/)[Deploy and release your application Environments, packages, review apps, GitLab Pages.](https://docs.gitlab.com/topics/release_your_application/)[Manage your infrastructure Terraform and Kubernetes deployments.](https://docs.gitlab.com/user/infrastructure/)[Monitor your application Track errors and manage incident response.](https://docs.gitlab.com/operations/)[Analyze GitLab usage Instance, group, and project analytics.](https://docs.gitlab.com/user/analytics/)
Was this page helpful?YesNo
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/user/_index.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/user/_index.md)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/user/_index.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/user/_index.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fuser%2F&_biz_t=1772174510785&_biz_i=Use%20GitLab%20%7C%20GitLab%20Docs&_biz_n=205&rnd=429559&cdn_o=a&_biz_z=1772174510785)
