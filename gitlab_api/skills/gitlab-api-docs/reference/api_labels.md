[Skip to main content](https://docs.gitlab.com/api/labels/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/labels/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/labels/)
    * [18.8](https://docs.gitlab.com/18.8/api/labels/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/labels/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/labels/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/labels.html)
...
/
  ...
  6. [Labels](https://docs.gitlab.com/api/labels/)
...
Use this API to manage [project labels](https://docs.gitlab.com/user/project/labels/).
For group labels, use the [group labels API](https://docs.gitlab.com/api/group_labels/).
## List all project labels[](https://docs.gitlab.com/api/labels/#list-all-project-labels "Permalink")
...
## Retrieve a project label[](https://docs.gitlab.com/api/labels/#retrieve-a-project-label "Permalink")
...
## Create a project label[](https://docs.gitlab.com/api/labels/#create-a-project-label "Permalink")
...
## Delete a project label[](https://docs.gitlab.com/api/labels/#delete-a-project-label "Permalink")
...
## Update a project label[](https://docs.gitlab.com/api/labels/#update-a-project-label "Permalink")
...
## Promote a project label to a group label[](https://docs.gitlab.com/api/labels/#promote-a-project-label-to-a-group-label "Permalink")
...
## Subscribe to a project label[](https://docs.gitlab.com/api/labels/#subscribe-to-a-project-label "Permalink")
...
## Unsubscribe from a project label[](https://docs.gitlab.com/api/labels/#unsubscribe-from-a-project-label "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/labels.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/labels.md)
  ...
  * [Retrieve a project label](https://docs.gitlab.com/api/labels/#retrieve-a-project-label)
  * [Create a project label](https://docs.gitlab.com/api/labels/#create-a-project-label)
  * [Delete a project label](https://docs.gitlab.com/api/labels/#delete-a-project-label)
  * [Update a project label](https://docs.gitlab.com/api/labels/#update-a-project-label)
  * [Promote a project label to a group label](https://docs.gitlab.com/api/labels/#promote-a-project-label-to-a-group-label)
  * [Subscribe to a project label](https://docs.gitlab.com/api/labels/#subscribe-to-a-project-label)
  * [Unsubscribe from a project label](https://docs.gitlab.com/api/labels/#unsubscribe-from-a-project-label)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/labels.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/labels.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Flabels%2F&_biz_t=1771981575238&_biz_i=Project%20labels%20API%20%7C%20GitLab%20Docs&_biz_n=88&rnd=936623&cdn_o=a&_biz_z=1771981575239)
