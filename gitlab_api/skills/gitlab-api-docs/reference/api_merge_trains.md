[Skip to main content](https://docs.gitlab.com/api/merge_trains/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/merge_trains/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/merge_trains/)
    * [18.8](https://docs.gitlab.com/18.8/api/merge_trains/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/merge_trains/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/merge_trains/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/merge_trains.html)
...
/
  ...
  5. [Merge trains](https://docs.gitlab.com/api/merge_trains/)
...
Use this API to interact with [merge trains](https://docs.gitlab.com/ci/pipelines/merge_trains/).
Prerequisites:
  * You must have the Developer, Maintainer, or Owner role.


All merge train endpoints support [offset-based pagination](https://docs.gitlab.com/api/rest/#offset-based-pagination) using the `page` and `per_page` parameters.
## List all merge trains for a project[](https://docs.gitlab.com/api/merge_trains/#list-all-merge-trains-for-a-project "Permalink")
...
## List all merge requests in a merge train[](https://docs.gitlab.com/api/merge_trains/#list-all-merge-requests-in-a-merge-train "Permalink")
...
## Retrieve merge train status[](https://docs.gitlab.com/api/merge_trains/#retrieve-merge-train-status "Permalink")
...
## Add a merge request to a merge train[](https://docs.gitlab.com/api/merge_trains/#add-a-merge-request-to-a-merge-train "Permalink")
...
If successful, returns:
  * [`201 Created`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) if the merge request is immediately added to the merge train.
  * [`202 Accepted`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) if the merge request is scheduled to be added to the merge train.
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/merge_trains.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/merge_trains.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all merge trains for a project](https://docs.gitlab.com/api/merge_trains/#list-all-merge-trains-for-a-project)
  * [List all merge requests in a merge train](https://docs.gitlab.com/api/merge_trains/#list-all-merge-requests-in-a-merge-train)
  * [Retrieve merge train status](https://docs.gitlab.com/api/merge_trains/#retrieve-merge-train-status)
  * [Add a merge request to a merge train](https://docs.gitlab.com/api/merge_trains/#add-a-merge-request-to-a-merge-train)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/merge_trains.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/merge_trains.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fmodel_registry%2F&_biz_t=1771981589805&_biz_i=Model%20registry%20API%20%7C%20GitLab%20Docs&_biz_n=97&rnd=711498&cdn_o=a&_biz_z=1771981589905)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fmerge_trains%2F&_biz_t=1771981589904&_biz_i=Merge%20trains%20API%20%7C%20GitLab%20Docs&_biz_n=98&rnd=850476&cdn_o=a&_biz_z=1771981589906)
