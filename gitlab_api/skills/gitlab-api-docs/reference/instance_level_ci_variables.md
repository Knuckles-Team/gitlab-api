[Skip to main content](https://docs.gitlab.com/api/instance_level_ci_variables/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/instance_level_ci_variables/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/instance_level_ci_variables/)
    * [18.8](https://docs.gitlab.com/18.8/api/instance_level_ci_variables/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/instance_level_ci_variables/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/instance_level_ci_variables/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/instance_level_ci_variables.html)
...
/
  ...
  5. [Instance CI/CD variables](https://docs.gitlab.com/api/instance_level_ci_variables/)
...
Use this API to interact with [CI/CD variables](https://docs.gitlab.com/ci/variables/#for-an-instance) for your instance.
## List all instance variables[](https://docs.gitlab.com/api/instance_level_ci_variables/#list-all-instance-variables "Permalink")
History
  * `description` parameter [introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/418331) in GitLab 16.8.


Lists all instance-level variables. Use the `page` and `per_page` [pagination](https://docs.gitlab.com/api/rest/#offset-based-pagination) parameters to control the pagination of results.
```
...
## Retrieve instance variable details[](https://docs.gitlab.com/api/instance_level_ci_variables/#retrieve-instance-variable-details "Permalink")
History
  * `description` parameter [introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/418331) in GitLab 16.8.
...
## Create instance variable[](https://docs.gitlab.com/api/instance_level_ci_variables/#create-instance-variable "Permalink")
History
  * `description` parameter [introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/418331) in GitLab 16.8.


Creates a new instance-level variable.
The [maximum number of instance-level variables](https://docs.gitlab.com/administration/instance_limits/#cicd-variable-limits) can be changed.
```
...
## Update instance variable[](https://docs.gitlab.com/api/instance_level_ci_variables/#update-instance-variable "Permalink")
History
  * `description` parameter [introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/418331) in GitLab 16.8.
...
## Delete instance variable[](https://docs.gitlab.com/api/instance_level_ci_variables/#delete-instance-variable "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/instance_level_ci_variables.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/instance_level_ci_variables.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all instance variables](https://docs.gitlab.com/api/instance_level_ci_variables/#list-all-instance-variables)
  * [Retrieve instance variable details](https://docs.gitlab.com/api/instance_level_ci_variables/#retrieve-instance-variable-details)
  * [Create instance variable](https://docs.gitlab.com/api/instance_level_ci_variables/#create-instance-variable)
  * [Update instance variable](https://docs.gitlab.com/api/instance_level_ci_variables/#update-instance-variable)
  * [Delete instance variable](https://docs.gitlab.com/api/instance_level_ci_variables/#delete-instance-variable)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/instance_level_ci_variables.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/instance_level_ci_variables.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Finstance_level_ci_variables%2F&_biz_t=1772174296814&_biz_i=Instance-level%20CI%2FCD%20variables%20API%20%7C%20GitLab%20Docs&_biz_n=75&rnd=448081&cdn_o=a&_biz_z=1772174296815)
