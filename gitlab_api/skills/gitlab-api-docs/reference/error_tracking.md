[Skip to main content](https://docs.gitlab.com/api/error_tracking/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/error_tracking/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/error_tracking/)
    * [18.8](https://docs.gitlab.com/18.8/api/error_tracking/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/error_tracking/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/error_tracking/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/error_tracking.html)
...
/
  ...
  5. [Error tracking](https://docs.gitlab.com/api/error_tracking/)
...
Use this API to interact with the Error Tracking feature for projects. For more information, see [Error Tracking](https://docs.gitlab.com/operations/error_tracking/).
Prerequisites:
  * You must have the Maintainer or Owner role.


## Get Error Tracking settings[](https://docs.gitlab.com/api/error_tracking/#get-error-tracking-settings "Permalink")
...
## Create Error Tracking settings[](https://docs.gitlab.com/api/error_tracking/#create-error-tracking-settings "Permalink")
History
...
This API is only available when used with [integrated error tracking](https://docs.gitlab.com/operations/integrated_error_tracking/).
```
...
## Activate the Error Tracking project settings[](https://docs.gitlab.com/api/error_tracking/#activate-the-error-tracking-project-settings "Permalink")
...
## List all project client keys[](https://docs.gitlab.com/api/error_tracking/#list-all-project-client-keys "Permalink")
Lists all [integrated error tracking](https://docs.gitlab.com/operations/integrated_error_tracking/) client keys for a specified project.
```
...
## Create a client key[](https://docs.gitlab.com/api/error_tracking/#create-a-client-key "Permalink")
Creates an [integrated error tracking](https://docs.gitlab.com/operations/integrated_error_tracking/) client key for a specified project. The public key attribute is generated automatically.
```
...
## Delete a client key[](https://docs.gitlab.com/api/error_tracking/#delete-a-client-key "Permalink")
Deletes an [integrated error tracking](https://docs.gitlab.com/operations/integrated_error_tracking/) client key from a specified project.
```
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/error_tracking.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/error_tracking.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Get Error Tracking settings](https://docs.gitlab.com/api/error_tracking/#get-error-tracking-settings)
  * [Create Error Tracking settings](https://docs.gitlab.com/api/error_tracking/#create-error-tracking-settings)
  * [Activate the Error Tracking project settings](https://docs.gitlab.com/api/error_tracking/#activate-the-error-tracking-project-settings)
  * [List all project client keys](https://docs.gitlab.com/api/error_tracking/#list-all-project-client-keys)
  * [Create a client key](https://docs.gitlab.com/api/error_tracking/#create-a-client-key)
  * [Delete a client key](https://docs.gitlab.com/api/error_tracking/#delete-a-client-key)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/error_tracking.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/error_tracking.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Ferror_tracking%2F&_biz_t=1772174257906&_biz_i=Error%20Tracking%20API%20%7C%20GitLab%20Docs&_biz_n=47&rnd=615527&cdn_o=a&_biz_z=1772174257907)
