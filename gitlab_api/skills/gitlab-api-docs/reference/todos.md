[Skip to main content](https://docs.gitlab.com/api/todos/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/todos/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/todos/)
    * [18.8](https://docs.gitlab.com/18.8/api/todos/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/todos/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/todos/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/todos.html)
...
/
  ...
  5. [To-Do List](https://docs.gitlab.com/api/todos/)
...
## List all to-do items[](https://docs.gitlab.com/api/todos/#list-all-to-do-items "Permalink")
...
## Mark a to-do item as done[](https://docs.gitlab.com/api/todos/#mark-a-to-do-item-as-done "Permalink")
...
## Mark all to-do items as done[](https://docs.gitlab.com/api/todos/#mark-all-to-do-items-as-done "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/todos.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/todos.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all to-do items](https://docs.gitlab.com/api/todos/#list-all-to-do-items)
  * [Mark a to-do item as done](https://docs.gitlab.com/api/todos/#mark-a-to-do-item-as-done)
  * [Mark all to-do items as done](https://docs.gitlab.com/api/todos/#mark-all-to-do-items-as-done)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/todos.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/todos.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Ftodos%2F&_biz_t=1772174481814&_biz_i=GitLab%20To-Do%20List%20API%20%7C%20GitLab%20Docs&_biz_n=180&rnd=725015&cdn_o=a&_biz_z=1772174481815)
