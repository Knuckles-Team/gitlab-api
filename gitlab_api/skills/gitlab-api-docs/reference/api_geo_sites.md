...
shell
```
curl --header "PRIVATE-TOKEN: YOUR_TOKEN" "https://primary.example.com/api/v4/geo_sites" \
     --request POST \
...
shell
```
curl --header "PRIVATE-TOKEN: YOUR_TOKEN" "https://primary.example.com/api/v4/geo_sites/1"
```
...
shell
```
curl --header "PRIVATE-TOKEN: YOUR_TOKEN" "https://primary.example.com/api/v4/geo_sites/status"
```
...
shell
```
curl --header "PRIVATE-TOKEN: YOUR_TOKEN" "https://primary.example.com/api/v4/geo_sites/2/status"
```
