[Skip to main content](https://docs.gitlab.com/install/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/install/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/install/)
    * [18.8](https://docs.gitlab.com/18.8/install/)
    * [18.7](https://archives.docs.gitlab.com/18.7/install/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/install/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/install/index.html)
...
[Cloud providers](https://docs.gitlab.com/install/cloud_providers/)
[Offline GitLab](https://docs.gitlab.com/topics/offline/)
[Reference architectures](https://docs.gitlab.com/administration/reference_architectures/)
[Steps after installing](https://docs.gitlab.com/install/next_steps/)
...
/
  ...
  2. [Install](https://docs.gitlab.com/install/)
...
[Installation requirements Prerequisites for installation.](https://docs.gitlab.com/install/requirements/)[Installation methods Linux, Helm, Docker, Operator, source, or scripts.](https://docs.gitlab.com/install/install_methods/)[Install GitLab on a cloud provider AWS, Google Cloud Platform, Azure.](https://docs.gitlab.com/install/cloud_providers/)[Offline GitLab Isolated installation.](https://docs.gitlab.com/topics/offline/)[Reference architectures Recommended deployments at scale.](https://docs.gitlab.com/administration/reference_architectures/)[Upgrade GitLab Upgrade GitLab to later versions.](https://docs.gitlab.com/update/)[Install GitLab Runner Run CI/CD jobs in a pipeline.](https://docs.gitlab.com/runner/install/)[Configure GitLab Runner Configuration and monitoring options.](https://docs.gitlab.com/runner/configuration/)[Install GitLab AI Gateway Gateway between GitLab and large language models.](https://docs.gitlab.com/install/install_ai_gateway/)
Was this page helpful?YesNo
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/install/_index.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/install/_index.md)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/install/_index.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/install/_index.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Finstall%2F&_biz_t=1772174506042&_biz_i=Install%20GitLab%20%7C%20GitLab%20Docs&_biz_n=198&rnd=768617&cdn_o=a&_biz_z=1772174506043)
