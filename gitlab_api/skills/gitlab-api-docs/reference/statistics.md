[Skip to main content](https://docs.gitlab.com/api/statistics/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/statistics/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/statistics/)
    * [18.8](https://docs.gitlab.com/18.8/api/statistics/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/statistics/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/statistics/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/statistics.html)
...
/
  ...
  5. [Application statistics](https://docs.gitlab.com/api/statistics/)
...
## Retrieve application statistics[](https://docs.gitlab.com/api/statistics/#retrieve-application-statistics "Permalink")
Retrieves statistics from your GitLab instance.
For values less than 10,000, this endpoint returns an exact count. For values of 10,000 and greater, this endpoint only returns approximate data when [TablesampleCountStrategy](https://gitlab.com/gitlab-org/gitlab/-/blob/master/lib/gitlab/database/count/tablesample_count_strategy.rb?ref_type=heads#L16) and [ReltuplesCountStrategy](https://gitlab.com/gitlab-org/gitlab/-/blob/master/lib/gitlab/database/count/reltuples_count_strategy.rb?ref_type=heads) strategies are used for calculations.
```
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/statistics.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/statistics.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Retrieve application statistics](https://docs.gitlab.com/api/statistics/#retrieve-application-statistics)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/statistics.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/statistics.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fstatistics%2F&_biz_t=1772174469493&_biz_i=Application%20statistics%20API%20%7C%20GitLab%20Docs&_biz_n=172&rnd=242970&cdn_o=a&_biz_z=1772174469500)
