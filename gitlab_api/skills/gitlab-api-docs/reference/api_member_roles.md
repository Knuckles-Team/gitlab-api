[Skip to main content](https://docs.gitlab.com/api/member_roles/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/member_roles/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/member_roles/)
    * [18.8](https://docs.gitlab.com/18.8/api/member_roles/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/member_roles/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/member_roles/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/member_roles.html)
...
/
  ...
  5. [Member roles](https://docs.gitlab.com/api/member_roles/)
...
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/96996) in GitLab 15.4. [Deployed behind the `customizable_roles` flag](https://docs.gitlab.com/administration/feature_flags/), disabled by default.
  ...
  * [Admin merge request introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/128302) in GitLab 16.4 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `admin_merge_request`. Disabled by default.
  * [Feature flag `admin_merge_request` removed](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/132578) in GitLab 16.5.
  * [Admin group members introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/131914) in GitLab 16.5 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `admin_group_member`. Disabled by default. The feature flag has been removed in GitLab 16.6.
  * [Manage project access tokens introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/132342) in GitLab 16.5 in [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `manage_project_access_tokens`. Disabled by default.
  ...
  * [Admin security testing introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/176628) in GitLab 17.9 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `custom_ability_admin_security_testing`. Disabled by default.


Use this API to interact with member roles for your GitLab.com groups or entire GitLab Self-Managed instance.
## Manage instance member roles[](https://docs.gitlab.com/api/member_roles/#manage-instance-member-roles "Permalink")
  * Tier: Ultimate
  * Offering: GitLab Self-Managed, GitLab Dedicated


Prerequisites:
  * [Authenticate yourself](https://docs.gitlab.com/api/rest/authentication/) as an administrator.


### Get all instance member roles[](https://docs.gitlab.com/api/member_roles/#get-all-instance-member-roles "Permalink")
...
### Create a instance member role[](https://docs.gitlab.com/api/member_roles/#create-a-instance-member-role "Permalink")
...
For more information on available permissions, see [custom permissions](https://docs.gitlab.com/user/custom_roles/abilities/).
Example request:
shell
```
curl --request POST \
...
### Delete an instance member role[](https://docs.gitlab.com/api/member_roles/#delete-an-instance-member-role "Permalink")
...
If successful, returns [`204`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and an empty response.
Example request:
shell
```
curl --request DELETE \
...
## Manage group member roles[](https://docs.gitlab.com/api/member_roles/#manage-group-member-roles "Permalink")
  * Tier: Ultimate
  * Offering: GitLab.com
...
### Get all group member roles[](https://docs.gitlab.com/api/member_roles/#get-all-group-member-roles "Permalink")
```
...
Attribute | Type | Required | Description
---|---|---|---
`id` | integer or string | yes | The ID or [URL-encoded path](https://docs.gitlab.com/api/rest/#namespaced-paths) of the group of the group
Example request:
shell
```
curl --request GET \
...
### Add a member role to a group[](https://docs.gitlab.com/api/member_roles/#add-a-member-role-to-a-group "Permalink")
History
...
In GitLab 16.3 and later, you can use the API to:
  * Add a name (required) and description (optional) when you [create a new custom role](https://docs.gitlab.com/user/custom_roles/#create-a-custom-member-role).
  * Update an existing custom role’s name and description.


### Remove member role of a group[](https://docs.gitlab.com/api/member_roles/#remove-member-role-of-a-group "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/member_roles.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/member_roles.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Manage instance member roles](https://docs.gitlab.com/api/member_roles/#manage-instance-member-roles)
  * [Get all instance member roles](https://docs.gitlab.com/api/member_roles/#get-all-instance-member-roles)
  * [Create a instance member role](https://docs.gitlab.com/api/member_roles/#create-a-instance-member-role)
  * [Delete an instance member role](https://docs.gitlab.com/api/member_roles/#delete-an-instance-member-role)
  * [Manage group member roles](https://docs.gitlab.com/api/member_roles/#manage-group-member-roles)
  * [Get all group member roles](https://docs.gitlab.com/api/member_roles/#get-all-group-member-roles)
  * [Add a member role to a group](https://docs.gitlab.com/api/member_roles/#add-a-member-role-to-a-group)
  * [Remove member role of a group](https://docs.gitlab.com/api/member_roles/#remove-member-role-of-a-group)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/member_roles.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/member_roles.md)
