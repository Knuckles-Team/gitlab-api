[Skip to main content](https://docs.gitlab.com/api/dependencies/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/dependencies/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/dependencies/)
    * [18.8](https://docs.gitlab.com/18.8/api/dependencies/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/dependencies/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/dependencies/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/dependencies.html)
...
/
  ...
  5. [Dependencies](https://docs.gitlab.com/api/dependencies/)
...
Every call to this endpoint requires authentication. To perform this call, user should be authorized to read repository. To see vulnerabilities in response, user should be authorized to read [Project Security Dashboard](https://docs.gitlab.com/user/application_security/security_dashboard/).
## List project dependencies[](https://docs.gitlab.com/api/dependencies/#list-project-dependencies "Permalink")
Get a list of project dependencies. This API partially mirroring [dependency list](https://docs.gitlab.com/user/application_security/dependency_list/) feature. This list can be generated only for [languages and package managers](https://docs.gitlab.com/user/application_security/dependency_scanning/#supported-languages-and-package-managers) supported by Gemnasium.
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/dependencies.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/dependencies.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List project dependencies](https://docs.gitlab.com/api/dependencies/#list-project-dependencies)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/dependencies.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/dependencies.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fdependencies%2F&_biz_t=1771981500340&_biz_i=Dependencies%20API%20%7C%20GitLab%20Docs&_biz_n=38&rnd=725789&cdn_o=a&_biz_z=1771981500341)
