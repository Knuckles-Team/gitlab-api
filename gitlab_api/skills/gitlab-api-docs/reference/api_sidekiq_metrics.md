[Skip to main content](https://docs.gitlab.com/api/sidekiq_metrics/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/sidekiq_metrics/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/sidekiq_metrics/)
    * [18.8](https://docs.gitlab.com/18.8/api/sidekiq_metrics/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/sidekiq_metrics/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/sidekiq_metrics/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/sidekiq_metrics.html)
...
/
  ...
  5. [Sidekiq metrics](https://docs.gitlab.com/api/sidekiq_metrics/)
...
## List all job queue metrics[](https://docs.gitlab.com/api/sidekiq_metrics/#list-all-job-queue-metrics "Permalink")
...
## List all Sidekiq processes[](https://docs.gitlab.com/api/sidekiq_metrics/#list-all-sidekiq-processes "Permalink")
...
## Retrieve job completion metrics[](https://docs.gitlab.com/api/sidekiq_metrics/#retrieve-job-completion-metrics "Permalink")
...
## List all Sidekiq metrics[](https://docs.gitlab.com/api/sidekiq_metrics/#list-all-sidekiq-metrics "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/sidekiq_metrics.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/sidekiq_metrics.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all job queue metrics](https://docs.gitlab.com/api/sidekiq_metrics/#list-all-job-queue-metrics)
  * [List all Sidekiq processes](https://docs.gitlab.com/api/sidekiq_metrics/#list-all-sidekiq-processes)
  * [Retrieve job completion metrics](https://docs.gitlab.com/api/sidekiq_metrics/#retrieve-job-completion-metrics)
  * [List all Sidekiq metrics](https://docs.gitlab.com/api/sidekiq_metrics/#list-all-sidekiq-metrics)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/sidekiq_metrics.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/sidekiq_metrics.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Ftags%2F&_biz_t=1771981722302&_biz_i=Tags%20API%20%7C%20GitLab%20Docs&_biz_n=170&rnd=615053&cdn_o=a&_biz_z=1771981722508)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fsidekiq_metrics%2F&_biz_t=1771981722508&_biz_i=Sidekiq%20Metrics%20API%20%7C%20GitLab%20Docs&_biz_n=171&rnd=104339&cdn_o=a&_biz_z=1771981722509)
