[Skip to main content](https://docs.gitlab.com/api/pipeline_triggers/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/pipeline_triggers/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/pipeline_triggers/)
    * [18.8](https://docs.gitlab.com/18.8/api/pipeline_triggers/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/pipeline_triggers/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/pipeline_triggers/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/pipeline_triggers.html)
...
/
  ...
  5. [Pipeline trigger tokens](https://docs.gitlab.com/api/pipeline_triggers/)
...
## List project trigger tokens[](https://docs.gitlab.com/api/pipeline_triggers/#list-project-trigger-tokens "Permalink")
...
## Retrieve trigger token details[](https://docs.gitlab.com/api/pipeline_triggers/#retrieve-trigger-token-details "Permalink")
...
## Create a trigger token[](https://docs.gitlab.com/api/pipeline_triggers/#create-a-trigger-token "Permalink")
...
## Update a pipeline trigger token[](https://docs.gitlab.com/api/pipeline_triggers/#update-a-pipeline-trigger-token "Permalink")
...
## Delete a pipeline trigger token[](https://docs.gitlab.com/api/pipeline_triggers/#delete-a-pipeline-trigger-token "Permalink")
...
## Trigger a pipeline with a token[](https://docs.gitlab.com/api/pipeline_triggers/#trigger-a-pipeline-with-a-token "Permalink")
History
  * `inputs` attribute [introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/519958) in GitLab 17.10 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `ci_inputs_for_pipelines`. Disabled by default.
...
Triggers a pipeline by using a [pipeline trigger token](https://docs.gitlab.com/ci/triggers/#create-a-pipeline-trigger-token) or a [CI/CD job token](https://docs.gitlab.com/ci/jobs/ci_job_token/) for authentication.
With a CI/CD job token, the [triggered pipeline is a multi-project pipeline](https://docs.gitlab.com/ci/pipelines/downstream_pipelines/#trigger-a-multi-project-pipeline-by-using-the-api). The job that authenticates the request becomes associated with the upstream pipeline, which is visible on the pipeline graph.
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/pipeline_triggers.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/pipeline_triggers.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List project trigger tokens](https://docs.gitlab.com/api/pipeline_triggers/#list-project-trigger-tokens)
  * [Retrieve trigger token details](https://docs.gitlab.com/api/pipeline_triggers/#retrieve-trigger-token-details)
  * [Create a trigger token](https://docs.gitlab.com/api/pipeline_triggers/#create-a-trigger-token)
  * [Update a pipeline trigger token](https://docs.gitlab.com/api/pipeline_triggers/#update-a-pipeline-trigger-token)
  * [Delete a pipeline trigger token](https://docs.gitlab.com/api/pipeline_triggers/#delete-a-pipeline-trigger-token)
  * [Trigger a pipeline with a token](https://docs.gitlab.com/api/pipeline_triggers/#trigger-a-pipeline-with-a-token)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/pipeline_triggers.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/pipeline_triggers.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpipelines%2F&_biz_t=1771981639518&_biz_i=Pipelines%20API%20%7C%20GitLab%20Docs&_biz_n=120&rnd=866101&cdn_o=a&_biz_z=1771981639622)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpipeline_triggers%2F&_biz_t=1771981639622&_biz_i=Pipeline%20trigger%20tokens%20API%20%7C%20GitLab%20Docs&_biz_n=121&rnd=651151&cdn_o=a&_biz_z=1771981639623)
