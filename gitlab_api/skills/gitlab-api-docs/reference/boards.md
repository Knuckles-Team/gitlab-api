[Skip to main content](https://docs.gitlab.com/api/boards/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/boards/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/boards/)
    * [18.8](https://docs.gitlab.com/18.8/api/boards/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/boards/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/boards/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/boards.html)
...
/
  ...
  6. [Issue boards](https://docs.gitlab.com/api/boards/)
...
Use this API to manage [issue boards](https://docs.gitlab.com/user/project/issue_board/). Every call to this API requires authentication.
If a user is not a member of a private project, a `GET` request on that project results in a `404` status code.
## List project issue boards[](https://docs.gitlab.com/api/boards/#list-project-issue-boards "Permalink")
...
## Show a single issue board[](https://docs.gitlab.com/api/boards/#show-a-single-issue-board "Permalink")
...
## Create an issue board[](https://docs.gitlab.com/api/boards/#create-an-issue-board "Permalink")
...
## Update an issue board[](https://docs.gitlab.com/api/boards/#update-an-issue-board "Permalink")
...
## Delete an issue board[](https://docs.gitlab.com/api/boards/#delete-an-issue-board "Permalink")
...
## List board lists in a project issue board[](https://docs.gitlab.com/api/boards/#list-board-lists-in-a-project-issue-board "Permalink")
...
## Show a single board list[](https://docs.gitlab.com/api/boards/#show-a-single-board-list "Permalink")
...
## Create a board list[](https://docs.gitlab.com/api/boards/#create-a-board-list "Permalink")
...
Label, assignee and milestone arguments are mutually exclusive, that is, only one of them are accepted in a request. Check the [issue board documentation](https://docs.gitlab.com/user/project/issue_board/) for more information regarding the required license for each list type.
shell
```
curl --request POST \
  --header "PRIVATE-TOKEN: <your_access_token>" \
...
## Reorder a list in a board[](https://docs.gitlab.com/api/boards/#reorder-a-list-in-a-board "Permalink")
...
## Delete a board list from a board[](https://docs.gitlab.com/api/boards/#delete-a-board-list-from-a-board "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/boards.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/boards.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List project issue boards](https://docs.gitlab.com/api/boards/#list-project-issue-boards)
  * [Show a single issue board](https://docs.gitlab.com/api/boards/#show-a-single-issue-board)
  * [Create an issue board](https://docs.gitlab.com/api/boards/#create-an-issue-board)
  * [Update an issue board](https://docs.gitlab.com/api/boards/#update-an-issue-board)
  * [Delete an issue board](https://docs.gitlab.com/api/boards/#delete-an-issue-board)
  * [List board lists in a project issue board](https://docs.gitlab.com/api/boards/#list-board-lists-in-a-project-issue-board)
  * [Show a single board list](https://docs.gitlab.com/api/boards/#show-a-single-board-list)
  * [Create a board list](https://docs.gitlab.com/api/boards/#create-a-board-list)
  * [Reorder a list in a board](https://docs.gitlab.com/api/boards/#reorder-a-list-in-a-board)
  * [Delete a board list from a board](https://docs.gitlab.com/api/boards/#delete-a-board-list-from-a-board)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/boards.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/boards.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fboards%2F&_biz_t=1772174218411&_biz_i=Project%20issue%20boards%20API%20%7C%20GitLab%20Docs&_biz_n=16&rnd=255079&cdn_o=a&_biz_z=1772174218412)
