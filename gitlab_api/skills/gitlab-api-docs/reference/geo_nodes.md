[Skip to main content](https://docs.gitlab.com/api/geo_nodes/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/geo_nodes/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/geo_nodes/)
    * [18.8](https://docs.gitlab.com/18.8/api/geo_nodes/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/geo_nodes/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/geo_nodes/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/geo_nodes.html)
...
/
  ...
  5. [Geo nodes (deprecated)](https://docs.gitlab.com/api/geo_nodes/)
...
The Geo Nodes API was [deprecated](https://gitlab.com/gitlab-org/gitlab/-/issues/369140) in GitLab 16.0 and is planned for removal in v5 of the API. Use the [Geo Sites API](https://docs.gitlab.com/api/geo_sites/) instead. This change is a breaking change.
Use this API to manage [Geo nodes](https://docs.gitlab.com/administration/geo/).
Prerequisites:
  * You must be an administrator.


## Create a Geo node[](https://docs.gitlab.com/api/geo_nodes/#create-a-geo-node "Permalink")
Creates a Geo node.
```
POST /geo_nodes
```
...
## List all Geo nodes[](https://docs.gitlab.com/api/geo_nodes/#list-all-geo-nodes "Permalink")
Lists all Geo nodes.
```
GET /geo_nodes
```
...
## Retrieve a Geo node[](https://docs.gitlab.com/api/geo_nodes/#retrieve-a-geo-node "Permalink")
...
## Update a Geo node[](https://docs.gitlab.com/api/geo_nodes/#update-a-geo-node "Permalink")
...
## Delete a Geo node[](https://docs.gitlab.com/api/geo_nodes/#delete-a-geo-node "Permalink")
Deletes a Geo node.
```
DELETE /geo_nodes/:id
```
...
---|---|---|---
`id` | integer | yes | The ID of the Geo node.
## Repair a Geo node[](https://docs.gitlab.com/api/geo_nodes/#repair-a-geo-node "Permalink")
...
## List all Geo node statuses[](https://docs.gitlab.com/api/geo_nodes/#list-all-geo-node-statuses "Permalink")
...
## Retrieve a Geo node status[](https://docs.gitlab.com/api/geo_nodes/#retrieve-a-geo-node-status "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/geo_nodes.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/geo_nodes.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Create a Geo node](https://docs.gitlab.com/api/geo_nodes/#create-a-geo-node)
  * [List all Geo nodes](https://docs.gitlab.com/api/geo_nodes/#list-all-geo-nodes)
  * [Retrieve a Geo node](https://docs.gitlab.com/api/geo_nodes/#retrieve-a-geo-node)
  * [Update a Geo node](https://docs.gitlab.com/api/geo_nodes/#update-a-geo-node)
  * [Delete a Geo node](https://docs.gitlab.com/api/geo_nodes/#delete-a-geo-node)
  * [Repair a Geo node](https://docs.gitlab.com/api/geo_nodes/#repair-a-geo-node)
  * [List all Geo node statuses](https://docs.gitlab.com/api/geo_nodes/#list-all-geo-node-statuses)
  * [Retrieve a Geo node status](https://docs.gitlab.com/api/geo_nodes/#retrieve-a-geo-node-status)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/geo_nodes.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/geo_nodes.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fgeo_nodes%2F&_biz_t=1772174270022&_biz_i=Geo%20Nodes%20API%20\(deprecated\)%20%7C%20GitLab%20Docs&_biz_n=54&rnd=252099&cdn_o=a&_biz_z=1772174270026)
