[Skip to main content](https://docs.gitlab.com/api/maven_virtual_registries/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/maven_virtual_registries/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/maven_virtual_registries/)
    * [18.8](https://docs.gitlab.com/18.8/api/maven_virtual_registries/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/maven_virtual_registries/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/maven_virtual_registries/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/maven_virtual_registries.html)
...
/
  ...
  5. [Maven virtual registry](https://docs.gitlab.com/api/maven_virtual_registries/)
...
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/161615) in GitLab 17.4 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `virtual_registry_maven`. Disabled by default.
...
## Manage Maven virtual registries[](https://docs.gitlab.com/api/maven_virtual_registries/#manage-maven-virtual-registries "Permalink")
Use the following endpoints to create and manage Maven virtual registries.
### List all virtual registries[](https://docs.gitlab.com/api/maven_virtual_registries/#list-all-virtual-registries "Permalink")
History
...
### Create a virtual registry[](https://docs.gitlab.com/api/maven_virtual_registries/#create-a-virtual-registry "Permalink")
...
### Retrieve a virtual registry[](https://docs.gitlab.com/api/maven_virtual_registries/#retrieve-a-virtual-registry "Permalink")
...
### Update a virtual registry[](https://docs.gitlab.com/api/maven_virtual_registries/#update-a-virtual-registry "Permalink")
...
If successful, returns a [`200 OK`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) status code.
### Delete a virtual registry[](https://docs.gitlab.com/api/maven_virtual_registries/#delete-a-virtual-registry "Permalink")
...
If successful, returns a [`204 No Content`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) status code.
### Delete cache entries for a virtual registry[](https://docs.gitlab.com/api/maven_virtual_registries/#delete-cache-entries-for-a-virtual-registry "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/538327) in GitLab 18.2 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `maven_virtual_registry`. Enabled by default.
...
If successful, returns a [`204 No Content`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) status code.
## Manage upstream registries[](https://docs.gitlab.com/api/maven_virtual_registries/#manage-upstream-registries "Permalink")
Use the following endpoints to configure and manage upstream Maven registries.
### List all upstream registries[](https://docs.gitlab.com/api/maven_virtual_registries/#list-all-upstream-registries "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/550728) in GitLab 18.3 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `maven_virtual_registry`. Enabled by default.
...
### Test upstream registry connection before creation[](https://docs.gitlab.com/api/maven_virtual_registries/#test-upstream-registry-connection-before-creation "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/535637) in GitLab 18.3 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `maven_virtual_registry`. Enabled by default.
...
#### Test workflow[](https://docs.gitlab.com/api/maven_virtual_registries/#test-workflow "Permalink")
...
### List all upstream registries for a virtual registry[](https://docs.gitlab.com/api/maven_virtual_registries/#list-all-upstream-registries-for-a-virtual-registry "Permalink")
...
### Create an upstream registry[](https://docs.gitlab.com/api/maven_virtual_registries/#create-an-upstream-registry "Permalink")
History
...
You cannot add two upstreams with the same URL and credentials (`username` and `password`) to the same top-level group. Instead, you can either:
  ...
  * [Associate an upstream](https://docs.gitlab.com/api/maven_virtual_registries/#associate-an-upstream-registry-with-a-virtual-registry) with multiple virtual registries.
...
### Retrieve an upstream registry[](https://docs.gitlab.com/api/maven_virtual_registries/#retrieve-an-upstream-registry "Permalink")
...
### Update an upstream registry[](https://docs.gitlab.com/api/maven_virtual_registries/#update-an-upstream-registry "Permalink")
History
  * `metadata_cache_validity_hours` [introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/556138) in GitLab 18.3.
...
If successful, returns a [`200 OK`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) status code.
### Update an upstream registry position[](https://docs.gitlab.com/api/maven_virtual_registries/#update-an-upstream-registry-position "Permalink")
...
If successful, returns a [`200 OK`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) status code.
### Delete an upstream registry[](https://docs.gitlab.com/api/maven_virtual_registries/#delete-an-upstream-registry "Permalink")
...
If successful, returns a [`204 No Content`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) status code.
### Associate an upstream registry with a virtual registry[](https://docs.gitlab.com/api/maven_virtual_registries/#associate-an-upstream-registry-with-a-virtual-registry "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/540276) in GitLab 18.1 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `maven_virtual_registry`. Disabled by default.
  * [Enabled on GitLab.com, GitLab Self-Managed, and GitLab Dedicated](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/197432) in GitLab 18.2.
...
### Disassociate an upstream registry from a virtual registry[](https://docs.gitlab.com/api/maven_virtual_registries/#disassociate-an-upstream-registry-from-a-virtual-registry "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/540276) in GitLab 18.1 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `maven_virtual_registry`. Disabled by default.
  * [Enabled on GitLab.com, GitLab Self-Managed, and GitLab Dedicated](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/197432) in GitLab 18.2.
...
If successful, returns a [`204 No Content`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) status code.
### Delete cache entries for an upstream registry[](https://docs.gitlab.com/api/maven_virtual_registries/#delete-cache-entries-for-an-upstream-registry "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/538327) in GitLab 18.2 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `maven_virtual_registry`. Enabled by default.
...
If successful, returns a [`204 No Content`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) status code.
### Test upstream registry connection[](https://docs.gitlab.com/api/maven_virtual_registries/#test-upstream-registry-connection "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/535637) in GitLab 18.3 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `maven_virtual_registry`. Enabled by default.
...
#### How the test works[](https://docs.gitlab.com/api/maven_virtual_registries/#how-the-test-works "Permalink")
...
### Test upstream registry connection with override parameters[](https://docs.gitlab.com/api/maven_virtual_registries/#test-upstream-registry-connection-with-override-parameters "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/565897) in GitLab 18.7 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `maven_virtual_registry`. Enabled by default.
...
#### How the test works[](https://docs.gitlab.com/api/maven_virtual_registries/#how-the-test-works-1 "Permalink")
...
## Manage cache entries[](https://docs.gitlab.com/api/maven_virtual_registries/#manage-cache-entries "Permalink")
Use the following endpoints to manage cache entries for a Maven virtual registry.
### List all upstream registry cache entries[](https://docs.gitlab.com/api/maven_virtual_registries/#list-all-upstream-registry-cache-entries "Permalink")
...
### Delete an upstream registry cache entry[](https://docs.gitlab.com/api/maven_virtual_registries/#delete-an-upstream-registry-cache-entry "Permalink")
...
If successful, returns a [`204 No Content`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) status code.
## Manage package operations[](https://docs.gitlab.com/api/maven_virtual_registries/#manage-package-operations "Permalink")
...
These endpoints do not adhere to the [REST API authentication methods](https://docs.gitlab.com/api/rest/authentication/). For more information on which headers and token types are supported, see [Maven virtual registry](https://docs.gitlab.com/user/packages/virtual_registry/maven/). Undocumented authentication methods might be removed in the future.
### Download a package[](https://docs.gitlab.com/api/maven_virtual_registries/#download-a-package "Permalink")
Downloads a package from a specified Maven virtual registry. To access this resource, you must [authenticate with the registry](https://docs.gitlab.com/user/packages/package_registry/supported_functionality/#authenticate-with-the-registry).
```
...
If successful, returns [`200 OK`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and the following response headers:
...
### Upload a package[](https://docs.gitlab.com/api/maven_virtual_registries/#upload-a-package "Permalink")
Uploads a package to a specified Maven virtual registry. This endpoint is accessible only by [GitLab Workhorse](https://docs.gitlab.com/development/workhorse/).
```
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/maven_virtual_registries.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/maven_virtual_registries.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Manage Maven virtual registries](https://docs.gitlab.com/api/maven_virtual_registries/#manage-maven-virtual-registries)
  * [List all virtual registries](https://docs.gitlab.com/api/maven_virtual_registries/#list-all-virtual-registries)
  * [Create a virtual registry](https://docs.gitlab.com/api/maven_virtual_registries/#create-a-virtual-registry)
  * [Retrieve a virtual registry](https://docs.gitlab.com/api/maven_virtual_registries/#retrieve-a-virtual-registry)
  * [Update a virtual registry](https://docs.gitlab.com/api/maven_virtual_registries/#update-a-virtual-registry)
  * [Delete a virtual registry](https://docs.gitlab.com/api/maven_virtual_registries/#delete-a-virtual-registry)
  * [Delete cache entries for a virtual registry](https://docs.gitlab.com/api/maven_virtual_registries/#delete-cache-entries-for-a-virtual-registry)
  * [Manage upstream registries](https://docs.gitlab.com/api/maven_virtual_registries/#manage-upstream-registries)
  * [List all upstream registries](https://docs.gitlab.com/api/maven_virtual_registries/#list-all-upstream-registries)
  * [Test upstream registry connection before creation](https://docs.gitlab.com/api/maven_virtual_registries/#test-upstream-registry-connection-before-creation)
  * [Test workflow](https://docs.gitlab.com/api/maven_virtual_registries/#test-workflow)
  * [List all upstream registries for a virtual registry](https://docs.gitlab.com/api/maven_virtual_registries/#list-all-upstream-registries-for-a-virtual-registry)
  * [Create an upstream registry](https://docs.gitlab.com/api/maven_virtual_registries/#create-an-upstream-registry)
  * [Retrieve an upstream registry](https://docs.gitlab.com/api/maven_virtual_registries/#retrieve-an-upstream-registry)
  * [Update an upstream registry](https://docs.gitlab.com/api/maven_virtual_registries/#update-an-upstream-registry)
  * [Update an upstream registry position](https://docs.gitlab.com/api/maven_virtual_registries/#update-an-upstream-registry-position)
  * [Delete an upstream registry](https://docs.gitlab.com/api/maven_virtual_registries/#delete-an-upstream-registry)
  * [Associate an upstream registry with a virtual registry](https://docs.gitlab.com/api/maven_virtual_registries/#associate-an-upstream-registry-with-a-virtual-registry)
  * [Disassociate an upstream registry from a virtual registry](https://docs.gitlab.com/api/maven_virtual_registries/#disassociate-an-upstream-registry-from-a-virtual-registry)
  * [Delete cache entries for an upstream registry](https://docs.gitlab.com/api/maven_virtual_registries/#delete-cache-entries-for-an-upstream-registry)
  * [Test upstream registry connection](https://docs.gitlab.com/api/maven_virtual_registries/#test-upstream-registry-connection)
  * [How the test works](https://docs.gitlab.com/api/maven_virtual_registries/#how-the-test-works)
  * [Test upstream registry connection with override parameters](https://docs.gitlab.com/api/maven_virtual_registries/#test-upstream-registry-connection-with-override-parameters)
  * [How the test works](https://docs.gitlab.com/api/maven_virtual_registries/#how-the-test-works-1)
  * [Manage cache entries](https://docs.gitlab.com/api/maven_virtual_registries/#manage-cache-entries)
  * [List all upstream registry cache entries](https://docs.gitlab.com/api/maven_virtual_registries/#list-all-upstream-registry-cache-entries)
  * [Delete an upstream registry cache entry](https://docs.gitlab.com/api/maven_virtual_registries/#delete-an-upstream-registry-cache-entry)
  * [Manage package operations](https://docs.gitlab.com/api/maven_virtual_registries/#manage-package-operations)
  * [Download a package](https://docs.gitlab.com/api/maven_virtual_registries/#download-a-package)
  * [Upload a package](https://docs.gitlab.com/api/maven_virtual_registries/#upload-a-package)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/maven_virtual_registries.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/maven_virtual_registries.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fmaven_virtual_registries%2F&_biz_t=1772174322809&_biz_i=Maven%20virtual%20registry%20API%20%7C%20GitLab%20Docs&_biz_n=89&rnd=969180&cdn_o=a&_biz_z=1772174322810)
