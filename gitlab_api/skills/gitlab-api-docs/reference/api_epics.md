[Skip to main content](https://docs.gitlab.com/api/epics/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/epics/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/epics/)
    * [18.8](https://docs.gitlab.com/18.8/api/epics/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/epics/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/epics/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/epics.html)
...
/
  ...
  5. [Epics (deprecated)](https://docs.gitlab.com/api/epics/)
...
## Legacy Epic IDs and WorkItem IDs[](https://docs.gitlab.com/api/epics/#legacy-epic-ids-and-workitem-ids "Permalink")
...
## Epic issues API[](https://docs.gitlab.com/api/epics/#epic-issues-api "Permalink")
The [epic issues API](https://docs.gitlab.com/api/epic_issues/) allows you to interact with issues associated with an epic.
## Milestone dates integration[](https://docs.gitlab.com/api/epics/#milestone-dates-integration "Permalink")
...
## List all group epics[](https://docs.gitlab.com/api/epics/#list-all-group-epics "Permalink")
...
## Retrieve an epic[](https://docs.gitlab.com/api/epics/#retrieve-an-epic "Permalink")
...
## Create an epic[](https://docs.gitlab.com/api/epics/#create-an-epic "Permalink")
...
## Update an epic[](https://docs.gitlab.com/api/epics/#update-an-epic "Permalink")
...
## Delete an epic[](https://docs.gitlab.com/api/epics/#delete-an-epic "Permalink")
History
...
## Create a to-do item for an epic[](https://docs.gitlab.com/api/epics/#create-a-to-do-item-for-an-epic "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/epics.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/epics.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Legacy Epic IDs and WorkItem IDs](https://docs.gitlab.com/api/epics/#legacy-epic-ids-and-workitem-ids)
  * [Epic issues API](https://docs.gitlab.com/api/epics/#epic-issues-api)
  * [Milestone dates integration](https://docs.gitlab.com/api/epics/#milestone-dates-integration)
  * [List all group epics](https://docs.gitlab.com/api/epics/#list-all-group-epics)
  * [Retrieve an epic](https://docs.gitlab.com/api/epics/#retrieve-an-epic)
  * [Create an epic](https://docs.gitlab.com/api/epics/#create-an-epic)
  * [Update an epic](https://docs.gitlab.com/api/epics/#update-an-epic)
  * [Delete an epic](https://docs.gitlab.com/api/epics/#delete-an-epic)
  * [Create a to-do item for an epic](https://docs.gitlab.com/api/epics/#create-a-to-do-item-for-an-epic)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/epics.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/epics.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fepics%2F&_biz_t=1771981512301&_biz_i=Epics%20API%20\(deprecated\)%20%7C%20GitLab%20Docs&_biz_n=40&rnd=896853&cdn_o=a&_biz_z=1771981512301)
