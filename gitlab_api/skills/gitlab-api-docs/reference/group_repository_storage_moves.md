[Skip to main content](https://docs.gitlab.com/api/group_repository_storage_moves/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/group_repository_storage_moves/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/group_repository_storage_moves/)
    * [18.8](https://docs.gitlab.com/18.8/api/group_repository_storage_moves/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/group_repository_storage_moves/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/group_repository_storage_moves/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/group_repository_storage_moves.html)
...
/
  ...
  6. [Repository storage moves](https://docs.gitlab.com/api/group_repository_storage_moves/)
...
This API requires you to [authenticate yourself](https://docs.gitlab.com/api/rest/authentication/) as an administrator.
APIs are also available to move other types of repositories:
  * [Project repository storage moves API](https://docs.gitlab.com/api/project_repository_storage_moves/).
  * [Snippet repository storage moves API](https://docs.gitlab.com/api/snippet_repository_storage_moves/).


## List all group repository storage moves[](https://docs.gitlab.com/api/group_repository_storage_moves/#list-all-group-repository-storage-moves "Permalink")
Lists all group repository storage moves for an instance.
```
GET /group_repository_storage_moves
```

By default, `GET` requests return 20 results at a time, because the API results are [paginated](https://docs.gitlab.com/api/rest/#pagination).
Example request:
shell
```
...
## List all repository storage moves for a group[](https://docs.gitlab.com/api/group_repository_storage_moves/#list-all-repository-storage-moves-for-a-group "Permalink")
...
## Retrieve a group repository storage move[](https://docs.gitlab.com/api/group_repository_storage_moves/#retrieve-a-group-repository-storage-move "Permalink")
...
## Retrieve a repository storage move for a group[](https://docs.gitlab.com/api/group_repository_storage_moves/#retrieve-a-repository-storage-move-for-a-group "Permalink")
...
## Create a group repository storage move[](https://docs.gitlab.com/api/group_repository_storage_moves/#create-a-group-repository-storage-move "Permalink")
Creates a group repository storage move for a specified group. This endpoint:
  * Moves only group Wiki repositories.
  * Doesn’t move repositories for projects in a group. To schedule project moves, use the [Project repository storage moves](https://docs.gitlab.com/api/project_repository_storage_moves/) API.
...
---|---|---|---
`group_id` | integer | yes | ID of the group.
`destination_storage_name` | string | no | Name of the destination storage shard. The storage is selected [based on storage weights](https://docs.gitlab.com/administration/repository_storage_paths/#configure-where-new-repositories-are-stored) if not provided.
Example request:
shell
```
...
## Create group repository storage moves for a storage shard[](https://docs.gitlab.com/api/group_repository_storage_moves/#create-group-repository-storage-moves-for-a-storage-shard "Permalink")
...
## Related topics[](https://docs.gitlab.com/api/group_repository_storage_moves/#related-topics "Permalink")
  * [Moving repositories managed by GitLab](https://docs.gitlab.com/administration/operations/moving_repositories/)


Was this page helpful?YesNo
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_repository_storage_moves.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_repository_storage_moves.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all group repository storage moves](https://docs.gitlab.com/api/group_repository_storage_moves/#list-all-group-repository-storage-moves)
  * [List all repository storage moves for a group](https://docs.gitlab.com/api/group_repository_storage_moves/#list-all-repository-storage-moves-for-a-group)
  * [Retrieve a group repository storage move](https://docs.gitlab.com/api/group_repository_storage_moves/#retrieve-a-group-repository-storage-move)
  * [Retrieve a repository storage move for a group](https://docs.gitlab.com/api/group_repository_storage_moves/#retrieve-a-repository-storage-move-for-a-group)
  * [Create a group repository storage move](https://docs.gitlab.com/api/group_repository_storage_moves/#create-a-group-repository-storage-move)
  * [Create group repository storage moves for a storage shard](https://docs.gitlab.com/api/group_repository_storage_moves/#create-group-repository-storage-moves-for-a-storage-shard)
  * [Related topics](https://docs.gitlab.com/api/group_repository_storage_moves/#related-topics)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_repository_storage_moves.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_repository_storage_moves.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fgroups%2F&_biz_t=1772174296309&_biz_i=Groups%20API%20%7C%20GitLab%20Docs&_biz_n=72&rnd=661917&cdn_o=a&_biz_z=1772174296501)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fgroup_repository_storage_moves%2F&_biz_t=1772174296496&_biz_i=Group%20repository%20storage%20moves%20API%20%7C%20GitLab%20Docs&_biz_n=73&rnd=56314&cdn_o=a&_biz_z=1772174296502)
