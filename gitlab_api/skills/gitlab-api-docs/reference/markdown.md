[Skip to main content](https://docs.gitlab.com/api/markdown/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/markdown/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/markdown/)
    * [18.8](https://docs.gitlab.com/18.8/api/markdown/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/markdown/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/markdown/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/markdown.html)
...
/
  ...
  5. [Markdown](https://docs.gitlab.com/api/markdown/)
...
History
  * Introduced [required authentication](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/93727) in GitLab 15.3 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `authenticate_markdown_api`. Enabled by default.


Use this API to render [Markdown](https://docs.gitlab.com/user/markdown/) content as HTML.
All requests to this API must be [authenticated](https://docs.gitlab.com/api/rest/authentication/).
The availability of this feature is controlled by a feature flag. For more information, see the history. This feature is available for testing, but not ready for production use.
## Render an arbitrary Markdown document[](https://docs.gitlab.com/api/markdown/#render-an-arbitrary-markdown-document "Permalink")
```
POST /markdown
```
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/markdown.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/markdown.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Render an arbitrary Markdown document](https://docs.gitlab.com/api/markdown/#render-an-arbitrary-markdown-document)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/markdown.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/markdown.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fmarkdown%2F&_biz_t=1772174323234&_biz_i=Markdown%20API%20%7C%20GitLab%20Docs&_biz_n=91&rnd=511699&cdn_o=a&_biz_z=1772174323235)
