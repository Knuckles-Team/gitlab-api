[Skip to main content](https://docs.gitlab.com/api/packages/rubygems/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/packages/rubygems/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/packages/rubygems/)
    * [18.8](https://docs.gitlab.com/18.8/api/packages/rubygems/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/packages/rubygems/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/packages/rubygems/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/packages/rubygems.html)
...
/
  ...
  5. [Ruby gems](https://docs.gitlab.com/api/packages/rubygems/)
...
Use this API to interact with the [Ruby gems and Bundler package manager clients](https://docs.gitlab.com/user/packages/rubygems_registry/).
This API is used by the [Ruby gems and Bundler package manager clients](https://maven.apache.org/) and is generally not meant for manual consumption. This API is under development and is not ready for production use due to limited functionality.
These endpoints do not adhere to the standard API authentication methods. See the [Ruby gems registry documentation](https://docs.gitlab.com/user/packages/rubygems_registry/) for details on which headers and token types are supported. Undocumented authentication methods might be removed in the future.
## Enable the Ruby gems API[](https://docs.gitlab.com/api/packages/rubygems/#enable-the-ruby-gems-api "Permalink")
...
## Download a gem file[](https://docs.gitlab.com/api/packages/rubygems/#download-a-gem-file "Permalink")
...
## Retrieve dependencies[](https://docs.gitlab.com/api/packages/rubygems/#retrieve-dependencies "Permalink")
Retrieves a list of dependencies for specified gems.
The response is a marshalled array of hashes for all versions of the requested gems. Because the response is marshalled, you can store it in a file.
```
...
If Ruby is installed, you can use the following Ruby command to read the response. For this to work, you must either [set your credentials in `~/.gem/credentials`](https://docs.gitlab.com/user/packages/rubygems_registry/#authenticate-to-the-package-registry), or pass your access token to the request:
shell
```
...
## Upload a gem[](https://docs.gitlab.com/api/packages/rubygems/#upload-a-gem "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/rubygems.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/rubygems.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Enable the Ruby gems API](https://docs.gitlab.com/api/packages/rubygems/#enable-the-ruby-gems-api)
  * [Download a gem file](https://docs.gitlab.com/api/packages/rubygems/#download-a-gem-file)
  * [Retrieve dependencies](https://docs.gitlab.com/api/packages/rubygems/#retrieve-dependencies)
  * [Upload a gem](https://docs.gitlab.com/api/packages/rubygems/#upload-a-gem)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/rubygems.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/rubygems.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpackages%2Frubygems%2F&_biz_t=1772174400303&_biz_i=Ruby%20gems%20API%20%7C%20GitLab%20Docs&_biz_n=117&rnd=969424&cdn_o=a&_biz_z=1772174400304)
