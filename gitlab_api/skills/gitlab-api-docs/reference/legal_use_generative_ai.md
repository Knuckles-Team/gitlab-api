[Skip to main content](https://docs.gitlab.com/legal/use_generative_ai/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/legal/use_generative_ai/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/legal/use_generative_ai/)
    * [18.8](https://docs.gitlab.com/18.8/legal/use_generative_ai/)
    * [18.7](https://archives.docs.gitlab.com/18.7/legal/use_generative_ai/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/legal/use_generative_ai/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/legal/use_generative_ai.html)
...
Some content on `docs.gitlab.com` was created with the assistance of generative AI tools. All content, AI-generated or human-created, is reviewed for accuracy and readability by a GitLab team member.
Translations of English documentation into other languages are created using a mix of human translation, automation, and AI-assisted translation. AI-assisted translations can appear in the documentation before human review is complete, or with only limited human review, to give non-English users faster access to the latest information. AI-assisted translations will be reviewed by a human and updated as needed for quality and accuracy. The English language documentation serves as the authoritative source.
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/legal/use_generative_ai.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/legal/use_generative_ai.md)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/legal/use_generative_ai.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/legal/use_generative_ai.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Flegal%2Fuse_generative_ai%2F&_biz_t=1772174506446&_biz_i=Use%20of%20generative%20AI%20%7C%20GitLab%20Docs&_biz_n=200&rnd=334306&cdn_o=a&_biz_z=1772174506447)
