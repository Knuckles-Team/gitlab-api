[Skip to main content](https://docs.gitlab.com/api/project_members/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/project_members/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/project_members/)
    * [18.8](https://docs.gitlab.com/18.8/api/project_members/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/project_members/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/project_members/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/project_members.html)
...
/
  ...
  6. [Members](https://docs.gitlab.com/api/project_members/)
...
For information about group members, see the [Group members API](https://docs.gitlab.com/api/group_members/).
## Known issues[](https://docs.gitlab.com/api/project_members/#known-issues "Permalink")
...
## List all members of a project[](https://docs.gitlab.com/api/project_members/#list-all-members-of-a-project "Permalink")
...
## List all members of a project, including inherited and invited members[](https://docs.gitlab.com/api/project_members/#list-all-members-of-a-project-including-inherited-and-invited-members "Permalink")
History
...
## Get a member of a project[](https://docs.gitlab.com/api/project_members/#get-a-member-of-a-project "Permalink")
...
## Get a member of a project, including inherited and invited members[](https://docs.gitlab.com/api/project_members/#get-a-member-of-a-project-including-inherited-and-invited-members "Permalink")
History
...
Gets a member of a project, including members inherited or invited through ancestor groups. See the corresponding [endpoint to list all inherited members](https://docs.gitlab.com/api/project_members/#list-all-members-of-a-project-including-inherited-and-invited-members) for details.
The invited group members have shared membership in the shared group or project. This means that if the requester is a member of a shared group or project, but not a member of an invited private group, then using this endpoint the requester can get all the shared group or project members, including the invited private group members.
```
...
## Add a member to a project[](https://docs.gitlab.com/api/project_members/#add-a-member-to-a-project "Permalink")
Adds a member to a project.
To give a group access to a project, see [share a project with group](https://docs.gitlab.com/api/projects/#share-a-project-with-a-group).
```
...
`access_level` | integer | yes | A valid [access level](https://docs.gitlab.com/user/permissions/#default-roles) Possible values: `0` (No access), `5` (Minimal access), `10` (Guest), `15` (Planner), `20` (Reporter), `30` (Developer), `40` (Maintainer), or `50` (Owner). Default: `30`.
...
## Edit a member of a project[](https://docs.gitlab.com/api/project_members/#edit-a-member-of-a-project "Permalink")
...
## Remove a member from a project[](https://docs.gitlab.com/api/project_members/#remove-a-member-from-a-project "Permalink")
Removes a user from a project where the user has been explicitly assigned a role.
The user needs to be a group member to qualify for removal. For example, if the user was added directly to a project in the group but not this group explicitly, you cannot use this endpoint to remove them. For more information, see [Remove a billable member from a group](https://docs.gitlab.com/api/group_members/#remove-a-billable-group-member).
```
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/project_members.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/project_members.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Known issues](https://docs.gitlab.com/api/project_members/#known-issues)
  * [List all members of a project](https://docs.gitlab.com/api/project_members/#list-all-members-of-a-project)
  * [List all members of a project, including inherited and invited members](https://docs.gitlab.com/api/project_members/#list-all-members-of-a-project-including-inherited-and-invited-members)
  * [Get a member of a project](https://docs.gitlab.com/api/project_members/#get-a-member-of-a-project)
  * [Get a member of a project, including inherited and invited members](https://docs.gitlab.com/api/project_members/#get-a-member-of-a-project-including-inherited-and-invited-members)
  * [Add a member to a project](https://docs.gitlab.com/api/project_members/#add-a-member-to-a-project)
  * [Edit a member of a project](https://docs.gitlab.com/api/project_members/#edit-a-member-of-a-project)
  * [Remove a member from a project](https://docs.gitlab.com/api/project_members/#remove-a-member-from-a-project)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/project_members.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/project_members.md)
