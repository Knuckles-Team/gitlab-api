[Skip to main content](https://docs.gitlab.com/api/dora/metrics/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/dora/metrics/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/dora/metrics/)
    * [18.8](https://docs.gitlab.com/18.8/api/dora/metrics/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/dora/metrics/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/dora/metrics/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/dora/metrics.html)
...
/
  ...
  5. [DORA4 metrics](https://docs.gitlab.com/api/dora/metrics/)
...
Use this API to retrieve details of [DORA metrics](https://docs.gitlab.com/user/analytics/dora_metrics/) for your groups and projects.
Additional endpoints are available with the [GraphQL API](https://docs.gitlab.com/api/graphql/reference/).
Prerequisites:
  * You must have the Reporter, Developer, Maintainer, or Owner role.


## Retrieve project-level DORA metrics[](https://docs.gitlab.com/api/dora/metrics/#retrieve-project-level-dora-metrics "Permalink")
...
---|---|---|---
`id` | integer or string | yes | The ID or [URL-encoded path of the project](https://docs.gitlab.com/api/rest/#namespaced-paths) can be accessed by the authenticated user.
...
`environment_tiers` | array of strings | no | The [tiers of the environments](https://docs.gitlab.com/ci/environments/#deployment-tier-of-environments). Default is `production`.
...
## Retrieve group-level DORA metrics[](https://docs.gitlab.com/api/dora/metrics/#retrieve-group-level-dora-metrics "Permalink")
...
## The `value` field[](https://docs.gitlab.com/api/dora/metrics/#the-value-field "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/dora/metrics.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/dora/metrics.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Retrieve project-level DORA metrics](https://docs.gitlab.com/api/dora/metrics/#retrieve-project-level-dora-metrics)
  * [Retrieve group-level DORA metrics](https://docs.gitlab.com/api/dora/metrics/#retrieve-group-level-dora-metrics)
  * [The value field](https://docs.gitlab.com/api/dora/metrics/#the-value-field)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/dora/metrics.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/dora/metrics.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fdiscussions%2F&_biz_t=1772174256304&_biz_i=Discussions%20API%20%7C%20GitLab%20Docs&_biz_n=39&rnd=41271&cdn_o=a&_biz_z=1772174256837)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fdraft_notes%2F&_biz_t=1772174256399&_biz_i=Draft%20Notes%20API%20%7C%20GitLab%20Docs&_biz_n=40&rnd=217832&cdn_o=a&_biz_z=1772174256838)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fdora%2Fmetrics%2F&_biz_t=1772174256836&_biz_i=DevOps%20Research%20and%20Assessment%20\(DORA\)%20metrics%20API%20%7C%20GitLab%20Docs&_biz_n=42&rnd=413045&cdn_o=a&_biz_z=1772174256838)
