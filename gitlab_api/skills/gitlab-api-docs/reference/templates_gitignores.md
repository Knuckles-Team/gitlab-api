[Skip to main content](https://docs.gitlab.com/api/templates/gitignores/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/templates/gitignores/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/templates/gitignores/)
    * [18.8](https://docs.gitlab.com/18.8/api/templates/gitignores/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/templates/gitignores/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/templates/gitignores/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/templates/gitignores.html)
...
/
  ...
  5. [.gitignore (templates)](https://docs.gitlab.com/api/templates/gitignores/)
...
Users with the Guest role can’t access the `.gitignore` templates. For more information, see [Project and group visibility](https://docs.gitlab.com/user/public_access/).
## List all `.gitignore` templates[](https://docs.gitlab.com/api/templates/gitignores/#list-all-gitignore-templates "Permalink")
...
## Retrieve a single `.gitignore` template[](https://docs.gitlab.com/api/templates/gitignores/#retrieve-a-single-gitignore-template "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/templates/gitignores.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/templates/gitignores.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all .gitignore templates](https://docs.gitlab.com/api/templates/gitignores/#list-all-gitignore-templates)
  * [Retrieve a single .gitignore template](https://docs.gitlab.com/api/templates/gitignores/#retrieve-a-single-gitignore-template)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/templates/gitignores.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/templates/gitignores.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Ftemplates%2Fgitignores%2F&_biz_t=1772174481504&_biz_i=.gitignore%20API%20%7C%20GitLab%20Docs&_biz_n=178&rnd=656537&cdn_o=a&_biz_z=1772174481505)
