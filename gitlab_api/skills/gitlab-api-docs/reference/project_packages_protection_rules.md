[Skip to main content](https://docs.gitlab.com/api/project_packages_protection_rules/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/project_packages_protection_rules/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/project_packages_protection_rules/)
    * [18.8](https://docs.gitlab.com/18.8/api/project_packages_protection_rules/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/project_packages_protection_rules/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/project_packages_protection_rules/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/project_packages_protection_rules.html)
...
/
  ...
  6. [Protected packages](https://docs.gitlab.com/api/project_packages_protection_rules/)
...
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/151741) in GitLab 17.1 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `packages_protected_packages`. Disabled by default.
  ...
  * [Added](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/180063) `minimum_access_level_for_delete` attribute in GitLab 17.11 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `packages_protected_packages_delete`. Disabled by default.


Use this API to manage [protection rules for packages](https://docs.gitlab.com/user/packages/package_registry/package_protection_rules/).
## List package protection rules[](https://docs.gitlab.com/api/project_packages_protection_rules/#list-package-protection-rules "Permalink")
...
If successful, returns [`200`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and a list of package protection rules.
...
## Create a package protection rule[](https://docs.gitlab.com/api/project_packages_protection_rules/#create-a-package-protection-rule "Permalink")
...
If successful, returns [`201`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and the created package protection rule.
Can return the following status codes:
...
## Update a package protection rule[](https://docs.gitlab.com/api/project_packages_protection_rules/#update-a-package-protection-rule "Permalink")
...
If successful, returns [`200`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and the updated package protection rule.
Can return the following status codes:
...
## Delete a package protection rule[](https://docs.gitlab.com/api/project_packages_protection_rules/#delete-a-package-protection-rule "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/project_packages_protection_rules.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/project_packages_protection_rules.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List package protection rules](https://docs.gitlab.com/api/project_packages_protection_rules/#list-package-protection-rules)
  * [Create a package protection rule](https://docs.gitlab.com/api/project_packages_protection_rules/#create-a-package-protection-rule)
  * [Update a package protection rule](https://docs.gitlab.com/api/project_packages_protection_rules/#update-a-package-protection-rule)
  * [Delete a package protection rule](https://docs.gitlab.com/api/project_packages_protection_rules/#delete-a-package-protection-rule)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/project_packages_protection_rules.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/project_packages_protection_rules.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fproject_packages_protection_rules%2F&_biz_t=1772174416416&_biz_i=Protected%20packages%20API%20%7C%20GitLab%20Docs&_biz_n=135&rnd=128299&cdn_o=a&_biz_z=1772174416417)
