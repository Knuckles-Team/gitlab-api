[Skip to main content](https://docs.gitlab.com/api/model_registry/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/model_registry/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/model_registry/)
    * [18.8](https://docs.gitlab.com/18.8/api/model_registry/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/model_registry/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/model_registry/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/model_registry.html)
...
/
  ...
  5. [Model registry](https://docs.gitlab.com/api/model_registry/)
...
## Download a machine learning model package file[](https://docs.gitlab.com/api/model_registry/#download-a-machine-learning-model-package-file "Permalink")
...
If successful, returns [`200 OK`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and the file contents.
Example request:
shell
```
...
## Upload a model package file[](https://docs.gitlab.com/api/model_registry/#upload-a-model-package-file "Permalink")
Uploads a file to a machine learning model package.
### Authorize the upload[](https://docs.gitlab.com/api/model_registry/#authorize-the-upload "Permalink")
...
### Send the file[](https://docs.gitlab.com/api/model_registry/#send-the-file "Permalink")
...
## Model version and candidate IDs[](https://docs.gitlab.com/api/model_registry/#model-version-and-candidate-ids "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/model_registry.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/model_registry.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Download a machine learning model package file](https://docs.gitlab.com/api/model_registry/#download-a-machine-learning-model-package-file)
  * [Upload a model package file](https://docs.gitlab.com/api/model_registry/#upload-a-model-package-file)
  * [Authorize the upload](https://docs.gitlab.com/api/model_registry/#authorize-the-upload)
  * [Send the file](https://docs.gitlab.com/api/model_registry/#send-the-file)
  * [Model version and candidate IDs](https://docs.gitlab.com/api/model_registry/#model-version-and-candidate-ids)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/model_registry.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/model_registry.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fmodel_registry%2F&_biz_t=1772174336501&_biz_i=Model%20registry%20API%20%7C%20GitLab%20Docs&_biz_n=100&rnd=692965&cdn_o=a&_biz_z=1772174336502)
