[Skip to main content](https://docs.gitlab.com/api/templates/gitlab_ci_ymls/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/templates/gitlab_ci_ymls/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/templates/gitlab_ci_ymls/)
    * [18.8](https://docs.gitlab.com/18.8/api/templates/gitlab_ci_ymls/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/templates/gitlab_ci_ymls/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/templates/gitlab_ci_ymls/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/templates/gitlab_ci_ymls.html)
...
/
  ...
  5. [.gitlab-ci.yml (templates)](https://docs.gitlab.com/api/templates/gitlab_ci_ymls/)
...
Users with the Guest role cannot access CI/CD templates. For more information, see [project and group visibility](https://docs.gitlab.com/user/public_access/).
## List all CI/CD templates[](https://docs.gitlab.com/api/templates/gitlab_ci_ymls/#list-all-cicd-templates "Permalink")
...
## Retrieve details of a CI/CD template[](https://docs.gitlab.com/api/templates/gitlab_ci_ymls/#retrieve-details-of-a-cicd-template "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/templates/gitlab_ci_ymls.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/templates/gitlab_ci_ymls.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all CI/CD templates](https://docs.gitlab.com/api/templates/gitlab_ci_ymls/#list-all-cicd-templates)
  * [Retrieve details of a CI/CD template](https://docs.gitlab.com/api/templates/gitlab_ci_ymls/#retrieve-details-of-a-cicd-template)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/templates/gitlab_ci_ymls.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/templates/gitlab_ci_ymls.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Ftemplates%2Fgitlab_ci_ymls%2F&_biz_t=1771981741631&_biz_i=CI%2FCD%20templates%20API%20%7C%20GitLab%20Docs&_biz_n=187&rnd=161866&cdn_o=a&_biz_z=1771981741632)
