[Skip to main content](https://docs.gitlab.com/api/project_job_token_scopes/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/project_job_token_scopes/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/project_job_token_scopes/)
    * [18.8](https://docs.gitlab.com/18.8/api/project_job_token_scopes/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/project_job_token_scopes/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/project_job_token_scopes/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/project_job_token_scopes.html)
...
/
  ...
  5. [Job token scopes](https://docs.gitlab.com/api/project_job_token_scopes/)
...
Use this API to interact with [CI/CD job token](https://docs.gitlab.com/ci/jobs/ci_job_token/) scopes.
All requests to the CI/CD job token scope API endpoint must be [authenticated](https://docs.gitlab.com/api/rest/authentication/). The authenticated user must have the Maintainer or Owner role for the project.
## Get a project’s CI/CD job token access settings[](https://docs.gitlab.com/api/project_job_token_scopes/#get-a-projects-cicd-job-token-access-settings "Permalink")
Fetch the [CI/CD job token access settings](https://docs.gitlab.com/ci/jobs/ci_job_token/#control-job-token-access-to-your-project) (job token scope) of a project.
```
...
---|---|---
`inbound_enabled` | boolean | Indicates if the [**Authorized groups and projects**](https://docs.gitlab.com/ci/jobs/ci_job_token/#add-a-group-or-project-to-the-job-token-allowlist) setting is enabled for the allowlist. If disabled, then [all projects have access](https://docs.gitlab.com/ci/jobs/ci_job_token/#allow-any-project-to-access-your-project). This value shows whether the allowlist is currently active, which can be `true` due to the [**Enforce job token allowlist**](https://docs.gitlab.com/administration/settings/continuous_integration/#enforce-job-token-allowlist) instance setting.
`outbound_enabled` | boolean | Indicates if the CI/CD job token generated in this project has access to other projects. [Deprecated and planned for removal in GitLab 18.0](https://docs.gitlab.com/update/deprecations/#cicd-job-token---limit-access-from-your-project-setting-removal).
Example request:
shell
```
curl --request GET \
...
## Patch a project’s CI/CD job token access settings[](https://docs.gitlab.com/api/project_job_token_scopes/#patch-a-projects-cicd-job-token-access-settings "Permalink")
History
...
Patch the [**Authorized groups and projects** setting](https://docs.gitlab.com/ci/jobs/ci_job_token/#add-a-group-or-project-to-the-job-token-allowlist) (job token scope) of a project.
```
...
---|---|---|---
`id` | integer or string | Yes | ID or [URL-encoded path of the project](https://docs.gitlab.com/api/rest/#namespaced-paths).
`enabled` | boolean | Yes | Restricts job token access to allowlisted projects only. Set to `false` to allow access from all projects. This parameter can be overridden by the [**Enforce job token allowlist**](https://docs.gitlab.com/administration/settings/continuous_integration/#enforce-job-token-allowlist) instance setting.
If successful, returns [`204`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and no response body.
If the **Enforce job token allowlist** instance setting is enabled and you attempt to set `enabled` to `false`, returns [`400`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) with an error message.
Example request:
shell
```
curl --request PATCH \
...
## Get a project’s CI/CD job token inbound allowlist[](https://docs.gitlab.com/api/project_job_token_scopes/#get-a-projects-cicd-job-token-inbound-allowlist "Permalink")
Fetch the [CI/CD job token inbound allowlist](https://docs.gitlab.com/ci/jobs/ci_job_token/#add-a-group-or-project-to-the-job-token-allowlist) (job token scope) of a project.
```
...
---|---|---|---
`id` | integer or string | Yes | ID or [URL-encoded path of the project](https://docs.gitlab.com/api/rest/#namespaced-paths).
This endpoint supports [offset-based pagination](https://docs.gitlab.com/api/rest/#offset-based-pagination).
If successful, returns [`200`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and a list of project with limited fields for each project.
Example request:
shell
```
curl --request GET \
...
## Add a project to a CI/CD job token inbound allowlist[](https://docs.gitlab.com/api/project_job_token_scopes/#add-a-project-to-a-cicd-job-token-inbound-allowlist "Permalink")
Add a project to the [CI/CD job token inbound allowlist](https://docs.gitlab.com/ci/jobs/ci_job_token/#add-a-group-or-project-to-the-job-token-allowlist) of a project.
```
...
If successful, returns [`201`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and the following response attributes:
Attribute | Type | Description
---|---|---
...
## Remove a project from a CI/CD job token inbound allowlist[](https://docs.gitlab.com/api/project_job_token_scopes/#remove-a-project-from-a-cicd-job-token-inbound-allowlist "Permalink")
Remove a project from the [CI/CD job token inbound allowlist](https://docs.gitlab.com/ci/jobs/ci_job_token/#add-a-group-or-project-to-the-job-token-allowlist) of a project.
```
...
## Get a project’s CI/CD job token allowlist of groups[](https://docs.gitlab.com/api/project_job_token_scopes/#get-a-projects-cicd-job-token-allowlist-of-groups "Permalink")
...
`id` | integer or string | Yes | ID or [URL-encoded path of the project](https://docs.gitlab.com/api/rest/#namespaced-paths).
This endpoint supports [offset-based pagination](https://docs.gitlab.com/api/rest/#offset-based-pagination).
If successful, returns [`200`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and a list of groups with limited fields for each project.
Example request:
shell
```
curl --request GET \
...
## Add a group to a CI/CD job token allowlist[](https://docs.gitlab.com/api/project_job_token_scopes/#add-a-group-to-a-cicd-job-token-allowlist "Permalink")
...
## Remove a group from a CI/CD job token allowlist[](https://docs.gitlab.com/api/project_job_token_scopes/#remove-a-group-from-a-cicd-job-token-allowlist "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/project_job_token_scopes.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/project_job_token_scopes.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Get a project’s CI/CD job token access settings](https://docs.gitlab.com/api/project_job_token_scopes/#get-a-projects-cicd-job-token-access-settings)
  * [Patch a project’s CI/CD job token access settings](https://docs.gitlab.com/api/project_job_token_scopes/#patch-a-projects-cicd-job-token-access-settings)
  * [Get a project’s CI/CD job token inbound allowlist](https://docs.gitlab.com/api/project_job_token_scopes/#get-a-projects-cicd-job-token-inbound-allowlist)
  * [Add a project to a CI/CD job token inbound allowlist](https://docs.gitlab.com/api/project_job_token_scopes/#add-a-project-to-a-cicd-job-token-inbound-allowlist)
  * [Remove a project from a CI/CD job token inbound allowlist](https://docs.gitlab.com/api/project_job_token_scopes/#remove-a-project-from-a-cicd-job-token-inbound-allowlist)
  * [Get a project’s CI/CD job token allowlist of groups](https://docs.gitlab.com/api/project_job_token_scopes/#get-a-projects-cicd-job-token-allowlist-of-groups)
  * [Add a group to a CI/CD job token allowlist](https://docs.gitlab.com/api/project_job_token_scopes/#add-a-group-to-a-cicd-job-token-allowlist)
  * [Remove a group from a CI/CD job token allowlist](https://docs.gitlab.com/api/project_job_token_scopes/#remove-a-group-from-a-cicd-job-token-allowlist)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/project_job_token_scopes.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/project_job_token_scopes.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fproject_job_token_scopes%2F&_biz_t=1772174415644&_biz_i=CI%2FCD%20job%20token%20scope%20API%20%7C%20GitLab%20Docs&_biz_n=131&rnd=291646&cdn_o=a&_biz_z=1772174415645)
