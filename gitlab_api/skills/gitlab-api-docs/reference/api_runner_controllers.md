[Skip to main content](https://docs.gitlab.com/api/runner_controllers/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/runner_controllers/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/runner_controllers/)
    * [18.8](https://docs.gitlab.com/18.8/api/runner_controllers/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/runner_controllers/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/runner_controllers/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/runner_controllers.html)
...
/
  ...
  5. [Runner controllers](https://docs.gitlab.com/api/runner_controllers/)


* * *
# Runner controllers API
  * Tier: Ultimate
...
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/218229) in GitLab 18.9 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `FF_USE_JOB_ROUTER`. This feature is an [experiment](https://docs.gitlab.com/policy/development_stages_support/) and subject to the [GitLab Testing Agreement](https://handbook.gitlab.com/handbook/legal/testing-agreement/).
...
## List all runner controllers[](https://docs.gitlab.com/api/runner_controllers/#list-all-runner-controllers "Permalink")
...
Response:
If successful, returns [`200 OK`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) with the following response attributes:
...
## Retrieve a single runner controller[](https://docs.gitlab.com/api/runner_controllers/#retrieve-a-single-runner-controller "Permalink")
...
## Register a runner controller[](https://docs.gitlab.com/api/runner_controllers/#register-a-runner-controller "Permalink")
...
Response:
If successful, returns [`201 Created`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) with the following response attributes:
Attribute | Type | Description
---|---|---
`id` | integer | The unique identifier of the runner controller.
`description` | string | A description for the runner controller.
...
## Update a runner controller[](https://docs.gitlab.com/api/runner_controllers/#update-a-runner-controller "Permalink")
...
## Delete a runner controller[](https://docs.gitlab.com/api/runner_controllers/#delete-a-runner-controller "Permalink")
...
## Runner controller scopes[](https://docs.gitlab.com/api/runner_controllers/#runner-controller-scopes "Permalink")
Runner controller scopes define which jobs a runner controller evaluates for admission control. A runner controller must have at least one scope to receive admission requests. Without a scope, the controller remains inactive even when its state is `enabled` or `dry_run`.
Instance scope: The runner controller evaluates jobs for all runners in the GitLab instance.
Only instance scoping is available. Runner scoping and additional scope types are proposed in [issue 586419](https://gitlab.com/gitlab-org/gitlab/-/issues/586419).
### List all scopes for a runner controller[](https://docs.gitlab.com/api/runner_controllers/#list-all-scopes-for-a-runner-controller "Permalink")
...
### Add instance scope[](https://docs.gitlab.com/api/runner_controllers/#add-instance-scope "Permalink")
...
### Remove instance scope[](https://docs.gitlab.com/api/runner_controllers/#remove-instance-scope "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/runner_controllers.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/runner_controllers.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all runner controllers](https://docs.gitlab.com/api/runner_controllers/#list-all-runner-controllers)
  * [Retrieve a single runner controller](https://docs.gitlab.com/api/runner_controllers/#retrieve-a-single-runner-controller)
  * [Register a runner controller](https://docs.gitlab.com/api/runner_controllers/#register-a-runner-controller)
  * [Update a runner controller](https://docs.gitlab.com/api/runner_controllers/#update-a-runner-controller)
  * [Delete a runner controller](https://docs.gitlab.com/api/runner_controllers/#delete-a-runner-controller)
  * [Runner controller scopes](https://docs.gitlab.com/api/runner_controllers/#runner-controller-scopes)
  * [List all scopes for a runner controller](https://docs.gitlab.com/api/runner_controllers/#list-all-scopes-for-a-runner-controller)
  * [Add instance scope](https://docs.gitlab.com/api/runner_controllers/#add-instance-scope)
  * [Remove instance scope](https://docs.gitlab.com/api/runner_controllers/#remove-instance-scope)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/runner_controllers.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/runner_controllers.md)
