[Skip to main content](https://docs.gitlab.com/api/suggestions/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/suggestions/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/suggestions/)
    * [18.8](https://docs.gitlab.com/18.8/api/suggestions/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/suggestions/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/suggestions/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/suggestions.html)
...
/
  ...
  5. [Suggestions](https://docs.gitlab.com/api/suggestions/)
...
Use this API to manage [code suggestions](https://docs.gitlab.com/user/project/merge_requests/reviews/suggestions/).
Suggestions provide a way to propose specific changes that can be directly applied to the code. You can programmatically create and apply code suggestions in merge request discussions with this API. Every API call to suggestions must be authenticated.
## Create a suggestion[](https://docs.gitlab.com/api/suggestions/#create-a-suggestion "Permalink")
To create a suggestion through the API, use the Discussions API to [create a new thread in the merge request diff](https://docs.gitlab.com/api/discussions/#create-new-merge-request-thread). The format for suggestions is:
markdown
```
```suggestion:-3+0
example text
...
## Apply a suggestion[](https://docs.gitlab.com/api/suggestions/#apply-a-suggestion "Permalink")
...
## Apply multiple suggestions[](https://docs.gitlab.com/api/suggestions/#apply-multiple-suggestions "Permalink")
...
`commit_message` | string | No | Custom commit message to use instead of the default generated message or the project’s default message.
If successful, returns [`200 OK`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and an array of suggestion objects with the following response attributes:
Attribute | Type | Description
---|---|---
`applicable` | boolean | If `true`, suggestion can be applied.
`applied` | boolean | If `true`, suggestion has been applied.
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/suggestions.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/suggestions.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Create a suggestion](https://docs.gitlab.com/api/suggestions/#create-a-suggestion)
  * [Apply a suggestion](https://docs.gitlab.com/api/suggestions/#apply-a-suggestion)
  * [Apply multiple suggestions](https://docs.gitlab.com/api/suggestions/#apply-multiple-suggestions)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/suggestions.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/suggestions.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fsuggestions%2F&_biz_t=1772174481190&_biz_i=Suggest%20Changes%20API%20%7C%20GitLab%20Docs&_biz_n=175&rnd=221350&cdn_o=a&_biz_z=1772174481190)
