[Skip to main content](https://docs.gitlab.com/api/resource_iteration_events/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/resource_iteration_events/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/resource_iteration_events/)
    * [18.8](https://docs.gitlab.com/18.8/api/resource_iteration_events/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/resource_iteration_events/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/resource_iteration_events/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/resource_iteration_events.html)
...
/
  ...
  5. [Resource iteration events](https://docs.gitlab.com/api/resource_iteration_events/)
...
Use this API to access [iteration events](https://docs.gitlab.com/user/group/iterations/) for issues.
## Issues[](https://docs.gitlab.com/api/resource_iteration_events/#issues "Permalink")
### List project issue iteration events[](https://docs.gitlab.com/api/resource_iteration_events/#list-project-issue-iteration-events "Permalink")
...
### Retrieve an issue iteration event[](https://docs.gitlab.com/api/resource_iteration_events/#retrieve-an-issue-iteration-event "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/resource_iteration_events.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/resource_iteration_events.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Issues](https://docs.gitlab.com/api/resource_iteration_events/#issues)
  * [List project issue iteration events](https://docs.gitlab.com/api/resource_iteration_events/#list-project-issue-iteration-events)
  * [Retrieve an issue iteration event](https://docs.gitlab.com/api/resource_iteration_events/#retrieve-an-issue-iteration-event)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/resource_iteration_events.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/resource_iteration_events.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fresource_iteration_events%2F&_biz_t=1772174442009&_biz_i=Resource%20iteration%20events%20API%20%7C%20GitLab%20Docs&_biz_n=153&rnd=281179&cdn_o=a&_biz_z=1772174442010)
