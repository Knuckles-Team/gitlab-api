[Skip to main content](https://docs.gitlab.com/api/plan_limits/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/plan_limits/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/plan_limits/)
    * [18.8](https://docs.gitlab.com/18.8/api/plan_limits/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/plan_limits/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/plan_limits/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/plan_limits.html)
...
/
  ...
  5. [Plan limits](https://docs.gitlab.com/api/plan_limits/)
...
## Retrieve current plan limits[](https://docs.gitlab.com/api/plan_limits/#retrieve-current-plan-limits "Permalink")
...
## Update plan limits[](https://docs.gitlab.com/api/plan_limits/#update-plan-limits "Permalink")
...
`ci_needs_size_limit` | integer | no | Maximum number of [`needs`](https://docs.gitlab.com/ci/yaml/needs/) dependencies that a job can have. [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/85895) in GitLab 15.0.
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/plan_limits.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/plan_limits.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Retrieve current plan limits](https://docs.gitlab.com/api/plan_limits/#retrieve-current-plan-limits)
  * [Update plan limits](https://docs.gitlab.com/api/plan_limits/#update-plan-limits)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/plan_limits.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/plan_limits.md)
