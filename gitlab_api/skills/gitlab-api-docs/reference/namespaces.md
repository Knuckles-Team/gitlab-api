[Skip to main content](https://docs.gitlab.com/api/namespaces/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/namespaces/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/namespaces/)
    * [18.8](https://docs.gitlab.com/18.8/api/namespaces/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/namespaces/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/namespaces/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/namespaces.html)
...
/
  ...
  5. [Namespaces](https://docs.gitlab.com/api/namespaces/)
...
History
  * Visibility of billing-related fields changed in GitLab 18.3 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `restrict_namespace_api_billing_fields`. Disabled by default.
...
This API uses [Pagination](https://docs.gitlab.com/api/rest/#pagination) to filter results.
## List all namespaces[](https://docs.gitlab.com/api/namespaces/#list-all-namespaces "Permalink")
History
...
## Retrieve namespace details[](https://docs.gitlab.com/api/namespaces/#retrieve-namespace-details "Permalink")
...
Attribute | Type | Required | Description
---|---|---|---
`id` | integer or string | yes | ID or [URL-encoded path](https://docs.gitlab.com/api/rest/#namespaced-paths) of the namespace.
Example request:
shell
```
curl --request GET \
...
## Verify namespace availability[](https://docs.gitlab.com/api/namespaces/#verify-namespace-availability "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/namespaces.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/namespaces.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all namespaces](https://docs.gitlab.com/api/namespaces/#list-all-namespaces)
  * [Retrieve namespace details](https://docs.gitlab.com/api/namespaces/#retrieve-namespace-details)
  * [Verify namespace availability](https://docs.gitlab.com/api/namespaces/#verify-namespace-availability)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/namespaces.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/namespaces.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fnamespaces%2F&_biz_t=1772174336716&_biz_i=Namespaces%20API%20%7C%20GitLab%20Docs&_biz_n=101&rnd=842115&cdn_o=a&_biz_z=1772174336717)
