[Skip to main content](https://docs.gitlab.com/api/snippets/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/snippets/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/snippets/)
    * [18.8](https://docs.gitlab.com/18.8/api/snippets/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/snippets/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/snippets/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/snippets.html)
...
/
  ...
  5. [Snippets](https://docs.gitlab.com/api/snippets/)
...
Use this API to manage [snippets](https://docs.gitlab.com/user/snippets/). Related APIs exist for [project snippets](https://docs.gitlab.com/api/project_snippets/) and [moving snippets between storages](https://docs.gitlab.com/api/snippet_repository_storage_moves/).
## List all snippets for current user[](https://docs.gitlab.com/api/snippets/#list-all-snippets-for-current-user "Permalink")
...
## Retrieve a snippet[](https://docs.gitlab.com/api/snippets/#retrieve-a-snippet "Permalink")
...
## Single snippet contents[](https://docs.gitlab.com/api/snippets/#single-snippet-contents "Permalink")
...
---|---|---|---
`id` | integer | Yes | ID of snippet to retrieve.
If successful, returns [`200 OK`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and the raw content of the snippet.
Example request:
shell
```
curl --header "PRIVATE-TOKEN: <your_access_token>" \
...
## Snippet repository file content[](https://docs.gitlab.com/api/snippets/#snippet-repository-file-content "Permalink")
...
If successful, returns [`200 OK`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and the raw file content.
Example request:
shell
```
curl --header "PRIVATE-TOKEN: <your_access_token>" \
...
## Create a snippet[](https://docs.gitlab.com/api/snippets/#create-a-snippet "Permalink")
...
## Update snippet[](https://docs.gitlab.com/api/snippets/#update-snippet "Permalink")
...
## Delete snippet[](https://docs.gitlab.com/api/snippets/#delete-snippet "Permalink")
...
## List all public snippets[](https://docs.gitlab.com/api/snippets/#list-all-public-snippets "Permalink")
...
## List all snippets[](https://docs.gitlab.com/api/snippets/#list-all-snippets "Permalink")
History
...
## Get user agent details[](https://docs.gitlab.com/api/snippets/#get-user-agent-details "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/snippets.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/snippets.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all snippets for current user](https://docs.gitlab.com/api/snippets/#list-all-snippets-for-current-user)
  * [Retrieve a snippet](https://docs.gitlab.com/api/snippets/#retrieve-a-snippet)
  * [Single snippet contents](https://docs.gitlab.com/api/snippets/#single-snippet-contents)
  * [Snippet repository file content](https://docs.gitlab.com/api/snippets/#snippet-repository-file-content)
  * [Create a snippet](https://docs.gitlab.com/api/snippets/#create-a-snippet)
  * [Update snippet](https://docs.gitlab.com/api/snippets/#update-snippet)
  * [Delete snippet](https://docs.gitlab.com/api/snippets/#delete-snippet)
  * [List all public snippets](https://docs.gitlab.com/api/snippets/#list-all-public-snippets)
  * [List all snippets](https://docs.gitlab.com/api/snippets/#list-all-snippets)
  * [Get user agent details](https://docs.gitlab.com/api/snippets/#get-user-agent-details)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/snippets.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/snippets.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fsnippets%2F&_biz_t=1772174469257&_biz_i=Snippets%20API%20%7C%20GitLab%20Docs&_biz_n=171&rnd=540564&cdn_o=a&_biz_z=1772174469258)
