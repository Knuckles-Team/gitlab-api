[Skip to main content](https://docs.gitlab.com/api/vulnerabilities/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/vulnerabilities/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/vulnerabilities/)
    * [18.8](https://docs.gitlab.com/18.8/api/vulnerabilities/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/vulnerabilities/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/vulnerabilities/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/vulnerabilities.html)
...
/
  ...
  5. [Vulnerabilities](https://docs.gitlab.com/api/vulnerabilities/)
...
The former Vulnerabilities API was renamed to Vulnerability Findings API and its documentation was moved to [a different location](https://docs.gitlab.com/api/vulnerability_findings/). This document now describes the new Vulnerabilities API that provides access to [Vulnerabilities](https://gitlab.com/groups/gitlab-org/-/epics/634).
Every API call to vulnerabilities must be [authenticated](https://docs.gitlab.com/api/rest/authentication/).
If an authenticated user does not have permission to [view vulnerability report](https://docs.gitlab.com/user/permissions/#project-application-security), this request returns a `403 Forbidden` status code.
This API is in the process of being deprecated and considered unstable. The response payload may be subject to change or breakage across GitLab releases. Use the [GraphQL API](https://docs.gitlab.com/api/graphql/reference/#queryvulnerabilities) instead. For more information, see [GraphQL examples](https://docs.gitlab.com/api/vulnerabilities/#replace-vulnerability-rest-api-with-graphql).
## Retrieve a vulnerability[](https://docs.gitlab.com/api/vulnerabilities/#retrieve-a-vulnerability "Permalink")
...
## Confirm a vulnerability[](https://docs.gitlab.com/api/vulnerabilities/#confirm-a-vulnerability "Permalink")
Confirms a specified vulnerability. Returns status code `304` if the vulnerability is already confirmed.
If an authenticated user does not have permission to [change vulnerability status](https://docs.gitlab.com/user/permissions/#project-application-security), this request results in a `403` status code.
```
...
## Resolve a vulnerability[](https://docs.gitlab.com/api/vulnerabilities/#resolve-a-vulnerability "Permalink")
...
## Dismiss a vulnerability[](https://docs.gitlab.com/api/vulnerabilities/#dismiss-a-vulnerability "Permalink")
...
## Revert a vulnerability to detected state[](https://docs.gitlab.com/api/vulnerabilities/#revert-a-vulnerability-to-detected-state "Permalink")
...
## Replace Vulnerability REST API with GraphQL[](https://docs.gitlab.com/api/vulnerabilities/#replace-vulnerability-rest-api-with-graphql "Permalink")
...
### GraphQL - Single vulnerability[](https://docs.gitlab.com/api/vulnerabilities/#graphql---single-vulnerability "Permalink")
Use [`Query.vulnerability`](https://docs.gitlab.com/api/graphql/reference/#queryvulnerability).
graphql
```
{
...
### GraphQL - Confirm vulnerability[](https://docs.gitlab.com/api/vulnerabilities/#graphql---confirm-vulnerability "Permalink")
Use [`Mutation.vulnerabilityConfirm`](https://docs.gitlab.com/api/graphql/reference/#mutationvulnerabilityconfirm).
graphql
```
mutation {
...
### GraphQL - Resolve vulnerability[](https://docs.gitlab.com/api/vulnerabilities/#graphql---resolve-vulnerability "Permalink")
Use [`Mutation.vulnerabilityResolve`](https://docs.gitlab.com/api/graphql/reference/#mutationvulnerabilityresolve).
graphql
```
mutation {
...
### GraphQL - Dismiss vulnerability[](https://docs.gitlab.com/api/vulnerabilities/#graphql---dismiss-vulnerability "Permalink")
Use [`Mutation.vulnerabilityDismiss`](https://docs.gitlab.com/api/graphql/reference/#mutationvulnerabilitydismiss).
graphql
```
mutation {
...
### GraphQL - Revert vulnerability to detected state[](https://docs.gitlab.com/api/vulnerabilities/#graphql---revert-vulnerability-to-detected-state "Permalink")
Use [`Mutation.vulnerabilityRevertToDetected`](https://docs.gitlab.com/api/graphql/reference/#mutationvulnerabilityreverttodetected).
graphql
```
mutation {
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/vulnerabilities.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/vulnerabilities.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Retrieve a vulnerability](https://docs.gitlab.com/api/vulnerabilities/#retrieve-a-vulnerability)
  * [Confirm a vulnerability](https://docs.gitlab.com/api/vulnerabilities/#confirm-a-vulnerability)
  * [Resolve a vulnerability](https://docs.gitlab.com/api/vulnerabilities/#resolve-a-vulnerability)
  * [Dismiss a vulnerability](https://docs.gitlab.com/api/vulnerabilities/#dismiss-a-vulnerability)
  * [Revert a vulnerability to detected state](https://docs.gitlab.com/api/vulnerabilities/#revert-a-vulnerability-to-detected-state)
  * [Replace Vulnerability REST API with GraphQL](https://docs.gitlab.com/api/vulnerabilities/#replace-vulnerability-rest-api-with-graphql)
  * [GraphQL - Single vulnerability](https://docs.gitlab.com/api/vulnerabilities/#graphql---single-vulnerability)
  * [GraphQL - Confirm vulnerability](https://docs.gitlab.com/api/vulnerabilities/#graphql---confirm-vulnerability)
  * [GraphQL - Resolve vulnerability](https://docs.gitlab.com/api/vulnerabilities/#graphql---resolve-vulnerability)
  * [GraphQL - Dismiss vulnerability](https://docs.gitlab.com/api/vulnerabilities/#graphql---dismiss-vulnerability)
  * [GraphQL - Revert vulnerability to detected state](https://docs.gitlab.com/api/vulnerabilities/#graphql---revert-vulnerability-to-detected-state)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/vulnerabilities.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/vulnerabilities.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fusers%2F&_biz_t=1772174494131&_biz_i=Users%20API%20%7C%20GitLab%20Docs&_biz_n=184&rnd=260350&cdn_o=a&_biz_z=1772174494295)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fversion%2F&_biz_t=1772174494198&_biz_i=Version%20API%20%7C%20GitLab%20Docs&_biz_n=185&rnd=501927&cdn_o=a&_biz_z=1772174494296)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fvulnerabilities%2F&_biz_t=1772174494294&_biz_i=Vulnerabilities%20API%20%7C%20GitLab%20Docs&_biz_n=186&rnd=371246&cdn_o=a&_biz_z=1772174494296)
