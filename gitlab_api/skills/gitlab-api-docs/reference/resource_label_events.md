[Skip to main content](https://docs.gitlab.com/api/resource_label_events/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/resource_label_events/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/resource_label_events/)
    * [18.8](https://docs.gitlab.com/18.8/api/resource_label_events/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/resource_label_events/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/resource_label_events/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/resource_label_events.html)
...
/
  ...
  5. [Resource label events](https://docs.gitlab.com/api/resource_label_events/)
...
Use this API to retrieve resource label events that track who, when, and which [label](https://docs.gitlab.com/user/project/labels/) was added to (or removed from) an issue, merge request, or epic.
## Issues[](https://docs.gitlab.com/api/resource_label_events/#issues "Permalink")
### List project issue label events[](https://docs.gitlab.com/api/resource_label_events/#list-project-issue-label-events "Permalink")
...
## Epics[](https://docs.gitlab.com/api/resource_label_events/#epics "Permalink")
...
### List group epic label events[](https://docs.gitlab.com/api/resource_label_events/#list-group-epic-label-events "Permalink")
...
### Retrieve a single epic label event[](https://docs.gitlab.com/api/resource_label_events/#retrieve-a-single-epic-label-event "Permalink")
...
## Merge requests[](https://docs.gitlab.com/api/resource_label_events/#merge-requests "Permalink")
### List project merge request label events[](https://docs.gitlab.com/api/resource_label_events/#list-project-merge-request-label-events "Permalink")
...
### Retrieve a single merge request label event[](https://docs.gitlab.com/api/resource_label_events/#retrieve-a-single-merge-request-label-event "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/resource_label_events.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/resource_label_events.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Issues](https://docs.gitlab.com/api/resource_label_events/#issues)
  * [List project issue label events](https://docs.gitlab.com/api/resource_label_events/#list-project-issue-label-events)
  * [Retrieve a single issue label event](https://docs.gitlab.com/api/resource_label_events/#retrieve-a-single-issue-label-event)
  * [Epics](https://docs.gitlab.com/api/resource_label_events/#epics)
  * [List group epic label events](https://docs.gitlab.com/api/resource_label_events/#list-group-epic-label-events)
  * [Retrieve a single epic label event](https://docs.gitlab.com/api/resource_label_events/#retrieve-a-single-epic-label-event)
  * [Merge requests](https://docs.gitlab.com/api/resource_label_events/#merge-requests)
  * [List project merge request label events](https://docs.gitlab.com/api/resource_label_events/#list-project-merge-request-label-events)
  * [Retrieve a single merge request label event](https://docs.gitlab.com/api/resource_label_events/#retrieve-a-single-merge-request-label-event)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/resource_label_events.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/resource_label_events.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Frepository_submodules%2F&_biz_t=1772174441566&_biz_i=Repository%20submodules%20API%20%7C%20GitLab%20Docs&_biz_n=150&rnd=870299&cdn_o=a&_biz_z=1772174441689)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fresource_label_events%2F&_biz_t=1772174441688&_biz_i=Resource%20label%20events%20API%20%7C%20GitLab%20Docs&_biz_n=151&rnd=871469&cdn_o=a&_biz_z=1772174441690)
