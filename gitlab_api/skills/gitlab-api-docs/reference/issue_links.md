[Skip to main content](https://docs.gitlab.com/api/issue_links/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/issue_links/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/issue_links/)
    * [18.8](https://docs.gitlab.com/18.8/api/issue_links/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/issue_links/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/issue_links/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/issue_links.html)
...
/
  ...
  5. [Links (issue)](https://docs.gitlab.com/api/issue_links/)
...
## List all issue links[](https://docs.gitlab.com/api/issue_links/#list-all-issue-links "Permalink")
Lists all [linked issues](https://docs.gitlab.com/user/project/issues/related_issues/) for a specified issue, sorted by the relationship creation datetime (ascending). Issues are filtered according to the user authorizations.
```
...
## Retrieve an issue link[](https://docs.gitlab.com/api/issue_links/#retrieve-an-issue-link "Permalink")
History
...
## Create an issue link[](https://docs.gitlab.com/api/issue_links/#create-an-issue-link "Permalink")
History
  * `id` response attribute [introduced](https://gitlab.com/gitlab-org/gitlab/-/work_items/585093) in GitLab 18.9.
...
`id` | integer or string | yes | The ID or [URL-encoded path of the project](https://docs.gitlab.com/api/rest/#namespaced-paths)
`issue_iid` | integer | yes | The internal ID of a project’s issue
`target_project_id` | integer or string | yes | The ID or [URL-encoded path of the project](https://docs.gitlab.com/api/rest/#namespaced-paths) of a target project
...
## Delete an issue link[](https://docs.gitlab.com/api/issue_links/#delete-an-issue-link "Permalink")
History
  * `id` response attribute [introduced](https://gitlab.com/gitlab-org/gitlab/-/work_items/585093) in GitLab 18.9.
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/issue_links.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/issue_links.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all issue links](https://docs.gitlab.com/api/issue_links/#list-all-issue-links)
  * [Retrieve an issue link](https://docs.gitlab.com/api/issue_links/#retrieve-an-issue-link)
  * [Create an issue link](https://docs.gitlab.com/api/issue_links/#create-an-issue-link)
  * [Delete an issue link](https://docs.gitlab.com/api/issue_links/#delete-an-issue-link)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/issue_links.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/issue_links.md)
