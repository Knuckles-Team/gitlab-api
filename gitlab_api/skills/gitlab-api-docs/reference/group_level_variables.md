[Skip to main content](https://docs.gitlab.com/api/group_level_variables/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/group_level_variables/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/group_level_variables/)
    * [18.8](https://docs.gitlab.com/18.8/api/group_level_variables/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/group_level_variables/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/group_level_variables/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/group_level_variables.html)
...
/
  ...
  6. [CI/CD variables](https://docs.gitlab.com/api/group_level_variables/)
...
Use this API to interact with [CI/CD variables](https://docs.gitlab.com/ci/variables/#for-a-group) for a group.
## List group variables[](https://docs.gitlab.com/api/group_level_variables/#list-group-variables "Permalink")
Get list of a group’s variables. Use the `page` and `per_page` [pagination](https://docs.gitlab.com/api/rest/#offset-based-pagination) parameters to control the pagination of results.
```
...
---|---|---|---
`id` | integer or string | Yes | The ID of a group or [URL-encoded path](https://docs.gitlab.com/api/rest/#namespaced-paths) of the group
shell
```
curl --request GET \
...
## Show variable details[](https://docs.gitlab.com/api/group_level_variables/#show-variable-details "Permalink")
History
...
Attribute | Type | Required | Description
---|---|---|---
`id` | integer or string | Yes | ID of a group or [URL-encoded path](https://docs.gitlab.com/api/rest/#namespaced-paths) of the group.
...
## Create variable[](https://docs.gitlab.com/api/group_level_variables/#create-variable "Permalink")
History
...
`environment_scope` | string | No | The [environment scope](https://docs.gitlab.com/ci/environments/#limit-the-environment-scope-of-a-cicd-variable) of a variable. Premium and Ultimate only.
...
## Update variable[](https://docs.gitlab.com/api/group_level_variables/#update-variable "Permalink")
History
  * The `filter` parameter was [introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/340185) in GitLab 16.9.
...
`environment_scope` | string | No |  [Environment scope](https://docs.gitlab.com/ci/environments/#limit-the-environment-scope-of-a-cicd-variable) of a variable. Premium and Ultimate only.
`filter` | hash | No | Filters results when multiple variables share the same key. Possible values: `[environment_scope]`. Premium and Ultimate only.
...
`raw` | boolean | No | If `true`, indicates the variable is treated as a raw string. When `false`, the variable value is [expanded](https://docs.gitlab.com/ci/variables/#allow-cicd-variable-expansion). Default: `true`.
...
## Remove variable[](https://docs.gitlab.com/api/group_level_variables/#remove-variable "Permalink")
History
  * The `filter` parameter was [introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/340185) in GitLab 16.9.
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_level_variables.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_level_variables.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List group variables](https://docs.gitlab.com/api/group_level_variables/#list-group-variables)
  * [Show variable details](https://docs.gitlab.com/api/group_level_variables/#show-variable-details)
  * [Create variable](https://docs.gitlab.com/api/group_level_variables/#create-variable)
  * [Update variable](https://docs.gitlab.com/api/group_level_variables/#update-variable)
  * [Remove variable](https://docs.gitlab.com/api/group_level_variables/#remove-variable)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_level_variables.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_level_variables.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fgroup_level_variables%2F&_biz_t=1772174283346&_biz_i=Group-level%20Variables%20API%20%7C%20GitLab%20Docs&_biz_n=66&rnd=770240&cdn_o=a&_biz_z=1772174283347)
