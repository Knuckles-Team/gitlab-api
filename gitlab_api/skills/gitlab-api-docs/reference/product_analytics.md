[Skip to main content](https://docs.gitlab.com/api/product_analytics/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/product_analytics/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/product_analytics/)
    * [18.8](https://docs.gitlab.com/18.8/api/product_analytics/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/product_analytics/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/product_analytics/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/product_analytics.html)
...
/
  ...
  5. [Product analytics](https://docs.gitlab.com/api/product_analytics/)
...
History
  * Introduced in GitLab 15.4 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `cube_api_proxy`. Disabled by default.
  ...
  * [Changed](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/167296) to beta in GitLab 17.5 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `product_analytics_features`.
...
Make sure to define the `cube_api_base_url` and `cube_api_key` application settings first using [the API](https://docs.gitlab.com/api/settings/).
## Send query request to Cube[](https://docs.gitlab.com/api/product_analytics/#send-query-request-to-cube "Permalink")
...
### Request body[](https://docs.gitlab.com/api/product_analytics/#request-body "Permalink")
...
#### Tracked events example[](https://docs.gitlab.com/api/product_analytics/#tracked-events-example "Permalink")
json
```
{
  "query": {
...
#### Sessions example[](https://docs.gitlab.com/api/product_analytics/#sessions-example "Permalink")
json
```
{
  "query": {
...
## Send metadata request to Cube[](https://docs.gitlab.com/api/product_analytics/#send-metadata-request-to-cube "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/product_analytics.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/product_analytics.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Send query request to Cube](https://docs.gitlab.com/api/product_analytics/#send-query-request-to-cube)
  * [Request body](https://docs.gitlab.com/api/product_analytics/#request-body)
  * [Tracked events example](https://docs.gitlab.com/api/product_analytics/#tracked-events-example)
  * [Sessions example](https://docs.gitlab.com/api/product_analytics/#sessions-example)
  * [Send metadata request to Cube](https://docs.gitlab.com/api/product_analytics/#send-metadata-request-to-cube)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/product_analytics.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/product_analytics.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fproduct_analytics%2F&_biz_t=1772174414437&_biz_i=Product%20analytics%20API%20%7C%20GitLab%20Docs&_biz_n=126&rnd=984123&cdn_o=a&_biz_z=1772174414438)
