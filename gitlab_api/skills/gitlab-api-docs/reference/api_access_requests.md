[Skip to main content](https://docs.gitlab.com/api/access_requests/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/access_requests/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/access_requests/)
    * [18.8](https://docs.gitlab.com/18.8/api/access_requests/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/access_requests/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/access_requests/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/access_requests.html)
...
/
  ...
  5. [Access requests](https://docs.gitlab.com/api/access_requests/)
...
## List all access requests for a group or project[](https://docs.gitlab.com/api/access_requests/#list-all-access-requests-for-a-group-or-project "Permalink")
...
## Request access to a group or project[](https://docs.gitlab.com/api/access_requests/#request-access-to-a-group-or-project "Permalink")
...
Attribute | Type | Required | Description
---|---|---|---
`id` | integer or string | yes | The ID or [URL-encoded path of the group or project](https://docs.gitlab.com/api/rest/#namespaced-paths)
Example request:
shell
```
curl --request POST \
...
## Approve an access request[](https://docs.gitlab.com/api/access_requests/#approve-an-access-request "Permalink")
...
`access_level` | integer | no | A valid [access level](https://docs.gitlab.com/user/permissions/#default-roles) Possible values: `0` (No access), `5` (Minimal access), `10` (Guest), `15` (Planner), `20` (Reporter), `30` (Developer), `40` (Maintainer), `50` (Owner). Default: `30`.
Example request:
shell
```
curl --request PUT \
...
## Deny an access request[](https://docs.gitlab.com/api/access_requests/#deny-an-access-request "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/access_requests.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/access_requests.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all access requests for a group or project](https://docs.gitlab.com/api/access_requests/#list-all-access-requests-for-a-group-or-project)
  * [Request access to a group or project](https://docs.gitlab.com/api/access_requests/#request-access-to-a-group-or-project)
  * [Approve an access request](https://docs.gitlab.com/api/access_requests/#approve-an-access-request)
  * [Deny an access request](https://docs.gitlab.com/api/access_requests/#deny-an-access-request)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/access_requests.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/access_requests.md)
