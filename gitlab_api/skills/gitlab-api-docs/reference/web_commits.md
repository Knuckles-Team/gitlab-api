[Skip to main content](https://docs.gitlab.com/api/web_commits/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/web_commits/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/web_commits/)
    * [18.8](https://docs.gitlab.com/18.8/api/web_commits/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/web_commits/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/web_commits/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/web_commits.html)
...
/
  ...
  5. [Web commits](https://docs.gitlab.com/api/web_commits/)
...
Use this API to retrieve information about [web commits](https://docs.gitlab.com/user/project/repository/web_editor/).
## Retrieve public signing key[](https://docs.gitlab.com/api/web_commits/#retrieve-public-signing-key "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/web_commits.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/web_commits.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Retrieve public signing key](https://docs.gitlab.com/api/web_commits/#retrieve-public-signing-key)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/web_commits.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/web_commits.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fweb_commits%2F&_biz_t=1772174494429&_biz_i=Web%20Commits%20API%20%7C%20GitLab%20Docs&_biz_n=187&rnd=360212&cdn_o=a&_biz_z=1772174494430)
