[Skip to main content](https://docs.gitlab.com/api/cluster_discovery/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/cluster_discovery/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/cluster_discovery/)
    * [18.8](https://docs.gitlab.com/18.8/api/cluster_discovery/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/cluster_discovery/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/cluster_discovery/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/cluster_discovery.html)
...
/
  ...
  5. [Cluster discovery (certificate-based) (deprecated)](https://docs.gitlab.com/api/cluster_discovery/)
...
## Retrieve certificate-based clusters[](https://docs.gitlab.com/api/cluster_discovery/#retrieve-certificate-based-clusters "Permalink")
...
shell
```
curl --header "PRIVATE-TOKEN: YOUR_TOKEN" "https://gitlab.example.com/api/v4/discover-cert-based-clusters?group_id=1"
```
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/cluster_discovery.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/cluster_discovery.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Retrieve certificate-based clusters](https://docs.gitlab.com/api/cluster_discovery/#retrieve-certificate-based-clusters)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/cluster_discovery.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/cluster_discovery.md)
...
%20\(deprecated\)%20%7C%20GitLab%20Docs&_biz_n=29&rnd=246389&cdn_o=a&_biz_z=1771981487303)
