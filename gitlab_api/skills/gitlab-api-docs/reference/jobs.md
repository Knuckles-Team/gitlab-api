[Skip to main content](https://docs.gitlab.com/api/jobs/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/jobs/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/jobs/)
    * [18.8](https://docs.gitlab.com/18.8/api/jobs/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/jobs/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/jobs/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/jobs.html)
...
/
  ...
  5. [Jobs](https://docs.gitlab.com/api/jobs/)
...
Use this API to interact with [CI/CD jobs](https://docs.gitlab.com/ci/jobs/).
## List all jobs for a project[](https://docs.gitlab.com/api/jobs/#list-all-jobs-for-a-project "Permalink")
...
This endpoint supports both offset-based and [keyset-based](https://docs.gitlab.com/api/rest/#keyset-based-pagination) pagination, but keyset-based pagination is strongly recommended when requesting consecutive pages of results.
```
...
`scope` | string, or array of strings | No | Scope of jobs to show. Either one of or an array of [job status values](https://docs.gitlab.com/api/jobs/#job-status-values). All jobs are returned if `scope` is not provided.
...
### Job status values[](https://docs.gitlab.com/api/jobs/#job-status-values "Permalink")
...
## List all jobs by pipeline[](https://docs.gitlab.com/api/jobs/#list-all-jobs-by-pipeline "Permalink")
Lists all jobs for a specified pipeline.
By default, this request returns 20 results at a time because the API results [are paginated](https://docs.gitlab.com/api/rest/#pagination)
This endpoint:
  * [Returns data for any pipeline](https://docs.gitlab.com/api/pipelines/#retrieve-a-single-pipeline) including [child pipelines](https://docs.gitlab.com/ci/pipelines/downstream_pipelines/#parent-child-pipelines).
...
`pipeline_id` | integer | Yes | ID of a pipeline. Can also be obtained in CI jobs using the [predefined CI variable](https://docs.gitlab.com/ci/variables/predefined_variables/) `CI_PIPELINE_ID`.
...
## List all trigger jobs by pipeline[](https://docs.gitlab.com/api/jobs/#list-all-trigger-jobs-by-pipeline "Permalink")
...
## Retrieve a job by job token[](https://docs.gitlab.com/api/jobs/#retrieve-a-job-by-job-token "Permalink")
Retrieves a job that was generated by a specified job token.
```
GET /job
```

Examples (must run as part of the [`script`](https://docs.gitlab.com/ci/yaml/#script) section of a [CI/CD job](https://docs.gitlab.com/ci/jobs/)):
shell
```
# Option 1
...
## Retrieve GitLab agent for Kubernetes by `CI_JOB_TOKEN`[](https://docs.gitlab.com/api/jobs/#retrieve-gitlab-agent-for-kubernetes-by-ci_job_token "Permalink")
Retrieve the job that generated the `CI_JOB_TOKEN`, along with a list of allowed [agents](https://docs.gitlab.com/user/clusters/agent/).
```
...
## Retrieve a job by job ID[](https://docs.gitlab.com/api/jobs/#retrieve-a-job-by-job-id "Permalink")
...
## Retrieve a log file for a job[](https://docs.gitlab.com/api/jobs/#retrieve-a-log-file-for-a-job "Permalink")
...
## Cancel a job[](https://docs.gitlab.com/api/jobs/#cancel-a-job "Permalink")
...
`id` | integer or string | Yes | ID or [URL-encoded path of the project](https://docs.gitlab.com/api/rest/#namespaced-paths).
`job_id` | integer | Yes | ID of a job.
`force` | boolean | No |  [Forces cancellation](https://docs.gitlab.com/ci/jobs/#force-cancel-a-job) of a job in `canceling` state when set to `true`.
shell
```
curl --request POST \
  --header "PRIVATE-TOKEN: <your_access_token>" \
...
## Retry a job[](https://docs.gitlab.com/api/jobs/#retry-a-job "Permalink")
...
## Erase a job[](https://docs.gitlab.com/api/jobs/#erase-a-job "Permalink")
...
You can’t delete archived jobs with the API, but you can [delete job artifacts and logs from jobs completed before a specific date](https://docs.gitlab.com/administration/cicd/job_artifacts_troubleshooting/#delete-old-builds-and-artifacts)
## Run a job[](https://docs.gitlab.com/api/jobs/#run-a-job "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/jobs.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/jobs.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all jobs for a project](https://docs.gitlab.com/api/jobs/#list-all-jobs-for-a-project)
  * [Job status values](https://docs.gitlab.com/api/jobs/#job-status-values)
  * [List all jobs by pipeline](https://docs.gitlab.com/api/jobs/#list-all-jobs-by-pipeline)
  * [List all trigger jobs by pipeline](https://docs.gitlab.com/api/jobs/#list-all-trigger-jobs-by-pipeline)
  * [Retrieve a job by job token](https://docs.gitlab.com/api/jobs/#retrieve-a-job-by-job-token)
  * [Retrieve GitLab agent for Kubernetes by CI_JOB_TOKEN](https://docs.gitlab.com/api/jobs/#retrieve-gitlab-agent-for-kubernetes-by-ci_job_token)
  * [Retrieve a job by job ID](https://docs.gitlab.com/api/jobs/#retrieve-a-job-by-job-id)
  * [Retrieve a log file for a job](https://docs.gitlab.com/api/jobs/#retrieve-a-log-file-for-a-job)
  * [Cancel a job](https://docs.gitlab.com/api/jobs/#cancel-a-job)
  * [Retry a job](https://docs.gitlab.com/api/jobs/#retry-a-job)
  * [Erase a job](https://docs.gitlab.com/api/jobs/#erase-a-job)
  * [Run a job](https://docs.gitlab.com/api/jobs/#run-a-job)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/jobs.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/jobs.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fjobs%2F&_biz_t=1772174308303&_biz_i=Jobs%20API%20%7C%20GitLab%20Docs&_biz_n=77&rnd=172476&cdn_o=a&_biz_z=1772174308304)
