[Skip to main content](https://docs.gitlab.com/api/search_admin/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/search_admin/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/search_admin/)
    * [18.8](https://docs.gitlab.com/18.8/api/search_admin/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/search_admin/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/search_admin/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/search_admin.html)
...
/
  ...
  5. [Search migrations](https://docs.gitlab.com/api/search_admin/)
...
Use this API to retrieve information about [advanced search migrations](https://docs.gitlab.com/integration/advanced_search/elasticsearch/#advanced-search-migrations).
Prerequisites:
  * You must be an administrator.


## List all advanced search migrations[](https://docs.gitlab.com/api/search_admin/#list-all-advanced-search-migrations "Permalink")
...
## Get an advanced search migration[](https://docs.gitlab.com/api/search_admin/#get-an-advanced-search-migration "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/search_admin.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/search_admin.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all advanced search migrations](https://docs.gitlab.com/api/search_admin/#list-all-advanced-search-migrations)
  * [Get an advanced search migration](https://docs.gitlab.com/api/search_admin/#get-an-advanced-search-migration)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/search_admin.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/search_admin.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fsearch_admin%2F&_biz_t=1772174468522&_biz_i=Search%20admin%20API%20%7C%20GitLab%20Docs&_biz_n=166&rnd=233396&cdn_o=a&_biz_z=1772174468523)
