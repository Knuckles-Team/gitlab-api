[Skip to main content](https://docs.gitlab.com/api/packages/pypi/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/packages/pypi/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/packages/pypi/)
    * [18.8](https://docs.gitlab.com/18.8/api/packages/pypi/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/packages/pypi/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/packages/pypi/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/packages/pypi.html)
...
/
  ...
  5. [PyPI](https://docs.gitlab.com/api/packages/pypi/)
...
Use this API to interact with the [PyPI package manager client](https://docs.gitlab.com/user/packages/pypi_repository/).
This API is used by the [PyPI package manager client](https://pypi.org/) and is generally not meant for manual consumption.
These endpoints do not adhere to the standard API authentication methods. See the [PyPI package registry documentation](https://docs.gitlab.com/user/packages/pypi_repository/) for details on which headers and token types are supported. Undocumented authentication methods might be removed in the future.
...
## Download a package file for a group[](https://docs.gitlab.com/api/packages/pypi/#download-a-package-file-for-a-group "Permalink")
Downloads a specified PyPI package file for a group. The [simple API](https://docs.gitlab.com/api/packages/pypi/#retrieve-package-descriptor-for-a-group) usually supplies this URL.
```
...
## List all packages for a group[](https://docs.gitlab.com/api/packages/pypi/#list-all-packages-for-a-group "Permalink")
...
## Retrieve package descriptor for a group[](https://docs.gitlab.com/api/packages/pypi/#retrieve-package-descriptor-for-a-group "Permalink")
...
## Download a package file for a project[](https://docs.gitlab.com/api/packages/pypi/#download-a-package-file-for-a-project "Permalink")
Downloads a specified PyPI package file for a project. The [simple API](https://docs.gitlab.com/api/packages/pypi/#retrieve-package-descriptor-for-a-project) usually supplies this URL.
```
...
This writes the downloaded file to `my.pypi.package-0.0.1.tar.gz` in the current directory.
## List all packages for a project[](https://docs.gitlab.com/api/packages/pypi/#list-all-packages-for-a-project "Permalink")
...
This writes the downloaded file to `simple_index.html` in the current directory.
## Retrieve package descriptor for a project[](https://docs.gitlab.com/api/packages/pypi/#retrieve-package-descriptor-for-a-project "Permalink")
...
This writes the downloaded file to `simple.html` in the current directory.
## Upload a package[](https://docs.gitlab.com/api/packages/pypi/#upload-a-package "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/pypi.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/pypi.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Download a package file for a group](https://docs.gitlab.com/api/packages/pypi/#download-a-package-file-for-a-group)
  * [List all packages for a group](https://docs.gitlab.com/api/packages/pypi/#list-all-packages-for-a-group)
  * [Retrieve package descriptor for a group](https://docs.gitlab.com/api/packages/pypi/#retrieve-package-descriptor-for-a-group)
  * [Download a package file for a project](https://docs.gitlab.com/api/packages/pypi/#download-a-package-file-for-a-project)
  * [List all packages for a project](https://docs.gitlab.com/api/packages/pypi/#list-all-packages-for-a-project)
  * [Retrieve package descriptor for a project](https://docs.gitlab.com/api/packages/pypi/#retrieve-package-descriptor-for-a-project)
  * [Upload a package](https://docs.gitlab.com/api/packages/pypi/#upload-a-package)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/pypi.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/pypi.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpackages%2Fpypi%2F&_biz_t=1771981625752&_biz_i=PyPI%20API%20%7C%20GitLab%20Docs&_biz_n=117&rnd=536048&cdn_o=a&_biz_z=1771981625752)
