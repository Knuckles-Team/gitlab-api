[Skip to main content](https://docs.gitlab.com/api/topics/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/topics/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/topics/)
    * [18.8](https://docs.gitlab.com/18.8/api/topics/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/topics/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/topics/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/topics.html)
...
/
  ...
  5. [Topics](https://docs.gitlab.com/api/topics/)
...
Use this API to interact with project topics. For more information, see [project topics](https://docs.gitlab.com/user/project/project_topics/).
## List all topics[](https://docs.gitlab.com/api/topics/#list-all-topics "Permalink")
...
## Retrieve a topic[](https://docs.gitlab.com/api/topics/#retrieve-a-topic "Permalink")
...
## List all projects assigned to a topic[](https://docs.gitlab.com/api/topics/#list-all-projects-assigned-to-a-topic "Permalink")
Uses the [Projects API](https://docs.gitlab.com/api/projects/#list-all-projects) to list all projects assigned to a specific topic.
```
GET /projects?topic=<topic_name>
```

## Create a project topic[](https://docs.gitlab.com/api/topics/#create-a-project-topic "Permalink")
...
`organization_id` | integer | No | The organization ID for the topic. Warning: this attribute is experimental and a subject to change in future. For more information on organizations, see [Organizations API](https://docs.gitlab.com/api/organizations/)
Example request:
shell
```
curl --request POST \
...
## Update a project topic[](https://docs.gitlab.com/api/topics/#update-a-project-topic "Permalink")
...
### Upload a topic avatar[](https://docs.gitlab.com/api/topics/#upload-a-topic-avatar "Permalink")
...
### Remove a topic avatar[](https://docs.gitlab.com/api/topics/#remove-a-topic-avatar "Permalink")
...
## Delete a project topic[](https://docs.gitlab.com/api/topics/#delete-a-project-topic "Permalink")
...
## Merge topics[](https://docs.gitlab.com/api/topics/#merge-topics "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/topics.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/topics.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all topics](https://docs.gitlab.com/api/topics/#list-all-topics)
  * [Retrieve a topic](https://docs.gitlab.com/api/topics/#retrieve-a-topic)
  * [List all projects assigned to a topic](https://docs.gitlab.com/api/topics/#list-all-projects-assigned-to-a-topic)
  * [Create a project topic](https://docs.gitlab.com/api/topics/#create-a-project-topic)
  * [Update a project topic](https://docs.gitlab.com/api/topics/#update-a-project-topic)
  * [Upload a topic avatar](https://docs.gitlab.com/api/topics/#upload-a-topic-avatar)
  * [Remove a topic avatar](https://docs.gitlab.com/api/topics/#remove-a-topic-avatar)
  * [Delete a project topic](https://docs.gitlab.com/api/topics/#delete-a-project-topic)
  * [Merge topics](https://docs.gitlab.com/api/topics/#merge-topics)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/topics.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/topics.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Ftopics%2F&_biz_t=1771981741513&_biz_i=Topics%20API%20%7C%20GitLab%20Docs&_biz_n=186&rnd=807638&cdn_o=a&_biz_z=1771981741514)
