[Skip to main content](https://docs.gitlab.com/api/group_wikis/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/group_wikis/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/group_wikis/)
    * [18.8](https://docs.gitlab.com/18.8/api/group_wikis/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/group_wikis/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/group_wikis/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/group_wikis.html)
...
/
  ...
  6. [Wikis](https://docs.gitlab.com/api/group_wikis/)
...
Use this API to manage [group wikis](https://docs.gitlab.com/user/project/wiki/group/). An API for [project wikis](https://docs.gitlab.com/api/wikis/) is also available.
...
## List wiki pages[](https://docs.gitlab.com/api/group_wikis/#list-wiki-pages "Permalink")
...
## Retrieve a wiki page[](https://docs.gitlab.com/api/group_wikis/#retrieve-a-wiki-page "Permalink")
...
## Create a wiki page[](https://docs.gitlab.com/api/group_wikis/#create-a-wiki-page "Permalink")
...
## Update a wiki page[](https://docs.gitlab.com/api/group_wikis/#update-a-wiki-page "Permalink")
...
## Delete a wiki page[](https://docs.gitlab.com/api/group_wikis/#delete-a-wiki-page "Permalink")
...
## Upload an attachment to the wiki repository[](https://docs.gitlab.com/api/group_wikis/#upload-an-attachment-to-the-wiki-repository "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_wikis.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_wikis.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List wiki pages](https://docs.gitlab.com/api/group_wikis/#list-wiki-pages)
  * [Retrieve a wiki page](https://docs.gitlab.com/api/group_wikis/#retrieve-a-wiki-page)
  * [Create a wiki page](https://docs.gitlab.com/api/group_wikis/#create-a-wiki-page)
  * [Update a wiki page](https://docs.gitlab.com/api/group_wikis/#update-a-wiki-page)
  * [Delete a wiki page](https://docs.gitlab.com/api/group_wikis/#delete-a-wiki-page)
  * [Upload an attachment to the wiki repository](https://docs.gitlab.com/api/group_wikis/#upload-an-attachment-to-the-wiki-repository)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_wikis.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_wikis.md)
