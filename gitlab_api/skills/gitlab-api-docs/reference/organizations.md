[Skip to main content](https://docs.gitlab.com/api/organizations/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/organizations/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/organizations/)
    * [18.8](https://docs.gitlab.com/18.8/api/organizations/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/organizations/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/organizations/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/organizations.html)
...
/
  ...
  5. [Organizations](https://docs.gitlab.com/api/organizations/)
...
Use this API to interact with GitLab organizations. For more information, see [organization](https://docs.gitlab.com/user/organization/).
## Create an organization[](https://docs.gitlab.com/api/organizations/#create-an-organization "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/470613) in GitLab 17.5 with a [flag](https://docs.gitlab.com/administration/feature_flags/) named `allow_organization_creation`. Disabled by default. This feature is an [experiment](https://docs.gitlab.com/policy/development_stages_support/).
...
This endpoint is an [experiment](https://docs.gitlab.com/policy/development_stages_support/) and might be changed or removed without notice.
```
POST /organizations
```
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/organizations.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/organizations.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Create an organization](https://docs.gitlab.com/api/organizations/#create-an-organization)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/organizations.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/organizations.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Forganizations%2F&_biz_t=1772174337553&_biz_i=Organizations%20API%20%7C%20GitLab%20Docs&_biz_n=104&rnd=868867&cdn_o=a&_biz_z=1772174337554)
