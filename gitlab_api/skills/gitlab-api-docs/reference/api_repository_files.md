[Skip to main content](https://docs.gitlab.com/api/repository_files/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/repository_files/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/repository_files/)
    * [18.8](https://docs.gitlab.com/18.8/api/repository_files/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/repository_files/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/repository_files/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/repository_files.html)
...
/
  ...
  5. [Repository files](https://docs.gitlab.com/api/repository_files/)
...
Use this API to manage [repository files](https://docs.gitlab.com/user/project/repository/). You can also [configure rate limits](https://docs.gitlab.com/administration/settings/files_api_rate_limits/) for this API.
## Available scopes for personal access tokens[](https://docs.gitlab.com/api/repository_files/#available-scopes-for-personal-access-tokens "Permalink")
...
## Retrieve a file from a repository[](https://docs.gitlab.com/api/repository_files/#retrieve-a-file-from-a-repository "Permalink")
Retrieves information about a specified file in a repository. This includes information like the name, size, and the file contents. File content is Base64 encoded. You can access this endpoint without authentication, if the repository is publicly accessible.
...
### Get file metadata only[](https://docs.gitlab.com/api/repository_files/#get-file-metadata-only "Permalink")
...
## Retrieve file blame history from a repository[](https://docs.gitlab.com/api/repository_files/#retrieve-file-blame-history-from-a-repository "Permalink")
...
### Get file blame metadata only[](https://docs.gitlab.com/api/repository_files/#get-file-blame-metadata-only "Permalink")
...
### Request a blame range[](https://docs.gitlab.com/api/repository_files/#request-a-blame-range "Permalink")
...
## Retrieve a raw file from a repository[](https://docs.gitlab.com/api/repository_files/#retrieve-a-raw-file-from-a-repository "Permalink")
...
Like [Retrieve a file from a repository](https://docs.gitlab.com/api/repository_files/#retrieve-a-file-from-a-repository), you can use `HEAD` to get just file metadata.
## Create a file in a repository[](https://docs.gitlab.com/api/repository_files/#create-a-file-in-a-repository "Permalink")
History
  * Request size and rate limits introduced in GitLab 18.7.


Creates a file in a specified repository. To create multiple files with a single request, see the [commits API](https://docs.gitlab.com/api/commits/#create-a-commit).
```
...
## Update a file in a repository[](https://docs.gitlab.com/api/repository_files/#update-a-file-in-a-repository "Permalink")
History
  * Request size and rate limits introduced in GitLab 18.7.


Updates a specified file in a repository. To update multiple files with a single request, see the [commits API](https://docs.gitlab.com/api/commits/#create-a-commit).
```
...
## Delete a file in a repository[](https://docs.gitlab.com/api/repository_files/#delete-a-file-in-a-repository "Permalink")
Deletes a specified file in a repository. To delete multiple files with a single request, see the [commits API](https://docs.gitlab.com/api/commits/#create-a-commit).
```
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/repository_files.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/repository_files.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Available scopes for personal access tokens](https://docs.gitlab.com/api/repository_files/#available-scopes-for-personal-access-tokens)
  * [Retrieve a file from a repository](https://docs.gitlab.com/api/repository_files/#retrieve-a-file-from-a-repository)
  * [Get file metadata only](https://docs.gitlab.com/api/repository_files/#get-file-metadata-only)
  * [Retrieve file blame history from a repository](https://docs.gitlab.com/api/repository_files/#retrieve-file-blame-history-from-a-repository)
  * [Get file blame metadata only](https://docs.gitlab.com/api/repository_files/#get-file-blame-metadata-only)
  * [Request a blame range](https://docs.gitlab.com/api/repository_files/#request-a-blame-range)
  * [Retrieve a raw file from a repository](https://docs.gitlab.com/api/repository_files/#retrieve-a-raw-file-from-a-repository)
  * [Create a file in a repository](https://docs.gitlab.com/api/repository_files/#create-a-file-in-a-repository)
  * [Update a file in a repository](https://docs.gitlab.com/api/repository_files/#update-a-file-in-a-repository)
  * [Delete a file in a repository](https://docs.gitlab.com/api/repository_files/#delete-a-file-in-a-repository)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/repository_files.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/repository_files.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Frepository_files%2F&_biz_t=1771981671846&_biz_i=Repository%20files%20API%20%7C%20GitLab%20Docs&_biz_n=144&rnd=603974&cdn_o=a&_biz_z=1771981671847)
