[Skip to main content](https://docs.gitlab.com/api/pipeline_schedules/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/pipeline_schedules/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/pipeline_schedules/)
    * [18.8](https://docs.gitlab.com/18.8/api/pipeline_schedules/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/pipeline_schedules/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/pipeline_schedules/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/pipeline_schedules.html)
...
/
  ...
  5. [Pipeline schedules](https://docs.gitlab.com/api/pipeline_schedules/)
...
Use this API to interact with [pipeline schedules](https://docs.gitlab.com/ci/pipelines/schedules/).
## List all pipeline schedules[](https://docs.gitlab.com/api/pipeline_schedules/#list-all-pipeline-schedules "Permalink")
...
The `inputs` field is only included in the response for users with the Maintainer or Owner roles, or for the schedule owner.
## Retrieve a pipeline schedule[](https://docs.gitlab.com/api/pipeline_schedules/#retrieve-a-pipeline-schedule "Permalink")
...
The `inputs` and `variables` fields are only included in the response for users with the Maintainer or Owner roles, or for the schedule owner.
## List all pipelines triggered by a pipeline schedule[](https://docs.gitlab.com/api/pipeline_schedules/#list-all-pipelines-triggered-by-a-pipeline-schedule "Permalink")
...
## Create a new pipeline schedule[](https://docs.gitlab.com/api/pipeline_schedules/#create-a-new-pipeline-schedule "Permalink")
History
  * `inputs` attribute [introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/525504) in GitLab 17.11 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `ci_inputs_for_pipelines`. Enabled by default.
...
`inputs` | hash | No | Array of [inputs](https://docs.gitlab.com/ci/inputs/#for-a-pipeline) to pass to the pipeline schedule. Each input contains a `name` and `value`. Values can be strings, arrays, numbers, or booleans.
Example request:
shell
```
curl --request POST \
...
## Update a pipeline schedule[](https://docs.gitlab.com/api/pipeline_schedules/#update-a-pipeline-schedule "Permalink")
...
`inputs` | hash | No | Array of [inputs](https://docs.gitlab.com/ci/inputs/) to pass to the pipeline schedule. Each input contains a `name` and `value`. To delete an existing input, include the `name` field and set `destroy` to `true`. Values can be strings, arrays, numbers, or booleans.
Example request:
shell
```
curl --request PUT \
...
## Update ownership of a pipeline schedule[](https://docs.gitlab.com/api/pipeline_schedules/#update-ownership-of-a-pipeline-schedule "Permalink")
...
## Delete a pipeline schedule[](https://docs.gitlab.com/api/pipeline_schedules/#delete-a-pipeline-schedule "Permalink")
...
## Run a pipeline schedule immediately[](https://docs.gitlab.com/api/pipeline_schedules/#run-a-pipeline-schedule-immediately "Permalink")
...
## Create a variable for a pipeline schedule[](https://docs.gitlab.com/api/pipeline_schedules/#create-a-variable-for-a-pipeline-schedule "Permalink")
...
## Retrieve a variable for a pipeline schedule[](https://docs.gitlab.com/api/pipeline_schedules/#retrieve-a-variable-for-a-pipeline-schedule "Permalink")
History
...
## Update a variable for a pipeline schedule[](https://docs.gitlab.com/api/pipeline_schedules/#update-a-variable-for-a-pipeline-schedule "Permalink")
...
## Delete a variable for a pipeline schedule[](https://docs.gitlab.com/api/pipeline_schedules/#delete-a-variable-for-a-pipeline-schedule "Permalink")
...
### Ambiguous refs[](https://docs.gitlab.com/api/pipeline_schedules/#ambiguous-refs "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/pipeline_schedules.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/pipeline_schedules.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all pipeline schedules](https://docs.gitlab.com/api/pipeline_schedules/#list-all-pipeline-schedules)
  * [Retrieve a pipeline schedule](https://docs.gitlab.com/api/pipeline_schedules/#retrieve-a-pipeline-schedule)
  * [List all pipelines triggered by a pipeline schedule](https://docs.gitlab.com/api/pipeline_schedules/#list-all-pipelines-triggered-by-a-pipeline-schedule)
  * [Create a new pipeline schedule](https://docs.gitlab.com/api/pipeline_schedules/#create-a-new-pipeline-schedule)
  * [Update a pipeline schedule](https://docs.gitlab.com/api/pipeline_schedules/#update-a-pipeline-schedule)
  * [Update ownership of a pipeline schedule](https://docs.gitlab.com/api/pipeline_schedules/#update-ownership-of-a-pipeline-schedule)
  * [Delete a pipeline schedule](https://docs.gitlab.com/api/pipeline_schedules/#delete-a-pipeline-schedule)
  * [Run a pipeline schedule immediately](https://docs.gitlab.com/api/pipeline_schedules/#run-a-pipeline-schedule-immediately)
  * [Create a variable for a pipeline schedule](https://docs.gitlab.com/api/pipeline_schedules/#create-a-variable-for-a-pipeline-schedule)
  * [Retrieve a variable for a pipeline schedule](https://docs.gitlab.com/api/pipeline_schedules/#retrieve-a-variable-for-a-pipeline-schedule)
  * [Update a variable for a pipeline schedule](https://docs.gitlab.com/api/pipeline_schedules/#update-a-variable-for-a-pipeline-schedule)
  * [Delete a variable for a pipeline schedule](https://docs.gitlab.com/api/pipeline_schedules/#delete-a-variable-for-a-pipeline-schedule)
  * [Ambiguous refs](https://docs.gitlab.com/api/pipeline_schedules/#ambiguous-refs)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/pipeline_schedules.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/pipeline_schedules.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpipeline_schedules%2F&_biz_t=1772174401390&_biz_i=Pipeline%20schedules%20API%20%7C%20GitLab%20Docs&_biz_n=122&rnd=394810&cdn_o=a&_biz_z=1772174401391)
