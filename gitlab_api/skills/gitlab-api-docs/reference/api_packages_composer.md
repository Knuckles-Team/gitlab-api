[Skip to main content](https://docs.gitlab.com/api/packages/composer/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/packages/composer/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/packages/composer/)
    * [18.8](https://docs.gitlab.com/18.8/api/packages/composer/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/packages/composer/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/packages/composer/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/packages/composer.html)
...
/
  ...
  5. [Composer](https://docs.gitlab.com/api/packages/composer/)
...
Use this API to interact with the [Composer package manager client](https://docs.gitlab.com/user/packages/composer_repository/).
This API is used by the [Composer package manager client](https://getcomposer.org/) and is generally not meant for manual consumption.
These endpoints do not adhere to the standard API authentication methods. See the [Composer package registry documentation](https://docs.gitlab.com/user/packages/composer_repository/) for details on which headers and token types are supported. Undocumented authentication methods might be removed in the future.
## Retrieve repository URL templates[](https://docs.gitlab.com/api/packages/composer/#retrieve-repository-url-templates "Permalink")
...
## V1 packages list[](https://docs.gitlab.com/api/packages/composer/#v1-packages-list "Permalink")
...
---|---|---|---
`id` | string | yes | The ID or full path of the group.
`sha` | string | yes | The provider SHA, provided by the Composer [base request](https://docs.gitlab.com/api/packages/composer/#retrieve-repository-url-templates).
shell
```
curl --user <username>:<personal_access_token> \
...
## Retrieve V1 package metadata[](https://docs.gitlab.com/api/packages/composer/#retrieve-v1-package-metadata "Permalink")
...
`sha` | string | yes | The SHA digest of the package, provided by the [V1 packages list](https://docs.gitlab.com/api/packages/composer/#v1-packages-list).
shell
```
curl --user <username>:<personal_access_token> \
...
## Retrieve V2 package metadata[](https://docs.gitlab.com/api/packages/composer/#retrieve-v2-package-metadata "Permalink")
...
## Create a package[](https://docs.gitlab.com/api/packages/composer/#create-a-package "Permalink")
...
## Download a package archive[](https://docs.gitlab.com/api/packages/composer/#download-a-package-archive "Permalink")
Downloads a specified Composer package archive for a project. This URL is provided in the [v1](https://docs.gitlab.com/api/packages/composer/#retrieve-v1-package-metadata) or [v2 package metadata](https://docs.gitlab.com/api/packages/composer/#retrieve-v2-package-metadata) response. A `.zip` file extension must be in the request.
```
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/composer.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/composer.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Retrieve repository URL templates](https://docs.gitlab.com/api/packages/composer/#retrieve-repository-url-templates)
  * [V1 packages list](https://docs.gitlab.com/api/packages/composer/#v1-packages-list)
  * [Retrieve V1 package metadata](https://docs.gitlab.com/api/packages/composer/#retrieve-v1-package-metadata)
  * [Retrieve V2 package metadata](https://docs.gitlab.com/api/packages/composer/#retrieve-v2-package-metadata)
  * [Create a package](https://docs.gitlab.com/api/packages/composer/#create-a-package)
  * [Download a package archive](https://docs.gitlab.com/api/packages/composer/#download-a-package-archive)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/composer.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/composer.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fnotes%2F&_biz_t=1771981606152&_biz_i=Notes%20API%20%7C%20GitLab%20Docs&_biz_n=101&rnd=611&cdn_o=a&_biz_z=1771981606522)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Foauth2%2F&_biz_t=1771981606232&_biz_i=OAuth%202.0%20identity%20provider%20API%20%7C%20GitLab%20Docs&_biz_n=103&rnd=827691&cdn_o=a&_biz_z=1771981606523)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpackages%2Fcomposer%2F&_biz_t=1771981606521&_biz_i=Composer%20API%20%7C%20GitLab%20Docs&_biz_n=105&rnd=555723&cdn_o=a&_biz_z=1771981606523)
