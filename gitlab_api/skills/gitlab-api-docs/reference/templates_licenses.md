[Skip to main content](https://docs.gitlab.com/api/templates/licenses/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/templates/licenses/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/templates/licenses/)
    * [18.8](https://docs.gitlab.com/18.8/api/templates/licenses/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/templates/licenses/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/templates/licenses/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/templates/licenses.html)
...
/
  ...
  5. [Licenses (templates)](https://docs.gitlab.com/api/templates/licenses/)
...
Users with the Guest role can’t access the license templates. For more information, see [Project and group visibility](https://docs.gitlab.com/user/public_access/).
## List all license templates[](https://docs.gitlab.com/api/templates/licenses/#list-all-license-templates "Permalink")
...
## Retrieve a single license template[](https://docs.gitlab.com/api/templates/licenses/#retrieve-a-single-license-template "Permalink")
Retrieves a single license template. You can pass parameters to replace the license placeholder.
```
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/templates/licenses.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/templates/licenses.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all license templates](https://docs.gitlab.com/api/templates/licenses/#list-all-license-templates)
  * [Retrieve a single license template](https://docs.gitlab.com/api/templates/licenses/#retrieve-a-single-license-template)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/templates/licenses.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/templates/licenses.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fsuggestions%2F&_biz_t=1772174481190&_biz_i=Suggest%20Changes%20API%20%7C%20GitLab%20Docs&_biz_n=175&rnd=221350&cdn_o=a&_biz_z=1772174481394)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fsystem_hooks%2F&_biz_t=1772174481275&_biz_i=System%20hooks%20API%20%7C%20GitLab%20Docs&_biz_n=176&rnd=889444&cdn_o=a&_biz_z=1772174481394)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Ftemplates%2Flicenses%2F&_biz_t=1772174481393&_biz_i=Licenses%20API%20%7C%20GitLab%20Docs&_biz_n=177&rnd=290287&cdn_o=a&_biz_z=1772174481394)
