[Skip to main content](https://docs.gitlab.com/tutorials/develop/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/tutorials/develop/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/tutorials/develop/)
    * [18.8](https://docs.gitlab.com/18.8/tutorials/develop/)
    * [18.7](https://archives.docs.gitlab.com/18.7/tutorials/develop/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/tutorials/develop/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/tutorials/develop.html)
...
/
  ...
  3. [Tutorials](https://docs.gitlab.com/tutorials/develop/)


* * *
# Tutorials: Extend with GitLab
GitLab [integrates](https://docs.gitlab.com/user/project/integrations/) with many third-party services, so you can work with those services directly in GitLab.
Topic | Description | Good for beginners
---|---|---
[Create Jira credentials](https://docs.gitlab.com/integration/jira/jira_server_configuration/) | Create Jira credentials to configure the Jira issues integration in GitLab. |
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/tutorials/develop.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/tutorials/develop.md)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/tutorials/develop.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/tutorials/develop.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Ftutorials%2Fdevelop%2F&_biz_t=1772174507639&_biz_i=Tutorials%3A%20Extend%20with%20GitLab%20%7C%20GitLab%20Docs&_biz_n=204&rnd=539173&cdn_o=a&_biz_z=1772174507640)
