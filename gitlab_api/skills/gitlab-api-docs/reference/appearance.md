[Skip to main content](https://docs.gitlab.com/api/appearance/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/appearance/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/appearance/)
    * [18.8](https://docs.gitlab.com/18.8/api/appearance/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/appearance/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/appearance/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/appearance.html)
...
/
  ...
  5. [Application appearance](https://docs.gitlab.com/api/appearance/)
...
Use this API to control the appearance of your GitLab instance. For more information, see [GitLab Appearance](https://docs.gitlab.com/administration/appearance/).
Prerequisites:
  * You must have administrator access to the instance.


## Retrieve application appearance[](https://docs.gitlab.com/api/appearance/#retrieve-application-appearance "Permalink")
...
## Update application appearance[](https://docs.gitlab.com/api/appearance/#update-application-appearance "Permalink")
...
`pwa_icon` | mixed | no | Icon used for Progressive Web App. See [Update application logo](https://docs.gitlab.com/api/appearance/#update-application-logo). [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/375708) in GitLab 15.8.
`logo` | mixed | no | Instance image used on the sign in / sign up page. See [Update application logo](https://docs.gitlab.com/api/appearance/#update-application-logo)
...
## Update application logo[](https://docs.gitlab.com/api/appearance/#update-application-logo "Permalink")
Updates the logo for this GitLab instance with an included image file.
To upload an avatar from your local file system, use the `--form` argument to include the file. This causes cURL to post data using the header `Content-Type: multipart/form-data`. The `file=` parameter must point to an image file on your file system and be preceded by `@`.
```
PUT /application/appearance
```
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/appearance.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/appearance.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Retrieve application appearance](https://docs.gitlab.com/api/appearance/#retrieve-application-appearance)
  * [Update application appearance](https://docs.gitlab.com/api/appearance/#update-application-appearance)
  * [Update application logo](https://docs.gitlab.com/api/appearance/#update-application-logo)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/appearance.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/appearance.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fappearance%2F&_biz_t=1772174216982&_biz_i=Application%20appearance%20API%20%7C%20GitLab%20Docs&_biz_n=11&rnd=464126&cdn_o=a&_biz_z=1772174216983)
