[Skip to main content](https://docs.gitlab.com/api/project_snippets/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/project_snippets/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/project_snippets/)
    * [18.8](https://docs.gitlab.com/18.8/api/project_snippets/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/project_snippets/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/project_snippets/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/project_snippets.html)
...
/
  ...
  6. [Snippets](https://docs.gitlab.com/api/project_snippets/)
...
Use this API to manage [project snippets](https://docs.gitlab.com/user/snippets/). Related APIs exist for [personal snippets](https://docs.gitlab.com/api/snippets/) and [moving snippets between storages](https://docs.gitlab.com/api/snippet_repository_storage_moves/).
## List all snippets for a project[](https://docs.gitlab.com/api/project_snippets/#list-all-snippets-for-a-project "Permalink")
...
## Retrieve a snippet[](https://docs.gitlab.com/api/project_snippets/#retrieve-a-snippet "Permalink")
...
## Create a snippet[](https://docs.gitlab.com/api/project_snippets/#create-a-snippet "Permalink")
...
## Update a snippet[](https://docs.gitlab.com/api/project_snippets/#update-a-snippet "Permalink")
...
## Delete a snippet[](https://docs.gitlab.com/api/project_snippets/#delete-a-snippet "Permalink")
...
## Retrieve snippet content[](https://docs.gitlab.com/api/project_snippets/#retrieve-snippet-content "Permalink")
...
## Retrieve snippet repository file content[](https://docs.gitlab.com/api/project_snippets/#retrieve-snippet-repository-file-content "Permalink")
...
## Retrieve user agent details[](https://docs.gitlab.com/api/project_snippets/#retrieve-user-agent-details "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/project_snippets.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/project_snippets.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all snippets for a project](https://docs.gitlab.com/api/project_snippets/#list-all-snippets-for-a-project)
  * [Retrieve a snippet](https://docs.gitlab.com/api/project_snippets/#retrieve-a-snippet)
  * [Create a snippet](https://docs.gitlab.com/api/project_snippets/#create-a-snippet)
  * [Update a snippet](https://docs.gitlab.com/api/project_snippets/#update-a-snippet)
  * [Delete a snippet](https://docs.gitlab.com/api/project_snippets/#delete-a-snippet)
  * [Retrieve snippet content](https://docs.gitlab.com/api/project_snippets/#retrieve-snippet-content)
  * [Retrieve snippet repository file content](https://docs.gitlab.com/api/project_snippets/#retrieve-snippet-repository-file-content)
  * [Retrieve user agent details](https://docs.gitlab.com/api/project_snippets/#retrieve-user-agent-details)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/project_snippets.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/project_snippets.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fproject_snippets%2F&_biz_t=1772174428322&_biz_i=Project%20snippets%20%7C%20GitLab%20Docs&_biz_n=140&rnd=241449&cdn_o=a&_biz_z=1772174428322)
