[Skip to main content](https://docs.gitlab.com/api/repository_submodules/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/repository_submodules/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/repository_submodules/)
    * [18.8](https://docs.gitlab.com/18.8/api/repository_submodules/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/repository_submodules/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/repository_submodules/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/repository_submodules.html)
...
/
  ...
  5. [Repository submodules](https://docs.gitlab.com/api/repository_submodules/)
...
## Update a submodule reference[](https://docs.gitlab.com/api/repository_submodules/#update-a-submodule-reference "Permalink")
Updates a submodule’s reference. Used for some workflows, especially automated ones, to keep up to date other projects that use it.
```
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/repository_submodules.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/repository_submodules.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Update a submodule reference](https://docs.gitlab.com/api/repository_submodules/#update-a-submodule-reference)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/repository_submodules.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/repository_submodules.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Frepository_submodules%2F&_biz_t=1771981684720&_biz_i=Repository%20submodules%20API%20%7C%20GitLab%20Docs&_biz_n=153&rnd=892102&cdn_o=a&_biz_z=1771981684720)
