[Skip to main content](https://docs.gitlab.com/api/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/)
    * [18.8](https://docs.gitlab.com/18.8/api/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/index.html)
...
[Integrate with GitLab Projects, issues, authentication, security providers.](https://docs.gitlab.com/integration/)[Webhooks Configure and manage project and group webhooks in GitLab.](https://docs.gitlab.com/user/project/integrations/webhooks/)[REST API Use the GitLab REST API for programmatic interaction with GitLab. Includes requests, rate limits, pagination, encoding, versioning, and response handling.](https://docs.gitlab.com/api/rest/)[GraphQL API Programmatic interaction with GitLab.](https://docs.gitlab.com/api/graphql/)[OAuth 2.0 identity provider API Third-party authorization to GitLab.](https://docs.gitlab.com/api/oauth2/)[Editor and IDE extensions Extend the features of GitLab to Visual Studio Code, JetBrains IDEs, Visual Studio, Eclipse, and Neovim.](https://docs.gitlab.com/editor_extensions/)
Was this page helpful?YesNo
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/_index.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/_index.md)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/_index.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/_index.md)
