[Skip to main content](https://docs.gitlab.com/api/group_badges/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/group_badges/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/group_badges/)
    * [18.8](https://docs.gitlab.com/18.8/api/group_badges/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/group_badges/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/group_badges/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/group_badges.html)
...
/
  ...
  6. [Badges](https://docs.gitlab.com/api/group_badges/)
...
Use this API to interact with group badges. For more information, see [group badges](https://docs.gitlab.com/user/project/badges/#group-badges).
...
## List all group badges[](https://docs.gitlab.com/api/group_badges/#list-all-group-badges "Permalink")
...
## Retrieve a group badge[](https://docs.gitlab.com/api/group_badges/#retrieve-a-group-badge "Permalink")
...
## Create a group badge[](https://docs.gitlab.com/api/group_badges/#create-a-group-badge "Permalink")
...
## Update a group badge[](https://docs.gitlab.com/api/group_badges/#update-a-group-badge "Permalink")
...
## Delete a group badge[](https://docs.gitlab.com/api/group_badges/#delete-a-group-badge "Permalink")
...
## Retrieve a group badge preview[](https://docs.gitlab.com/api/group_badges/#retrieve-a-group-badge-preview "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_badges.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_badges.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all group badges](https://docs.gitlab.com/api/group_badges/#list-all-group-badges)
  * [Retrieve a group badge](https://docs.gitlab.com/api/group_badges/#retrieve-a-group-badge)
  * [Create a group badge](https://docs.gitlab.com/api/group_badges/#create-a-group-badge)
  * [Update a group badge](https://docs.gitlab.com/api/group_badges/#update-a-group-badge)
  * [Delete a group badge](https://docs.gitlab.com/api/group_badges/#delete-a-group-badge)
  * [Retrieve a group badge preview](https://docs.gitlab.com/api/group_badges/#retrieve-a-group-badge-preview)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_badges.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_badges.md)
