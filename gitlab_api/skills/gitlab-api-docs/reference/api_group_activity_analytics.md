[Skip to main content](https://docs.gitlab.com/api/group_activity_analytics/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/group_activity_analytics/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/group_activity_analytics/)
    * [18.8](https://docs.gitlab.com/18.8/api/group_activity_analytics/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/group_activity_analytics/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/group_activity_analytics/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/group_activity_analytics.html)
...
/
  ...
  6. [Activity analytics](https://docs.gitlab.com/api/group_activity_analytics/)
...
Use this API to retrieve information about group activities. For more information, see [group activity analytics](https://docs.gitlab.com/user/group/manage/#group-activity-analytics).
## Retrieve count of recently created issues for a group[](https://docs.gitlab.com/api/group_activity_analytics/#retrieve-count-of-recently-created-issues-for-a-group "Permalink")
...
## Retrieve count of recently created merge requests for a group[](https://docs.gitlab.com/api/group_activity_analytics/#retrieve-count-of-recently-created-merge-requests-for-a-group "Permalink")
...
## Retrieve count of members recently added to a group[](https://docs.gitlab.com/api/group_activity_analytics/#retrieve-count-of-members-recently-added-to-a-group "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_activity_analytics.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_activity_analytics.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Retrieve count of recently created issues for a group](https://docs.gitlab.com/api/group_activity_analytics/#retrieve-count-of-recently-created-issues-for-a-group)
  * [Retrieve count of recently created merge requests for a group](https://docs.gitlab.com/api/group_activity_analytics/#retrieve-count-of-recently-created-merge-requests-for-a-group)
  * [Retrieve count of members recently added to a group](https://docs.gitlab.com/api/group_activity_analytics/#retrieve-count-of-members-recently-added-to-a-group)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_activity_analytics.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_activity_analytics.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fgroup_boards%2F&_biz_t=1771981540880&_biz_i=Group%20issue%20boards%20API%20%7C%20GitLab%20Docs&_biz_n=61&rnd=158998&cdn_o=a&_biz_z=1771981540931)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fgroup_activity_analytics%2F&_biz_t=1771981540931&_biz_i=Group%20activity%20analytics%20API%20%7C%20GitLab%20Docs&_biz_n=62&rnd=304072&cdn_o=a&_biz_z=1771981540932)
