[Skip to main content](https://docs.gitlab.com/api/virtual_registries_cleanup_policies/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/virtual_registries_cleanup_policies/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/virtual_registries_cleanup_policies/)
    * [18.8](https://docs.gitlab.com/18.8/api/virtual_registries_cleanup_policies/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/virtual_registries_cleanup_policies/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/virtual_registries_cleanup_policies/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/virtual_registries_cleanup_policies.html)
...
/
  ...
  5. [Virtual registries cleanup policies](https://docs.gitlab.com/api/virtual_registries_cleanup_policies/)
...
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/572839) in GitLab 18.6 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `maven_virtual_registry`. Enabled by default.
...
## Manage cleanup policies[](https://docs.gitlab.com/api/virtual_registries_cleanup_policies/#manage-cleanup-policies "Permalink")
...
### Retrieve the cleanup policy for a group[](https://docs.gitlab.com/api/virtual_registries_cleanup_policies/#retrieve-the-cleanup-policy-for-a-group "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/572839) in GitLab 18.6 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `maven_virtual_registry`. Enabled by default.
...
### Create a cleanup policy[](https://docs.gitlab.com/api/virtual_registries_cleanup_policies/#create-a-cleanup-policy "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/572839) in GitLab 18.6 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `maven_virtual_registry`. Enabled by default.
...
### Update a cleanup policy[](https://docs.gitlab.com/api/virtual_registries_cleanup_policies/#update-a-cleanup-policy "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/572839) in GitLab 18.6 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `maven_virtual_registry`. Enabled by default.
...
### Delete a cleanup policy[](https://docs.gitlab.com/api/virtual_registries_cleanup_policies/#delete-a-cleanup-policy "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/572839) in GitLab 18.6 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `maven_virtual_registry`. Enabled by default.
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/virtual_registries_cleanup_policies.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/virtual_registries_cleanup_policies.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Manage cleanup policies](https://docs.gitlab.com/api/virtual_registries_cleanup_policies/#manage-cleanup-policies)
  * [Retrieve the cleanup policy for a group](https://docs.gitlab.com/api/virtual_registries_cleanup_policies/#retrieve-the-cleanup-policy-for-a-group)
  * [Create a cleanup policy](https://docs.gitlab.com/api/virtual_registries_cleanup_policies/#create-a-cleanup-policy)
  * [Update a cleanup policy](https://docs.gitlab.com/api/virtual_registries_cleanup_policies/#update-a-cleanup-policy)
  * [Delete a cleanup policy](https://docs.gitlab.com/api/virtual_registries_cleanup_policies/#delete-a-cleanup-policy)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/virtual_registries_cleanup_policies.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/virtual_registries_cleanup_policies.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fvirtual_registries_cleanup_policies%2F&_biz_t=1772174494696&_biz_i=Virtual%20registries%20cleanup%20policies%20API%20%7C%20GitLab%20Docs&_biz_n=189&rnd=629033&cdn_o=a&_biz_z=1772174494697)
