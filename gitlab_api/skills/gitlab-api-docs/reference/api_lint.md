[Skip to main content](https://docs.gitlab.com/api/lint/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/lint/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/lint/)
    * [18.8](https://docs.gitlab.com/18.8/api/lint/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/lint/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/lint/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/lint.html)
...
/
  ...
  5. [Lint .gitlab-ci.yml](https://docs.gitlab.com/api/lint/)
...
Use this API to [validate your GitLab CI/CD configuration](https://docs.gitlab.com/ci/yaml/lint/).
...
```
  ...
  2. To escape and encode an input YAML file (`example-gitlab-ci.yml`), then `POST` it to the GitLab API, create a one-line command that combines `curl` and `jq`:
shell
```
jq --null-input --arg yaml "$(<example-gitlab-ci.yml)" '.content=$yaml' \
| curl --url "https://gitlab.com/api/v4/projects/:id/ci/lint?include_merged_yaml=true" \
...
## Parse responses from this API[](https://docs.gitlab.com/api/lint/#parse-responses-from-this-api "Permalink")
...
## Validate CI/CD configuration[](https://docs.gitlab.com/api/lint/#validate-cicd-configuration "Permalink")
Validates `.gitlab-ci.yml` configuration for a specified project. This endpoint validates the CI/CD configuration in the context of the project, including:
...
`dry_run` | boolean | No | Run [pipeline creation simulation](https://docs.gitlab.com/ci/yaml/lint/#simulate-a-pipeline), or only do static check. Default: `false`.
...
## Validate existing CI/CD configuration[](https://docs.gitlab.com/api/lint/#validate-existing-cicd-configuration "Permalink")
History
...
Validates the existing `.gitlab-ci.yml` configuration for a specified project. This endpoint validates the CI/CD configuration in the context of the project, including:
  * Using the project’s CI/CD variables.
  * Searching the project’s files for `include:local` entries.
...
Example responses:
  * Valid configuration, with `include.yml` as an [included file](https://docs.gitlab.com/ci/yaml/#include) and `include_jobs` set to `true`:
json
```
{
  "valid": true,
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/lint.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/lint.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Parse responses from this API](https://docs.gitlab.com/api/lint/#parse-responses-from-this-api)
  * [Validate CI/CD configuration](https://docs.gitlab.com/api/lint/#validate-cicd-configuration)
  * [Validate existing CI/CD configuration](https://docs.gitlab.com/api/lint/#validate-existing-cicd-configuration)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/lint.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/lint.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fjobs%2F&_biz_t=1771981574632&_biz_i=Jobs%20API%20%7C%20GitLab%20Docs&_biz_n=83&rnd=750322&cdn_o=a&_biz_z=1771981574700)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Flint%2F&_biz_t=1771981574700&_biz_i=CI%20Lint%20API%20%7C%20GitLab%20Docs&_biz_n=84&rnd=356905&cdn_o=a&_biz_z=1771981574701)
