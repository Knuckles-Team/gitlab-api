[Skip to main content](https://docs.gitlab.com/api/group_labels/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/group_labels/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/group_labels/)
    * [18.8](https://docs.gitlab.com/18.8/api/group_labels/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/group_labels/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/group_labels/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/group_labels.html)
...
/
  ...
  6. [Labels](https://docs.gitlab.com/api/group_labels/)
...
History
  * `archived` attribute [introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/4233) in GitLab 18.3 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `labels_archive`.
...
## List group labels[](https://docs.gitlab.com/api/group_labels/#list-group-labels "Permalink")
...
## Get a single group label[](https://docs.gitlab.com/api/group_labels/#get-a-single-group-label "Permalink")
...
## Create a new group label[](https://docs.gitlab.com/api/group_labels/#create-a-new-group-label "Permalink")
...
## Update a group label[](https://docs.gitlab.com/api/group_labels/#update-a-group-label "Permalink")
...
## Delete a group label[](https://docs.gitlab.com/api/group_labels/#delete-a-group-label "Permalink")
...
## Subscribe to a group label[](https://docs.gitlab.com/api/group_labels/#subscribe-to-a-group-label "Permalink")
...
## Unsubscribe from a group label[](https://docs.gitlab.com/api/group_labels/#unsubscribe-from-a-group-label "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_labels.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_labels.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List group labels](https://docs.gitlab.com/api/group_labels/#list-group-labels)
  * [Get a single group label](https://docs.gitlab.com/api/group_labels/#get-a-single-group-label)
  * [Create a new group label](https://docs.gitlab.com/api/group_labels/#create-a-new-group-label)
  * [Update a group label](https://docs.gitlab.com/api/group_labels/#update-a-group-label)
  * [Delete a group label](https://docs.gitlab.com/api/group_labels/#delete-a-group-label)
  * [Subscribe to a group label](https://docs.gitlab.com/api/group_labels/#subscribe-to-a-group-label)
  * [Unsubscribe from a group label](https://docs.gitlab.com/api/group_labels/#unsubscribe-from-a-group-label)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_labels.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_labels.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fgroup_iterations%2F&_biz_t=1772174281906&_biz_i=Group%20iterations%20API%20%7C%20GitLab%20Docs&_biz_n=59&rnd=267388&cdn_o=a&_biz_z=1772174282148)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fgroup_badges%2F&_biz_t=1772174281979&_biz_i=Group%20badges%20API%20%7C%20GitLab%20Docs&_biz_n=60&rnd=549330&cdn_o=a&_biz_z=1772174282149)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fgroup_labels%2F&_biz_t=1772174282146&_biz_i=Group%20labels%20API%20%7C%20GitLab%20Docs&_biz_n=61&rnd=407283&cdn_o=a&_biz_z=1772174282149)
