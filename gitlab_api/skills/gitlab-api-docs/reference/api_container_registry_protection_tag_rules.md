[Skip to main content](https://docs.gitlab.com/api/container_registry_protection_tag_rules/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/container_registry_protection_tag_rules/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/container_registry_protection_tag_rules/)
    * [18.8](https://docs.gitlab.com/18.8/api/container_registry_protection_tag_rules/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/container_registry_protection_tag_rules/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/container_registry_protection_tag_rules/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/container_registry_protection_tag_rules.html)
...
/
  ...
  5. [Container registry protection tag rules](https://docs.gitlab.com/api/container_registry_protection_tag_rules/)


* * *
# Container registry protection tag rules API
...
Use this API to manage [protected container tags](https://docs.gitlab.com/user/packages/container_registry/protected_container_tags/).
## List container registry protection tag rules[](https://docs.gitlab.com/api/container_registry_protection_tag_rules/#list-container-registry-protection-tag-rules "Permalink")
...
## Create a container registry protection tag rule[](https://docs.gitlab.com/api/container_registry_protection_tag_rules/#create-a-container-registry-protection-tag-rule "Permalink")
History
...
## Update a container registry protection tag rule[](https://docs.gitlab.com/api/container_registry_protection_tag_rules/#update-a-container-registry-protection-tag-rule "Permalink")
History
...
## Delete a container registry protection tag rule[](https://docs.gitlab.com/api/container_registry_protection_tag_rules/#delete-a-container-registry-protection-tag-rule "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/581199) in GitLab 18.9.
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/container_registry_protection_tag_rules.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/container_registry_protection_tag_rules.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List container registry protection tag rules](https://docs.gitlab.com/api/container_registry_protection_tag_rules/#list-container-registry-protection-tag-rules)
  * [Create a container registry protection tag rule](https://docs.gitlab.com/api/container_registry_protection_tag_rules/#create-a-container-registry-protection-tag-rule)
  * [Update a container registry protection tag rule](https://docs.gitlab.com/api/container_registry_protection_tag_rules/#update-a-container-registry-protection-tag-rule)
  * [Delete a container registry protection tag rule](https://docs.gitlab.com/api/container_registry_protection_tag_rules/#delete-a-container-registry-protection-tag-rule)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/container_registry_protection_tag_rules.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/container_registry_protection_tag_rules.md)
