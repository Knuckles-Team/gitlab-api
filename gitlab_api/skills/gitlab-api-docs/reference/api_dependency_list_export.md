[Skip to main content](https://docs.gitlab.com/api/dependency_list_export/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/dependency_list_export/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/dependency_list_export/)
    * [18.8](https://docs.gitlab.com/18.8/api/dependency_list_export/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/dependency_list_export/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/dependency_list_export/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/dependency_list_export.html)
...
/
  ...
  5. [Dependency list export](https://docs.gitlab.com/api/dependency_list_export/)
...
Use this API to export [dependency lists](https://docs.gitlab.com/user/application_security/dependency_list/). Every call to this API requires authentication.
## Create a dependency list export[](https://docs.gitlab.com/api/dependency_list_export/#create-a-dependency-list-export "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/333463) in GitLab 16.4 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `merge_sbom_api`. Enabled by default.
...
If an authenticated user does not have the [read_dependency](https://docs.gitlab.com/user/custom_roles/abilities/#vulnerability-management) permission, this request returns a `403 Forbidden` status code.
...
`export_type` | string | yes | Format of the export. See [export types](https://docs.gitlab.com/api/dependency_list_export/#export-types) for a list of accepted values.
...
### Export types[](https://docs.gitlab.com/api/dependency_list_export/#export-types "Permalink")
...
## Get single dependency list export[](https://docs.gitlab.com/api/dependency_list_export/#get-single-dependency-list-export "Permalink")
...
## Download dependency list export[](https://docs.gitlab.com/api/dependency_list_export/#download-dependency-list-export "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/dependency_list_export.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/dependency_list_export.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Create a dependency list export](https://docs.gitlab.com/api/dependency_list_export/#create-a-dependency-list-export)
  * [Export types](https://docs.gitlab.com/api/dependency_list_export/#export-types)
  * [Get single dependency list export](https://docs.gitlab.com/api/dependency_list_export/#get-single-dependency-list-export)
  * [Download dependency list export](https://docs.gitlab.com/api/dependency_list_export/#download-dependency-list-export)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/dependency_list_export.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/dependency_list_export.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fdependency_list_export%2F&_biz_t=1771981499962&_biz_i=Dependency%20list%20export%20API%20%7C%20GitLab%20Docs&_biz_n=35&rnd=409721&cdn_o=a&_biz_z=1771981499962)
