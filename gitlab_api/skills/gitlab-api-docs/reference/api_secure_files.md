[Skip to main content](https://docs.gitlab.com/api/secure_files/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/secure_files/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/secure_files/)
    * [18.8](https://docs.gitlab.com/18.8/api/secure_files/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/secure_files/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/secure_files/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/secure_files.html)
...
/
  ...
  5. [Secure files](https://docs.gitlab.com/api/secure_files/)
...
Use this API to manage [secure files](https://docs.gitlab.com/ci/secure_files/) for a project.
## List project secure files[](https://docs.gitlab.com/api/secure_files/#list-project-secure-files "Permalink")
...
## Show secure file details[](https://docs.gitlab.com/api/secure_files/#show-secure-file-details "Permalink")
...
## Create secure file[](https://docs.gitlab.com/api/secure_files/#create-secure-file "Permalink")
...
## Download secure file[](https://docs.gitlab.com/api/secure_files/#download-secure-file "Permalink")
...
## Remove secure file[](https://docs.gitlab.com/api/secure_files/#remove-secure-file "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/secure_files.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/secure_files.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List project secure files](https://docs.gitlab.com/api/secure_files/#list-project-secure-files)
  * [Show secure file details](https://docs.gitlab.com/api/secure_files/#show-secure-file-details)
  * [Create secure file](https://docs.gitlab.com/api/secure_files/#create-secure-file)
  * [Download secure file](https://docs.gitlab.com/api/secure_files/#download-secure-file)
  * [Remove secure file](https://docs.gitlab.com/api/secure_files/#remove-secure-file)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/secure_files.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/secure_files.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fsecure_files%2F&_biz_t=1771981705345&_biz_i=Project-level%20Secure%20Files%20API%20%7C%20GitLab%20Docs&_biz_n=168&rnd=667441&cdn_o=a&_biz_z=1771981705345)
