[Skip to main content](https://docs.gitlab.com/api/merge_request_context_commits/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/merge_request_context_commits/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/merge_request_context_commits/)
    * [18.8](https://docs.gitlab.com/18.8/api/merge_request_context_commits/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/merge_request_context_commits/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/merge_request_context_commits/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/merge_request_context_commits.html)
...
/
  ...
  5. [Merge request context commits](https://docs.gitlab.com/api/merge_request_context_commits/)
...
If your merge request builds upon a previous merge request, you might need to [include previously-merged commits for context](https://docs.gitlab.com/user/project/merge_requests/commits/#show-commits-from-previous-merge-requests) in your merge request. Use this API to add commits to a merge request for more context.
## List context commits for a merge request[](https://docs.gitlab.com/api/merge_request_context_commits/#list-context-commits-for-a-merge-request "Permalink")
...
## Create context commits for a merge request[](https://docs.gitlab.com/api/merge_request_context_commits/#create-context-commits-for-a-merge-request "Permalink")
...
## Delete context commits from a merge request[](https://docs.gitlab.com/api/merge_request_context_commits/#delete-context-commits-from-a-merge-request "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/merge_request_context_commits.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/merge_request_context_commits.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List context commits for a merge request](https://docs.gitlab.com/api/merge_request_context_commits/#list-context-commits-for-a-merge-request)
  * [Create context commits for a merge request](https://docs.gitlab.com/api/merge_request_context_commits/#create-context-commits-for-a-merge-request)
  * [Delete context commits from a merge request](https://docs.gitlab.com/api/merge_request_context_commits/#delete-context-commits-from-a-merge-request)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/merge_request_context_commits.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/merge_request_context_commits.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fmerge_request_context_commits%2F&_biz_t=1772174323462&_biz_i=Merge%20request%20context%20commits%20API%20%7C%20GitLab%20Docs&_biz_n=92&rnd=638322&cdn_o=a&_biz_z=1772174323463)
