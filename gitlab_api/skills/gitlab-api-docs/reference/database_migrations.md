[Skip to main content](https://docs.gitlab.com/api/database_migrations/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/database_migrations/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/database_migrations/)
    * [18.8](https://docs.gitlab.com/18.8/api/database_migrations/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/database_migrations/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/database_migrations/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/database_migrations.html)
...
/
  ...
  5. [Database migrations](https://docs.gitlab.com/api/database_migrations/)
...
## Mark a migration as successful[](https://docs.gitlab.com/api/database_migrations/#mark-a-migration-as-successful "Permalink")
...
## List pending migrations[](https://docs.gitlab.com/api/database_migrations/#list-pending-migrations "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/database_migrations.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/database_migrations.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Mark a migration as successful](https://docs.gitlab.com/api/database_migrations/#mark-a-migration-as-successful)
  * [List pending migrations](https://docs.gitlab.com/api/database_migrations/#list-pending-migrations)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/database_migrations.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/database_migrations.md)
