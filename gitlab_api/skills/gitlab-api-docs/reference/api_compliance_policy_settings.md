[Skip to main content](https://docs.gitlab.com/api/compliance_policy_settings/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/compliance_policy_settings/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/compliance_policy_settings/)
    * [18.8](https://docs.gitlab.com/18.8/api/compliance_policy_settings/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/compliance_policy_settings/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/compliance_policy_settings/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/compliance_policy_settings.html)
...
/
  ...
  5. [Compliance and policy settings](https://docs.gitlab.com/api/compliance_policy_settings/)
...
History
  * [Introduced](https://gitlab.com/groups/gitlab-org/-/epics/17392) in GitLab 18.2 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `security_policies_csp`. Disabled by default.
...
## Retrieve security policy settings[](https://docs.gitlab.com/api/compliance_policy_settings/#retrieve-security-policy-settings "Permalink")
...
## Update security policy settings[](https://docs.gitlab.com/api/compliance_policy_settings/#update-security-policy-settings "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/compliance_policy_settings.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/compliance_policy_settings.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Retrieve security policy settings](https://docs.gitlab.com/api/compliance_policy_settings/#retrieve-security-policy-settings)
  * [Update security policy settings](https://docs.gitlab.com/api/compliance_policy_settings/#update-security-policy-settings)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/compliance_policy_settings.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/compliance_policy_settings.md)
