[Skip to main content](https://docs.gitlab.com/api/code_suggestions/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/code_suggestions/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/code_suggestions/)
    * [18.8](https://docs.gitlab.com/18.8/api/code_suggestions/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/code_suggestions/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/code_suggestions/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/code_suggestions.html)
...
/
  ...
  5. [Code Suggestions](https://docs.gitlab.com/api/code_suggestions/)


* * *
# Code Suggestions API
Use this API to access the [GitLab Duo Code Suggestions](https://docs.gitlab.com/user/duo_agent_platform/code_suggestions/) or [GitLab Duo Code Suggestions (Classic)](https://docs.gitlab.com/user/project/repository/code_suggestions/) feature.
## Generate code completions[](https://docs.gitlab.com/api/code_suggestions/#generate-code-completions "Permalink")
  * Status: Experiment


History
  * Introduced in GitLab 16.2 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `code_suggestions_completion_api`. Disabled by default. This feature is an experiment.
  ...
  * `context` and `user_instruction` attributes [introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/462750) in GitLab 17.1 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `code_suggestions_context`. Disabled by default.
...
---|---|---|---
`current_file` | hash | yes | Attributes of file that suggestions are being generated for. See [File attributes](https://docs.gitlab.com/api/code_suggestions/#file-attributes) for a list of strings this attribute accepts.
...
`context` | array | no | Additional context to be used for Code Suggestions. See [Context attributes](https://docs.gitlab.com/api/code_suggestions/#context-attributes) for a list of parameters this attribute accepts.
`user_instruction` | string | no | A user’s instructions for Code Suggestions.
### File attributes[](https://docs.gitlab.com/api/code_suggestions/#file-attributes "Permalink")
...
### Context attributes[](https://docs.gitlab.com/api/code_suggestions/#context-attributes "Permalink")
...
## Validate that Code Suggestions is enabled[](https://docs.gitlab.com/api/code_suggestions/#validate-that-code-suggestions-is-enabled "Permalink")
History
...
If successful, returns:
  * [`200`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) if the feature is enabled.
  * [`403`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) if the feature is disabled.


Additionally, returns a [`404`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) if the path is empty or the project does not exist.
Example request:
shell
```
curl --request POST \
...
## Fetch direct connection details for the AI Gateway[](https://docs.gitlab.com/api/code_suggestions/#fetch-direct-connection-details-for-the-ai-gateway "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/452044) in GitLab 17.0 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `code_suggestions_direct_completions`. Disabled by default.
...
## Fetch connection details[](https://docs.gitlab.com/api/code_suggestions/#fetch-connection-details "Permalink")
History
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/code_suggestions.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/code_suggestions.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Generate code completions](https://docs.gitlab.com/api/code_suggestions/#generate-code-completions)
  * [File attributes](https://docs.gitlab.com/api/code_suggestions/#file-attributes)
  * [Context attributes](https://docs.gitlab.com/api/code_suggestions/#context-attributes)
  * [Validate that Code Suggestions is enabled](https://docs.gitlab.com/api/code_suggestions/#validate-that-code-suggestions-is-enabled)
  * [Fetch direct connection details for the AI Gateway](https://docs.gitlab.com/api/code_suggestions/#fetch-direct-connection-details-for-the-ai-gateway)
  * [Fetch connection details](https://docs.gitlab.com/api/code_suggestions/#fetch-connection-details)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/code_suggestions.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/code_suggestions.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fcode_suggestions%2F&_biz_t=1771981487061&_biz_i=Code%20Suggestions%20API%20%7C%20GitLab%20Docs&_biz_n=27&rnd=810818&cdn_o=a&_biz_z=1771981487062)
