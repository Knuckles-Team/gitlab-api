[Skip to main content](https://docs.gitlab.com/api/chat/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/chat/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/chat/)
    * [18.8](https://docs.gitlab.com/18.8/api/chat/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/chat/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/chat/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/chat.html)
...
/
  ...
  5. [GitLab Duo Chat completions](https://docs.gitlab.com/api/chat/)


* * *
# GitLab Duo Chat completions API
This API is used to generate responses for [GitLab Duo Chat](https://docs.gitlab.com/user/gitlab_duo_chat/):
  * On GitLab.com, this API is for internal use only.
  * On GitLab Self-Managed, you can enable this API [with a feature flag](https://docs.gitlab.com/administration/feature_flags/) named `access_rest_chat`.
...
## Generate a Chat response[](https://docs.gitlab.com/api/chat/#generate-a-chat-response "Permalink")
Generates a response for a GitLab Duo Chat question.
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/133015) in GitLab 16.7 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `access_rest_chat`. Disabled by default. This feature is internal-only.
  * `additional_context` parameter [added](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/162650) in GitLab 17.4 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `duo_additional_context`. Disabled by default. This feature is internal-only.
...
`additional_context` | array | No | An array of additional context items for this chat request. See [Context attributes](https://docs.gitlab.com/api/chat/#context-attributes) for a list of parameters this attribute accepts.
### Context attributes[](https://docs.gitlab.com/api/chat/#context-attributes "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/chat.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/chat.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Generate a Chat response](https://docs.gitlab.com/api/chat/#generate-a-chat-response)
  * [Context attributes](https://docs.gitlab.com/api/chat/#context-attributes)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/chat.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/chat.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fchat%2F&_biz_t=1772174228689&_biz_i=GitLab%20Duo%20Chat%20completions%20API%20%7C%20GitLab%20Docs&_biz_n=20&rnd=758084&cdn_o=a&_biz_z=1772174228690)
