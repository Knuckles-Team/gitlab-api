[Skip to main content](https://docs.gitlab.com/administration/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/administration/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/administration/)
    * [18.8](https://docs.gitlab.com/18.8/administration/)
    * [18.7](https://archives.docs.gitlab.com/18.7/administration/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/administration/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/administration/index.html)
...
[Get started Administration overview.](https://docs.gitlab.com/administration/get_started/)[All feature flags Complete list of all feature flags in GitLab.](https://docs.gitlab.com/administration/feature_flags/list/)[Configure GitLab Configuration settings.](https://docs.gitlab.com/administration/configure/)[Update your Admin area settings Product settings.](https://docs.gitlab.com/administration/settings/)[Maintain GitLab Backup and restore, move repos, maintenance tasks.](https://docs.gitlab.com/administration/operations/)[Monitor GitLab Performance, health, uptime monitoring.](https://docs.gitlab.com/administration/monitoring/)[Secure GitLab SSH key limits, 2FA, tokens, hardening.](https://docs.gitlab.com/security/)[Administer users Administer GitLab users.](https://docs.gitlab.com/administration/administer_users/)[GitLab Dedicated Get started with GitLab Dedicated.](https://docs.gitlab.com/administration/dedicated/)[GitLab Runner Run CI/CD jobs in a pipeline.](https://docs.gitlab.com/runner/)
Only GitLab team members have access to administration tools and settings on GitLab.com.
Was this page helpful?YesNo
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/administration/_index.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/administration/_index.md)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/administration/_index.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/administration/_index.md)
