[Skip to main content](https://docs.gitlab.com/api/iterations/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/iterations/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/iterations/)
    * [18.8](https://docs.gitlab.com/18.8/api/iterations/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/iterations/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/iterations/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/iterations.html)
...
/
  ...
  6. [Iterations](https://docs.gitlab.com/api/iterations/)
...
Use this API to access [project iterations](https://docs.gitlab.com/user/group/iterations/).
For group iterations, use the [group iterations API](https://docs.gitlab.com/api/group_iterations/).
...
## List all project iterations[](https://docs.gitlab.com/api/iterations/#list-all-project-iterations "Permalink")
Lists all iterations for a specified project.
Iterations created by **Enable automatic scheduling** in [Iteration cadences](https://docs.gitlab.com/user/group/iterations/#iteration-cadences) return `null` for the `title` and `description` fields.
```
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/iterations.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/iterations.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all project iterations](https://docs.gitlab.com/api/iterations/#list-all-project-iterations)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/iterations.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/iterations.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fjobs%2F&_biz_t=1772174308303&_biz_i=Jobs%20API%20%7C%20GitLab%20Docs&_biz_n=77&rnd=172476&cdn_o=a&_biz_z=1772174308536)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fissue_links%2F&_biz_t=1772174308441&_biz_i=Issue%20links%20API%20%7C%20GitLab%20Docs&_biz_n=78&rnd=60297&cdn_o=a&_biz_z=1772174308537)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fissues%2F&_biz_t=1772174308509&_biz_i=Issues%20API%20%7C%20GitLab%20Docs&_biz_n=79&rnd=247911&cdn_o=a&_biz_z=1772174308537)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fiterations%2F&_biz_t=1772174308536&_biz_i=Project%20iterations%20API%20%7C%20GitLab%20Docs&_biz_n=80&rnd=566452&cdn_o=a&_biz_z=1772174308537)
