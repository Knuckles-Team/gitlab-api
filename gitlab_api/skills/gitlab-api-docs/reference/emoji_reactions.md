[Skip to main content](https://docs.gitlab.com/api/emoji_reactions/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/emoji_reactions/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/emoji_reactions/)
    * [18.8](https://docs.gitlab.com/18.8/api/emoji_reactions/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/emoji_reactions/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/emoji_reactions/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/emoji_reactions.html)
...
/
  ...
  5. [Emoji reactions](https://docs.gitlab.com/api/emoji_reactions/)
...
Use this API to manage [emoji reactions](https://docs.gitlab.com/user/emoji_reactions/).
GitLab objects that accept emoji reactions are called awardables. You can react with emoji on the following resources:
  * [Epics](https://docs.gitlab.com/user/group/epics/) ([API](https://docs.gitlab.com/api/epics/)).
  * [Issues](https://docs.gitlab.com/user/project/issues/) ([API](https://docs.gitlab.com/api/issues/)).
  * [Merge requests](https://docs.gitlab.com/user/project/merge_requests/) ([API](https://docs.gitlab.com/api/merge_requests/)).
  * [Snippets](https://docs.gitlab.com/user/snippets/) ([API](https://docs.gitlab.com/api/snippets/)).
  * [Comments](https://docs.gitlab.com/user/emoji_reactions/#emoji-reactions-for-comments) ([API](https://docs.gitlab.com/api/notes/)).


## Issues, merge requests, and snippets[](https://docs.gitlab.com/api/emoji_reactions/#issues-merge-requests-and-snippets "Permalink")
For information on using these endpoints with comments, see [Add reactions to comments](https://docs.gitlab.com/api/emoji_reactions/#add-reactions-to-comments).
### List all emoji reactions for a resource[](https://docs.gitlab.com/api/emoji_reactions/#list-all-emoji-reactions-for-a-resource "Permalink")
History
...
### Retrieve an emoji reaction from a resource[](https://docs.gitlab.com/api/emoji_reactions/#retrieve-an-emoji-reaction-from-a-resource "Permalink")
History
  * [Changed](https://gitlab.com/gitlab-org/gitlab/-/issues/335068) in GitLab 15.1 to allow unauthenticated access to public awardables.
...
### Add an emoji reaction to a resource[](https://docs.gitlab.com/api/emoji_reactions/#add-an-emoji-reaction-to-a-resource "Permalink")
...
### Delete an emoji reaction from a resource[](https://docs.gitlab.com/api/emoji_reactions/#delete-an-emoji-reaction-from-a-resource "Permalink")
...
## Add reactions to comments[](https://docs.gitlab.com/api/emoji_reactions/#add-reactions-to-comments "Permalink")
...
### List all emoji reactions for a comment[](https://docs.gitlab.com/api/emoji_reactions/#list-all-emoji-reactions-for-a-comment "Permalink")
History
...
### Retrieve an emoji reaction from a comment[](https://docs.gitlab.com/api/emoji_reactions/#retrieve-an-emoji-reaction-from-a-comment "Permalink")
History
  * [Changed](https://gitlab.com/gitlab-org/gitlab/-/issues/335068) in GitLab 15.1 to allow unauthenticated access to public comments.
...
### Add an emoji reaction to a comment[](https://docs.gitlab.com/api/emoji_reactions/#add-an-emoji-reaction-to-a-comment "Permalink")
...
### Delete an emoji reaction from a comment[](https://docs.gitlab.com/api/emoji_reactions/#delete-an-emoji-reaction-from-a-comment "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/emoji_reactions.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/emoji_reactions.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Issues, merge requests, and snippets](https://docs.gitlab.com/api/emoji_reactions/#issues-merge-requests-and-snippets)
  * [List all emoji reactions for a resource](https://docs.gitlab.com/api/emoji_reactions/#list-all-emoji-reactions-for-a-resource)
  * [Retrieve an emoji reaction from a resource](https://docs.gitlab.com/api/emoji_reactions/#retrieve-an-emoji-reaction-from-a-resource)
  * [Add an emoji reaction to a resource](https://docs.gitlab.com/api/emoji_reactions/#add-an-emoji-reaction-to-a-resource)
  * [Delete an emoji reaction from a resource](https://docs.gitlab.com/api/emoji_reactions/#delete-an-emoji-reaction-from-a-resource)
  * [Add reactions to comments](https://docs.gitlab.com/api/emoji_reactions/#add-reactions-to-comments)
  * [List all emoji reactions for a comment](https://docs.gitlab.com/api/emoji_reactions/#list-all-emoji-reactions-for-a-comment)
  * [Retrieve an emoji reaction from a comment](https://docs.gitlab.com/api/emoji_reactions/#retrieve-an-emoji-reaction-from-a-comment)
  * [Add an emoji reaction to a comment](https://docs.gitlab.com/api/emoji_reactions/#add-an-emoji-reaction-to-a-comment)
  * [Delete an emoji reaction from a comment](https://docs.gitlab.com/api/emoji_reactions/#delete-an-emoji-reaction-from-a-comment)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/emoji_reactions.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/emoji_reactions.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Femoji_reactions%2F&_biz_t=1772174256629&_biz_i=Emoji%20reactions%20API%20%7C%20GitLab%20Docs&_biz_n=41&rnd=658912&cdn_o=a&_biz_z=1772174256630)
