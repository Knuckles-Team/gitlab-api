[Skip to main content](https://docs.gitlab.com/api/usage_data/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/usage_data/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/usage_data/)
    * [18.8](https://docs.gitlab.com/18.8/api/usage_data/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/usage_data/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/usage_data/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/usage_data.html)
...
/
  ...
  5. [Service Ping](https://docs.gitlab.com/api/usage_data/)
...
## Export Service Ping data[](https://docs.gitlab.com/api/usage_data/#export-service-ping-data "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/141446) in GitLab 16.9.


Exports the JSON payload collected in Service Ping. If no payload data is available in the application cache, it returns empty response. If payload data is empty, make sure the [Service Ping feature is enabled](https://docs.gitlab.com/administration/settings/usage_statistics/#enable-or-disable-service-ping) and wait for the cron job to be executed, or generate payload data manually.
Prerequisites:
...
### Interpreting `schema_inconsistencies_metric`[](https://docs.gitlab.com/api/usage_data/#interpreting-schema_inconsistencies_metric "Permalink")
...
## List all Service Ping SQL queries[](https://docs.gitlab.com/api/usage_data/#list-all-service-ping-sql-queries "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/57016) in GitLab 13.11.
  * [Deployed behind a feature flag](https://docs.gitlab.com/administration/feature_flags/) named `usage_data_queries_api`, disabled by default.


Lists all raw SQL queries used to compute Service Ping. This action is behind the `usage_data_queries_api` feature flag and is available only for the GitLab instance [Administrator](https://docs.gitlab.com/user/permissions/) users.
```
...
## List all non-SQL metrics[](https://docs.gitlab.com/api/usage_data/#list-all-non-sql-metrics "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/57050) in GitLab 13.11.
  * [Deployed behind a feature flag](https://docs.gitlab.com/administration/feature_flags/), named `usage_data_non_sql_metrics`, disabled by default.


Lists all non-SQL metrics data used in the Service ping. This action is behind the `usage_data_non_sql_metrics` feature flag and is available only for the GitLab instance [Administrator](https://docs.gitlab.com/user/permissions/) users.
```
...
## Track internal events[](https://docs.gitlab.com/api/usage_data/#track-internal-events "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/usage_data.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/usage_data.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Export Service Ping data](https://docs.gitlab.com/api/usage_data/#export-service-ping-data)
  * [Interpreting schema_inconsistencies_metric](https://docs.gitlab.com/api/usage_data/#interpreting-schema_inconsistencies_metric)
  * [Export metric definitions](https://docs.gitlab.com/api/usage_data/#export-metric-definitions)
  * [List all Service Ping SQL queries](https://docs.gitlab.com/api/usage_data/#list-all-service-ping-sql-queries)
  * [List all non-SQL metrics](https://docs.gitlab.com/api/usage_data/#list-all-non-sql-metrics)
  * [Track internal events](https://docs.gitlab.com/api/usage_data/#track-internal-events)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/usage_data.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/usage_data.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fusers%2F&_biz_t=1771981740749&_biz_i=Users%20API%20%7C%20GitLab%20Docs&_biz_n=180&rnd=712426&cdn_o=a&_biz_z=1771981740853)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fusage_data%2F&_biz_t=1771981740853&_biz_i=Service%20Ping%20API%20%7C%20GitLab%20Docs&_biz_n=181&rnd=561775&cdn_o=a&_biz_z=1771981740854)
