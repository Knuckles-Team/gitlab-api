[Skip to main content](https://docs.gitlab.com/api/keys/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/keys/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/keys/)
    * [18.8](https://docs.gitlab.com/18.8/api/keys/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/keys/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/keys/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/keys.html)
...
/
  ...
  5. [Keys](https://docs.gitlab.com/api/keys/)
...
Use this API to retrieve information about [SSH keys](https://docs.gitlab.com/user/ssh/). Queries about deploy key fingerprints also retrieve information about the projects using that key.
If you use a SHA256 fingerprint in an API call, you should URL-encode the fingerprint.
## Retrieve user by SSH key ID[](https://docs.gitlab.com/api/keys/#retrieve-user-by-ssh-key-id "Permalink")
Prerequisites:
...
## Retrieve user by SSH key fingerprint[](https://docs.gitlab.com/api/keys/#retrieve-user-by-ssh-key-fingerprint "Permalink")
Prerequisites:
  * You must have administrator access to the instance.
...
## Retrieve user by deploy key fingerprint[](https://docs.gitlab.com/api/keys/#retrieve-user-by-deploy-key-fingerprint "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/keys.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/keys.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Retrieve user by SSH key ID](https://docs.gitlab.com/api/keys/#retrieve-user-by-ssh-key-id)
  * [Retrieve user by SSH key fingerprint](https://docs.gitlab.com/api/keys/#retrieve-user-by-ssh-key-fingerprint)
  * [Retrieve user by deploy key fingerprint](https://docs.gitlab.com/api/keys/#retrieve-user-by-deploy-key-fingerprint)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/keys.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/keys.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fkeys%2F&_biz_t=1772174308789&_biz_i=Keys%20API%20%7C%20GitLab%20Docs&_biz_n=82&rnd=794433&cdn_o=a&_biz_z=1772174308790)
