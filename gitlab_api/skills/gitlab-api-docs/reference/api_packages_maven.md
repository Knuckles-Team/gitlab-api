[Skip to main content](https://docs.gitlab.com/api/packages/maven/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/packages/maven/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/packages/maven/)
    * [18.8](https://docs.gitlab.com/18.8/api/packages/maven/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/packages/maven/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/packages/maven/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/packages/maven.html)
...
/
  ...
  5. [Maven](https://docs.gitlab.com/api/packages/maven/)
...
This API is used by the [Maven package manager client](https://maven.apache.org/) and is generally not meant for manual consumption.
These endpoints do not adhere to the standard API authentication methods. See [Maven package registry documentation](https://docs.gitlab.com/user/packages/maven_repository/) for details on which headers and token types are supported. Undocumented authentication methods might be removed in the future.
## Download a package file for an instance[](https://docs.gitlab.com/api/packages/maven/#download-a-package-file-for-an-instance "Permalink")
...
## Download a package file for a group-level[](https://docs.gitlab.com/api/packages/maven/#download-a-package-file-for-a-group-level "Permalink")
...
This writes the downloaded file to `mypkg-1.0-SNAPSHOT.jar` in the current directory.
## Download a package file for a project[](https://docs.gitlab.com/api/packages/maven/#download-a-package-file-for-a-project "Permalink")
...
This writes the downloaded file to `mypkg-1.0-SNAPSHOT.jar` in the current directory.
## Upload a package file[](https://docs.gitlab.com/api/packages/maven/#upload-a-package-file "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/maven.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/maven.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Download a package file for an instance](https://docs.gitlab.com/api/packages/maven/#download-a-package-file-for-an-instance)
  * [Download a package file for a group-level](https://docs.gitlab.com/api/packages/maven/#download-a-package-file-for-a-group-level)
  * [Download a package file for a project](https://docs.gitlab.com/api/packages/maven/#download-a-package-file-for-a-project)
  * [Upload a package file](https://docs.gitlab.com/api/packages/maven/#upload-a-package-file)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/maven.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/maven.md)
