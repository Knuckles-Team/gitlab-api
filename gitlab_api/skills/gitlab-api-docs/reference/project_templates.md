[Skip to main content](https://docs.gitlab.com/api/project_templates/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/project_templates/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/project_templates/)
    * [18.8](https://docs.gitlab.com/18.8/api/project_templates/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/project_templates/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/project_templates/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/project_templates.html)
...
/
  ...
  6. [Templates](https://docs.gitlab.com/api/project_templates/)
...
Use this API to retrieve project-specific version of these endpoints:
  * [Dockerfile templates](https://docs.gitlab.com/api/templates/dockerfiles/)
  * [Gitignore templates](https://docs.gitlab.com/api/templates/gitignores/)
  * [GitLab CI/CD Configuration templates](https://docs.gitlab.com/api/templates/gitlab_ci_ymls/)
  * [Open source license templates](https://docs.gitlab.com/api/templates/licenses/)
  * [Issue and merge request templates](https://docs.gitlab.com/user/project/description_templates/)
...
Support is also available for [file templates for groups](https://docs.gitlab.com/user/group/manage/#group-file-templates).
## List all templates of a particular type[](https://docs.gitlab.com/api/project_templates/#list-all-templates-of-a-particular-type "Permalink")
...
## Retrieve a template of a particular type[](https://docs.gitlab.com/api/project_templates/#retrieve-a-template-of-a-particular-type "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/project_templates.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/project_templates.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all templates of a particular type](https://docs.gitlab.com/api/project_templates/#list-all-templates-of-a-particular-type)
  * [Retrieve a template of a particular type](https://docs.gitlab.com/api/project_templates/#retrieve-a-template-of-a-particular-type)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/project_templates.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/project_templates.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fproject_templates%2F&_biz_t=1772174427941&_biz_i=Project%20templates%20API%20%7C%20GitLab%20Docs&_biz_n=137&rnd=208252&cdn_o=a&_biz_z=1772174427941)
