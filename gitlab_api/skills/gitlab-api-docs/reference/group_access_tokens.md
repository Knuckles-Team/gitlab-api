[Skip to main content](https://docs.gitlab.com/api/group_access_tokens/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/group_access_tokens/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/group_access_tokens/)
    * [18.8](https://docs.gitlab.com/18.8/api/group_access_tokens/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/group_access_tokens/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/group_access_tokens/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/group_access_tokens.html)
...
/
  ...
  6. [Access tokens](https://docs.gitlab.com/api/group_access_tokens/)
...
Use this API to interact with group access tokens. For more information, see [Group access tokens](https://docs.gitlab.com/user/group/settings/group_access_tokens/).
## List all group access tokens[](https://docs.gitlab.com/api/group_access_tokens/#list-all-group-access-tokens "Permalink")
History
...
## Get details on a group access token[](https://docs.gitlab.com/api/group_access_tokens/#get-details-on-a-group-access-token "Permalink")
...
## Create a group access token[](https://docs.gitlab.com/api/group_access_tokens/#create-a-group-access-token "Permalink")
History
...
`scopes` | `Array[String]` | yes | List of [scopes](https://docs.gitlab.com/user/group/settings/group_access_tokens/#scopes-for-a-group-access-token) available to the token.
...
`expires_at` | date | no | Expiration date of the access token in ISO format (`YYYY-MM-DD`). If undefined, the date is set to the [maximum allowable lifetime limit](https://docs.gitlab.com/user/profile/personal_access_tokens/#access-token-expiration).
shell
```
curl --request POST \
  --header "PRIVATE-TOKEN: <your_access_token>" \
...
Prerequisites:
  * To rotate another group access token, you must have a personal access token with the [`api` scope](https://docs.gitlab.com/user/profile/personal_access_tokens/#personal-access-token-scopes).
  * To [self-rotate](https://docs.gitlab.com/api/group_access_tokens/#self-rotate) a group access token, the token must have the [`api` or `self_rotate` scope](https://docs.gitlab.com/user/profile/personal_access_tokens/#personal-access-token-scopes).
...
Other possible responses:
  ...
  * `401: Unauthorized` if any of the following conditions are true:
    ...
    * You’re using a group access token to rotate another group access token. See [Self-rotate](https://docs.gitlab.com/api/group_access_tokens/#self-rotate) instead.
...
### Self-rotate[](https://docs.gitlab.com/api/group_access_tokens/#self-rotate "Permalink")
Instead of rotating a specific group access token, you can rotate the same group access token you used to authenticate the request. To self-rotate a group access token, you must:
  * Rotate a group access token with the [`api` or `self_rotate` scope](https://docs.gitlab.com/user/profile/personal_access_tokens/#personal-access-token-scopes).
...
## Revoke a group access token[](https://docs.gitlab.com/api/group_access_tokens/#revoke-a-group-access-token "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_access_tokens.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_access_tokens.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all group access tokens](https://docs.gitlab.com/api/group_access_tokens/#list-all-group-access-tokens)
  * [Get details on a group access token](https://docs.gitlab.com/api/group_access_tokens/#get-details-on-a-group-access-token)
  * [Create a group access token](https://docs.gitlab.com/api/group_access_tokens/#create-a-group-access-token)
  * [Rotate a group access token](https://docs.gitlab.com/api/group_access_tokens/#rotate-a-group-access-token)
  * [Self-rotate](https://docs.gitlab.com/api/group_access_tokens/#self-rotate)
  * [Revoke a group access token](https://docs.gitlab.com/api/group_access_tokens/#revoke-a-group-access-token)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_access_tokens.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_access_tokens.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fgroup_access_tokens%2F&_biz_t=1772174282565&_biz_i=Group%20access%20tokens%20API%20%7C%20GitLab%20Docs&_biz_n=63&rnd=590966&cdn_o=a&_biz_z=1772174282569)
