[Skip to main content](https://docs.gitlab.com/api/group_releases/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/group_releases/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/group_releases/)
    * [18.8](https://docs.gitlab.com/18.8/api/group_releases/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/group_releases/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/group_releases/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/group_releases.html)
...
/
  ...
  6. [Releases](https://docs.gitlab.com/api/group_releases/)
...
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/351703) in GitLab 14.10 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `group_releases_finder_inoperator`. Disabled by default.
...
Use this API to interact with [projects releases](https://docs.gitlab.com/user/project/releases/) in groups.
To interact with project releases directly, see the [project release API](https://docs.gitlab.com/api/releases/).
## List all releases in a group[](https://docs.gitlab.com/api/group_releases/#list-all-releases-in-a-group "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_releases.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_releases.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all releases in a group](https://docs.gitlab.com/api/group_releases/#list-all-releases-in-a-group)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_releases.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_releases.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fgroup_ssh_certificates%2F&_biz_t=1772174295040&_biz_i=Group%20SSH%20certificates%20API%20%7C%20GitLab%20Docs&_biz_n=68&rnd=998706&cdn_o=a&_biz_z=1772174295213)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fgroup_releases%2F&_biz_t=1772174295212&_biz_i=Group%20release%20API%20%7C%20GitLab%20Docs&_biz_n=69&rnd=645699&cdn_o=a&_biz_z=1772174295216)
