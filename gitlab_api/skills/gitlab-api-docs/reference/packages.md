[Skip to main content](https://docs.gitlab.com/api/packages/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/packages/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/packages/)
    * [18.8](https://docs.gitlab.com/18.8/api/packages/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/packages/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/packages/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/packages.html)
...
/
  ...
  5. [Packages](https://docs.gitlab.com/api/packages/)
...
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/349418) support for [GitLab CI/CD job token](https://docs.gitlab.com/ci/jobs/ci_job_token/) authentication for the project-level API in GitLab 15.3.


Use this API to interact with [GitLab Packages](https://docs.gitlab.com/administration/packages/).
## List packages[](https://docs.gitlab.com/api/packages/#list-packages "Permalink")
History
  * `pipelines` [deprecated](https://gitlab.com/gitlab-org/gitlab/-/issues/341950) in GitLab 16.1.


### For a project[](https://docs.gitlab.com/api/packages/#for-a-project "Permalink")
...
By default, the `GET` request returns 20 results, because the API is [paginated](https://docs.gitlab.com/api/rest/#pagination).
...
### For a group[](https://docs.gitlab.com/api/packages/#for-a-group "Permalink")
...
Although you can filter packages by status, working with packages that have a `processing` status can result in malformed data or broken packages.
## Retrieve a project package[](https://docs.gitlab.com/api/packages/#retrieve-a-project-package "Permalink")
History
  * `pipelines` [deprecated](https://gitlab.com/gitlab-org/gitlab/-/issues/341950) in GitLab 16.1.
...
## List package files[](https://docs.gitlab.com/api/packages/#list-package-files "Permalink")
...
By default, the `GET` request returns 20 results, because the API is [paginated](https://docs.gitlab.com/api/rest/#pagination).
## List package pipelines[](https://docs.gitlab.com/api/packages/#list-package-pipelines "Permalink")
History
...
The results are [paginated](https://docs.gitlab.com/api/rest/#keyset-based-pagination) and return up to 20 records per page.
```
...
## Delete a project package[](https://docs.gitlab.com/api/packages/#delete-a-project-package "Permalink")
...
If [request forwarding](https://docs.gitlab.com/user/packages/package_registry/supported_functionality/#forwarding-requests) is enabled, deleting a package can introduce a [dependency confusion risk](https://docs.gitlab.com/user/packages/package_registry/supported_functionality/#deleting-packages).
If a package is protected by a [protection rule](https://docs.gitlab.com/user/packages/package_registry/package_protection_rules/#protect-a-package), then deleting the package is forbidden.
## Delete a package file[](https://docs.gitlab.com/api/packages/#delete-a-package-file "Permalink")
...
If a package that a package file belongs to is protected by a [protection rule](https://docs.gitlab.com/user/packages/package_registry/package_protection_rules/#protect-a-package), then deleting the package file is forbidden.
Was this page helpful?YesNo
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List packages](https://docs.gitlab.com/api/packages/#list-packages)
  * [For a project](https://docs.gitlab.com/api/packages/#for-a-project)
  * [For a group](https://docs.gitlab.com/api/packages/#for-a-group)
  * [Retrieve a project package](https://docs.gitlab.com/api/packages/#retrieve-a-project-package)
  * [List package files](https://docs.gitlab.com/api/packages/#list-package-files)
  * [List package pipelines](https://docs.gitlab.com/api/packages/#list-package-pipelines)
  * [Delete a project package](https://docs.gitlab.com/api/packages/#delete-a-project-package)
  * [Delete a package file](https://docs.gitlab.com/api/packages/#delete-a-package-file)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpackages%2F&_biz_t=1772174337448&_biz_i=Packages%20API%20%7C%20GitLab%20Docs&_biz_n=103&rnd=757492&cdn_o=a&_biz_z=1772174337448)
