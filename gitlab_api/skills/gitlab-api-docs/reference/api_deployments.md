[Skip to main content](https://docs.gitlab.com/api/deployments/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/deployments/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/deployments/)
    * [18.8](https://docs.gitlab.com/18.8/api/deployments/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/deployments/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/deployments/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/deployments.html)
...
/
  ...
  5. [Deployments](https://docs.gitlab.com/api/deployments/)
...
History
  * Support for [GitLab CI/CD job token](https://docs.gitlab.com/ci/jobs/ci_job_token/) authentication [introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/414549) in GitLab 16.2.


Use this API to interact with [code deployments](https://docs.gitlab.com/ci/environments/deployments/) to GitLab environments.
## List all project deployments[](https://docs.gitlab.com/api/deployments/#list-all-project-deployments "Permalink")
...
`environment` | string | no | The [name of the environment](https://docs.gitlab.com/ci/environments/) to filter deployments by.
...
## Retrieve a deployment[](https://docs.gitlab.com/api/deployments/#retrieve-a-deployment "Permalink")
...
When [multiple approval rules](https://docs.gitlab.com/ci/environments/deployment_approvals/#add-multiple-approval-rules) are configured, deployments created by users on GitLab Premium or Ultimate include the `approval_summary` property:
json
```
{
  "approval_summary": {
...
## Create a deployment[](https://docs.gitlab.com/api/deployments/#create-a-deployment "Permalink")
...
---|---|---|---
`id` | integer or string | yes | The ID or [URL-encoded path of the project](https://docs.gitlab.com/api/rest/#namespaced-paths).
`environment` | string | yes | The [name of the environment](https://docs.gitlab.com/ci/environments/) to create the deployment for.
...
## Update a deployment[](https://docs.gitlab.com/api/deployments/#update-a-deployment "Permalink")
...
## Delete a deployment[](https://docs.gitlab.com/api/deployments/#delete-a-deployment "Permalink")
...
## List all merge requests associated with a deployment[](https://docs.gitlab.com/api/deployments/#list-all-merge-requests-associated-with-a-deployment "Permalink")
Not all deployments can be associated with merge requests. See [Track what merge requests were deployed to an environment](https://docs.gitlab.com/ci/environments/deployments/#track-newly-included-merge-requests-per-deployment) for more information.
Lists all merge requests shipped with a given deployment.
```
GET /projects/:id/deployments/:deployment_id/merge_requests
```

It supports the same parameters as the [Merge requests API](https://docs.gitlab.com/api/merge_requests/#list-merge-requests) and returns a response using the same format:
shell
```
curl --request "GET" \
  --header "PRIVATE-TOKEN: <your_access_token>" \
...
## Approve or reject a deployment[](https://docs.gitlab.com/api/deployments/#approve-or-reject-a-deployment "Permalink")
...
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/343864) in GitLab 14.7 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `deployment_approvals`. Disabled by default.
...
`represented_as` | string | no | The name of the User/Group/Role to use for the approval, when the user belongs to [multiple approval rules](https://docs.gitlab.com/ci/environments/deployment_approvals/#add-multiple-approval-rules).
shell
```
curl --request "POST" \
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/deployments.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/deployments.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all project deployments](https://docs.gitlab.com/api/deployments/#list-all-project-deployments)
  * [Retrieve a deployment](https://docs.gitlab.com/api/deployments/#retrieve-a-deployment)
  * [Create a deployment](https://docs.gitlab.com/api/deployments/#create-a-deployment)
  * [Update a deployment](https://docs.gitlab.com/api/deployments/#update-a-deployment)
  * [Delete a deployment](https://docs.gitlab.com/api/deployments/#delete-a-deployment)
  * [List all merge requests associated with a deployment](https://docs.gitlab.com/api/deployments/#list-all-merge-requests-associated-with-a-deployment)
  * [Approve or reject a deployment](https://docs.gitlab.com/api/deployments/#approve-or-reject-a-deployment)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/deployments.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/deployments.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fdeployments%2F&_biz_t=1771981500100&_biz_i=Deployments%20API%20%7C%20GitLab%20Docs&_biz_n=36&rnd=950645&cdn_o=a&_biz_z=1771981500101)
