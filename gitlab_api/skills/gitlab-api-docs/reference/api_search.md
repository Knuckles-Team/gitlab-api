[Skip to main content](https://docs.gitlab.com/api/search/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/search/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/search/)
    * [18.8](https://docs.gitlab.com/18.8/api/search/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/search/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/search/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/search.html)
...
/
  ...
  5. [Search](https://docs.gitlab.com/api/search/)
...
Use this API to [search across GitLab](https://docs.gitlab.com/user/search/). Every call to this API requires authentication.
Some scopes are available for [basic search](https://docs.gitlab.com/user/search/#available-scopes). When [advanced search](https://docs.gitlab.com/user/search/advanced_search/#available-scopes) or [exact code search](https://docs.gitlab.com/user/search/exact_code_search/#available-scopes) is enabled, additional scopes are available for [global search](https://docs.gitlab.com/api/search/#global-search), [group search](https://docs.gitlab.com/api/search/#group-search), and [project search](https://docs.gitlab.com/api/search/#project-search) APIs.
If you want to use basic search instead, see [specify a search type](https://docs.gitlab.com/user/search/#specify-a-search-type).
The search API supports [offset-based pagination](https://docs.gitlab.com/api/rest/#offset-based-pagination).
## Global search[](https://docs.gitlab.com/api/search/#global-search "Permalink")
Search for a [term](https://docs.gitlab.com/user/search/advanced_search/#syntax) across the entire GitLab instance. The response depends on the requested scope.
```
GET /search
```
...
### Scope: `projects`[](https://docs.gitlab.com/api/search/#scope-projects "Permalink")
shell
```
curl --request GET \
...
### Scope: `issues`[](https://docs.gitlab.com/api/search/#scope-issues "Permalink")
shell
```
curl --request GET \
  --header "PRIVATE-TOKEN: YOUR_TOKEN" \
...
### Scope: `merge_requests`[](https://docs.gitlab.com/api/search/#scope-merge_requests "Permalink")
shell
```
curl --request GET \
  --header "PRIVATE-TOKEN: YOUR_TOKEN" \
...
### Scope: `milestones`[](https://docs.gitlab.com/api/search/#scope-milestones "Permalink")
shell
```
curl --request GET \
  --header "PRIVATE-TOKEN: YOUR_TOKEN" \
...
### Scope: `snippet_titles`[](https://docs.gitlab.com/api/search/#scope-snippet_titles "Permalink")
shell
```
curl --request GET \
  --header "PRIVATE-TOKEN: YOUR_TOKEN" \
...
### Scope: `users`[](https://docs.gitlab.com/api/search/#scope-users "Permalink")
shell
```
curl --request GET \
  --header "PRIVATE-TOKEN: YOUR_TOKEN" \
...
### Scope: `wiki_blobs`[](https://docs.gitlab.com/api/search/#scope-wiki_blobs "Permalink")
...
### Scope: `commits`[](https://docs.gitlab.com/api/search/#scope-commits "Permalink")
  * Tier: Premium, Ultimate
...
### Scope: `blobs`[](https://docs.gitlab.com/api/search/#scope-blobs "Permalink")
  * Tier: Premium, Ultimate


Use this scope to search code.
This scope is available only when [advanced search](https://docs.gitlab.com/user/search/advanced_search/#use-advanced-search) or [exact code search](https://docs.gitlab.com/user/search/exact_code_search/#use-exact-code-search) is enabled.
The following filters are available for this scope:
  * `filename`
  * `path`
  * `extension`
...
`filename` is deprecated in favor of `path`. Both return the full path of the file inside the repository, but in the future `filename` is intended to be only the filename and not the full path. For details, see [issue 34521](https://gitlab.com/gitlab-org/gitlab/-/issues/34521). Elasticsearch syntax might not work properly with exact code search. Replace Elasticsearch wildcard queries with regular expressions for exact code search. For more information, see [issue 521686](https://gitlab.com/gitlab-org/gitlab/-/issues/521686).
### Scope: `notes`[](https://docs.gitlab.com/api/search/#scope-notes "Permalink")
  * Tier: Premium, Ultimate
...
## Group search[](https://docs.gitlab.com/api/search/#group-search "Permalink")
...
### Scope: `projects`[](https://docs.gitlab.com/api/search/#scope-projects-1 "Permalink")
shell
```
curl --request GET \
  --header "PRIVATE-TOKEN: YOUR_TOKEN" \
...
### Scope: `issues`[](https://docs.gitlab.com/api/search/#scope-issues-1 "Permalink")
shell
```
curl --request GET \
  --header "PRIVATE-TOKEN: YOUR_TOKEN" \
...
### Scope: `merge_requests`[](https://docs.gitlab.com/api/search/#scope-merge_requests-1 "Permalink")
shell
```
curl --request GET \
  --header "PRIVATE-TOKEN: YOUR_TOKEN" \
...
### Scope: `milestones`[](https://docs.gitlab.com/api/search/#scope-milestones-1 "Permalink")
shell
```
curl --request GET \
  --header "PRIVATE-TOKEN: YOUR_TOKEN" \
...
### Scope: `users`[](https://docs.gitlab.com/api/search/#scope-users-1 "Permalink")
shell
```
curl --request GET \
  --header "PRIVATE-TOKEN: YOUR_TOKEN" \
...
### Scope: `wiki_blobs`[](https://docs.gitlab.com/api/search/#scope-wiki_blobs-1 "Permalink")
  * Tier: Premium, Ultimate
...
`filename` is deprecated in favor of `path`. Both return the full path of the file inside the repository, but in the future `filename` is intended to be only the filename and not the full path. For details, see [issue 34521](https://gitlab.com/gitlab-org/gitlab/-/issues/34521).
### Scope: `commits`[](https://docs.gitlab.com/api/search/#scope-commits-1 "Permalink")
  * Tier: Premium, Ultimate
...
### Scope: `blobs`[](https://docs.gitlab.com/api/search/#scope-blobs-1 "Permalink")
  * Tier: Premium, Ultimate
...
`filename` is deprecated in favor of `path`. Both return the full path of the file inside the repository, but in the future `filename` is intended to be only the filename and not the full path. For details, see [issue 34521](https://gitlab.com/gitlab-org/gitlab/-/issues/34521). Elasticsearch syntax might not work properly with exact code search. Replace Elasticsearch wildcard queries with regular expressions for exact code search. For more information, see [issue 521686](https://gitlab.com/gitlab-org/gitlab/-/issues/521686).
### Scope: `notes`[](https://docs.gitlab.com/api/search/#scope-notes-1 "Permalink")
  * Tier: Premium, Ultimate
...
## Project search[](https://docs.gitlab.com/api/search/#project-search "Permalink")
...
`sort` | string | No | Allowed values are `asc` or `desc` only. If not set, results are sorted by `created_at` in descending order for basic search, or by the most relevant documents for advanced search.
The response depends on the requested scope.
### Scope: `issues`[](https://docs.gitlab.com/api/search/#scope-issues-2 "Permalink")
shell
```
curl --request GET \
  --header "PRIVATE-TOKEN: YOUR_TOKEN" \
...
The `assignee` column is deprecated. It is now a single-sized `assignees` array.
### Scope: `merge_requests`[](https://docs.gitlab.com/api/search/#scope-merge_requests-2 "Permalink")
shell
```
curl --request GET \
  --header "PRIVATE-TOKEN: YOUR_TOKEN" \
...
### Scope: `milestones`[](https://docs.gitlab.com/api/search/#scope-milestones-2 "Permalink")
shell
```
curl --request GET \
  --header "PRIVATE-TOKEN: YOUR_TOKEN" \
...
### Scope: `users`[](https://docs.gitlab.com/api/search/#scope-users-2 "Permalink")
shell
```
curl --request GET \
  --header "PRIVATE-TOKEN: YOUR_TOKEN" \
...
### Scope: `wiki_blobs`[](https://docs.gitlab.com/api/search/#scope-wiki_blobs-2 "Permalink")
Use this scope to search wikis.
The following filters are available for this scope:
  * `filename`
  * `path`
...
`filename` is deprecated in favor of `path`. Both return the full path of the file inside the repository, but in the future `filename` is intended to be only the filename and not the full path. For details, see [issue 34521](https://gitlab.com/gitlab-org/gitlab/-/issues/34521).
### Scope: `commits`[](https://docs.gitlab.com/api/search/#scope-commits-2 "Permalink")
shell
```
curl --request GET \
  --header "PRIVATE-TOKEN: YOUR_TOKEN" \
...
### Scope: `blobs`[](https://docs.gitlab.com/api/search/#scope-blobs-2 "Permalink")
Use this scope to search code.
The following filters are available for this scope:
  * `filename`
  * `path`
...
`filename` is deprecated in favor of `path`. Both return the full path of the file inside the repository, but in the future `filename` is intended to be only the filename and not the full path. For details, see [issue 34521](https://gitlab.com/gitlab-org/gitlab/-/issues/34521). Elasticsearch syntax might not work properly with exact code search. Replace Elasticsearch wildcard queries with regular expressions for exact code search. For more information, see [issue 521686](https://gitlab.com/gitlab-org/gitlab/-/issues/521686).
### Scope: `notes`[](https://docs.gitlab.com/api/search/#scope-notes-2 "Permalink")
shell
```
curl --request GET \
  --header "PRIVATE-TOKEN: YOUR_TOKEN" \
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/search.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/search.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Global search](https://docs.gitlab.com/api/search/#global-search)
  * [Scope: projects](https://docs.gitlab.com/api/search/#scope-projects)
  * [Scope: issues](https://docs.gitlab.com/api/search/#scope-issues)
  * [Scope: merge_requests](https://docs.gitlab.com/api/search/#scope-merge_requests)
  * [Scope: milestones](https://docs.gitlab.com/api/search/#scope-milestones)
  * [Scope: snippet_titles](https://docs.gitlab.com/api/search/#scope-snippet_titles)
  * [Scope: users](https://docs.gitlab.com/api/search/#scope-users)
  * [Scope: wiki_blobs](https://docs.gitlab.com/api/search/#scope-wiki_blobs)
  * [Scope: commits](https://docs.gitlab.com/api/search/#scope-commits)
  * [Scope: blobs](https://docs.gitlab.com/api/search/#scope-blobs)
  * [Scope: notes](https://docs.gitlab.com/api/search/#scope-notes)
  * [Group search](https://docs.gitlab.com/api/search/#group-search)
  * [Scope: projects](https://docs.gitlab.com/api/search/#scope-projects-1)
  * [Scope: issues](https://docs.gitlab.com/api/search/#scope-issues-1)
  * [Scope: merge_requests](https://docs.gitlab.com/api/search/#scope-merge_requests-1)
  * [Scope: milestones](https://docs.gitlab.com/api/search/#scope-milestones-1)
  * [Scope: users](https://docs.gitlab.com/api/search/#scope-users-1)
  * [Scope: wiki_blobs](https://docs.gitlab.com/api/search/#scope-wiki_blobs-1)
  * [Scope: commits](https://docs.gitlab.com/api/search/#scope-commits-1)
  * [Scope: blobs](https://docs.gitlab.com/api/search/#scope-blobs-1)
  * [Scope: notes](https://docs.gitlab.com/api/search/#scope-notes-1)
  * [Project search](https://docs.gitlab.com/api/search/#project-search)
  * [Scope: issues](https://docs.gitlab.com/api/search/#scope-issues-2)
  * [Scope: merge_requests](https://docs.gitlab.com/api/search/#scope-merge_requests-2)
  * [Scope: milestones](https://docs.gitlab.com/api/search/#scope-milestones-2)
  * [Scope: users](https://docs.gitlab.com/api/search/#scope-users-2)
  * [Scope: wiki_blobs](https://docs.gitlab.com/api/search/#scope-wiki_blobs-2)
  * [Scope: commits](https://docs.gitlab.com/api/search/#scope-commits-2)
  * [Scope: blobs](https://docs.gitlab.com/api/search/#scope-blobs-2)
  * [Scope: notes](https://docs.gitlab.com/api/search/#scope-notes-2)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/search.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/search.md)
