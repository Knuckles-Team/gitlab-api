[Skip to main content](https://docs.gitlab.com/api/releases/links/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/releases/links/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/releases/links/)
    * [18.8](https://docs.gitlab.com/18.8/api/releases/links/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/releases/links/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/releases/links/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/releases/links.html)
...
/
  ...
  6. [Release links](https://docs.gitlab.com/api/releases/links/)
...
History
  * [Added](https://gitlab.com/gitlab-org/gitlab/-/issues/250819) authentication with a [GitLab CI/CD job token](https://docs.gitlab.com/ci/jobs/ci_job_token/) in GitLab 15.1.


Use this API to interact with links to [releases](https://docs.gitlab.com/user/project/releases/).
...
## List all release links[](https://docs.gitlab.com/api/releases/links/#list-all-release-links "Permalink")
...
## Retrieve a release link[](https://docs.gitlab.com/api/releases/links/#retrieve-a-release-link "Permalink")
...
## Create a release link[](https://docs.gitlab.com/api/releases/links/#create-a-release-link "Permalink")
...
`direct_asset_path` | string | no | Optional path for a [direct asset link](https://docs.gitlab.com/user/project/releases/release_fields/#permanent-links-to-release-assets).
...
## Update a release link[](https://docs.gitlab.com/api/releases/links/#update-a-release-link "Permalink")
...
## Delete a release link[](https://docs.gitlab.com/api/releases/links/#delete-a-release-link "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/releases/links.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/releases/links.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all release links](https://docs.gitlab.com/api/releases/links/#list-all-release-links)
  * [Retrieve a release link](https://docs.gitlab.com/api/releases/links/#retrieve-a-release-link)
  * [Create a release link](https://docs.gitlab.com/api/releases/links/#create-a-release-link)
  * [Update a release link](https://docs.gitlab.com/api/releases/links/#update-a-release-link)
  * [Delete a release link](https://docs.gitlab.com/api/releases/links/#delete-a-release-link)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/releases/links.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/releases/links.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Freleases%2Flinks%2F&_biz_t=1772174441429&_biz_i=Release%20links%20API%20%7C%20GitLab%20Docs&_biz_n=149&rnd=548856&cdn_o=a&_biz_z=1772174441430)
