[Skip to main content](https://docs.gitlab.com/api/packages/debian_group_distributions/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/packages/debian_group_distributions/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/packages/debian_group_distributions/)
    * [18.8](https://docs.gitlab.com/18.8/api/packages/debian_group_distributions/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/packages/debian_group_distributions/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/packages/debian_group_distributions/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/packages/debian_group_distributions.html)
...
/
  ...
  5. [Debian group distributions](https://docs.gitlab.com/api/packages/debian_group_distributions/)
...
Use this API to manage [Debian group distributions](https://docs.gitlab.com/user/packages/debian_repository/). This API is behind a feature flag that is disabled by default. To use this API, you must [enable it](https://docs.gitlab.com/api/packages/debian_group_distributions/#enable-the-debian-group-api).
This API is under development and is not meant for production use.
## Enable the Debian group API[](https://docs.gitlab.com/api/packages/debian_group_distributions/#enable-the-debian-group-api "Permalink")
Debian group repository support is still a work in progress. It’s gated behind a feature flag that’s disabled by default. [GitLab administrators with access to the GitLab Rails console](https://docs.gitlab.com/administration/feature_flags/) can opt to enable it. To enable it, follow the instructions in [Enable the Debian group API](https://docs.gitlab.com/user/packages/debian_repository/#enable-the-debian-group-api).
## Authenticate to the Debian distributions APIs[](https://docs.gitlab.com/api/packages/debian_group_distributions/#authenticate-to-the-debian-distributions-apis "Permalink")
See [Authenticate to the Debian distributions APIs](https://docs.gitlab.com/user/packages/debian_repository/#authenticate-to-the-debian-distributions-apis).
## List all Debian distributions in a group[](https://docs.gitlab.com/api/packages/debian_group_distributions/#list-all-debian-distributions-in-a-group "Permalink")
...
## Retrieve a Debian group distribution[](https://docs.gitlab.com/api/packages/debian_group_distributions/#retrieve-a-debian-group-distribution "Permalink")
...
## Retrieve a Debian group distribution key[](https://docs.gitlab.com/api/packages/debian_group_distributions/#retrieve-a-debian-group-distribution-key "Permalink")
...
## Create a Debian group distribution[](https://docs.gitlab.com/api/packages/debian_group_distributions/#create-a-debian-group-distribution "Permalink")
...
## Update a Debian group distribution[](https://docs.gitlab.com/api/packages/debian_group_distributions/#update-a-debian-group-distribution "Permalink")
...
## Delete a Debian group distribution[](https://docs.gitlab.com/api/packages/debian_group_distributions/#delete-a-debian-group-distribution "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/debian_group_distributions.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/debian_group_distributions.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Enable the Debian group API](https://docs.gitlab.com/api/packages/debian_group_distributions/#enable-the-debian-group-api)
  * [Authenticate to the Debian distributions APIs](https://docs.gitlab.com/api/packages/debian_group_distributions/#authenticate-to-the-debian-distributions-apis)
  * [List all Debian distributions in a group](https://docs.gitlab.com/api/packages/debian_group_distributions/#list-all-debian-distributions-in-a-group)
  * [Retrieve a Debian group distribution](https://docs.gitlab.com/api/packages/debian_group_distributions/#retrieve-a-debian-group-distribution)
  * [Retrieve a Debian group distribution key](https://docs.gitlab.com/api/packages/debian_group_distributions/#retrieve-a-debian-group-distribution-key)
  * [Create a Debian group distribution](https://docs.gitlab.com/api/packages/debian_group_distributions/#create-a-debian-group-distribution)
  * [Update a Debian group distribution](https://docs.gitlab.com/api/packages/debian_group_distributions/#update-a-debian-group-distribution)
  * [Delete a Debian group distribution](https://docs.gitlab.com/api/packages/debian_group_distributions/#delete-a-debian-group-distribution)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/debian_group_distributions.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/debian_group_distributions.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpackages%2Fnuget%2F&_biz_t=1772174387295&_biz_i=NuGet%20API%20%7C%20GitLab%20Docs&_biz_n=106&rnd=623166&cdn_o=a&_biz_z=1772174387665)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpackages%2Fmaven%2F&_biz_t=1772174387382&_biz_i=Maven%20API%20%7C%20GitLab%20Docs&_biz_n=107&rnd=304584&cdn_o=a&_biz_z=1772174387665)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpackages%2Fhelm%2F&_biz_t=1772174387513&_biz_i=Helm%20API%20%7C%20GitLab%20Docs&_biz_n=108&rnd=6846&cdn_o=a&_biz_z=1772174387666)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpackages%2Fdebian_group_distributions%2F&_biz_t=1772174387664&_biz_i=Debian%20group%20distributions%20API%20%7C%20GitLab%20Docs&_biz_n=109&rnd=756569&cdn_o=a&_biz_z=1772174387666)
