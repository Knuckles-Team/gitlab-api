[Skip to main content](https://docs.gitlab.com/api/epic_links/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/epic_links/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/epic_links/)
    * [18.8](https://docs.gitlab.com/18.8/api/epic_links/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/epic_links/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/epic_links/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/epic_links.html)
...
/
  ...
  5. [Links (epic) (deprecated)](https://docs.gitlab.com/api/epic_links/)
...
Manages parent-child [epic relationships](https://docs.gitlab.com/user/group/epics/manage_epics/#multi-level-child-epics).
...
Multi-level Epics are available only in [GitLab Ultimate](https://about.gitlab.com/pricing/). If the Multi-level Epics feature is not available, a `403` status code is returned.
## List all child epics of an epic[](https://docs.gitlab.com/api/epic_links/#list-all-child-epics-of-an-epic "Permalink")
...
## Assign a child epic[](https://docs.gitlab.com/api/epic_links/#assign-a-child-epic "Permalink")
...
## Create and assign a child epic[](https://docs.gitlab.com/api/epic_links/#create-and-assign-a-child-epic "Permalink")
...
## Re-order a child epic[](https://docs.gitlab.com/api/epic_links/#re-order-a-child-epic "Permalink")
```
...
## Unassign a child epic[](https://docs.gitlab.com/api/epic_links/#unassign-a-child-epic "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/epic_links.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/epic_links.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all child epics of an epic](https://docs.gitlab.com/api/epic_links/#list-all-child-epics-of-an-epic)
  * [Assign a child epic](https://docs.gitlab.com/api/epic_links/#assign-a-child-epic)
  * [Create and assign a child epic](https://docs.gitlab.com/api/epic_links/#create-and-assign-a-child-epic)
  * [Re-order a child epic](https://docs.gitlab.com/api/epic_links/#re-order-a-child-epic)
  * [Unassign a child epic](https://docs.gitlab.com/api/epic_links/#unassign-a-child-epic)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/epic_links.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/epic_links.md)
