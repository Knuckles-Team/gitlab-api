[Skip to main content](https://docs.gitlab.com/api/snippet_repository_storage_moves/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/snippet_repository_storage_moves/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/snippet_repository_storage_moves/)
    * [18.8](https://docs.gitlab.com/18.8/api/snippet_repository_storage_moves/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/snippet_repository_storage_moves/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/snippet_repository_storage_moves/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/snippet_repository_storage_moves.html)
...
/
  ...
  5. [Snippet repository storage moves](https://docs.gitlab.com/api/snippet_repository_storage_moves/)
...
Use this API to manage [snippet repository storage moves](https://docs.gitlab.com/administration/operations/moving_repositories/). This API can help you, for example, [migrate to Gitaly Cluster (Praefect)](https://docs.gitlab.com/administration/gitaly/praefect/#migrate-to-gitaly-cluster-praefect).
...
## List all snippet repository storage moves[](https://docs.gitlab.com/api/snippet_repository_storage_moves/#list-all-snippet-repository-storage-moves "Permalink")
...
## List all repository storage moves for a snippet[](https://docs.gitlab.com/api/snippet_repository_storage_moves/#list-all-repository-storage-moves-for-a-snippet "Permalink")
...
## Retrieve a snippet repository storage move[](https://docs.gitlab.com/api/snippet_repository_storage_moves/#retrieve-a-snippet-repository-storage-move "Permalink")
...
## Retrieve a repository storage move for a snippet[](https://docs.gitlab.com/api/snippet_repository_storage_moves/#retrieve-a-repository-storage-move-for-a-snippet "Permalink")
...
## Schedule a repository storage move for a snippet[](https://docs.gitlab.com/api/snippet_repository_storage_moves/#schedule-a-repository-storage-move-for-a-snippet "Permalink")
...
## Schedule repository storage moves for all snippets on a storage shard[](https://docs.gitlab.com/api/snippet_repository_storage_moves/#schedule-repository-storage-moves-for-all-snippets-on-a-storage-shard "Permalink")
...
## Related topics[](https://docs.gitlab.com/api/snippet_repository_storage_moves/#related-topics "Permalink")
  * [Moving repositories managed by GitLab](https://docs.gitlab.com/administration/operations/moving_repositories/)


Was this page helpful?YesNo
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/snippet_repository_storage_moves.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/snippet_repository_storage_moves.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all snippet repository storage moves](https://docs.gitlab.com/api/snippet_repository_storage_moves/#list-all-snippet-repository-storage-moves)
  * [List all repository storage moves for a snippet](https://docs.gitlab.com/api/snippet_repository_storage_moves/#list-all-repository-storage-moves-for-a-snippet)
  * [Retrieve a snippet repository storage move](https://docs.gitlab.com/api/snippet_repository_storage_moves/#retrieve-a-snippet-repository-storage-move)
  * [Retrieve a repository storage move for a snippet](https://docs.gitlab.com/api/snippet_repository_storage_moves/#retrieve-a-repository-storage-move-for-a-snippet)
  * [Schedule a repository storage move for a snippet](https://docs.gitlab.com/api/snippet_repository_storage_moves/#schedule-a-repository-storage-move-for-a-snippet)
  * [Schedule repository storage moves for all snippets on a storage shard](https://docs.gitlab.com/api/snippet_repository_storage_moves/#schedule-repository-storage-moves-for-all-snippets-on-a-storage-shard)
  * [Related topics](https://docs.gitlab.com/api/snippet_repository_storage_moves/#related-topics)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/snippet_repository_storage_moves.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/snippet_repository_storage_moves.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fsnippet_repository_storage_moves%2F&_biz_t=1772174468645&_biz_i=Snippet%20repository%20storage%20moves%20API%20%7C%20GitLab%20Docs&_biz_n=168&rnd=206625&cdn_o=a&_biz_z=1772174468646)
