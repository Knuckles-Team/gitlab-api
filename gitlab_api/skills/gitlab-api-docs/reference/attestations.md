[Skip to main content](https://docs.gitlab.com/api/attestations/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/attestations/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/attestations/)
    * [18.8](https://docs.gitlab.com/18.8/api/attestations/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/attestations/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/attestations/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/attestations.html)
...
/
  ...
  5. [Attestations](https://docs.gitlab.com/api/attestations/)
...
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/547865) in GitLab 18.5 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `slsa_provenance_statement`. Disabled by default.


The availability of this feature is controlled by a feature flag. For more information, see the history. This feature is available for testing, but not ready for production use.
Use this API to interact with [provenance attestations](https://docs.gitlab.com/ci/pipeline_security/slsa/provenance_v1/).
## Provenance attestations[](https://docs.gitlab.com/api/attestations/#provenance-attestations "Permalink")
Some endpoints return [Sigstore bundles](https://docs.sigstore.dev/about/bundle/) as part of the response. You can verify these using [glab](https://docs.gitlab.com/cli/) or [cosign](https://github.com/sigstore/cosign). For more information on provenance, see [SLSA provenance specification](https://docs.gitlab.com/ci/pipeline_security/slsa/provenance_v1/)
## List all attestations[](https://docs.gitlab.com/api/attestations/#list-all-attestations "Permalink")
History
...
## Download an attestation[](https://docs.gitlab.com/api/attestations/#download-an-attestation "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/212141) in 18.7.


Downloads a specific provenance Sigstore bundle by project and attestation IID. The bundle itself is returned in the response body. For more information on this file format, see the relevant [Sigstore documentation](https://docs.sigstore.dev/about/bundle/).
```
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/attestations.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/attestations.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Provenance attestations](https://docs.gitlab.com/api/attestations/#provenance-attestations)
  * [List all attestations](https://docs.gitlab.com/api/attestations/#list-all-attestations)
  * [Download an attestation](https://docs.gitlab.com/api/attestations/#download-an-attestation)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/attestations.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/attestations.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fattestations%2F&_biz_t=1772174217905&_biz_i=Attestations%20API%20%7C%20GitLab%20Docs&_biz_n=15&rnd=487303&cdn_o=a&_biz_z=1772174217912)
