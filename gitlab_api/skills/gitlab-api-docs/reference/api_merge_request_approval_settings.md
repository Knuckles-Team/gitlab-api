[Skip to main content](https://docs.gitlab.com/api/merge_request_approval_settings/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/merge_request_approval_settings/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/merge_request_approval_settings/)
    * [18.8](https://docs.gitlab.com/18.8/api/merge_request_approval_settings/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/merge_request_approval_settings/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/merge_request_approval_settings/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/merge_request_approval_settings.html)
...
/
  ...
  5. [Merge request approval settings](https://docs.gitlab.com/api/merge_request_approval_settings/)
...
Use this API to manage group and project [merge request approval settings](https://docs.gitlab.com/user/project/merge_requests/approvals/settings/). All endpoints require authentication.
## Group MR approval settings[](https://docs.gitlab.com/api/merge_request_approval_settings/#group-mr-approval-settings "Permalink")
Prerequisites:
  * You must have the Owner role in the group.


### Retrieve MR approval settings for a group[](https://docs.gitlab.com/api/merge_request_approval_settings/#retrieve-mr-approval-settings-for-a-group "Permalink")
...
### Update group MR approval settings[](https://docs.gitlab.com/api/merge_request_approval_settings/#update-group-mr-approval-settings "Permalink")
...
## Project MR approval settings[](https://docs.gitlab.com/api/merge_request_approval_settings/#project-mr-approval-settings "Permalink")
Prerequisites:
  * You must have the Maintainer role in the project.


### Retrieve MR approval settings for a project[](https://docs.gitlab.com/api/merge_request_approval_settings/#retrieve-mr-approval-settings-for-a-project "Permalink")
...
### Update project MR approval settings[](https://docs.gitlab.com/api/merge_request_approval_settings/#update-project-mr-approval-settings "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/merge_request_approval_settings.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/merge_request_approval_settings.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Group MR approval settings](https://docs.gitlab.com/api/merge_request_approval_settings/#group-mr-approval-settings)
  * [Retrieve MR approval settings for a group](https://docs.gitlab.com/api/merge_request_approval_settings/#retrieve-mr-approval-settings-for-a-group)
  * [Update group MR approval settings](https://docs.gitlab.com/api/merge_request_approval_settings/#update-group-mr-approval-settings)
  * [Project MR approval settings](https://docs.gitlab.com/api/merge_request_approval_settings/#project-mr-approval-settings)
  * [Retrieve MR approval settings for a project](https://docs.gitlab.com/api/merge_request_approval_settings/#retrieve-mr-approval-settings-for-a-project)
  * [Update project MR approval settings](https://docs.gitlab.com/api/merge_request_approval_settings/#update-project-mr-approval-settings)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/merge_request_approval_settings.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/merge_request_approval_settings.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fnamespaces%2F&_biz_t=1771981588978&_biz_i=Namespaces%20API%20%7C%20GitLab%20Docs&_biz_n=90&rnd=760028&cdn_o=a&_biz_z=1771981589075)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fmerge_request_approval_settings%2F&_biz_t=1771981589075&_biz_i=Merge%20request%20approval%20settings%20API%20%7C%20GitLab%20Docs&_biz_n=91&rnd=204750&cdn_o=a&_biz_z=1771981589076)
