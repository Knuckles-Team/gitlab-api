[Skip to main content](https://docs.gitlab.com/api/admin/data_management/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/admin/data_management/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/admin/data_management/)
    * [18.8](https://docs.gitlab.com/18.8/api/admin/data_management/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/admin/data_management/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/admin/data_management/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/admin/data_management.html)
...
/
  ...
  5. [Data management](https://docs.gitlab.com/api/admin/data_management/)
...
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/537707) in GitLab 18.3 with a [flag](https://docs.gitlab.com/administration/feature_flags/) named `geo_primary_verification_view`. Disabled by default. This feature is an [experiment](https://docs.gitlab.com/policy/development_stages_support/).
...
## Retrieve model information[](https://docs.gitlab.com/api/admin/data_management/#retrieve-model-information "Permalink")
Retrieves information about a data model in an instance. This operation is an [experiment](https://docs.gitlab.com/policy/development_stages_support/) and might be changed or removed without notice.
```
...
This endpoint supports [keyset pagination](https://docs.gitlab.com/api/rest/#keyset-based-pagination) on the model’s primary key, with sorting in ascending or descending order. To use keyset pagination, add the `pagination=keyset` parameter to the request. By default, keyset pagination loads 20 records per page sorted in ascending order. You can modify the sorting order with the query parameter `sort`, and values `asc` or `desc`. To select a number of records per page, use the parameter `per_page`.
If successful, returns [`200`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and information about the model. It includes the following response attributes:
...
## Recalculate checksums for model records[](https://docs.gitlab.com/api/admin/data_management/#recalculate-checksums-for-model-records "Permalink")
...
If successful, it returns [`200`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and a JSON response containing the following information:
Attribute | Type | Description
---|---|---
...
## Retrieve information about a model record[](https://docs.gitlab.com/api/admin/data_management/#retrieve-information-about-a-model-record "Permalink")
...
If successful, it returns [`200`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and information about the specific model record. It includes the following response attributes:
Attribute | Type | Description
---|---|---
`checksum_information` | JSON | Geo-specific checksum information, if available.
`created_at` | timestamp | Creation timestamp, if available.
...
## Recalculate the checksum of a model record[](https://docs.gitlab.com/api/admin/data_management/#recalculate-the-checksum-of-a-model-record "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/admin/data_management.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/admin/data_management.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Retrieve model information](https://docs.gitlab.com/api/admin/data_management/#retrieve-model-information)
  * [Recalculate checksums for model records](https://docs.gitlab.com/api/admin/data_management/#recalculate-checksums-for-model-records)
  * [Retrieve information about a model record](https://docs.gitlab.com/api/admin/data_management/#retrieve-information-about-a-model-record)
  * [Recalculate the checksum of a model record](https://docs.gitlab.com/api/admin/data_management/#recalculate-the-checksum-of-a-model-record)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/admin/data_management.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/admin/data_management.md)
