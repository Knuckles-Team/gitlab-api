[Skip to main content](https://docs.gitlab.com/api/resource_milestone_events/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/resource_milestone_events/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/resource_milestone_events/)
    * [18.8](https://docs.gitlab.com/18.8/api/resource_milestone_events/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/resource_milestone_events/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/resource_milestone_events/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/resource_milestone_events.html)
...
/
  ...
  5. [Resource milestone events](https://docs.gitlab.com/api/resource_milestone_events/)
...
## Issues[](https://docs.gitlab.com/api/resource_milestone_events/#issues "Permalink")
### List project issue milestone events[](https://docs.gitlab.com/api/resource_milestone_events/#list-project-issue-milestone-events "Permalink")
...
shell
```
curl --header "PRIVATE-TOKEN: YOUR_TOKEN" "https://gitlab.example.com/api/v4/projects/5/issues/11/resource_milestone_events"
```
...
### Retrieve a single issue milestone event[](https://docs.gitlab.com/api/resource_milestone_events/#retrieve-a-single-issue-milestone-event "Permalink")
...
shell
```
curl --header "PRIVATE-TOKEN: YOUR_TOKEN" "https://gitlab.example.com/api/v4/projects/5/issues/11/resource_milestone_events/1"
```

## Merge requests[](https://docs.gitlab.com/api/resource_milestone_events/#merge-requests "Permalink")
### List project merge request milestone events[](https://docs.gitlab.com/api/resource_milestone_events/#list-project-merge-request-milestone-events "Permalink")
...
shell
```
curl --header "PRIVATE-TOKEN: YOUR_TOKEN" "https://gitlab.example.com/api/v4/projects/5/merge_requests/11/resource_milestone_events"
```
...
### Retrieve a single merge request milestone event[](https://docs.gitlab.com/api/resource_milestone_events/#retrieve-a-single-merge-request-milestone-event "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/resource_milestone_events.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/resource_milestone_events.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Issues](https://docs.gitlab.com/api/resource_milestone_events/#issues)
  * [List project issue milestone events](https://docs.gitlab.com/api/resource_milestone_events/#list-project-issue-milestone-events)
  * [Retrieve a single issue milestone event](https://docs.gitlab.com/api/resource_milestone_events/#retrieve-a-single-issue-milestone-event)
  * [Merge requests](https://docs.gitlab.com/api/resource_milestone_events/#merge-requests)
  * [List project merge request milestone events](https://docs.gitlab.com/api/resource_milestone_events/#list-project-merge-request-milestone-events)
  * [Retrieve a single merge request milestone event](https://docs.gitlab.com/api/resource_milestone_events/#retrieve-a-single-merge-request-milestone-event)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/resource_milestone_events.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/resource_milestone_events.md)
