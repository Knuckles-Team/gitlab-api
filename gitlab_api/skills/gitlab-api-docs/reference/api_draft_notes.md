[Skip to main content](https://docs.gitlab.com/api/draft_notes/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/draft_notes/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/draft_notes/)
    * [18.8](https://docs.gitlab.com/18.8/api/draft_notes/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/draft_notes/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/draft_notes/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/draft_notes.html)
...
/
  ...
  6. [Draft notes](https://docs.gitlab.com/api/draft_notes/)
...
## List all merge request draft notes[](https://docs.gitlab.com/api/draft_notes/#list-all-merge-request-draft-notes "Permalink")
...
## Retrieve a draft note[](https://docs.gitlab.com/api/draft_notes/#retrieve-a-draft-note "Permalink")
...
## Create a draft note[](https://docs.gitlab.com/api/draft_notes/#create-a-draft-note "Permalink")
...
## Update a draft note[](https://docs.gitlab.com/api/draft_notes/#update-a-draft-note "Permalink")
...
## Delete a draft note[](https://docs.gitlab.com/api/draft_notes/#delete-a-draft-note "Permalink")
...
## Publish a draft note[](https://docs.gitlab.com/api/draft_notes/#publish-a-draft-note "Permalink")
...
## Publish all pending draft notes[](https://docs.gitlab.com/api/draft_notes/#publish-all-pending-draft-notes "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/draft_notes.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/draft_notes.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all merge request draft notes](https://docs.gitlab.com/api/draft_notes/#list-all-merge-request-draft-notes)
  * [Retrieve a draft note](https://docs.gitlab.com/api/draft_notes/#retrieve-a-draft-note)
  * [Create a draft note](https://docs.gitlab.com/api/draft_notes/#create-a-draft-note)
  * [Update a draft note](https://docs.gitlab.com/api/draft_notes/#update-a-draft-note)
  * [Delete a draft note](https://docs.gitlab.com/api/draft_notes/#delete-a-draft-note)
  * [Publish a draft note](https://docs.gitlab.com/api/draft_notes/#publish-a-draft-note)
  * [Publish all pending draft notes](https://docs.gitlab.com/api/draft_notes/#publish-all-pending-draft-notes)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/draft_notes.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/draft_notes.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fdraft_notes%2F&_biz_t=1771981512594&_biz_i=Draft%20Notes%20API%20%7C%20GitLab%20Docs&_biz_n=43&rnd=465766&cdn_o=a&_biz_z=1771981512594)
