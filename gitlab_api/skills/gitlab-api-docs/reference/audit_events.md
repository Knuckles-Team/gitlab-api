[Skip to main content](https://docs.gitlab.com/api/audit_events/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/audit_events/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/audit_events/)
    * [18.8](https://docs.gitlab.com/18.8/api/audit_events/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/audit_events/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/audit_events/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/audit_events.html)
...
/
  ...
  5. [Audit events](https://docs.gitlab.com/api/audit_events/)
...
## Instance audit events[](https://docs.gitlab.com/api/audit_events/#instance-audit-events "Permalink")
  * Tier: Premium, Ultimate
  * Offering: GitLab Self-Managed, GitLab Dedicated


Use this API to retrieve [instance audit events](https://docs.gitlab.com/administration/compliance/audit_event_reports/).
To retrieve audit events using the API, you must [authenticate yourself](https://docs.gitlab.com/api/rest/authentication/) as an Administrator.
### List all instance audit events[](https://docs.gitlab.com/api/audit_events/#list-all-instance-audit-events "Permalink")
History
...
Offset-based pagination was [deprecated](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/186194) in GitLab 17.8 and is planned for removal in 19.0. Use [keyset-based](https://docs.gitlab.com/api/rest/#keyset-based-pagination) pagination instead. This change is a breaking change.
...
### Retrieve an instance audit event[](https://docs.gitlab.com/api/audit_events/#retrieve-an-instance-audit-event "Permalink")
...
## Group audit events[](https://docs.gitlab.com/api/audit_events/#group-audit-events "Permalink")
History
  * Support for keyset pagination [introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/333968) in GitLab 15.2.


Use this API to retrieve [group audit events](https://docs.gitlab.com/user/compliance/audit_events/#group-audit-events).
A user with:
...
Offset-based pagination was [deprecated](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/186194) in GitLab 17.8 and is planned for removal in 19.0. Use [keyset-based](https://docs.gitlab.com/api/rest/#keyset-based-pagination) pagination instead. This change is a breaking change.
This endpoint supports both offset-based and [keyset-based](https://docs.gitlab.com/api/rest/#keyset-based-pagination) pagination. Keyset-based pagination is recommended when requesting consecutive pages of results.
### List all group audit events[](https://docs.gitlab.com/api/audit_events/#list-all-group-audit-events "Permalink")
History
  * Support for keyset pagination [introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/333968) in GitLab 15.2.
...
### Retrieve a group audit event[](https://docs.gitlab.com/api/audit_events/#retrieve-a-group-audit-event "Permalink")
...
## Project audit events[](https://docs.gitlab.com/api/audit_events/#project-audit-events "Permalink")
Use this API to retrieve [project audit events](https://docs.gitlab.com/user/compliance/audit_events/#project-audit-events).
...
### List all project audit events[](https://docs.gitlab.com/api/audit_events/#list-all-project-audit-events "Permalink")
History
...
Offset-based pagination was [deprecated](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/186194) in GitLab 17.8 and is planned for removal in 19.0. Use [keyset-based](https://docs.gitlab.com/api/rest/#keyset-based-pagination) pagination instead. This change is a breaking change.
By default, `GET` requests return 20 results at a time because the API results are paginated. When requesting consecutive pages of results, you should use [keyset pagination](https://docs.gitlab.com/api/rest/#keyset-based-pagination).
Read more on [pagination](https://docs.gitlab.com/api/rest/#pagination).
shell
```
curl --request GET \
...
### Retrieve a project audit event[](https://docs.gitlab.com/api/audit_events/#retrieve-a-project-audit-event "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/audit_events.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/audit_events.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Instance audit events](https://docs.gitlab.com/api/audit_events/#instance-audit-events)
  * [List all instance audit events](https://docs.gitlab.com/api/audit_events/#list-all-instance-audit-events)
  * [Retrieve an instance audit event](https://docs.gitlab.com/api/audit_events/#retrieve-an-instance-audit-event)
  * [Group audit events](https://docs.gitlab.com/api/audit_events/#group-audit-events)
  * [List all group audit events](https://docs.gitlab.com/api/audit_events/#list-all-group-audit-events)
  * [Retrieve a group audit event](https://docs.gitlab.com/api/audit_events/#retrieve-a-group-audit-event)
  * [Project audit events](https://docs.gitlab.com/api/audit_events/#project-audit-events)
  * [List all project audit events](https://docs.gitlab.com/api/audit_events/#list-all-project-audit-events)
  * [Retrieve a project audit event](https://docs.gitlab.com/api/audit_events/#retrieve-a-project-audit-event)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/audit_events.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/audit_events.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Faudit_events%2F&_biz_t=1772174217740&_biz_i=Audit%20events%20API%20%7C%20GitLab%20Docs&_biz_n=13&rnd=715758&cdn_o=a&_biz_z=1772174217741)
