[Skip to main content](https://docs.gitlab.com/api/wikis/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/wikis/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/wikis/)
    * [18.8](https://docs.gitlab.com/18.8/api/wikis/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/wikis/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/wikis/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/wikis.html)
...
/
  ...
  6. [Wikis](https://docs.gitlab.com/api/wikis/)
...
Use this API to manage [project wikis](https://docs.gitlab.com/user/project/wiki/). An API for [group wikis](https://docs.gitlab.com/api/group_wikis/) is also available.
Comments on a wiki page are called `notes`. To interact with them, use the [notes API](https://docs.gitlab.com/api/notes/#project-wikis).
## List all wiki pages[](https://docs.gitlab.com/api/wikis/#list-all-wiki-pages "Permalink")
...
## Retrieve a wiki page[](https://docs.gitlab.com/api/wikis/#retrieve-a-wiki-page "Permalink")
...
## Create a wiki page[](https://docs.gitlab.com/api/wikis/#create-a-wiki-page "Permalink")
...
The `--data-urlencode "content@content.md"` option URL-encodes the contents of the Markdown file and assigns it to the `content` attribute. This encoding handles special characters, line breaks, and complex Markdown syntax that might otherwise cause errors.
Example response:
json
```
{
...
## Update a wiki page[](https://docs.gitlab.com/api/wikis/#update-a-wiki-page "Permalink")
...
## Delete a wiki page[](https://docs.gitlab.com/api/wikis/#delete-a-wiki-page "Permalink")
...
## Upload an attachment to the wiki repository[](https://docs.gitlab.com/api/wikis/#upload-an-attachment-to-the-wiki-repository "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/wikis.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/wikis.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all wiki pages](https://docs.gitlab.com/api/wikis/#list-all-wiki-pages)
  * [Retrieve a wiki page](https://docs.gitlab.com/api/wikis/#retrieve-a-wiki-page)
  * [Create a wiki page](https://docs.gitlab.com/api/wikis/#create-a-wiki-page)
  * [Update a wiki page](https://docs.gitlab.com/api/wikis/#update-a-wiki-page)
  * [Delete a wiki page](https://docs.gitlab.com/api/wikis/#delete-a-wiki-page)
  * [Upload an attachment to the wiki repository](https://docs.gitlab.com/api/wikis/#upload-an-attachment-to-the-wiki-repository)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/wikis.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/wikis.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fwikis%2F&_biz_t=1772174495561&_biz_i=Project%20wikis%20API%20%7C%20GitLab%20Docs&_biz_n=192&rnd=960128&cdn_o=a&_biz_z=1772174495562)
