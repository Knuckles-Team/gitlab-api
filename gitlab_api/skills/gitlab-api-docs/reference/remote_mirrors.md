[Skip to main content](https://docs.gitlab.com/api/remote_mirrors/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/remote_mirrors/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/remote_mirrors/)
    * [18.8](https://docs.gitlab.com/18.8/api/remote_mirrors/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/remote_mirrors/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/remote_mirrors/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/remote_mirrors.html)
...
/
  ...
  6. [Remote mirrors](https://docs.gitlab.com/api/remote_mirrors/)
...
Use this API to manage [remote mirrors](https://docs.gitlab.com/user/project/repository/mirror/push/). You can query and modify the state of these mirrors with the remote mirror API.
For security reasons, the `url` attribute in the API response is always scrubbed of username and password information.
[Pull mirrors](https://docs.gitlab.com/user/project/repository/mirror/pull/) use [a different API endpoint](https://docs.gitlab.com/api/project_pull_mirroring/#update-project-pull-mirroring-settings) to display and update them.
## List all remote mirrors for a project[](https://docs.gitlab.com/api/remote_mirrors/#list-all-remote-mirrors-for-a-project "Permalink")
History
...
## Retrieve a remote mirror for a project[](https://docs.gitlab.com/api/remote_mirrors/#retrieve-a-remote-mirror-for-a-project "Permalink")
History
  * Attribute `host_keys` [introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/203435) in GitLab 18.4.
...
## Retrieve a public key for a remote mirror[](https://docs.gitlab.com/api/remote_mirrors/#retrieve-a-public-key-for-a-remote-mirror "Permalink")
History
...
## Create a pull mirror[](https://docs.gitlab.com/api/remote_mirrors/#create-a-pull-mirror "Permalink")
Learn how to [configure a pull mirror](https://docs.gitlab.com/api/project_pull_mirroring/#update-project-pull-mirroring-settings) by using the project pull mirroring API.
## Create a push mirror[](https://docs.gitlab.com/api/remote_mirrors/#create-a-push-mirror "Permalink")
History
...
Each project can have a maximum of 10 enabled push mirrors. For more information, see [Maximum number of project push mirrors](https://docs.gitlab.com/administration/instance_limits/#maximum-number-of-project-push-mirrors).
...
## Update a remote mirror in a project[](https://docs.gitlab.com/api/remote_mirrors/#update-a-remote-mirror-in-a-project "Permalink")
History
  * Field `auth_method` [introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/75155) in GitLab 16.10.
  * Attribute `host_keys` [introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/203435) in GitLab 18.4.
...
## Force push mirror update[](https://docs.gitlab.com/api/remote_mirrors/#force-push-mirror-update "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/388907) in GitLab 16.11.


[Force an update](https://docs.gitlab.com/user/project/repository/mirror/#force-an-update) to a push mirror.
```
...
## Delete a remote mirror from a project[](https://docs.gitlab.com/api/remote_mirrors/#delete-a-remote-mirror-from-a-project "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/remote_mirrors.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/remote_mirrors.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all remote mirrors for a project](https://docs.gitlab.com/api/remote_mirrors/#list-all-remote-mirrors-for-a-project)
  * [Retrieve a remote mirror for a project](https://docs.gitlab.com/api/remote_mirrors/#retrieve-a-remote-mirror-for-a-project)
  * [Retrieve a public key for a remote mirror](https://docs.gitlab.com/api/remote_mirrors/#retrieve-a-public-key-for-a-remote-mirror)
  * [Create a pull mirror](https://docs.gitlab.com/api/remote_mirrors/#create-a-pull-mirror)
  * [Create a push mirror](https://docs.gitlab.com/api/remote_mirrors/#create-a-push-mirror)
  * [Update a remote mirror in a project](https://docs.gitlab.com/api/remote_mirrors/#update-a-remote-mirror-in-a-project)
  * [Force push mirror update](https://docs.gitlab.com/api/remote_mirrors/#force-push-mirror-update)
  * [Delete a remote mirror from a project](https://docs.gitlab.com/api/remote_mirrors/#delete-a-remote-mirror-from-a-project)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/remote_mirrors.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/remote_mirrors.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Frepository_files%2F&_biz_t=1772174440983&_biz_i=Repository%20files%20API%20%7C%20GitLab%20Docs&_biz_n=145&rnd=636836&cdn_o=a&_biz_z=1772174441140)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Frepositories%2F&_biz_t=1772174441097&_biz_i=Repositories%20API%20%7C%20GitLab%20Docs&_biz_n=146&rnd=180553&cdn_o=a&_biz_z=1772174441141)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fremote_mirrors%2F&_biz_t=1772174441140&_biz_i=Project%20remote%20mirrors%20API%20%7C%20GitLab%20Docs&_biz_n=147&rnd=450822&cdn_o=a&_biz_z=1772174441141)
