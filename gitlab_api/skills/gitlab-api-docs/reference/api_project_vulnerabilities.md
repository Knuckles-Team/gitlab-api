[Skip to main content](https://docs.gitlab.com/api/project_vulnerabilities/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/project_vulnerabilities/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/project_vulnerabilities/)
    * [18.8](https://docs.gitlab.com/18.8/api/project_vulnerabilities/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/project_vulnerabilities/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/project_vulnerabilities/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/project_vulnerabilities.html)
...
/
  ...
  6. [Vulnerabilities](https://docs.gitlab.com/api/project_vulnerabilities/)
...
This API is in the process of being deprecated and considered unstable. The response payload may be subject to change or breakage across GitLab releases. Use the [GraphQL API](https://docs.gitlab.com/api/graphql/reference/#queryvulnerabilities) instead.
Use this API to manage [project vulnerabilities](https://docs.gitlab.com/user/application_security/vulnerabilities/). Every call to this API requires authentication.
If a user isn’t a member of a private project, requests to the private project return a `404 Not Found` status code.
## List project vulnerabilities[](https://docs.gitlab.com/api/project_vulnerabilities/#list-project-vulnerabilities "Permalink")
List all of a project’s vulnerabilities.
If an authenticated user does not have permission to [use the Project Security Dashboard](https://docs.gitlab.com/user/permissions/#project-permissions), `GET` requests for vulnerabilities of this project result in a `403` status code.
...
## Create a vulnerability[](https://docs.gitlab.com/api/project_vulnerabilities/#create-a-vulnerability "Permalink")
Creates a new vulnerability.
If an authenticated user does not have a permission to [create a new vulnerability](https://docs.gitlab.com/user/permissions/#project-permissions), this request results in a `403` status code.
```
...
Attribute | Type | Required | Description
---|---|---|---
`id` | integer or string | yes | The ID or [URL-encoded path of the project](https://docs.gitlab.com/api/rest/#namespaced-paths) which the authenticated user is a member of
...
### Errors[](https://docs.gitlab.com/api/project_vulnerabilities/#errors "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/project_vulnerabilities.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/project_vulnerabilities.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List project vulnerabilities](https://docs.gitlab.com/api/project_vulnerabilities/#list-project-vulnerabilities)
  * [Create a vulnerability](https://docs.gitlab.com/api/project_vulnerabilities/#create-a-vulnerability)
  * [Errors](https://docs.gitlab.com/api/project_vulnerabilities/#errors)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/project_vulnerabilities.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/project_vulnerabilities.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fproject_vulnerabilities%2F&_biz_t=1771981672220&_biz_i=Project%20vulnerabilities%20API%20%7C%20GitLab%20Docs&_biz_n=148&rnd=63322&cdn_o=a&_biz_z=1771981672221)
