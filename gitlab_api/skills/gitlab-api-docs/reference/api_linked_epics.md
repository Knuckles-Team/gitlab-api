[Skip to main content](https://docs.gitlab.com/api/linked_epics/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/linked_epics/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/linked_epics/)
    * [18.8](https://docs.gitlab.com/18.8/api/linked_epics/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/linked_epics/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/linked_epics/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/linked_epics.html)
...
/
  ...
  5. [Linked epics (deprecated)](https://docs.gitlab.com/api/linked_epics/)


* * *
# Linked epics API (deprecated)
  * Tier: Ultimate
  * Offering: GitLab.com, GitLab Self-Managed, GitLab Dedicated


History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/352493) in GitLab 14.9 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `related_epics_widget`. Enabled by default.
...
## List all related epic links for a group[](https://docs.gitlab.com/api/linked_epics/#list-all-related-epic-links-for-a-group "Permalink")
...
## List all linked epics for an epic[](https://docs.gitlab.com/api/linked_epics/#list-all-linked-epics-for-an-epic "Permalink")
...
## Create a related epic link[](https://docs.gitlab.com/api/linked_epics/#create-a-related-epic-link "Permalink")
History
...
`target_group_id` | integer or string | Yes | ID or [URL-encoded path of the target group](https://docs.gitlab.com/api/rest/#namespaced-paths).
...
## Delete a related epic link[](https://docs.gitlab.com/api/linked_epics/#delete-a-related-epic-link "Permalink")
History
  * Minimum required role for the group [changed](https://gitlab.com/gitlab-org/gitlab/-/issues/381308) from Reporter to Guest in GitLab 15.8.
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/linked_epics.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/linked_epics.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all related epic links for a group](https://docs.gitlab.com/api/linked_epics/#list-all-related-epic-links-for-a-group)
  * [List all linked epics for an epic](https://docs.gitlab.com/api/linked_epics/#list-all-linked-epics-for-an-epic)
  * [Create a related epic link](https://docs.gitlab.com/api/linked_epics/#create-a-related-epic-link)
  * [Delete a related epic link](https://docs.gitlab.com/api/linked_epics/#delete-a-related-epic-link)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/linked_epics.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/linked_epics.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fkeys%2F&_biz_t=1771981574245&_biz_i=Keys%20API%20%7C%20GitLab%20Docs&_biz_n=80&rnd=807464&cdn_o=a&_biz_z=1771981574397)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Flinked_epics%2F&_biz_t=1771981574396&_biz_i=Linked%20epics%20API%20\(deprecated\)%20%7C%20GitLab%20Docs&_biz_n=81&rnd=486311&cdn_o=a&_biz_z=1771981574397)
