[Skip to main content](https://docs.gitlab.com/api/resource_groups/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/resource_groups/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/resource_groups/)
    * [18.8](https://docs.gitlab.com/18.8/api/resource_groups/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/resource_groups/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/resource_groups/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/resource_groups.html)
...
/
  ...
  5. [Resource group](https://docs.gitlab.com/api/resource_groups/)
...
Use this API to interact with [resource groups](https://docs.gitlab.com/ci/resource_groups/).
## List all resource groups[](https://docs.gitlab.com/api/resource_groups/#list-all-resource-groups "Permalink")
...
## Retrieve a resource group[](https://docs.gitlab.com/api/resource_groups/#retrieve-a-resource-group "Permalink")
...
## Retrieve current job for a resource group[](https://docs.gitlab.com/api/resource_groups/#retrieve-current-job-for-a-resource-group "Permalink")
History
...
## List upcoming jobs for a specific resource group[](https://docs.gitlab.com/api/resource_groups/#list-upcoming-jobs-for-a-specific-resource-group "Permalink")
```
...
## Update a resource group[](https://docs.gitlab.com/api/resource_groups/#update-a-resource-group "Permalink")
...
`id` | integer or string | yes | The ID or [URL-encoded path of the project](https://docs.gitlab.com/api/rest/#namespaced-paths)
`key` | string | yes | The URL-encoded key of the resource group. For example, use `resource%5Fa` instead of `resource_a`.
`process_mode` | string | no | The process mode of the resource group. One of `unordered`, `oldest_first`, `newest_first`, or `newest_ready_first`. Read [process modes](https://docs.gitlab.com/ci/resource_groups/#process-modes) for more information.
shell
```
curl --request PUT \
     --header "PRIVATE-TOKEN: <your_access_token>" \
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/resource_groups.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/resource_groups.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all resource groups](https://docs.gitlab.com/api/resource_groups/#list-all-resource-groups)
  * [Retrieve a resource group](https://docs.gitlab.com/api/resource_groups/#retrieve-a-resource-group)
  * [Retrieve current job for a resource group](https://docs.gitlab.com/api/resource_groups/#retrieve-current-job-for-a-resource-group)
  * [List upcoming jobs for a specific resource group](https://docs.gitlab.com/api/resource_groups/#list-upcoming-jobs-for-a-specific-resource-group)
  * [Update a resource group](https://docs.gitlab.com/api/resource_groups/#update-a-resource-group)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/resource_groups.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/resource_groups.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Frepository_files%2F&_biz_t=1772174440983&_biz_i=Repository%20files%20API%20%7C%20GitLab%20Docs&_biz_n=145&rnd=636836&cdn_o=a&_biz_z=1772174441263)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Frepositories%2F&_biz_t=1772174441097&_biz_i=Repositories%20API%20%7C%20GitLab%20Docs&_biz_n=146&rnd=180553&cdn_o=a&_biz_z=1772174441264)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fremote_mirrors%2F&_biz_t=1772174441140&_biz_i=Project%20remote%20mirrors%20API%20%7C%20GitLab%20Docs&_biz_n=147&rnd=450822&cdn_o=a&_biz_z=1772174441264)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fresource_groups%2F&_biz_t=1772174441263&_biz_i=Resource%20group%20API%20%7C%20GitLab%20Docs&_biz_n=148&rnd=864027&cdn_o=a&_biz_z=1772174441264)
