[Skip to main content](https://docs.gitlab.com/api/group_milestones/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/group_milestones/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/group_milestones/)
    * [18.8](https://docs.gitlab.com/18.8/api/group_milestones/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/group_milestones/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/group_milestones/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/group_milestones.html)
...
/
  ...
  6. [Milestones](https://docs.gitlab.com/api/group_milestones/)
...
## List group milestones[](https://docs.gitlab.com/api/group_milestones/#list-group-milestones "Permalink")
...
## Get single milestone[](https://docs.gitlab.com/api/group_milestones/#get-single-milestone "Permalink")
...
## Create new milestone[](https://docs.gitlab.com/api/group_milestones/#create-new-milestone "Permalink")
...
## Edit milestone[](https://docs.gitlab.com/api/group_milestones/#edit-milestone "Permalink")
...
## Delete group milestone[](https://docs.gitlab.com/api/group_milestones/#delete-group-milestone "Permalink")
...
## Get all issues assigned to a single milestone[](https://docs.gitlab.com/api/group_milestones/#get-all-issues-assigned-to-a-single-milestone "Permalink")
...
`id` | integer or string | yes | The ID or [URL-encoded path](https://docs.gitlab.com/api/rest/#namespaced-paths) of the group
`milestone_id` | integer | yes | The ID of a group milestone
Currently, this API endpoint doesn’t return issues from any subgroups. If you want to get all the milestones’ issues, you can instead use the [List issues API](https://docs.gitlab.com/api/issues/#list-all-issues) and filter for a particular milestone (for example, `GET /issues?milestone=1.0.0&state=opened`).
## Get all merge requests assigned to a single milestone[](https://docs.gitlab.com/api/group_milestones/#get-all-merge-requests-assigned-to-a-single-milestone "Permalink")
...
`id` | integer or string | yes | The ID or [URL-encoded path](https://docs.gitlab.com/api/rest/#namespaced-paths) of the group
`milestone_id` | integer | yes | The ID of a group milestone
## Get all burndown chart events for a single milestone[](https://docs.gitlab.com/api/group_milestones/#get-all-burndown-chart-events-for-a-single-milestone "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_milestones.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_milestones.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List group milestones](https://docs.gitlab.com/api/group_milestones/#list-group-milestones)
  * [Get single milestone](https://docs.gitlab.com/api/group_milestones/#get-single-milestone)
  * [Create new milestone](https://docs.gitlab.com/api/group_milestones/#create-new-milestone)
  * [Edit milestone](https://docs.gitlab.com/api/group_milestones/#edit-milestone)
  * [Delete group milestone](https://docs.gitlab.com/api/group_milestones/#delete-group-milestone)
  * [Get all issues assigned to a single milestone](https://docs.gitlab.com/api/group_milestones/#get-all-issues-assigned-to-a-single-milestone)
  * [Get all merge requests assigned to a single milestone](https://docs.gitlab.com/api/group_milestones/#get-all-merge-requests-assigned-to-a-single-milestone)
  * [Get all burndown chart events for a single milestone](https://docs.gitlab.com/api/group_milestones/#get-all-burndown-chart-events-for-a-single-milestone)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_milestones.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_milestones.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fimport%2F&_biz_t=1772174295848&_biz_i=Import%20API%20%7C%20GitLab%20Docs&_biz_n=70&rnd=959004&cdn_o=a&_biz_z=1772174296103)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fgroup_milestones%2F&_biz_t=1772174296102&_biz_i=Group%20milestones%20API%20%7C%20GitLab%20Docs&_biz_n=71&rnd=566383&cdn_o=a&_biz_z=1772174296104)
