[Skip to main content](https://docs.gitlab.com/api/system_hooks/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/system_hooks/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/system_hooks/)
    * [18.8](https://docs.gitlab.com/18.8/api/system_hooks/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/system_hooks/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/system_hooks/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/system_hooks.html)
...
/
  ...
  5. [System hooks](https://docs.gitlab.com/api/system_hooks/)
...
Use this API to manage [system hooks](https://docs.gitlab.com/administration/system_hooks/). System hooks are different from [group webhooks](https://docs.gitlab.com/api/group_webhooks/) that impact all projects and subgroups in a group, and [project webhooks](https://docs.gitlab.com/api/project_webhooks/) that are limited to a single project.
Prerequisites:
  * You must be an administrator.


## List all system hooks[](https://docs.gitlab.com/api/system_hooks/#list-all-system-hooks "Permalink")
...
## Retrieve system hook[](https://docs.gitlab.com/api/system_hooks/#retrieve-system-hook "Permalink")
...
## Add new system hook[](https://docs.gitlab.com/api/system_hooks/#add-new-system-hook "Permalink")
...
## Update system hook[](https://docs.gitlab.com/api/system_hooks/#update-system-hook "Permalink")
...
## Test system hook[](https://docs.gitlab.com/api/system_hooks/#test-system-hook "Permalink")
...
## Delete system hook[](https://docs.gitlab.com/api/system_hooks/#delete-system-hook "Permalink")
...
## Set a URL variable[](https://docs.gitlab.com/api/system_hooks/#set-a-url-variable "Permalink")
```
...
## Delete a URL variable[](https://docs.gitlab.com/api/system_hooks/#delete-a-url-variable "Permalink")
```
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/system_hooks.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/system_hooks.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all system hooks](https://docs.gitlab.com/api/system_hooks/#list-all-system-hooks)
  * [Retrieve system hook](https://docs.gitlab.com/api/system_hooks/#retrieve-system-hook)
  * [Add new system hook](https://docs.gitlab.com/api/system_hooks/#add-new-system-hook)
  * [Update system hook](https://docs.gitlab.com/api/system_hooks/#update-system-hook)
  * [Test system hook](https://docs.gitlab.com/api/system_hooks/#test-system-hook)
  * [Delete system hook](https://docs.gitlab.com/api/system_hooks/#delete-system-hook)
  * [Set a URL variable](https://docs.gitlab.com/api/system_hooks/#set-a-url-variable)
  * [Delete a URL variable](https://docs.gitlab.com/api/system_hooks/#delete-a-url-variable)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/system_hooks.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/system_hooks.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fsuggestions%2F&_biz_t=1772174481190&_biz_i=Suggest%20Changes%20API%20%7C%20GitLab%20Docs&_biz_n=175&rnd=221350&cdn_o=a&_biz_z=1772174481276)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fsystem_hooks%2F&_biz_t=1772174481275&_biz_i=System%20hooks%20API%20%7C%20GitLab%20Docs&_biz_n=176&rnd=889444&cdn_o=a&_biz_z=1772174481277)
