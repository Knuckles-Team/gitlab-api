[Skip to main content](https://docs.gitlab.com/api/avatar/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/avatar/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/avatar/)
    * [18.8](https://docs.gitlab.com/18.8/api/avatar/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/avatar/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/avatar/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/avatar.html)
...
/
  ...
  5. [Avatar](https://docs.gitlab.com/api/avatar/)
...
## Retrieve user account avatar[](https://docs.gitlab.com/api/avatar/#retrieve-user-account-avatar "Permalink")
Retrieves the URL of a user account [avatar](https://docs.gitlab.com/user/profile/#access-your-user-settings) associated with a specified public email address. This endpoint does not require authentication.
...
## Related topics[](https://docs.gitlab.com/api/avatar/#related-topics "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/avatar.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/avatar.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Retrieve user account avatar](https://docs.gitlab.com/api/avatar/#retrieve-user-account-avatar)
  * [Related topics](https://docs.gitlab.com/api/avatar/#related-topics)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/avatar.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/avatar.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fboards%2F&_biz_t=1772174218411&_biz_i=Project%20issue%20boards%20API%20%7C%20GitLab%20Docs&_biz_n=16&rnd=255079&cdn_o=a&_biz_z=1772174218545)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Favatar%2F&_biz_t=1772174218544&_biz_i=Avatar%20API%20%7C%20GitLab%20Docs&_biz_n=17&rnd=982516&cdn_o=a&_biz_z=1772174218546)
