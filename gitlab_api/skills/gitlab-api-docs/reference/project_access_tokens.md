[Skip to main content](https://docs.gitlab.com/api/project_access_tokens/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/project_access_tokens/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/project_access_tokens/)
    * [18.8](https://docs.gitlab.com/18.8/api/project_access_tokens/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/project_access_tokens/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/project_access_tokens/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/project_access_tokens.html)
...
/
  ...
  6. [Access tokens](https://docs.gitlab.com/api/project_access_tokens/)
...
## List all project access tokens[](https://docs.gitlab.com/api/project_access_tokens/#list-all-project-access-tokens "Permalink")
History
...
## Retrieve details on a project access token[](https://docs.gitlab.com/api/project_access_tokens/#retrieve-details-on-a-project-access-token "Permalink")
...
## Create a project access token[](https://docs.gitlab.com/api/project_access_tokens/#create-a-project-access-token "Permalink")
History
...
`scopes` | `Array[String]` | yes | List of [scopes](https://docs.gitlab.com/user/project/settings/project_access_tokens/#scopes-for-a-project-access-token) available to the token.
...
## Rotate a project access token[](https://docs.gitlab.com/api/project_access_tokens/#rotate-a-project-access-token "Permalink")
History
...
Prerequisites:
  ...
  * To [self-rotate](https://docs.gitlab.com/api/project_access_tokens/#self-rotate) a project access token, the token must have the [`api` or `self_rotate` scope](https://docs.gitlab.com/user/profile/personal_access_tokens/#personal-access-token-scopes).
...
Other possible responses:
  ...
  * `401: Unauthorized` if any of the following conditions are true:
    ...
    * You’re using a project access token to rotate another project access token. See [Self-rotate](https://docs.gitlab.com/api/project_access_tokens/#self-rotate) instead.
...
### Self-rotate[](https://docs.gitlab.com/api/project_access_tokens/#self-rotate "Permalink")
...
## Revoke a project access token[](https://docs.gitlab.com/api/project_access_tokens/#revoke-a-project-access-token "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/project_access_tokens.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/project_access_tokens.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all project access tokens](https://docs.gitlab.com/api/project_access_tokens/#list-all-project-access-tokens)
  * [Retrieve details on a project access token](https://docs.gitlab.com/api/project_access_tokens/#retrieve-details-on-a-project-access-token)
  * [Create a project access token](https://docs.gitlab.com/api/project_access_tokens/#create-a-project-access-token)
  * [Rotate a project access token](https://docs.gitlab.com/api/project_access_tokens/#rotate-a-project-access-token)
  * [Self-rotate](https://docs.gitlab.com/api/project_access_tokens/#self-rotate)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/project_access_tokens.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/project_access_tokens.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fproject_access_tokens%2F&_biz_t=1772174416247&_biz_i=Project%20access%20tokens%20API%20%7C%20GitLab%20Docs&_biz_n=134&rnd=17104&cdn_o=a&_biz_z=1772174416248)
