[Skip to main content](https://docs.gitlab.com/api/feature_flags/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/feature_flags/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/feature_flags/)
    * [18.8](https://docs.gitlab.com/18.8/api/feature_flags/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/feature_flags/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/feature_flags/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/feature_flags.html)
...
/
  ...
  5. [Feature flags](https://docs.gitlab.com/api/feature_flags/)
...
Use this API to interact with GitLab [feature flags](https://docs.gitlab.com/operations/feature_flags/).
Prerequisites:
  * You must have the Developer, Maintainer, or Owner role.


## List feature flags for a project[](https://docs.gitlab.com/api/feature_flags/#list-feature-flags-for-a-project "Permalink")
...
## Retrieve a feature flag[](https://docs.gitlab.com/api/feature_flags/#retrieve-a-feature-flag "Permalink")
...
## Create a feature flag[](https://docs.gitlab.com/api/feature_flags/#create-a-feature-flag "Permalink")
...
`strategies` | array of strategy JSON objects | no | The feature flag [strategies](https://docs.gitlab.com/operations/feature_flags/#feature-flag-strategies).
...
## Update a feature flag[](https://docs.gitlab.com/api/feature_flags/#update-a-feature-flag "Permalink")
...
## Delete a feature flag[](https://docs.gitlab.com/api/feature_flags/#delete-a-feature-flag "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/feature_flags.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/feature_flags.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List feature flags for a project](https://docs.gitlab.com/api/feature_flags/#list-feature-flags-for-a-project)
  * [Retrieve a feature flag](https://docs.gitlab.com/api/feature_flags/#retrieve-a-feature-flag)
  * [Create a feature flag](https://docs.gitlab.com/api/feature_flags/#create-a-feature-flag)
  * [Update a feature flag](https://docs.gitlab.com/api/feature_flags/#update-a-feature-flag)
  * [Delete a feature flag](https://docs.gitlab.com/api/feature_flags/#delete-a-feature-flag)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/feature_flags.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/feature_flags.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Ffeature_flag_user_lists%2F&_biz_t=1772174268918&_biz_i=Feature%20flag%20user%20lists%20API%20%7C%20GitLab%20Docs&_biz_n=50&rnd=179128&cdn_o=a&_biz_z=1772174269050)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Ffeature_flags%2F&_biz_t=1772174269049&_biz_i=Feature%20flag%20API%20%7C%20GitLab%20Docs&_biz_n=51&rnd=509046&cdn_o=a&_biz_z=1772174269051)
