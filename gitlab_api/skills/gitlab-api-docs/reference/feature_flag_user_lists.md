[Skip to main content](https://docs.gitlab.com/api/feature_flag_user_lists/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/feature_flag_user_lists/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/feature_flag_user_lists/)
    * [18.8](https://docs.gitlab.com/18.8/api/feature_flag_user_lists/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/feature_flag_user_lists/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/feature_flag_user_lists/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/feature_flag_user_lists.html)
...
/
  ...
  5. [Feature flag user lists](https://docs.gitlab.com/api/feature_flag_user_lists/)
...
Use this API to interact with GitLab feature flags for [user lists](https://docs.gitlab.com/operations/feature_flags/#user-list).
Prerequisites:
  * You must have the Developer, Maintainer, or Owner role.


To interact with feature flags for all users, see the [Feature flag API](https://docs.gitlab.com/api/feature_flags/).
## List all feature flag user lists for a project[](https://docs.gitlab.com/api/feature_flag_user_lists/#list-all-feature-flag-user-lists-for-a-project "Permalink")
...
## Create a feature flag user list[](https://docs.gitlab.com/api/feature_flag_user_lists/#create-a-feature-flag-user-list "Permalink")
...
## Get a feature flag user list[](https://docs.gitlab.com/api/feature_flag_user_lists/#get-a-feature-flag-user-list "Permalink")
...
## Update a feature flag user list[](https://docs.gitlab.com/api/feature_flag_user_lists/#update-a-feature-flag-user-list "Permalink")
...
## Delete feature flag user list[](https://docs.gitlab.com/api/feature_flag_user_lists/#delete-feature-flag-user-list "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/feature_flag_user_lists.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/feature_flag_user_lists.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all feature flag user lists for a project](https://docs.gitlab.com/api/feature_flag_user_lists/#list-all-feature-flag-user-lists-for-a-project)
  * [Create a feature flag user list](https://docs.gitlab.com/api/feature_flag_user_lists/#create-a-feature-flag-user-list)
  * [Get a feature flag user list](https://docs.gitlab.com/api/feature_flag_user_lists/#get-a-feature-flag-user-list)
  * [Update a feature flag user list](https://docs.gitlab.com/api/feature_flag_user_lists/#update-a-feature-flag-user-list)
  * [Delete feature flag user list](https://docs.gitlab.com/api/feature_flag_user_lists/#delete-feature-flag-user-list)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/feature_flag_user_lists.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/feature_flag_user_lists.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Ffeature_flag_user_lists%2F&_biz_t=1772174268918&_biz_i=Feature%20flag%20user%20lists%20API%20%7C%20GitLab%20Docs&_biz_n=50&rnd=179128&cdn_o=a&_biz_z=1772174268919)
