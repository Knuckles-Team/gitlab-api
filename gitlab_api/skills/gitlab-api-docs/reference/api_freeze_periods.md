[Skip to main content](https://docs.gitlab.com/api/freeze_periods/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/freeze_periods/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/freeze_periods/)
    * [18.8](https://docs.gitlab.com/18.8/api/freeze_periods/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/freeze_periods/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/freeze_periods/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/freeze_periods.html)
...
/
  ...
  5. [Freeze periods](https://docs.gitlab.com/api/freeze_periods/)
...
Use this API to interact with deployment [freeze periods](https://docs.gitlab.com/user/project/releases/#prevent-unintentional-releases-by-setting-a-deploy-freeze).
## List freeze periods[](https://docs.gitlab.com/api/freeze_periods/#list-freeze-periods "Permalink")
...
## Retrieve a freeze period[](https://docs.gitlab.com/api/freeze_periods/#retrieve-a-freeze-period "Permalink")
...
## Create a freeze period[](https://docs.gitlab.com/api/freeze_periods/#create-a-freeze-period "Permalink")
...
## Update a freeze period[](https://docs.gitlab.com/api/freeze_periods/#update-a-freeze-period "Permalink")
...
## Delete a freeze period[](https://docs.gitlab.com/api/freeze_periods/#delete-a-freeze-period "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/freeze_periods.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/freeze_periods.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List freeze periods](https://docs.gitlab.com/api/freeze_periods/#list-freeze-periods)
  * [Retrieve a freeze period](https://docs.gitlab.com/api/freeze_periods/#retrieve-a-freeze-period)
  * [Create a freeze period](https://docs.gitlab.com/api/freeze_periods/#create-a-freeze-period)
  * [Update a freeze period](https://docs.gitlab.com/api/freeze_periods/#update-a-freeze-period)
  * [Delete a freeze period](https://docs.gitlab.com/api/freeze_periods/#delete-a-freeze-period)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/freeze_periods.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/freeze_periods.md)
