[Skip to main content](https://docs.gitlab.com/api/admin/token/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/admin/token/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/admin/token/)
    * [18.8](https://docs.gitlab.com/18.8/api/admin/token/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/admin/token/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/admin/token/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/admin/token.html)
...
/
  ...
  5. [Token information](https://docs.gitlab.com/api/admin/token/)
...
## Token prefixes[](https://docs.gitlab.com/api/admin/token/#token-prefixes "Permalink")
When making a request, `personal`, `project` or `group access` tokens must begin with `glpat` or the current [custom prefix](https://docs.gitlab.com/administration/settings/account_and_limit_settings/#personal-access-token-prefix). If the token begins with a previous custom prefix, the operation fails. Interest in support for previous custom prefixes is tracked in [issue 165663](https://gitlab.com/gitlab-org/gitlab/-/issues/165663).
Prerequisites:
  * You must have administrator access to the instance.


## Retrieve token information[](https://docs.gitlab.com/api/admin/token/#retrieve-token-information "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/165157) in GitLab 17.5 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `admin_agnostic_token_finder`. Disabled by default.
...
Retrieves information for a specified token. This endpoint supports the following tokens:
  ...
  * [Feed tokens](https://docs.gitlab.com/security/tokens/#feed-token)
  * [OAuth application secrets](https://docs.gitlab.com/integration/oauth_provider/)
  * [Cluster agent tokens](https://docs.gitlab.com/security/tokens/#gitlab-cluster-agent-tokens)
  * [Runner authentication tokens](https://docs.gitlab.com/security/tokens/#runner-authentication-tokens)
  * [Pipeline trigger tokens](https://docs.gitlab.com/ci/triggers/#create-a-pipeline-trigger-token)
  * [CI/CD Job Tokens](https://docs.gitlab.com/security/tokens/#cicd-job-tokens)
  * [Feature flags client tokens](https://docs.gitlab.com/operations/feature_flags/#get-access-credentials)
  * [GitLab session cookies](https://docs.gitlab.com/user/profile/active_sessions/)
  * [Incoming email tokens](https://docs.gitlab.com/security/tokens/#incoming-email-token)
...
---|---|---|---
`token` | string | Yes | Existing token to identify. `Personal`, `project` or `group access` tokens must begin with `glpat` or the current [custom prefix](https://docs.gitlab.com/administration/settings/account_and_limit_settings/#personal-access-token-prefix).
If successful, returns [`200`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and information about the token.
...
## Revoke a token[](https://docs.gitlab.com/api/admin/token/#revoke-a-token "Permalink")
History
  ...
  * [Pipeline trigger tokens added](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/181598) in GitLab 17.10 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `token_api_expire_pipeline_triggers`. Disabled by default.
...
---|---
[Personal access tokens](https://docs.gitlab.com/user/profile/personal_access_tokens/) | Revoke
[Impersonation tokens](https://docs.gitlab.com/user/profile/personal_access_tokens/) | Revoke
[Project access tokens](https://docs.gitlab.com/security/tokens/#project-access-tokens) | Revoke
[Group access tokens](https://docs.gitlab.com/security/tokens/#group-access-tokens) | Revoke
[Deploy tokens](https://docs.gitlab.com/user/project/deploy_tokens/) | Revoke
[Cluster agent tokens](https://docs.gitlab.com/security/tokens/#gitlab-cluster-agent-tokens) | Revoke
[Pipeline trigger tokens](https://docs.gitlab.com/ci/triggers/#create-a-pipeline-trigger-token) | Revoke
[Feed tokens](https://docs.gitlab.com/security/tokens/#feed-token) | Reset
[Runner authentication tokens](https://docs.gitlab.com/security/tokens/#runner-authentication-tokens) | Reset
[OAuth application secrets](https://docs.gitlab.com/integration/oauth_provider/) | Reset
[Incoming email tokens](https://docs.gitlab.com/security/tokens/#incoming-email-token) | Reset
[Feature flags client tokens](https://docs.gitlab.com/operations/feature_flags/#get-access-credentials) | Reset
[GitLab session cookies](https://docs.gitlab.com/user/profile/active_sessions/) | Delete
```
...
Attribute | Type | Required | Description
---|---|---|---
`token` | string | Yes | Existing token to revoke. `Personal`, `project` or `group access` tokens must begin with `glpat` or the current [custom prefix](https://docs.gitlab.com/administration/settings/account_and_limit_settings/#personal-access-token-prefix).
If successful, returns [`204`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) without content.
Can return the following status codes:
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/admin/token.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/admin/token.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Token prefixes](https://docs.gitlab.com/api/admin/token/#token-prefixes)
  * [Retrieve token information](https://docs.gitlab.com/api/admin/token/#retrieve-token-information)
  * [Revoke a token](https://docs.gitlab.com/api/admin/token/#revoke-a-token)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/admin/token.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/admin/token.md)
