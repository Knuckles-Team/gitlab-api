[Skip to main content](https://docs.gitlab.com/user/gitlab_duo/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/user/gitlab_duo/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/user/gitlab_duo/)
    * [18.8](https://docs.gitlab.com/18.8/user/gitlab_duo/)
    * [18.7](https://archives.docs.gitlab.com/18.7/user/gitlab_duo/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/user/gitlab_duo/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/user/gitlab_duo/index.html)
...
[Prompt examples](https://docs.gitlab.com/user/gitlab_duo/prompt_examples/)
[Data usage](https://docs.gitlab.com/user/gitlab_duo/data_usage/)
/
  1. [GitLab Docs](https://docs.gitlab.com/)
  2. [GitLab Duo](https://docs.gitlab.com/user/gitlab_duo/)
...
GitLab Duo features are available in [IDE extensions](https://docs.gitlab.com/editor_extensions/) and the GitLab UI. Some features are also available as part of [GitLab Duo Chat](https://docs.gitlab.com/user/gitlab_duo_chat/examples/).
What do you want to do?
Search multiple sources, create files, and take action.
Use pre-built or custom agents to handle specialized work.
Chain together agents to solve complex problems automatically.
Create structured representations of your repositories to improve AI accuracy.
Integrate GitLab Duo with third-party data sources.
Customize GitLab Duo to match your workflow, standards, or requirements.
Host your own AI gateway and language models.
Ensure GitLab Duo is configured and operating properly.
Was this page helpful?YesNo
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/user/gitlab_duo/_index.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/user/gitlab_duo/_index.md)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/user/gitlab_duo/_index.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/user/gitlab_duo/_index.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fuser%2Fgitlab_duo%2F&_biz_t=1771981775180&_biz_i=GitLab%20Duo%20%7C%20GitLab%20Docs&_biz_n=200&rnd=48903&cdn_o=a&_biz_z=1771981775181)
