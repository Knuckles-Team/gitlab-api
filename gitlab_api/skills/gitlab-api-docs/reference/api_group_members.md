[Skip to main content](https://docs.gitlab.com/api/group_members/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/group_members/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/group_members/)
    * [18.8](https://docs.gitlab.com/18.8/api/group_members/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/group_members/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/group_members/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/group_members.html)
...
/
  ...
  6. [Members](https://docs.gitlab.com/api/group_members/)
...
For information about project members, see the [Project members API](https://docs.gitlab.com/api/project_members/).
## Known issues[](https://docs.gitlab.com/api/group_members/#known-issues "Permalink")
  * The `group_saml_identity` and `group_scim_identity` attributes are only visible to group owners for [SSO-enabled groups](https://docs.gitlab.com/user/group/saml_sso/).
  * The `email` attribute is only visible to group owners for [enterprise users](https://docs.gitlab.com/user/enterprise_user/) of the group when an API request is sent to the group itself, or that group’s subgroups or projects.


## List all group members[](https://docs.gitlab.com/api/group_members/#list-all-group-members "Permalink")
...
---|---|---|---
`id` | integer or string | yes | The ID or [URL-encoded path of the group](https://docs.gitlab.com/api/rest/#namespaced-paths).
...
## List all group members, including inherited and invited members[](https://docs.gitlab.com/api/group_members/#list-all-group-members-including-inherited-and-invited-members "Permalink")
History
  * [Changed](https://gitlab.com/gitlab-org/gitlab/-/issues/219230) to return members of the invited private group if the current user is a member of the shared group or project in GitLab 16.10 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `webui_members_inherited_users`. Disabled by default.
...
## Retrieve a group member[](https://docs.gitlab.com/api/group_members/#retrieve-a-group-member "Permalink")
...
## Retrieve a group member, including inherited and invited members[](https://docs.gitlab.com/api/group_members/#retrieve-a-group-member-including-inherited-and-invited-members "Permalink")
History
...
Retrieves a specified member of a group, including members inherited or invited through ancestor groups. For more information, see [List all inherited members](https://docs.gitlab.com/api/group_members/#list-all-group-members-including-inherited-and-invited-members).
The invited group members have shared membership in the shared group. This means that if the requester is a member of a shared group, but not a member of an invited private group, then using this endpoint the requester can get all the shared group members, including the invited private group members.
```
...
## List all billable group members[](https://docs.gitlab.com/api/group_members/#list-all-billable-group-members "Permalink")
Lists all billable members of a specified group. The list includes members in subgroups and projects.
Prerequisites:
  * You must have the Owner role to access the API endpoint for billing permissions, as shown in [billing permissions](https://docs.gitlab.com/user/free_user_limit/).
  * This API endpoint works on top-level groups only. It does not work on subgroups.


This function takes [pagination](https://docs.gitlab.com/api/rest/#pagination) parameters `page` and `per_page` to restrict the list of users.
...
## List all memberships for a billable group member[](https://docs.gitlab.com/api/group_members/#list-all-memberships-for-a-billable-group-member "Permalink")
...
This API endpoint takes [pagination](https://docs.gitlab.com/api/rest/#pagination) parameters `page` and `per_page` to restrict the list of memberships.
```
...
## List all indirect memberships for a billable group member[](https://docs.gitlab.com/api/group_members/#list-all-indirect-memberships-for-a-billable-group-member "Permalink")
  * Status: Experiment
...
## Remove a billable group member[](https://docs.gitlab.com/api/group_members/#remove-a-billable-group-member "Permalink")
...
## Change group membership state for a user[](https://docs.gitlab.com/api/group_members/#change-group-membership-state-for-a-user "Permalink")
Changes the membership state for a specified user in a group.
When a user is over [the free user limit](https://docs.gitlab.com/user/free_user_limit/), changing their membership state for a group or project to `awaiting` or `active` can allow them to access that group or project. The change is applied to applied to all subgroups and projects.
```
...
## Add a group member[](https://docs.gitlab.com/api/group_members/#add-a-group-member "Permalink")
...
`access_level` | integer | yes | A valid [access level](https://docs.gitlab.com/user/permissions/#default-roles) Possible values: `0` (No access), `5` (Minimal access), `10` (Guest), `15` (Planner), `20` (Reporter), `30` (Developer), `40` (Maintainer), `50` (Owner). Default: `30`.
...
If [administrator approval for role promotions](https://docs.gitlab.com/administration/settings/sign_up_restrictions/#turn-on-administrator-approval-for-role-promotions) is turned on, membership requests that promote existing users into a billable role require administrator approval.
...
## Update a group member[](https://docs.gitlab.com/api/group_members/#update-a-group-member "Permalink")
...
`id` | integer or string | yes | The ID or [URL-encoded path of the group](https://docs.gitlab.com/api/rest/#namespaced-paths).
`user_id` | integer | yes | The user ID of the member.
`access_level` | integer | yes | A valid [access level](https://docs.gitlab.com/user/permissions/#default-roles) Possible values: `0` (No access), `5` (Minimal access), `10` (Guest), `15` (Planner), `20` (Reporter), `30` (Developer), `40` (Maintainer), `50` (Owner), `60` (Admin). Default: `30`.
`expires_at` | string | no | A date string in the format `YEAR-MONTH-DAY`.
...
### Set override flag for a member of a group[](https://docs.gitlab.com/api/group_members/#set-override-flag-for-a-member-of-a-group "Permalink")
...
### Remove override for a member of a group[](https://docs.gitlab.com/api/group_members/#remove-override-for-a-member-of-a-group "Permalink")
...
## Approve a group member[](https://docs.gitlab.com/api/group_members/#approve-a-group-member "Permalink")
...
Attribute | Type | Required | Description
---|---|---|---
`id` | integer or string | yes | The ID or [URL-encoded path of the top-level group](https://docs.gitlab.com/api/rest/#namespaced-paths).
...
## Approve all pending group members[](https://docs.gitlab.com/api/group_members/#approve-all-pending-group-members "Permalink")
...
## List all pending group members in a group and its subgroups and projects[](https://docs.gitlab.com/api/group_members/#list-all-pending-group-members-in-a-group-and-its-subgroups-and-projects "Permalink")
...
This API endpoint takes [pagination](https://docs.gitlab.com/api/rest/#pagination) parameters `page` and `per_page` to restrict the list of members.
```
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_members.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_members.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Known issues](https://docs.gitlab.com/api/group_members/#known-issues)
  * [List all group members](https://docs.gitlab.com/api/group_members/#list-all-group-members)
  * [List all group members, including inherited and invited members](https://docs.gitlab.com/api/group_members/#list-all-group-members-including-inherited-and-invited-members)
  * [Retrieve a group member](https://docs.gitlab.com/api/group_members/#retrieve-a-group-member)
  * [Retrieve a group member, including inherited and invited members](https://docs.gitlab.com/api/group_members/#retrieve-a-group-member-including-inherited-and-invited-members)
  * [List all billable group members](https://docs.gitlab.com/api/group_members/#list-all-billable-group-members)
  * [List all memberships for a billable group member](https://docs.gitlab.com/api/group_members/#list-all-memberships-for-a-billable-group-member)
  * [List all indirect memberships for a billable group member](https://docs.gitlab.com/api/group_members/#list-all-indirect-memberships-for-a-billable-group-member)
  * [Remove a billable group member](https://docs.gitlab.com/api/group_members/#remove-a-billable-group-member)
  * [Change group membership state for a user](https://docs.gitlab.com/api/group_members/#change-group-membership-state-for-a-user)
  * [Add a group member](https://docs.gitlab.com/api/group_members/#add-a-group-member)
  * [Update a group member](https://docs.gitlab.com/api/group_members/#update-a-group-member)
  * [Set override flag for a member of a group](https://docs.gitlab.com/api/group_members/#set-override-flag-for-a-member-of-a-group)
  * [Remove override for a member of a group](https://docs.gitlab.com/api/group_members/#remove-override-for-a-member-of-a-group)
  * [Remove a group member](https://docs.gitlab.com/api/group_members/#remove-a-group-member)
  * [Approve a group member](https://docs.gitlab.com/api/group_members/#approve-a-group-member)
  * [Approve all pending group members](https://docs.gitlab.com/api/group_members/#approve-all-pending-group-members)
  * [List all pending group members in a group and its subgroups and projects](https://docs.gitlab.com/api/group_members/#list-all-pending-group-members-in-a-group-and-its-subgroups-and-projects)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_members.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_members.md)
