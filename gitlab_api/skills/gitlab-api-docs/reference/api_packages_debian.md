[Skip to main content](https://docs.gitlab.com/api/packages/debian/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/packages/debian/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/packages/debian/)
    * [18.8](https://docs.gitlab.com/18.8/api/packages/debian/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/packages/debian/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/packages/debian/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/packages/debian.html)
...
/
  ...
  5. [Debian](https://docs.gitlab.com/api/packages/debian/)
...
History
  * [Deployed behind a feature flag](https://docs.gitlab.com/administration/feature_flags/), disabled by default.


This API is used by the Debian related package clients such as [dput](https://manpages.debian.org/stable/dput-ng/dput.1.en.html) and [apt-get](https://manpages.debian.org/stable/apt/apt-get.8.en.html), and is generally not meant for manual consumption. This API is under development and is not ready for production use due to limited functionality.
Use this API to interact with the [Debian package manager client](https://docs.gitlab.com/user/packages/debian_repository/).
These endpoints do not adhere to the standard API authentication methods. See the [Debian registry documentation](https://docs.gitlab.com/user/packages/debian_repository/) for details on which headers and token types are supported. Undocumented authentication methods might be removed in the future.
## Enable the Debian API[](https://docs.gitlab.com/api/packages/debian/#enable-the-debian-api "Permalink")
The Debian API is behind a feature flag that is disabled by default. [GitLab administrators with access to the GitLab Rails console](https://docs.gitlab.com/administration/feature_flags/) can opt to enable it. To enable it, follow the instructions in [Enable the Debian API](https://docs.gitlab.com/user/packages/debian_repository/#enable-the-debian-api).
## Enable the Debian group API[](https://docs.gitlab.com/api/packages/debian/#enable-the-debian-group-api "Permalink")
The Debian group API is behind a feature flag that is disabled by default. [GitLab administrators with access to the GitLab Rails console](https://docs.gitlab.com/administration/feature_flags/) can opt to enable it. To enable it, follow the instructions in [Enable the Debian group API](https://docs.gitlab.com/user/packages/debian_repository/#enable-the-debian-group-api).
### Authenticate to the Debian Package Repositories[](https://docs.gitlab.com/api/packages/debian/#authenticate-to-the-debian-package-repositories "Permalink")
See [Authenticate to the Debian Package Repositories](https://docs.gitlab.com/user/packages/debian_repository/#authenticate-to-the-debian-package-repositories).
## Upload a package file[](https://docs.gitlab.com/api/packages/debian/#upload-a-package-file "Permalink")
...
## Download a package[](https://docs.gitlab.com/api/packages/debian/#download-a-package "Permalink")
...
## Route prefix[](https://docs.gitlab.com/api/packages/debian/#route-prefix "Permalink")
...
### Project-level[](https://docs.gitlab.com/api/packages/debian/#project-level "Permalink")
```
...
### Group-level[](https://docs.gitlab.com/api/packages/debian/#group-level "Permalink")
```
...
## Download a distribution Release file[](https://docs.gitlab.com/api/packages/debian/#download-a-distribution-release-file "Permalink")
...
This writes the downloaded file using the remote filename in the current directory.
## Download a signed distribution Release file[](https://docs.gitlab.com/api/packages/debian/#download-a-signed-distribution-release-file "Permalink")
...
This writes the downloaded file using the remote filename in the current directory.
## Download a release file signature[](https://docs.gitlab.com/api/packages/debian/#download-a-release-file-signature "Permalink")
...
This writes the downloaded file using the remote filename in the current directory.
## Download a packages index[](https://docs.gitlab.com/api/packages/debian/#download-a-packages-index "Permalink")
...
This writes the downloaded file using the remote filename in the current directory.
## Download a packages index by hash[](https://docs.gitlab.com/api/packages/debian/#download-a-packages-index-by-hash "Permalink")
...
This writes the downloaded file using the remote filename in the current directory.
## Download a Debian Installer packages index[](https://docs.gitlab.com/api/packages/debian/#download-a-debian-installer-packages-index "Permalink")
...
This writes the downloaded file using the remote filename in the current directory.
## Download a Debian Installer packages index by hash[](https://docs.gitlab.com/api/packages/debian/#download-a-debian-installer-packages-index-by-hash "Permalink")
...
This writes the downloaded file using the remote filename in the current directory.
## Download a source packages index[](https://docs.gitlab.com/api/packages/debian/#download-a-source-packages-index "Permalink")
...
This writes the downloaded file using the remote filename in the current directory.
## Download a source packages index by hash[](https://docs.gitlab.com/api/packages/debian/#download-a-source-packages-index-by-hash "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/debian.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/debian.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Enable the Debian API](https://docs.gitlab.com/api/packages/debian/#enable-the-debian-api)
  * [Enable the Debian group API](https://docs.gitlab.com/api/packages/debian/#enable-the-debian-group-api)
  * [Authenticate to the Debian Package Repositories](https://docs.gitlab.com/api/packages/debian/#authenticate-to-the-debian-package-repositories)
  * [Upload a package file](https://docs.gitlab.com/api/packages/debian/#upload-a-package-file)
  * [Download a package](https://docs.gitlab.com/api/packages/debian/#download-a-package)
  * [Route prefix](https://docs.gitlab.com/api/packages/debian/#route-prefix)
  * [Project-level](https://docs.gitlab.com/api/packages/debian/#project-level)
  * [Group-level](https://docs.gitlab.com/api/packages/debian/#group-level)
  * [Download a distribution Release file](https://docs.gitlab.com/api/packages/debian/#download-a-distribution-release-file)
  * [Download a signed distribution Release file](https://docs.gitlab.com/api/packages/debian/#download-a-signed-distribution-release-file)
  * [Download a release file signature](https://docs.gitlab.com/api/packages/debian/#download-a-release-file-signature)
  * [Download a packages index](https://docs.gitlab.com/api/packages/debian/#download-a-packages-index)
  * [Download a packages index by hash](https://docs.gitlab.com/api/packages/debian/#download-a-packages-index-by-hash)
  * [Download a Debian Installer packages index](https://docs.gitlab.com/api/packages/debian/#download-a-debian-installer-packages-index)
  * [Download a Debian Installer packages index by hash](https://docs.gitlab.com/api/packages/debian/#download-a-debian-installer-packages-index-by-hash)
  * [Download a source packages index](https://docs.gitlab.com/api/packages/debian/#download-a-source-packages-index)
  * [Download a source packages index by hash](https://docs.gitlab.com/api/packages/debian/#download-a-source-packages-index-by-hash)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/debian.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/debian.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpackages%2Fdebian%2F&_biz_t=1771981606982&_biz_i=Debian%20API%20%7C%20GitLab%20Docs&_biz_n=108&rnd=590429&cdn_o=a&_biz_z=1771981606983)
