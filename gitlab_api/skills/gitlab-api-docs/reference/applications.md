[Skip to main content](https://docs.gitlab.com/api/applications/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/applications/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/applications/)
    * [18.8](https://docs.gitlab.com/18.8/api/applications/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/applications/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/applications/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/applications.html)
...
/
  ...
  5. [Applications](https://docs.gitlab.com/api/applications/)
...
Use this API to manage instance-wide OAuth applications that:
  * [Use GitLab as an authentication provider](https://docs.gitlab.com/integration/oauth_provider/).
  * [Allow access to GitLab resources on a user’s behalf](https://docs.gitlab.com/api/oauth2/).
...
## Create an application[](https://docs.gitlab.com/api/applications/#create-an-application "Permalink")
...
## List all applications[](https://docs.gitlab.com/api/applications/#list-all-applications "Permalink")
...
## Delete an application[](https://docs.gitlab.com/api/applications/#delete-an-application "Permalink")
...
## Renew an application secret[](https://docs.gitlab.com/api/applications/#renew-an-application-secret "Permalink")
History
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/applications.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/applications.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Create an application](https://docs.gitlab.com/api/applications/#create-an-application)
  * [List all applications](https://docs.gitlab.com/api/applications/#list-all-applications)
  * [Delete an application](https://docs.gitlab.com/api/applications/#delete-an-application)
  * [Renew an application secret](https://docs.gitlab.com/api/applications/#renew-an-application-secret)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/applications.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/applications.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Faudit_events%2F&_biz_t=1772174217740&_biz_i=Audit%20events%20API%20%7C%20GitLab%20Docs&_biz_n=13&rnd=715758&cdn_o=a&_biz_z=1772174217768)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fapplications%2F&_biz_t=1772174217767&_biz_i=Applications%20API%20%7C%20GitLab%20Docs&_biz_n=14&rnd=629100&cdn_o=a&_biz_z=1772174217768)
