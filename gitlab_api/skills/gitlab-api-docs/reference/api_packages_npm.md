[Skip to main content](https://docs.gitlab.com/api/packages/npm/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/packages/npm/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/packages/npm/)
    * [18.8](https://docs.gitlab.com/18.8/api/packages/npm/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/packages/npm/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/packages/npm/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/packages/npm.html)
...
/
  ...
  5. [npm](https://docs.gitlab.com/api/packages/npm/)
...
This API is used by the [npm package manager client](https://docs.npmjs.com/) and is not meant for manual consumption.
These endpoints do not adhere to the standard API authentication methods. See the [npm package registry documentation](https://docs.gitlab.com/user/packages/npm_registry/) for details on which headers and token types are supported. Undocumented authentication methods might be removed in the future.
## Download a package[](https://docs.gitlab.com/api/packages/npm/#download-a-package "Permalink")
...
## Upload a package file[](https://docs.gitlab.com/api/packages/npm/#upload-a-package-file "Permalink")
...
## Route prefix[](https://docs.gitlab.com/api/packages/npm/#route-prefix "Permalink")
...
### Instance-level[](https://docs.gitlab.com/api/packages/npm/#instance-level "Permalink")
```
/packages/npm
```

### Project-level[](https://docs.gitlab.com/api/packages/npm/#project-level "Permalink")
```
...
### Group-level[](https://docs.gitlab.com/api/packages/npm/#group-level "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/299834) in GitLab 16.0 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `npm_group_level_endpoints`. Disabled by default.
...
## Retrieve package metadata[](https://docs.gitlab.com/api/packages/npm/#retrieve-package-metadata "Permalink")
...
## Dist-Tags[](https://docs.gitlab.com/api/packages/npm/#dist-tags "Permalink")
### List all dist-tags[](https://docs.gitlab.com/api/packages/npm/#list-all-dist-tags "Permalink")
...
The URLs in the response have the same route prefix used to request them. If you request them with the instance-level route, the returned URLs contain `/api/v4/packages/npm`.
### Create or update a dist-tag[](https://docs.gitlab.com/api/packages/npm/#create-or-update-a-dist-tag "Permalink")
...
### Delete a dist-tag[](https://docs.gitlab.com/api/packages/npm/#delete-a-dist-tag "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/npm.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/npm.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Download a package](https://docs.gitlab.com/api/packages/npm/#download-a-package)
  * [Upload a package file](https://docs.gitlab.com/api/packages/npm/#upload-a-package-file)
  * [Route prefix](https://docs.gitlab.com/api/packages/npm/#route-prefix)
  * [Instance-level](https://docs.gitlab.com/api/packages/npm/#instance-level)
  * [Project-level](https://docs.gitlab.com/api/packages/npm/#project-level)
  * [Group-level](https://docs.gitlab.com/api/packages/npm/#group-level)
  * [Retrieve package metadata](https://docs.gitlab.com/api/packages/npm/#retrieve-package-metadata)
  * [Dist-Tags](https://docs.gitlab.com/api/packages/npm/#dist-tags)
  * [List all dist-tags](https://docs.gitlab.com/api/packages/npm/#list-all-dist-tags)
  * [Create or update a dist-tag](https://docs.gitlab.com/api/packages/npm/#create-or-update-a-dist-tag)
  * [Delete a dist-tag](https://docs.gitlab.com/api/packages/npm/#delete-a-dist-tag)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/npm.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/npm.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpackages%2Fnpm%2F&_biz_t=1771981625346&_biz_i=npm%20API%20%7C%20GitLab%20Docs&_biz_n=114&rnd=441115&cdn_o=a&_biz_z=1771981625347)
