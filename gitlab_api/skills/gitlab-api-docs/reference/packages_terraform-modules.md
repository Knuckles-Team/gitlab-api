[Skip to main content](https://docs.gitlab.com/api/packages/terraform-modules/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/packages/terraform-modules/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/packages/terraform-modules/)
    * [18.8](https://docs.gitlab.com/18.8/api/packages/terraform-modules/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/packages/terraform-modules/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/packages/terraform-modules/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/packages/terraform-modules.html)
...
/
  ...
  5. [Terraform registry](https://docs.gitlab.com/api/packages/terraform-modules/)
...
Use this API to interact with the [Terraform CLI](https://docs.gitlab.com/user/packages/terraform_module_registry/).
This API is used by the [Terraform CLI](https://www.terraform.io/) and is generally not meant for manual consumption. Undocumented authentication methods might be removed in the future.
## List available versions for a specific module[](https://docs.gitlab.com/api/packages/terraform-modules/#list-available-versions-for-a-specific-module "Permalink")
...
## Retrieve latest version for a module[](https://docs.gitlab.com/api/packages/terraform-modules/#retrieve-latest-version-for-a-module "Permalink")
...
## Retrieve a specific version for a module[](https://docs.gitlab.com/api/packages/terraform-modules/#retrieve-a-specific-version-for-a-module "Permalink")
...
## Retrieve download URL for latest module version[](https://docs.gitlab.com/api/packages/terraform-modules/#retrieve-download-url-for-latest-module-version "Permalink")
...
## Retrieve download URL for a specific module version[](https://docs.gitlab.com/api/packages/terraform-modules/#retrieve-download-url-for-a-specific-module-version "Permalink")
...
## Download module[](https://docs.gitlab.com/api/packages/terraform-modules/#download-module "Permalink")
### From a namespace[](https://docs.gitlab.com/api/packages/terraform-modules/#from-a-namespace "Permalink")
```
...
### From a project[](https://docs.gitlab.com/api/packages/terraform-modules/#from-a-project "Permalink")
```
...
## Upload module[](https://docs.gitlab.com/api/packages/terraform-modules/#upload-module "Permalink")
...
Header | Value
---|---
`PRIVATE-TOKEN` | A [personal access token](https://docs.gitlab.com/user/profile/personal_access_tokens/) with `api` scope.
`DEPLOY-TOKEN` | A [deploy token](https://docs.gitlab.com/user/project/deploy_tokens/) with `write_package_registry` scope.
`JOB-TOKEN` | A [job token](https://docs.gitlab.com/ci/jobs/ci_job_token/).
Example response:
json
```
{
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/terraform-modules.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/terraform-modules.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List available versions for a specific module](https://docs.gitlab.com/api/packages/terraform-modules/#list-available-versions-for-a-specific-module)
  * [Retrieve latest version for a module](https://docs.gitlab.com/api/packages/terraform-modules/#retrieve-latest-version-for-a-module)
  * [Retrieve a specific version for a module](https://docs.gitlab.com/api/packages/terraform-modules/#retrieve-a-specific-version-for-a-module)
  * [Retrieve download URL for latest module version](https://docs.gitlab.com/api/packages/terraform-modules/#retrieve-download-url-for-latest-module-version)
  * [Retrieve download URL for a specific module version](https://docs.gitlab.com/api/packages/terraform-modules/#retrieve-download-url-for-a-specific-module-version)
  * [Download module](https://docs.gitlab.com/api/packages/terraform-modules/#download-module)
  * [From a namespace](https://docs.gitlab.com/api/packages/terraform-modules/#from-a-namespace)
  * [From a project](https://docs.gitlab.com/api/packages/terraform-modules/#from-a-project)
  * [Upload module](https://docs.gitlab.com/api/packages/terraform-modules/#upload-module)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/terraform-modules.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/terraform-modules.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpackages%2Fterraform-modules%2F&_biz_t=1772174400766&_biz_i=Terraform%20Module%20Registry%20API%20%7C%20GitLab%20Docs&_biz_n=121&rnd=427662&cdn_o=a&_biz_z=1772174400767)
