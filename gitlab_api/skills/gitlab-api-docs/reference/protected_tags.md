[Skip to main content](https://docs.gitlab.com/api/protected_tags/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/protected_tags/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/protected_tags/)
    * [18.8](https://docs.gitlab.com/18.8/api/protected_tags/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/protected_tags/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/protected_tags/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/protected_tags.html)
...
/
  ...
  6. [Protected tags](https://docs.gitlab.com/api/protected_tags/)
...
Use this API to manage [protected tags](https://docs.gitlab.com/user/project/protected_tags/).
## Valid access levels[](https://docs.gitlab.com/api/protected_tags/#valid-access-levels "Permalink")
...
## List protected tags[](https://docs.gitlab.com/api/protected_tags/#list-protected-tags "Permalink")
History
  * Deploy key information [introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/116846) in GitLab 16.0.


Get a list of [protected tags](https://docs.gitlab.com/user/project/protected_tags/) from a project. This function takes pagination parameters `page` and `per_page` to restrict the list of protected tags.
```
...
## Get a protected tag or wildcard protected tag[](https://docs.gitlab.com/api/protected_tags/#get-a-protected-tag-or-wildcard-protected-tag "Permalink")
...
## Protect a repository tag[](https://docs.gitlab.com/api/protected_tags/#protect-a-repository-tag "Permalink")
History
...
## Unprotect repository tags[](https://docs.gitlab.com/api/protected_tags/#unprotect-repository-tags "Permalink")
...
## Related topics[](https://docs.gitlab.com/api/protected_tags/#related-topics "Permalink")
  * [Tags API](https://docs.gitlab.com/api/tags/) for all tags
  * [Tags](https://docs.gitlab.com/user/project/repository/tags/) user documentation
  * [Protected tags](https://docs.gitlab.com/user/project/protected_tags/) user documentation


Was this page helpful?YesNo
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/protected_tags.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/protected_tags.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Valid access levels](https://docs.gitlab.com/api/protected_tags/#valid-access-levels)
  * [List protected tags](https://docs.gitlab.com/api/protected_tags/#list-protected-tags)
  * [Get a protected tag or wildcard protected tag](https://docs.gitlab.com/api/protected_tags/#get-a-protected-tag-or-wildcard-protected-tag)
  * [Protect a repository tag](https://docs.gitlab.com/api/protected_tags/#protect-a-repository-tag)
  * [Example with user and group access](https://docs.gitlab.com/api/protected_tags/#example-with-user-and-group-access)
  * [Unprotect repository tags](https://docs.gitlab.com/api/protected_tags/#unprotect-repository-tags)
  * [Related topics](https://docs.gitlab.com/api/protected_tags/#related-topics)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/protected_tags.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/protected_tags.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fprotected_tags%2F&_biz_t=1772174429090&_biz_i=Protected%20tags%20API%20%7C%20GitLab%20Docs&_biz_n=142&rnd=300355&cdn_o=a&_biz_z=1772174429091)
