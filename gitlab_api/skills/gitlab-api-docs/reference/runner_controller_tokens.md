[Skip to main content](https://docs.gitlab.com/api/runner_controller_tokens/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/runner_controller_tokens/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/runner_controller_tokens/)
    * [18.8](https://docs.gitlab.com/18.8/api/runner_controller_tokens/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/runner_controller_tokens/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/runner_controller_tokens/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/runner_controller_tokens.html)
...
/
  ...
  5. [Runner controller tokens](https://docs.gitlab.com/api/runner_controller_tokens/)
...
## List all runner controller tokens[](https://docs.gitlab.com/api/runner_controller_tokens/#list-all-runner-controller-tokens "Permalink")
...
## Retrieve a single runner controller token[](https://docs.gitlab.com/api/runner_controller_tokens/#retrieve-a-single-runner-controller-token "Permalink")
...
Response:
If successful, returns [`200 OK`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) with the following fields:
Attribute | Type | Description
---|---|---
`id` | integer | The unique identifier of the runner controller token.
`runner_controller_id` | integer | The ID of the associated runner controller.
...
## Create a runner controller token[](https://docs.gitlab.com/api/runner_controller_tokens/#create-a-runner-controller-token "Permalink")
...
Response:
If successful, returns [`201 Created`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) with the following attributes:
Attribute | Type | Description
---|---|---
`id` | integer | The unique identifier of the runner controller token.
`runner_controller_id` | integer | The ID of the associated runner controller.
...
## Revoke a runner controller token[](https://docs.gitlab.com/api/runner_controller_tokens/#revoke-a-runner-controller-token "Permalink")
...
`id` | integer | Yes | The ID of the runner controller.
`token_id` | integer | Yes | The ID of the runner controller token.
If successful, it returns [`204 No Content`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes).
shell
```
curl --request DELETE \
    --header "PRIVATE-TOKEN: <your_access_token>" \
...
## Rotate a runner controller token[](https://docs.gitlab.com/api/runner_controller_tokens/#rotate-a-runner-controller-token "Permalink")
...
`token_id` | integer | Yes | The ID of the runner controller token.
Response:
If successful, returns [`200 OK`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) with the following attributes:
Attribute | Type | Description
---|---|---
`id` | integer | The unique identifier of the runner controller token.
`runner_controller_id` | integer | The ID of the associated runner controller.
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/runner_controller_tokens.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/runner_controller_tokens.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all runner controller tokens](https://docs.gitlab.com/api/runner_controller_tokens/#list-all-runner-controller-tokens)
  * [Retrieve a single runner controller token](https://docs.gitlab.com/api/runner_controller_tokens/#retrieve-a-single-runner-controller-token)
  * [Create a runner controller token](https://docs.gitlab.com/api/runner_controller_tokens/#create-a-runner-controller-token)
  * [Revoke a runner controller token](https://docs.gitlab.com/api/runner_controller_tokens/#revoke-a-runner-controller-token)
  * [Rotate a runner controller token](https://docs.gitlab.com/api/runner_controller_tokens/#rotate-a-runner-controller-token)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/runner_controller_tokens.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/runner_controller_tokens.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Frunner_controller_tokens%2F&_biz_t=1772174456583&_biz_i=Runner%20controller%20tokens%20API%20%7C%20GitLab%20Docs&_biz_n=162&rnd=513579&cdn_o=a&_biz_z=1772174456584)
