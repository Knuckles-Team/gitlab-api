[Skip to main content](https://docs.gitlab.com/api/packages/helm/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/packages/helm/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/packages/helm/)
    * [18.8](https://docs.gitlab.com/18.8/api/packages/helm/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/packages/helm/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/packages/helm/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/packages/helm.html)
...
/
  ...
  5. [Helm](https://docs.gitlab.com/api/packages/helm/)
...
This API is used by the Helm-related package clients such as [Helm](https://helm.sh/) and [`helm-push`](https://github.com/chartmuseum/helm-push/#readme), and is generally not meant for manual consumption.
These endpoints do not adhere to the standard API authentication methods. See the [Helm registry documentation](https://docs.gitlab.com/user/packages/helm_repository/) for details on which headers and token types are supported. Undocumented authentication methods might be removed in the future.
## Download a chart index[](https://docs.gitlab.com/api/packages/helm/#download-a-chart-index "Permalink")
...
## Download a chart[](https://docs.gitlab.com/api/packages/helm/#download-a-chart "Permalink")
...
## Upload a chart[](https://docs.gitlab.com/api/packages/helm/#upload-a-chart "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/helm.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/helm.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Download a chart index](https://docs.gitlab.com/api/packages/helm/#download-a-chart-index)
  * [Download a chart](https://docs.gitlab.com/api/packages/helm/#download-a-chart)
  * [Upload a chart](https://docs.gitlab.com/api/packages/helm/#upload-a-chart)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/helm.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/helm.md)
