[Skip to main content](https://docs.gitlab.com/api/templates/dockerfiles/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/templates/dockerfiles/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/templates/dockerfiles/)
    * [18.8](https://docs.gitlab.com/18.8/api/templates/dockerfiles/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/templates/dockerfiles/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/templates/dockerfiles/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/templates/dockerfiles.html)
...
/
  ...
  5. [Dockerfile (templates)](https://docs.gitlab.com/api/templates/dockerfiles/)
...
GitLab provides an API endpoint for Dockerfile templates available to the entire instance. Default templates are defined at [`vendor/Dockerfile`](https://gitlab.com/gitlab-org/gitlab-foss/-/tree/master/vendor/Dockerfile) in the GitLab repository.
Users with the Guest role can’t access the Dockerfiles templates. For more information, see [Project and group visibility](https://docs.gitlab.com/user/public_access/).
## Override Dockerfile API templates[](https://docs.gitlab.com/api/templates/dockerfiles/#override-dockerfile-api-templates "Permalink")
  * Tier: Premium, Ultimate
  * Offering: GitLab Self-Managed, GitLab Dedicated


In [GitLab Premium and Ultimate](https://about.gitlab.com/pricing/) tiers, GitLab instance administrators can override templates in the [**Admin** area](https://docs.gitlab.com/administration/settings/instance_template_repository/).
## List all Dockerfile templates[](https://docs.gitlab.com/api/templates/dockerfiles/#list-all-dockerfile-templates "Permalink")
...
## Retrieve a single Dockerfile template[](https://docs.gitlab.com/api/templates/dockerfiles/#retrieve-a-single-dockerfile-template "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/templates/dockerfiles.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/templates/dockerfiles.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Override Dockerfile API templates](https://docs.gitlab.com/api/templates/dockerfiles/#override-dockerfile-api-templates)
  * [List all Dockerfile templates](https://docs.gitlab.com/api/templates/dockerfiles/#list-all-dockerfile-templates)
  * [Retrieve a single Dockerfile template](https://docs.gitlab.com/api/templates/dockerfiles/#retrieve-a-single-dockerfile-template)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/templates/dockerfiles.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/templates/dockerfiles.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Ftemplates%2Fdockerfiles%2F&_biz_t=1772174481630&_biz_i=Dockerfiles%20API%20%7C%20GitLab%20Docs&_biz_n=179&rnd=836259&cdn_o=a&_biz_z=1772174481631)
