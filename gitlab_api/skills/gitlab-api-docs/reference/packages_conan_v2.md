[Skip to main content](https://docs.gitlab.com/api/packages/conan_v2/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/packages/conan_v2/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/packages/conan_v2/)
    * [18.8](https://docs.gitlab.com/18.8/api/packages/conan_v2/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/packages/conan_v2/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/packages/conan_v2/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/packages/conan_v2.html)
...
/
  ...
  5. [Conan v2](https://docs.gitlab.com/api/packages/conan_v2/)
...
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/519741) in GitLab 17.11 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `conan_package_revisions_support`. Disabled by default.
...
Use this API to interact with the [Conan v2 package manager](https://docs.gitlab.com/user/packages/conan_2_repository/). For Conan v1 operations, see [Conan v1 API](https://docs.gitlab.com/api/packages/conan_v1/).
...
Generally, these endpoints are used by the [Conan 2 package manager client](https://docs.conan.io/2/index.html) and are not meant for manual consumption.
...
## Create an authentication token[](https://docs.gitlab.com/api/packages/conan_v2/#create-an-authentication-token "Permalink")
...
## Verify authentication credentials[](https://docs.gitlab.com/api/packages/conan_v2/#verify-authentication-credentials "Permalink")
Verifies the validity of Basic Auth credentials or a specified Conan JWT generated from the Conan v1 [`/authenticate`](https://docs.gitlab.com/api/packages/conan_v1/#create-an-authentication-token) endpoint.
```
...
## Search for a Conan package[](https://docs.gitlab.com/api/packages/conan_v2/#search-for-a-conan-package "Permalink")
...
## Retrieve latest recipe revision[](https://docs.gitlab.com/api/packages/conan_v2/#retrieve-latest-recipe-revision "Permalink")
...
## List all recipe revisions[](https://docs.gitlab.com/api/packages/conan_v2/#list-all-recipe-revisions "Permalink")
...
## Delete a recipe revision[](https://docs.gitlab.com/api/packages/conan_v2/#delete-a-recipe-revision "Permalink")
...
## List all recipe files[](https://docs.gitlab.com/api/packages/conan_v2/#list-all-recipe-files "Permalink")
...
## Retrieve a recipe file[](https://docs.gitlab.com/api/packages/conan_v2/#retrieve-a-recipe-file "Permalink")
...
## Upload a recipe file[](https://docs.gitlab.com/api/packages/conan_v2/#upload-a-recipe-file "Permalink")
...
## List all package revisions[](https://docs.gitlab.com/api/packages/conan_v2/#list-all-package-revisions "Permalink")
...
## Retrieve latest package revision[](https://docs.gitlab.com/api/packages/conan_v2/#retrieve-latest-package-revision "Permalink")
...
## Delete a package revision[](https://docs.gitlab.com/api/packages/conan_v2/#delete-a-package-revision "Permalink")
...
## Retrieve a package file[](https://docs.gitlab.com/api/packages/conan_v2/#retrieve-a-package-file "Permalink")
...
## Upload a package file[](https://docs.gitlab.com/api/packages/conan_v2/#upload-a-package-file "Permalink")
...
## Retrieve package references metadata[](https://docs.gitlab.com/api/packages/conan_v2/#retrieve-package-references-metadata "Permalink")
...
## Retrieve package references metadata by recipe revision[](https://docs.gitlab.com/api/packages/conan_v2/#retrieve-package-references-metadata-by-recipe-revision "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/conan_v2.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/conan_v2.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Create an authentication token](https://docs.gitlab.com/api/packages/conan_v2/#create-an-authentication-token)
  * [Verify authentication credentials](https://docs.gitlab.com/api/packages/conan_v2/#verify-authentication-credentials)
  * [Search for a Conan package](https://docs.gitlab.com/api/packages/conan_v2/#search-for-a-conan-package)
  * [Retrieve latest recipe revision](https://docs.gitlab.com/api/packages/conan_v2/#retrieve-latest-recipe-revision)
  * [List all recipe revisions](https://docs.gitlab.com/api/packages/conan_v2/#list-all-recipe-revisions)
  * [Delete a recipe revision](https://docs.gitlab.com/api/packages/conan_v2/#delete-a-recipe-revision)
  * [List all recipe files](https://docs.gitlab.com/api/packages/conan_v2/#list-all-recipe-files)
  * [Retrieve a recipe file](https://docs.gitlab.com/api/packages/conan_v2/#retrieve-a-recipe-file)
  * [Upload a recipe file](https://docs.gitlab.com/api/packages/conan_v2/#upload-a-recipe-file)
  * [List all package revisions](https://docs.gitlab.com/api/packages/conan_v2/#list-all-package-revisions)
  * [Retrieve latest package revision](https://docs.gitlab.com/api/packages/conan_v2/#retrieve-latest-package-revision)
  * [Delete a package revision](https://docs.gitlab.com/api/packages/conan_v2/#delete-a-package-revision)
  * [Retrieve a package file](https://docs.gitlab.com/api/packages/conan_v2/#retrieve-a-package-file)
  * [Upload a package file](https://docs.gitlab.com/api/packages/conan_v2/#upload-a-package-file)
  * [Retrieve package references metadata](https://docs.gitlab.com/api/packages/conan_v2/#retrieve-package-references-metadata)
  * [Retrieve package references metadata by recipe revision](https://docs.gitlab.com/api/packages/conan_v2/#retrieve-package-references-metadata-by-recipe-revision)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/conan_v2.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/conan_v2.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpackages%2Fconan_v2%2F&_biz_t=1772174388173&_biz_i=Conan%20v2%20API%20%7C%20GitLab%20Docs&_biz_n=111&rnd=123549&cdn_o=a&_biz_z=1772174388174)
