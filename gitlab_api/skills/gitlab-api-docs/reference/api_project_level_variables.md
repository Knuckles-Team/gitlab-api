[Skip to main content](https://docs.gitlab.com/api/project_level_variables/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/project_level_variables/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/project_level_variables/)
    * [18.8](https://docs.gitlab.com/18.8/api/project_level_variables/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/project_level_variables/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/project_level_variables/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/project_level_variables.html)
...
/
  ...
  6. [CI/CD variables](https://docs.gitlab.com/api/project_level_variables/)
...
Use this API to interact with [CI/CD variables](https://docs.gitlab.com/ci/variables/#for-a-project) for a project.
## List project variables[](https://docs.gitlab.com/api/project_level_variables/#list-project-variables "Permalink")
Lists all variables for a project. Use the `page` and `per_page` [pagination](https://docs.gitlab.com/api/rest/#offset-based-pagination) parameters to control the pagination of results.
```
...
## Retrieve a single variable[](https://docs.gitlab.com/api/project_level_variables/#retrieve-a-single-variable "Permalink")
Retrieves details of a single variable. If there are multiple variables with the same key, use `filter` to select the correct `environment_scope`.
```
...
## Create a variable[](https://docs.gitlab.com/api/project_level_variables/#create-a-variable "Permalink")
History
  * `masked_and_hidden` and `hidden` attributes [introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/29674) in GitLab 17.4.


Creates a new variable. If a variable with the same `key` already exists, the new variable must have a different `environment_scope`. Otherwise, GitLab returns a message similar to: `VARIABLE_NAME has already been taken`.
```
...
## Update a variable[](https://docs.gitlab.com/api/project_level_variables/#update-a-variable "Permalink")
...
## Delete a variable[](https://docs.gitlab.com/api/project_level_variables/#delete-a-variable "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/project_level_variables.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/project_level_variables.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List project variables](https://docs.gitlab.com/api/project_level_variables/#list-project-variables)
  * [Retrieve a single variable](https://docs.gitlab.com/api/project_level_variables/#retrieve-a-single-variable)
  * [Create a variable](https://docs.gitlab.com/api/project_level_variables/#create-a-variable)
  * [Update a variable](https://docs.gitlab.com/api/project_level_variables/#update-a-variable)
  * [Delete a variable](https://docs.gitlab.com/api/project_level_variables/#delete-a-variable)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/project_level_variables.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/project_level_variables.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fproject_job_token_scopes%2F&_biz_t=1771981656028&_biz_i=CI%2FCD%20job%20token%20scope%20API%20%7C%20GitLab%20Docs&_biz_n=130&rnd=844319&cdn_o=a&_biz_z=1771981656111)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fproject_level_variables%2F&_biz_t=1771981656110&_biz_i=Project-level%20CI%2FCD%20variables%20API%20%7C%20GitLab%20Docs&_biz_n=131&rnd=973555&cdn_o=a&_biz_z=1771981656111)
