[Skip to main content](https://docs.gitlab.com/api/group_boards/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/group_boards/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/group_boards/)
    * [18.8](https://docs.gitlab.com/18.8/api/group_boards/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/group_boards/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/group_boards/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/group_boards.html)
...
/
  ...
  6. [Issue boards](https://docs.gitlab.com/api/group_boards/)
...
Use this API to manage [group issue boards](https://docs.gitlab.com/user/project/issue_board/#group-issue-boards). Every call to this API requires authentication.
If a user is not a member of a group and the group is private, a `GET` request results in `404` status code.
## List all group issue boards in a group[](https://docs.gitlab.com/api/group_boards/#list-all-group-issue-boards-in-a-group "Permalink")
...
## Retrieve a group issue board[](https://docs.gitlab.com/api/group_boards/#retrieve-a-group-issue-board "Permalink")
...
## Create a group issue board[](https://docs.gitlab.com/api/group_boards/#create-a-group-issue-board "Permalink")
...
## Update a group issue board[](https://docs.gitlab.com/api/group_boards/#update-a-group-issue-board "Permalink")
...
## Delete a group issue board[](https://docs.gitlab.com/api/group_boards/#delete-a-group-issue-board "Permalink")
  * Tier: Premium, Ultimate
  * Offering: GitLab.com, GitLab Self-Managed, GitLab Dedicated
...
## List group issue board lists[](https://docs.gitlab.com/api/group_boards/#list-group-issue-board-lists "Permalink")
...
## Retrieve a group issue board list[](https://docs.gitlab.com/api/group_boards/#retrieve-a-group-issue-board-list "Permalink")
...
## Create a group issue board list[](https://docs.gitlab.com/api/group_boards/#create-a-group-issue-board-list "Permalink")
...
## Update a group issue board list[](https://docs.gitlab.com/api/group_boards/#update-a-group-issue-board-list "Permalink")
...
## Delete a group issue board list[](https://docs.gitlab.com/api/group_boards/#delete-a-group-issue-board-list "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_boards.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_boards.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all group issue boards in a group](https://docs.gitlab.com/api/group_boards/#list-all-group-issue-boards-in-a-group)
  * [Retrieve a group issue board](https://docs.gitlab.com/api/group_boards/#retrieve-a-group-issue-board)
  * [Create a group issue board](https://docs.gitlab.com/api/group_boards/#create-a-group-issue-board)
  * [Update a group issue board](https://docs.gitlab.com/api/group_boards/#update-a-group-issue-board)
  * [Delete a group issue board](https://docs.gitlab.com/api/group_boards/#delete-a-group-issue-board)
  * [List group issue board lists](https://docs.gitlab.com/api/group_boards/#list-group-issue-board-lists)
  * [Retrieve a group issue board list](https://docs.gitlab.com/api/group_boards/#retrieve-a-group-issue-board-list)
  * [Create a group issue board list](https://docs.gitlab.com/api/group_boards/#create-a-group-issue-board-list)
  * [Update a group issue board list](https://docs.gitlab.com/api/group_boards/#update-a-group-issue-board-list)
  * [Delete a group issue board list](https://docs.gitlab.com/api/group_boards/#delete-a-group-issue-board-list)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_boards.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_boards.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fgroup_boards%2F&_biz_t=1772174282378&_biz_i=Group%20issue%20boards%20API%20%7C%20GitLab%20Docs&_biz_n=62&rnd=401543&cdn_o=a&_biz_z=1772174282379)
