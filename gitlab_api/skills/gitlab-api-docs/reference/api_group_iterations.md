[Skip to main content](https://docs.gitlab.com/api/group_iterations/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/group_iterations/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/group_iterations/)
    * [18.8](https://docs.gitlab.com/18.8/api/group_iterations/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/group_iterations/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/group_iterations/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/group_iterations.html)
...
/
  ...
  6. [Iterations](https://docs.gitlab.com/api/group_iterations/)
...
## List group iterations[](https://docs.gitlab.com/api/group_iterations/#list-group-iterations "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_iterations.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_iterations.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List group iterations](https://docs.gitlab.com/api/group_iterations/#list-group-iterations)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_iterations.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_iterations.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fgroup_iterations%2F&_biz_t=1771981541557&_biz_i=Group%20iterations%20API%20%7C%20GitLab%20Docs&_biz_n=67&rnd=512687&cdn_o=a&_biz_z=1771981541558)
