[Skip to main content](https://docs.gitlab.com/api/glql/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/glql/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/glql/)
    * [18.8](https://docs.gitlab.com/18.8/api/glql/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/glql/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/glql/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/glql.html)
...
/
  ...
  5. [GLQL](https://docs.gitlab.com/api/glql/)
...
Use this API to execute [GitLab Query Language (GLQL)](https://docs.gitlab.com/user/glql/) queries programmatically. GLQL provides a simplified query language for searching and filtering [GitLab resources](https://docs.gitlab.com/user/glql/#supported-areas) such as issues, merge requests, and epics across projects and groups.
Prerequisites:
  * The group or project must allow access to its data.
  * For private groups and projects, you must use [a personal access token](https://docs.gitlab.com/user/profile/personal_access_tokens/) with appropriate permissions.


## Execute a GLQL query[](https://docs.gitlab.com/api/glql/#execute-a-glql-query "Permalink")
...
---|---|---|---
`glql_yaml` | string | Yes | The GLQL query with optional YAML configuration. Maximum size: 10,000 bytes (10 KB). See [Query formats](https://docs.gitlab.com/api/glql/#query-formats) for details.
...
### Query formats[](https://docs.gitlab.com/api/glql/#query-formats "Permalink")
...
### Configuration options[](https://docs.gitlab.com/api/glql/#configuration-options "Permalink")
...
### Available fields[](https://docs.gitlab.com/api/glql/#available-fields "Permalink")
The `fields` configuration option is defined by [GLQL’s available fields](https://docs.gitlab.com/user/glql/fields/).
### GLQL query syntax[](https://docs.gitlab.com/api/glql/#glql-query-syntax "Permalink")
The query syntax is defined by [GLQL](https://docs.gitlab.com/user/glql/#query-syntax).
### Response attributes[](https://docs.gitlab.com/api/glql/#response-attributes "Permalink")
...
### Example: Basic query[](https://docs.gitlab.com/api/glql/#example-basic-query "Permalink")
...
### Example: Query with front matter configuration[](https://docs.gitlab.com/api/glql/#example-query-with-front-matter-configuration "Permalink")
...
### Example: Query with project scope[](https://docs.gitlab.com/api/glql/#example-query-with-project-scope "Permalink")
...
### Example: Query with `currentUser()` function[](https://docs.gitlab.com/api/glql/#example-query-with-currentuser-function "Permalink")
...
### Example: Query with limit and pagination[](https://docs.gitlab.com/api/glql/#example-query-with-limit-and-pagination "Permalink")
...
## Rate limiting[](https://docs.gitlab.com/api/glql/#rate-limiting "Permalink")
...
## Error handling[](https://docs.gitlab.com/api/glql/#error-handling "Permalink")
...
### Error response examples[](https://docs.gitlab.com/api/glql/#error-response-examples "Permalink")
...
## Limits and constraints[](https://docs.gitlab.com/api/glql/#limits-and-constraints "Permalink")
...
## Related topics[](https://docs.gitlab.com/api/glql/#related-topics "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/glql.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/glql.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Execute a GLQL query](https://docs.gitlab.com/api/glql/#execute-a-glql-query)
  * [Query formats](https://docs.gitlab.com/api/glql/#query-formats)
  * [Configuration options](https://docs.gitlab.com/api/glql/#configuration-options)
  * [Available fields](https://docs.gitlab.com/api/glql/#available-fields)
  * [GLQL query syntax](https://docs.gitlab.com/api/glql/#glql-query-syntax)
  * [Response attributes](https://docs.gitlab.com/api/glql/#response-attributes)
  * [Example: Basic query](https://docs.gitlab.com/api/glql/#example-basic-query)
  * [Example: Query with front matter configuration](https://docs.gitlab.com/api/glql/#example-query-with-front-matter-configuration)
  * [Example: Query with project scope](https://docs.gitlab.com/api/glql/#example-query-with-project-scope)
  * [Example: Query with currentUser() function](https://docs.gitlab.com/api/glql/#example-query-with-currentuser-function)
  * [Example: Query with limit and pagination](https://docs.gitlab.com/api/glql/#example-query-with-limit-and-pagination)
  * [Rate limiting](https://docs.gitlab.com/api/glql/#rate-limiting)
  * [Error handling](https://docs.gitlab.com/api/glql/#error-handling)
  * [Error response examples](https://docs.gitlab.com/api/glql/#error-response-examples)
  * [Limits and constraints](https://docs.gitlab.com/api/glql/#limits-and-constraints)
  * [Related topics](https://docs.gitlab.com/api/glql/#related-topics)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/glql.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/glql.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fglql%2F&_biz_t=1771981525752&_biz_i=GLQL%20API%20%7C%20GitLab%20Docs&_biz_n=55&rnd=27183&cdn_o=a&_biz_z=1771981525752)
