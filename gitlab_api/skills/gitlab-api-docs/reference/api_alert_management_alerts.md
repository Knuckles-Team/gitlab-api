[Skip to main content](https://docs.gitlab.com/api/alert_management_alerts/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/alert_management_alerts/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/alert_management_alerts/)
    * [18.8](https://docs.gitlab.com/18.8/api/alert_management_alerts/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/alert_management_alerts/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/alert_management_alerts/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/alert_management_alerts.html)
...
/
  ...
  5. [Alert management](https://docs.gitlab.com/api/alert_management_alerts/)
...
Use this API to interact with metric images for [alerts](https://docs.gitlab.com/operations/incident_management/alerts/).
Additional endpoints are available with the [GraphQL API](https://docs.gitlab.com/api/graphql/reference/#alertmanagementalert).
## Upload metric image[](https://docs.gitlab.com/api/alert_management_alerts/#upload-metric-image "Permalink")
...
## List all metric images[](https://docs.gitlab.com/api/alert_management_alerts/#list-all-metric-images "Permalink")
...
## Update a metric image[](https://docs.gitlab.com/api/alert_management_alerts/#update-a-metric-image "Permalink")
...
## Delete a metric image[](https://docs.gitlab.com/api/alert_management_alerts/#delete-a-metric-image "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/alert_management_alerts.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/alert_management_alerts.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Upload metric image](https://docs.gitlab.com/api/alert_management_alerts/#upload-metric-image)
  * [List all metric images](https://docs.gitlab.com/api/alert_management_alerts/#list-all-metric-images)
  * [Update a metric image](https://docs.gitlab.com/api/alert_management_alerts/#update-a-metric-image)
  * [Delete a metric image](https://docs.gitlab.com/api/alert_management_alerts/#delete-a-metric-image)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/alert_management_alerts.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/alert_management_alerts.md)
