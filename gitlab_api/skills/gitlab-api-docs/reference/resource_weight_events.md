[Skip to main content](https://docs.gitlab.com/api/resource_weight_events/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/resource_weight_events/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/resource_weight_events/)
    * [18.8](https://docs.gitlab.com/18.8/api/resource_weight_events/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/resource_weight_events/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/resource_weight_events/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/resource_weight_events.html)
...
/
  ...
  5. [Resource weight events](https://docs.gitlab.com/api/resource_weight_events/)
...
## Issues[](https://docs.gitlab.com/api/resource_weight_events/#issues "Permalink")
### List all project issue weight events[](https://docs.gitlab.com/api/resource_weight_events/#list-all-project-issue-weight-events "Permalink")
...
### Retrieve single issue weight event[](https://docs.gitlab.com/api/resource_weight_events/#retrieve-single-issue-weight-event "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/resource_weight_events.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/resource_weight_events.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Issues](https://docs.gitlab.com/api/resource_weight_events/#issues)
  * [List all project issue weight events](https://docs.gitlab.com/api/resource_weight_events/#list-all-project-issue-weight-events)
  * [Retrieve single issue weight event](https://docs.gitlab.com/api/resource_weight_events/#retrieve-single-issue-weight-event)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/resource_weight_events.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/resource_weight_events.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Frest%2Fdeprecations%2F&_biz_t=1772174455767&_biz_i=REST%20API%20deprecations%20%7C%20GitLab%20Docs&_biz_n=158&rnd=596432&cdn_o=a&_biz_z=1772174456126)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fresource_weight_events%2F&_biz_t=1772174456125&_biz_i=Resource%20weight%20events%20API%20%7C%20GitLab%20Docs&_biz_n=160&rnd=600028&cdn_o=a&_biz_z=1772174456126)
