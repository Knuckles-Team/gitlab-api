[Skip to main content](https://docs.gitlab.com/api/deploy_tokens/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/deploy_tokens/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/deploy_tokens/)
    * [18.8](https://docs.gitlab.com/18.8/api/deploy_tokens/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/deploy_tokens/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/deploy_tokens/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/deploy_tokens.html)
...
/
  ...
  5. [Deploy tokens](https://docs.gitlab.com/api/deploy_tokens/)
...
Use this API to interact with [deploy tokens](https://docs.gitlab.com/user/project/deploy_tokens/).
## List all deploy tokens[](https://docs.gitlab.com/api/deploy_tokens/#list-all-deploy-tokens "Permalink")
  * Tier: Free, Premium, Ultimate
...
## Project deploy tokens[](https://docs.gitlab.com/api/deploy_tokens/#project-deploy-tokens "Permalink")
Project deploy token API endpoints require the Maintainer or Owner role for the project.
### List project deploy tokens[](https://docs.gitlab.com/api/deploy_tokens/#list-project-deploy-tokens "Permalink")
...
### Retrieve a project deploy token[](https://docs.gitlab.com/api/deploy_tokens/#retrieve-a-project-deploy-token "Permalink")
...
### Create a project deploy token[](https://docs.gitlab.com/api/deploy_tokens/#create-a-project-deploy-token "Permalink")
...
### Delete a project deploy token[](https://docs.gitlab.com/api/deploy_tokens/#delete-a-project-deploy-token "Permalink")
...
## Group deploy tokens[](https://docs.gitlab.com/api/deploy_tokens/#group-deploy-tokens "Permalink")
...
### List group deploy tokens[](https://docs.gitlab.com/api/deploy_tokens/#list-group-deploy-tokens "Permalink")
...
### Retrieve a group deploy token[](https://docs.gitlab.com/api/deploy_tokens/#retrieve-a-group-deploy-token "Permalink")
...
### Create a group deploy token[](https://docs.gitlab.com/api/deploy_tokens/#create-a-group-deploy-token "Permalink")
...
### Delete a group deploy token[](https://docs.gitlab.com/api/deploy_tokens/#delete-a-group-deploy-token "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/deploy_tokens.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/deploy_tokens.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all deploy tokens](https://docs.gitlab.com/api/deploy_tokens/#list-all-deploy-tokens)
  * [Project deploy tokens](https://docs.gitlab.com/api/deploy_tokens/#project-deploy-tokens)
  * [List project deploy tokens](https://docs.gitlab.com/api/deploy_tokens/#list-project-deploy-tokens)
  * [Retrieve a project deploy token](https://docs.gitlab.com/api/deploy_tokens/#retrieve-a-project-deploy-token)
  * [Create a project deploy token](https://docs.gitlab.com/api/deploy_tokens/#create-a-project-deploy-token)
  * [Delete a project deploy token](https://docs.gitlab.com/api/deploy_tokens/#delete-a-project-deploy-token)
  * [Group deploy tokens](https://docs.gitlab.com/api/deploy_tokens/#group-deploy-tokens)
  * [List group deploy tokens](https://docs.gitlab.com/api/deploy_tokens/#list-group-deploy-tokens)
  * [Retrieve a group deploy token](https://docs.gitlab.com/api/deploy_tokens/#retrieve-a-group-deploy-token)
  * [Create a group deploy token](https://docs.gitlab.com/api/deploy_tokens/#create-a-group-deploy-token)
  * [Delete a group deploy token](https://docs.gitlab.com/api/deploy_tokens/#delete-a-group-deploy-token)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/deploy_tokens.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/deploy_tokens.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fdeploy_keys%2F&_biz_t=1772174244282&_biz_i=Deploy%20keys%20API%20%7C%20GitLab%20Docs&_biz_n=34&rnd=580416&cdn_o=a&_biz_z=1772174244326)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fdeploy_tokens%2F&_biz_t=1772174244325&_biz_i=Deploy%20tokens%20API%20%7C%20GitLab%20Docs&_biz_n=35&rnd=288367&cdn_o=a&_biz_z=1772174244326)
