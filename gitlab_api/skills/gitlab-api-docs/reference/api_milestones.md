[Skip to main content](https://docs.gitlab.com/api/milestones/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/milestones/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/milestones/)
    * [18.8](https://docs.gitlab.com/18.8/api/milestones/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/milestones/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/milestones/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/milestones.html)
...
/
  ...
  6. [Milestones](https://docs.gitlab.com/api/milestones/)
...
Use this API to manage [project milestones](https://docs.gitlab.com/user/project/milestones/).
For group milestones, use the [group milestones API](https://docs.gitlab.com/api/group_milestones/).
## List all project milestones[](https://docs.gitlab.com/api/milestones/#list-all-project-milestones "Permalink")
...
## Retrieve a milestone[](https://docs.gitlab.com/api/milestones/#retrieve-a-milestone "Permalink")
...
## Create a milestone[](https://docs.gitlab.com/api/milestones/#create-a-milestone "Permalink")
...
## Update a milestone[](https://docs.gitlab.com/api/milestones/#update-a-milestone "Permalink")
...
## Delete a milestone[](https://docs.gitlab.com/api/milestones/#delete-a-milestone "Permalink")
History
...
`id` | integer or string | yes | The ID or [URL-encoded path of the project](https://docs.gitlab.com/api/rest/#namespaced-paths)
`milestone_id` | integer | yes | The ID of the project’s milestone
## List all issues for a milestone[](https://docs.gitlab.com/api/milestones/#list-all-issues-for-a-milestone "Permalink")
...
`id` | integer or string | yes | The ID or [URL-encoded path of the project](https://docs.gitlab.com/api/rest/#namespaced-paths)
`milestone_id` | integer | yes | The ID of the project’s milestone
## List all merge requests for a milestone[](https://docs.gitlab.com/api/milestones/#list-all-merge-requests-for-a-milestone "Permalink")
...
`id` | integer or string | yes | The ID or [URL-encoded path of the project](https://docs.gitlab.com/api/rest/#namespaced-paths)
`milestone_id` | integer | yes | The ID of the project’s milestone
## Promote a milestone to group milestone[](https://docs.gitlab.com/api/milestones/#promote-a-milestone-to-group-milestone "Permalink")
History
  * [Changed](https://gitlab.com/gitlab-org/gitlab/-/issues/343889) the minimum user role from Developer to Reporter in GitLab 15.0.
  * [Changed](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/169256) the minimum user role from Reporter to Planner in GitLab 17.7.
...
`id` | integer or string | yes | The ID or [URL-encoded path of the project](https://docs.gitlab.com/api/rest/#namespaced-paths)
`milestone_id` | integer | yes | The ID of the project’s milestone
## List all burndown chart events for a milestone[](https://docs.gitlab.com/api/milestones/#list-all-burndown-chart-events-for-a-milestone "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/milestones.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/milestones.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all project milestones](https://docs.gitlab.com/api/milestones/#list-all-project-milestones)
  * [Retrieve a milestone](https://docs.gitlab.com/api/milestones/#retrieve-a-milestone)
  * [Create a milestone](https://docs.gitlab.com/api/milestones/#create-a-milestone)
  * [Update a milestone](https://docs.gitlab.com/api/milestones/#update-a-milestone)
  * [Delete a milestone](https://docs.gitlab.com/api/milestones/#delete-a-milestone)
  * [List all issues for a milestone](https://docs.gitlab.com/api/milestones/#list-all-issues-for-a-milestone)
  * [List all merge requests for a milestone](https://docs.gitlab.com/api/milestones/#list-all-merge-requests-for-a-milestone)
  * [Promote a milestone to group milestone](https://docs.gitlab.com/api/milestones/#promote-a-milestone-to-group-milestone)
  * [List all burndown chart events for a milestone](https://docs.gitlab.com/api/milestones/#list-all-burndown-chart-events-for-a-milestone)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/milestones.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/milestones.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fmilestones%2F&_biz_t=1771981589318&_biz_i=Project%20milestones%20API%20%7C%20GitLab%20Docs&_biz_n=94&rnd=846954&cdn_o=a&_biz_z=1771981589318)
