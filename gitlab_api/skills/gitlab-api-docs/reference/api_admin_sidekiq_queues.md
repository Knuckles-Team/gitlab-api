[Skip to main content](https://docs.gitlab.com/api/admin_sidekiq_queues/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/admin_sidekiq_queues/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/admin_sidekiq_queues/)
    * [18.8](https://docs.gitlab.com/18.8/api/admin_sidekiq_queues/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/admin_sidekiq_queues/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/admin_sidekiq_queues/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/admin_sidekiq_queues.html)
...
/
  ...
  5. [Sidekiq queues](https://docs.gitlab.com/api/admin_sidekiq_queues/)
...
## Delete jobs from a Sidekiq queue[](https://docs.gitlab.com/api/admin_sidekiq_queues/#delete-jobs-from-a-sidekiq-queue "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/admin_sidekiq_queues.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/admin_sidekiq_queues.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Delete jobs from a Sidekiq queue](https://docs.gitlab.com/api/admin_sidekiq_queues/#delete-jobs-from-a-sidekiq-queue)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/admin_sidekiq_queues.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/admin_sidekiq_queues.md)
