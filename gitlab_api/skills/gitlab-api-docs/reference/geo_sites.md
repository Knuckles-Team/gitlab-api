[Skip to main content](https://docs.gitlab.com/api/geo_sites/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/geo_sites/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/geo_sites/)
    * [18.8](https://docs.gitlab.com/18.8/api/geo_sites/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/geo_sites/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/geo_sites/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/geo_sites.html)
...
/
  ...
  5. [Geo sites](https://docs.gitlab.com/api/geo_sites/)
...
## Create a Geo site[](https://docs.gitlab.com/api/geo_sites/#create-a-geo-site "Permalink")
History
...
## List all Geo sites[](https://docs.gitlab.com/api/geo_sites/#list-all-geo-sites "Permalink")
Lists all Geo sites.
```
GET /geo_sites
```
...
## Retrieve a Geo site[](https://docs.gitlab.com/api/geo_sites/#retrieve-a-geo-site "Permalink")
...
## Update a Geo site[](https://docs.gitlab.com/api/geo_sites/#update-a-geo-site "Permalink")
History
  * `blob_download_timeout` was [introduced](https://gitlab.com/gitlab-org/gitlab/-/work_items/569919) in GitLab 18.10.
...
## Delete a Geo site[](https://docs.gitlab.com/api/geo_sites/#delete-a-geo-site "Permalink")
Deletes a Geo site.
```
DELETE /geo_sites/:id
```
...
---|---|---|---
`id` | integer | yes | The ID of the Geo site.
## Repair a Geo site[](https://docs.gitlab.com/api/geo_sites/#repair-a-geo-site "Permalink")
...
## List all Geo site statuses[](https://docs.gitlab.com/api/geo_sites/#list-all-geo-site-statuses "Permalink")
...
## Retrieve a Geo site status[](https://docs.gitlab.com/api/geo_sites/#retrieve-a-geo-site-status "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/geo_sites.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/geo_sites.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Create a Geo site](https://docs.gitlab.com/api/geo_sites/#create-a-geo-site)
  * [List all Geo sites](https://docs.gitlab.com/api/geo_sites/#list-all-geo-sites)
  * [Retrieve a Geo site](https://docs.gitlab.com/api/geo_sites/#retrieve-a-geo-site)
  * [Update a Geo site](https://docs.gitlab.com/api/geo_sites/#update-a-geo-site)
  * [Delete a Geo site](https://docs.gitlab.com/api/geo_sites/#delete-a-geo-site)
  * [Repair a Geo site](https://docs.gitlab.com/api/geo_sites/#repair-a-geo-site)
  * [List all Geo site statuses](https://docs.gitlab.com/api/geo_sites/#list-all-geo-site-statuses)
  * [Retrieve a Geo site status](https://docs.gitlab.com/api/geo_sites/#retrieve-a-geo-site-status)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/geo_sites.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/geo_sites.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fgeo_nodes%2F&_biz_t=1772174270022&_biz_i=Geo%20Nodes%20API%20\(deprecated\)%20%7C%20GitLab%20Docs&_biz_n=54&rnd=252099&cdn_o=a&_biz_z=1772174270447)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fget_started%2Fget_started_extending%2F&_biz_t=1772174270293&_biz_i=Get%20started%20extending%20GitLab%20%7C%20GitLab%20Docs&_biz_n=55&rnd=449793&cdn_o=a&_biz_z=1772174270448)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fgeo_sites%2F&_biz_t=1772174270446&_biz_i=Geo%20sites%20API%20%7C%20GitLab%20Docs&_biz_n=56&rnd=335566&cdn_o=a&_biz_z=1772174270449)
