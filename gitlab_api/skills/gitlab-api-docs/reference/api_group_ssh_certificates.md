[Skip to main content](https://docs.gitlab.com/api/group_ssh_certificates/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/group_ssh_certificates/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/group_ssh_certificates/)
    * [18.8](https://docs.gitlab.com/18.8/api/group_ssh_certificates/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/group_ssh_certificates/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/group_ssh_certificates/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/group_ssh_certificates.html)
...
/
  ...
  6. [SSH certificates](https://docs.gitlab.com/api/group_ssh_certificates/)
...
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/421915) in GitLab 16.4 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `ssh_certificates_rest_endpoints`. Disabled by default.
...
Use this API to manage [SSH certificates for groups](https://docs.gitlab.com/user/group/ssh_certificates/). Only top-level groups can store SSH certificates.
Prerequisites:
  * You must be an Owner for a top-level group.


## List all group SSH certificates[](https://docs.gitlab.com/api/group_ssh_certificates/#list-all-group-ssh-certificates "Permalink")
...
## Add a group SSH certificate[](https://docs.gitlab.com/api/group_ssh_certificates/#add-a-group-ssh-certificate "Permalink")
...
## Delete a group SSH certificate[](https://docs.gitlab.com/api/group_ssh_certificates/#delete-a-group-ssh-certificate "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_ssh_certificates.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_ssh_certificates.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all group SSH certificates](https://docs.gitlab.com/api/group_ssh_certificates/#list-all-group-ssh-certificates)
  * [Add a group SSH certificate](https://docs.gitlab.com/api/group_ssh_certificates/#add-a-group-ssh-certificate)
  * [Delete a group SSH certificate](https://docs.gitlab.com/api/group_ssh_certificates/#delete-a-group-ssh-certificate)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/group_ssh_certificates.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/group_ssh_certificates.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fgroup_ssh_certificates%2F&_biz_t=1771981560426&_biz_i=Group%20SSH%20certificates%20API%20%7C%20GitLab%20Docs&_biz_n=77&rnd=362369&cdn_o=a&_biz_z=1771981560426)
