[Skip to main content](https://docs.gitlab.com/api/packages/debian_project_distributions/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/packages/debian_project_distributions/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/packages/debian_project_distributions/)
    * [18.8](https://docs.gitlab.com/18.8/api/packages/debian_project_distributions/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/packages/debian_project_distributions/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/packages/debian_project_distributions/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/packages/debian_project_distributions.html)
...
/
  ...
  5. [Debian project distributions](https://docs.gitlab.com/api/packages/debian_project_distributions/)
...
Use this API to manage [Debian project distributions](https://docs.gitlab.com/user/packages/debian_repository/). This API is behind a feature flag that is disabled by default. To use this API, you must [enable the Debian API](https://docs.gitlab.com/api/packages/debian_project_distributions/#enable-the-debian-api).
This API is under development and is not meant for production use.
## Enable the Debian API[](https://docs.gitlab.com/api/packages/debian_project_distributions/#enable-the-debian-api "Permalink")
...
## Authenticate to the Debian distributions APIs[](https://docs.gitlab.com/api/packages/debian_project_distributions/#authenticate-to-the-debian-distributions-apis "Permalink")
...
## List all Debian distributions in a project[](https://docs.gitlab.com/api/packages/debian_project_distributions/#list-all-debian-distributions-in-a-project "Permalink")
...
## Retrieve a Debian project distribution[](https://docs.gitlab.com/api/packages/debian_project_distributions/#retrieve-a-debian-project-distribution "Permalink")
...
## Retrieve a Debian project distribution key[](https://docs.gitlab.com/api/packages/debian_project_distributions/#retrieve-a-debian-project-distribution-key "Permalink")
...
## Create a Debian project distribution[](https://docs.gitlab.com/api/packages/debian_project_distributions/#create-a-debian-project-distribution "Permalink")
...
## Update a Debian project distribution[](https://docs.gitlab.com/api/packages/debian_project_distributions/#update-a-debian-project-distribution "Permalink")
...
## Delete a Debian project distribution[](https://docs.gitlab.com/api/packages/debian_project_distributions/#delete-a-debian-project-distribution "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/debian_project_distributions.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/debian_project_distributions.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Enable the Debian API](https://docs.gitlab.com/api/packages/debian_project_distributions/#enable-the-debian-api)
  * [Authenticate to the Debian distributions APIs](https://docs.gitlab.com/api/packages/debian_project_distributions/#authenticate-to-the-debian-distributions-apis)
  * [List all Debian distributions in a project](https://docs.gitlab.com/api/packages/debian_project_distributions/#list-all-debian-distributions-in-a-project)
  * [Retrieve a Debian project distribution](https://docs.gitlab.com/api/packages/debian_project_distributions/#retrieve-a-debian-project-distribution)
  * [Retrieve a Debian project distribution key](https://docs.gitlab.com/api/packages/debian_project_distributions/#retrieve-a-debian-project-distribution-key)
  * [Create a Debian project distribution](https://docs.gitlab.com/api/packages/debian_project_distributions/#create-a-debian-project-distribution)
  * [Update a Debian project distribution](https://docs.gitlab.com/api/packages/debian_project_distributions/#update-a-debian-project-distribution)
  * [Delete a Debian project distribution](https://docs.gitlab.com/api/packages/debian_project_distributions/#delete-a-debian-project-distribution)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/packages/debian_project_distributions.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/packages/debian_project_distributions.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpackages%2Fdebian_project_distributions%2F&_biz_t=1772174388603&_biz_i=Debian%20project%20distributions%20API%20%7C%20GitLab%20Docs&_biz_n=113&rnd=630475&cdn_o=a&_biz_z=1772174388604)
