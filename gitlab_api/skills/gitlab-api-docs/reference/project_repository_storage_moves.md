[Skip to main content](https://docs.gitlab.com/api/project_repository_storage_moves/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/project_repository_storage_moves/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/project_repository_storage_moves/)
    * [18.8](https://docs.gitlab.com/18.8/api/project_repository_storage_moves/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/project_repository_storage_moves/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/project_repository_storage_moves/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/project_repository_storage_moves.html)
...
/
  ...
  6. [Repository storage moves](https://docs.gitlab.com/api/project_repository_storage_moves/)
...
Project repositories including wiki and design repositories can be moved between storages. This API can help you when [migrating to Gitaly Cluster (Praefect)](https://docs.gitlab.com/administration/gitaly/praefect/#migrate-to-gitaly-cluster-praefect), for example.
...
For other repository types see:
  ...
  * [Group repository storage moves API](https://docs.gitlab.com/api/group_repository_storage_moves/).


## List all project repository storage moves[](https://docs.gitlab.com/api/project_repository_storage_moves/#list-all-project-repository-storage-moves "Permalink")
```
...
## List all repository storage moves for a project[](https://docs.gitlab.com/api/project_repository_storage_moves/#list-all-repository-storage-moves-for-a-project "Permalink")
```
...
## Retrieve a project repository storage move[](https://docs.gitlab.com/api/project_repository_storage_moves/#retrieve-a-project-repository-storage-move "Permalink")
```
...
## Retrieve a repository storage move for a project[](https://docs.gitlab.com/api/project_repository_storage_moves/#retrieve-a-repository-storage-move-for-a-project "Permalink")
```
...
## Create a repository storage move for a project[](https://docs.gitlab.com/api/project_repository_storage_moves/#create-a-repository-storage-move-for-a-project "Permalink")
```
...
---|---|---|---
`project_id` | integer | yes | ID of the project
`destination_storage_name` | string | no | Name of the destination storage shard. The storage is selected [automatically based on storage weights](https://docs.gitlab.com/administration/repository_storage_paths/#configure-where-new-repositories-are-stored) if not provided
Example request:
shell
```
curl --request POST \
...
## Create repository storage moves for all projects on a storage shard[](https://docs.gitlab.com/api/project_repository_storage_moves/#create-repository-storage-moves-for-all-projects-on-a-storage-shard "Permalink")
...
## Related topics[](https://docs.gitlab.com/api/project_repository_storage_moves/#related-topics "Permalink")
  * [Moving repositories managed by GitLab](https://docs.gitlab.com/administration/operations/moving_repositories/)


Was this page helpful?YesNo
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/project_repository_storage_moves.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/project_repository_storage_moves.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all project repository storage moves](https://docs.gitlab.com/api/project_repository_storage_moves/#list-all-project-repository-storage-moves)
  * [List all repository storage moves for a project](https://docs.gitlab.com/api/project_repository_storage_moves/#list-all-repository-storage-moves-for-a-project)
  * [Retrieve a project repository storage move](https://docs.gitlab.com/api/project_repository_storage_moves/#retrieve-a-project-repository-storage-move)
  * [Retrieve a repository storage move for a project](https://docs.gitlab.com/api/project_repository_storage_moves/#retrieve-a-repository-storage-move-for-a-project)
  * [Create a repository storage move for a project](https://docs.gitlab.com/api/project_repository_storage_moves/#create-a-repository-storage-move-for-a-project)
  * [Create repository storage moves for all projects on a storage shard](https://docs.gitlab.com/api/project_repository_storage_moves/#create-repository-storage-moves-for-all-projects-on-a-storage-shard)
  * [Related topics](https://docs.gitlab.com/api/project_repository_storage_moves/#related-topics)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/project_repository_storage_moves.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/project_repository_storage_moves.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fproject_repository_storage_moves%2F&_biz_t=1772174427563&_biz_i=Project%20repository%20storage%20moves%20API%20%7C%20GitLab%20Docs&_biz_n=136&rnd=951002&cdn_o=a&_biz_z=1772174427564)
