[Skip to main content](https://docs.gitlab.com/api/resource_state_events/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/resource_state_events/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/resource_state_events/)
    * [18.8](https://docs.gitlab.com/18.8/api/resource_state_events/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/resource_state_events/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/resource_state_events/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/resource_state_events.html)
...
/
  ...
  5. [Resource state events](https://docs.gitlab.com/api/resource_state_events/)
...
## Issues[](https://docs.gitlab.com/api/resource_state_events/#issues "Permalink")
### List project issue state events[](https://docs.gitlab.com/api/resource_state_events/#list-project-issue-state-events "Permalink")
...
shell
```
curl --header "PRIVATE-TOKEN: YOUR_TOKEN" "https://gitlab.example.com/api/v4/projects/5/issues/11/resource_state_events"
```
...
### Retrieve a single issue state event[](https://docs.gitlab.com/api/resource_state_events/#retrieve-a-single-issue-state-event "Permalink")
...
shell
```
curl --header "PRIVATE-TOKEN: YOUR_TOKEN" "https://gitlab.example.com/api/v4/projects/5/issues/11/resource_state_events/143"
```
...
## Merge requests[](https://docs.gitlab.com/api/resource_state_events/#merge-requests "Permalink")
### List project merge request state events[](https://docs.gitlab.com/api/resource_state_events/#list-project-merge-request-state-events "Permalink")
...
shell
```
curl --header "PRIVATE-TOKEN: YOUR_TOKEN" "https://gitlab.example.com/api/v4/projects/5/merge_requests/11/resource_state_events"
```
...
### Retrieve a single merge request state event[](https://docs.gitlab.com/api/resource_state_events/#retrieve-a-single-merge-request-state-event "Permalink")
...
shell
```
curl --request GET --header "PRIVATE-TOKEN: YOUR_TOKEN" "https://gitlab.example.com/api/v4/projects/5/merge_requests/11/resource_state_events/120"
```
...
## Epics[](https://docs.gitlab.com/api/resource_state_events/#epics "Permalink")
History
...
### List group epic state events[](https://docs.gitlab.com/api/resource_state_events/#list-group-epic-state-events "Permalink")
...
shell
```
curl --header "PRIVATE-TOKEN: YOUR_TOKEN" "https://gitlab.example.com/api/v4/groups/5/epics/11/resource_state_events"
```
...
### Retrieve a single epic state event[](https://docs.gitlab.com/api/resource_state_events/#retrieve-a-single-epic-state-event "Permalink")
...
shell
```
curl --header "PRIVATE-TOKEN: YOUR_TOKEN" "https://gitlab.example.com/api/v4/groups/5/epics/11/resource_state_events/143"
```
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/resource_state_events.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/resource_state_events.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Issues](https://docs.gitlab.com/api/resource_state_events/#issues)
  * [List project issue state events](https://docs.gitlab.com/api/resource_state_events/#list-project-issue-state-events)
  * [Retrieve a single issue state event](https://docs.gitlab.com/api/resource_state_events/#retrieve-a-single-issue-state-event)
  * [Merge requests](https://docs.gitlab.com/api/resource_state_events/#merge-requests)
  * [List project merge request state events](https://docs.gitlab.com/api/resource_state_events/#list-project-merge-request-state-events)
  * [Retrieve a single merge request state event](https://docs.gitlab.com/api/resource_state_events/#retrieve-a-single-merge-request-state-event)
  * [Epics](https://docs.gitlab.com/api/resource_state_events/#epics)
  * [List group epic state events](https://docs.gitlab.com/api/resource_state_events/#list-group-epic-state-events)
  * [Retrieve a single epic state event](https://docs.gitlab.com/api/resource_state_events/#retrieve-a-single-epic-state-event)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/resource_state_events.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/resource_state_events.md)
