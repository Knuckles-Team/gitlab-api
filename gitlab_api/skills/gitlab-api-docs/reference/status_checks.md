[Skip to main content](https://docs.gitlab.com/api/status_checks/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/status_checks/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/status_checks/)
    * [18.8](https://docs.gitlab.com/18.8/api/status_checks/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/status_checks/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/status_checks/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/status_checks.html)
...
/
  ...
  5. [External status checks](https://docs.gitlab.com/api/status_checks/)
...
Use this API to manage [external status checks](https://docs.gitlab.com/user/project/merge_requests/status_checks/).
## Retrieve project external status check services[](https://docs.gitlab.com/api/status_checks/#retrieve-project-external-status-check-services "Permalink")
...
## Create external status check service[](https://docs.gitlab.com/api/status_checks/#create-external-status-check-service "Permalink")
...
## Update external status check service[](https://docs.gitlab.com/api/status_checks/#update-external-status-check-service "Permalink")
...
`shared_secret` | string | no | HMAC secret for external status check
`protected_branch_ids` | `array<Integer>` | no | IDs of protected branches to scope the rule by
## Delete external status check service[](https://docs.gitlab.com/api/status_checks/#delete-external-status-check-service "Permalink")
...
`check_id` | integer | yes | ID of an external status check service
`id` | integer | yes | ID of a project
## List all status checks for a merge request[](https://docs.gitlab.com/api/status_checks/#list-all-status-checks-for-a-merge-request "Permalink")
...
## Set status of an external status check[](https://docs.gitlab.com/api/status_checks/#set-status-of-an-external-status-check "Permalink")
History
...
Sets the status of an external status check for a single merge request, informing GitLab that a merge request has passed a check by an external service. To set the status of an external check, the personal access token used must belong to a user with the Developer, Maintainer, or Owner role on the target project of the merge request.
...
## Retry failed status check for a merge request[](https://docs.gitlab.com/api/status_checks/#retry-failed-status-check-for-a-merge-request "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/383200) in GitLab 15.7.


Retries the specified failed external status check for a single merge request. Even though the merge request hasn’t changed, this endpoint resends the current state of merge request to the defined external service.
```
...
## Response[](https://docs.gitlab.com/api/status_checks/#response "Permalink")
...
## Example payload sent to external service[](https://docs.gitlab.com/api/status_checks/#example-payload-sent-to-external-service "Permalink")
json
```
{
...
## Related topics[](https://docs.gitlab.com/api/status_checks/#related-topics "Permalink")
  * [External status checks](https://docs.gitlab.com/user/project/merge_requests/status_checks/)


Was this page helpful?YesNo
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/status_checks.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/status_checks.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Retrieve project external status check services](https://docs.gitlab.com/api/status_checks/#retrieve-project-external-status-check-services)
  * [Create external status check service](https://docs.gitlab.com/api/status_checks/#create-external-status-check-service)
  * [Update external status check service](https://docs.gitlab.com/api/status_checks/#update-external-status-check-service)
  * [Delete external status check service](https://docs.gitlab.com/api/status_checks/#delete-external-status-check-service)
  * [List all status checks for a merge request](https://docs.gitlab.com/api/status_checks/#list-all-status-checks-for-a-merge-request)
  * [Set status of an external status check](https://docs.gitlab.com/api/status_checks/#set-status-of-an-external-status-check)
  * [Retry failed status check for a merge request](https://docs.gitlab.com/api/status_checks/#retry-failed-status-check-for-a-merge-request)
  * [Response](https://docs.gitlab.com/api/status_checks/#response)
  * [Example payload sent to external service](https://docs.gitlab.com/api/status_checks/#example-payload-sent-to-external-service)
  * [Related topics](https://docs.gitlab.com/api/status_checks/#related-topics)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/status_checks.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/status_checks.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fstatus_checks%2F&_biz_t=1772174469717&_biz_i=External%20Status%20Checks%20API%20%7C%20GitLab%20Docs&_biz_n=173&rnd=873974&cdn_o=a&_biz_z=1772174469722)
