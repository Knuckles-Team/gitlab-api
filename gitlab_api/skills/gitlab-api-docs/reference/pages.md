[Skip to main content](https://docs.gitlab.com/api/pages/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/pages/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/pages/)
    * [18.8](https://docs.gitlab.com/18.8/api/pages/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/pages/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/pages/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/pages.html)
...
/
  ...
  5. [GitLab Pages](https://docs.gitlab.com/api/pages/)
...
Use this API to [administer](https://docs.gitlab.com/administration/pages/) and [use](https://docs.gitlab.com/user/project/pages/) GitLab Pages.
The GitLab Pages feature must be enabled to use these endpoints.
## Unpublish Pages[](https://docs.gitlab.com/api/pages/#unpublish-pages "Permalink")
History
...
## Get Pages settings for a project[](https://docs.gitlab.com/api/pages/#get-pages-settings-for-a-project "Permalink")
History
...
`is_unique_domain_enabled` | boolean | If [unique domain](https://docs.gitlab.com/user/project/pages/introduction/) is enabled.
...
`path_prefix` | string | Path prefix of this deployment when using [parallel deployments](https://docs.gitlab.com/user/project/pages/#parallel-deployments).
...
## Update Pages settings for a project[](https://docs.gitlab.com/api/pages/#update-pages-settings-for-a-project "Permalink")
History
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/pages.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/pages.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Unpublish Pages](https://docs.gitlab.com/api/pages/#unpublish-pages)
  * [Get Pages settings for a project](https://docs.gitlab.com/api/pages/#get-pages-settings-for-a-project)
  * [Update Pages settings for a project](https://docs.gitlab.com/api/pages/#update-pages-settings-for-a-project)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/pages.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/pages.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpackages%2Frubygems%2F&_biz_t=1772174400303&_biz_i=Ruby%20gems%20API%20%7C%20GitLab%20Docs&_biz_n=117&rnd=969424&cdn_o=a&_biz_z=1772174400474)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpersonal_access_tokens%2F&_biz_t=1772174400379&_biz_i=Personal%20access%20tokens%20API%20%7C%20GitLab%20Docs&_biz_n=118&rnd=167146&cdn_o=a&_biz_z=1772174400475)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fpages%2F&_biz_t=1772174400474&_biz_i=Pages%20API%20%7C%20GitLab%20Docs&_biz_n=119&rnd=637965&cdn_o=a&_biz_z=1772174400475)
