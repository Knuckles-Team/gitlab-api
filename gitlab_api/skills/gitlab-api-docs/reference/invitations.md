[Skip to main content](https://docs.gitlab.com/api/invitations/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/invitations/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/invitations/)
    * [18.8](https://docs.gitlab.com/18.8/api/invitations/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/invitations/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/invitations/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/invitations.html)
...
/
  ...
  5. [Invitations](https://docs.gitlab.com/api/invitations/)
...
Use this API to manage invitations and add users to a [group](https://docs.gitlab.com/user/group/#add-users-to-a-group) or [project](https://docs.gitlab.com/user/project/members/).
## Add a member to a group or project[](https://docs.gitlab.com/api/invitations/#add-a-member-to-a-group-or-project "Permalink")
...
Prerequisites:
  ...
  * For projects:
    ...
    * [Group membership lock](https://docs.gitlab.com/user/group/access_and_permissions/#prevent-members-from-being-added-to-projects-in-a-group) must be disabled.
  * For GitLab Self-Managed instances:
    * If [new sign-ups are disabled](https://docs.gitlab.com/administration/settings/sign_up_restrictions/#disable-new-sign-ups), an administrator must add the user.
    * If [user invitations are not allowed](https://docs.gitlab.com/administration/settings/visibility_and_access_controls/#prevent-invitations-to-groups-and-projects), an administrator must add the user.
    * If [administrator approval for role promotions is enabled](https://docs.gitlab.com/administration/settings/sign_up_restrictions/#turn-on-administrator-approval-for-role-promotions), an administrator must approve the invitation.
...
---|---|---|---
`id` | integer or string | yes | The ID or [URL-encoded path of the project or group](https://docs.gitlab.com/api/rest/#namespaced-paths)
...
## List all invitations pending for a group or project[](https://docs.gitlab.com/api/invitations/#list-all-invitations-pending-for-a-group-or-project "Permalink")
...
## Update an invitation to a group or project[](https://docs.gitlab.com/api/invitations/#update-an-invitation-to-a-group-or-project "Permalink")
...
`access_level` | integer | no | A valid [access level](https://docs.gitlab.com/user/permissions/#default-roles) Possible values: `0` (No access), `5` (Minimal access), `10` (Guest), `15` (Planner), `20` (Reporter), `30` (Developer), `40` (Maintainer), or `50` (Owner). Default: `30`.
...
## Delete an invitation to a group or project[](https://docs.gitlab.com/api/invitations/#delete-an-invitation-to-a-group-or-project "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/invitations.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/invitations.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Add a member to a group or project](https://docs.gitlab.com/api/invitations/#add-a-member-to-a-group-or-project)
  * [List all invitations pending for a group or project](https://docs.gitlab.com/api/invitations/#list-all-invitations-pending-for-a-group-or-project)
  * [Update an invitation to a group or project](https://docs.gitlab.com/api/invitations/#update-an-invitation-to-a-group-or-project)
  * [Delete an invitation to a group or project](https://docs.gitlab.com/api/invitations/#delete-an-invitation-to-a-group-or-project)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/invitations.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/invitations.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Finvitations%2F&_biz_t=1772174297123&_biz_i=Invitations%20API%20%7C%20GitLab%20Docs&_biz_n=76&rnd=787124&cdn_o=a&_biz_z=1772174297125)
