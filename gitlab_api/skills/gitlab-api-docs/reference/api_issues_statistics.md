[Skip to main content](https://docs.gitlab.com/api/issues_statistics/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/issues_statistics/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/issues_statistics/)
    * [18.8](https://docs.gitlab.com/18.8/api/issues_statistics/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/issues_statistics/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/issues_statistics/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/issues_statistics.html)
...
/
  ...
  5. [Issues statistics](https://docs.gitlab.com/api/issues_statistics/)
...
Use this API to retrieve statistics about [issues](https://docs.gitlab.com/user/project/issues/). Every call to this API requires authentication.
...
## Retrieve issues statistics for a user[](https://docs.gitlab.com/api/issues_statistics/#retrieve-issues-statistics-for-a-user "Permalink")
Retrieves statistics for issues accessible by the current user. By default, it returns only issues created by the current user. To get all issues, set the `scope` attribute to `all`.
```
...
## Retrieve issues statistics for a group[](https://docs.gitlab.com/api/issues_statistics/#retrieve-issues-statistics-for-a-group "Permalink")
...
## Retrieve issues statistics for a project[](https://docs.gitlab.com/api/issues_statistics/#retrieve-issues-statistics-for-a-project "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/issues_statistics.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/issues_statistics.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Retrieve issues statistics for a user](https://docs.gitlab.com/api/issues_statistics/#retrieve-issues-statistics-for-a-user)
  * [Retrieve issues statistics for a group](https://docs.gitlab.com/api/issues_statistics/#retrieve-issues-statistics-for-a-group)
  * [Retrieve issues statistics for a project](https://docs.gitlab.com/api/issues_statistics/#retrieve-issues-statistics-for-a-project)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/issues_statistics.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/issues_statistics.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fissues_statistics%2F&_biz_t=1771981560678&_biz_i=Issues%20statistics%20API%20%7C%20GitLab%20Docs&_biz_n=79&rnd=116837&cdn_o=a&_biz_z=1771981560679)
