[Skip to main content](https://docs.gitlab.com/api/container_repository_protection_rules/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/container_repository_protection_rules/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/container_repository_protection_rules/)
    * [18.8](https://docs.gitlab.com/18.8/api/container_repository_protection_rules/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/container_repository_protection_rules/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/container_repository_protection_rules/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/container_repository_protection_rules.html)
...
/
  ...
  5. [Container repository protection rules](https://docs.gitlab.com/api/container_repository_protection_rules/)
...
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/155798) in GitLab 17.2 [with a flag](https://docs.gitlab.com/administration/feature_flags/) named `container_registry_protected_containers`. Disabled by default.
...
Use this API to manage [container repository protection rules](https://docs.gitlab.com/user/packages/container_registry/protected_container_tags/).
## List all container repository protection rules[](https://docs.gitlab.com/api/container_repository_protection_rules/#list-all-container-repository-protection-rules "Permalink")
...
If successful, returns [`200`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and a list of container repository protection rules.
...
## Create a container repository protection rule[](https://docs.gitlab.com/api/container_repository_protection_rules/#create-a-container-repository-protection-rule "Permalink")
History
...
If successful, returns [`201`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and the created container repository protection rule.
Can return the following status codes:
...
## Update a container repository protection rule[](https://docs.gitlab.com/api/container_repository_protection_rules/#update-a-container-repository-protection-rule "Permalink")
History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/457518) in GitLab 17.2.
...
If successful, returns [`200`](https://docs.gitlab.com/api/rest/troubleshooting/#status-codes) and the updated protection rule.
Can return the following status codes:
...
## Delete a container repository protection rule[](https://docs.gitlab.com/api/container_repository_protection_rules/#delete-a-container-repository-protection-rule "Permalink")
History
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/container_repository_protection_rules.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/container_repository_protection_rules.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all container repository protection rules](https://docs.gitlab.com/api/container_repository_protection_rules/#list-all-container-repository-protection-rules)
  * [Create a container repository protection rule](https://docs.gitlab.com/api/container_repository_protection_rules/#create-a-container-repository-protection-rule)
  * [Update a container repository protection rule](https://docs.gitlab.com/api/container_repository_protection_rules/#update-a-container-repository-protection-rule)
  * [Delete a container repository protection rule](https://docs.gitlab.com/api/container_repository_protection_rules/#delete-a-container-repository-protection-rule)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/container_repository_protection_rules.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/container_repository_protection_rules.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fcontainer_virtual_registries%2F&_biz_t=1772174241907&_biz_i=Container%20virtual%20registry%20API%20%7C%20GitLab%20Docs&_biz_n=29&rnd=435905&cdn_o=a&_biz_z=1772174242051)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fcontainer_repository_protection_rules%2F&_biz_t=1772174242050&_biz_i=Container%20repository%20protection%20rules%20API%20%7C%20GitLab%20Docs&_biz_n=30&rnd=400815&cdn_o=a&_biz_z=1772174242052)
