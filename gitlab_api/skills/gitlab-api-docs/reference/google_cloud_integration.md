[Skip to main content](https://docs.gitlab.com/api/google_cloud_integration/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/google_cloud_integration/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/google_cloud_integration/)
    * [18.8](https://docs.gitlab.com/18.8/api/google_cloud_integration/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/google_cloud_integration/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/google_cloud_integration/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/google_cloud_integration.html)
...
/
  ...
  5. [Google Cloud integration](https://docs.gitlab.com/api/google_cloud_integration/)
...
## Project-level Google Cloud integration scripts[](https://docs.gitlab.com/api/google_cloud_integration/#project-level-google-cloud-integration-scripts "Permalink")
  * Status: Experiment


History
  * [Introduced](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/141870) in GitLab 16.10. This feature is an [experiment](https://docs.gitlab.com/policy/development_stages_support/).


### Workload identity federation creation script[](https://docs.gitlab.com/api/google_cloud_integration/#workload-identity-federation-creation-script "Permalink")
History
...
Only the [Google Artifact Management integration](https://docs.gitlab.com/user/project/integrations/google_artifact_management/) is supported. The script creates IAM policies to access Google Artifact Registry:
  * [Artifact Registry Reader](https://cloud.google.com/artifact-registry/docs/access-control#roles) role is granted to members with at least Reporter role
  * [Artifact Registry Writer](https://cloud.google.com/artifact-registry/docs/access-control#roles) role is granted to members with at least Developer role
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/google_cloud_integration.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/google_cloud_integration.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Project-level Google Cloud integration scripts](https://docs.gitlab.com/api/google_cloud_integration/#project-level-google-cloud-integration-scripts)
  * [Workload identity federation creation script](https://docs.gitlab.com/api/google_cloud_integration/#workload-identity-federation-creation-script)
  * [Script to set up a Google Cloud integration](https://docs.gitlab.com/api/google_cloud_integration/#script-to-set-up-a-google-cloud-integration)
  * [Script to configure a Google Cloud project for runner provisioning](https://docs.gitlab.com/api/google_cloud_integration/#script-to-configure-a-google-cloud-project-for-runner-provisioning)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/google_cloud_integration.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/google_cloud_integration.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fgroup_activity_analytics%2F&_biz_t=1772174282768&_biz_i=Group%20activity%20analytics%20API%20%7C%20GitLab%20Docs&_biz_n=64&rnd=318590&cdn_o=a&_biz_z=1772174283074)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=10503924d6784ad3f2d352558587a67a&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fgoogle_cloud_integration%2F&_biz_t=1772174283073&_biz_i=Google%20Cloud%20integration%20API%20%7C%20GitLab%20Docs&_biz_n=65&rnd=379373&cdn_o=a&_biz_z=1772174283077)
