[Skip to main content](https://docs.gitlab.com/api/tags/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/tags/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/tags/)
    * [18.8](https://docs.gitlab.com/18.8/api/tags/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/tags/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/tags/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/tags.html)
...
/
  ...
  5. [Tags](https://docs.gitlab.com/api/tags/)
...
Use this API to manage [Git tags](https://docs.gitlab.com/user/project/repository/tags/). This API also returns X.509 signature information from signed tags.
## List project repository tags[](https://docs.gitlab.com/api/tags/#list-project-repository-tags "Permalink")
History
...
## Get a single repository tag[](https://docs.gitlab.com/api/tags/#get-a-single-repository-tag "Permalink")
History
  * `created_at` response attribute [introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/451011) in GitLab 16.11.
...
## Create a new tag[](https://docs.gitlab.com/api/tags/#create-a-new-tag "Permalink")
History
  * `created_at` response attribute [introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/451011) in GitLab 16.11.
...
## Delete a tag[](https://docs.gitlab.com/api/tags/#delete-a-tag "Permalink")
...
`id` | integer or string | Yes | ID or [URL-encoded path of the project](https://docs.gitlab.com/api/rest/#namespaced-paths).
`tag_name` | string | Yes | Name of a tag.
## Get X.509 signature of a tag[](https://docs.gitlab.com/api/tags/#get-x509-signature-of-a-tag "Permalink")
Get the [X.509 signature from a tag](https://docs.gitlab.com/user/project/repository/signed_commits/x509/), if it is signed. Unsigned tags return a `404 Not Found` response.
```
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/tags.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/tags.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List project repository tags](https://docs.gitlab.com/api/tags/#list-project-repository-tags)
  * [Get a single repository tag](https://docs.gitlab.com/api/tags/#get-a-single-repository-tag)
  * [Create a new tag](https://docs.gitlab.com/api/tags/#create-a-new-tag)
  * [Delete a tag](https://docs.gitlab.com/api/tags/#delete-a-tag)
  * [Get X.509 signature of a tag](https://docs.gitlab.com/api/tags/#get-x509-signature-of-a-tag)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/tags.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/tags.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Ftags%2F&_biz_t=1771981722302&_biz_i=Tags%20API%20%7C%20GitLab%20Docs&_biz_n=170&rnd=615053&cdn_o=a&_biz_z=1771981722303)
