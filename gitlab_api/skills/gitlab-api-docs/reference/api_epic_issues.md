[Skip to main content](https://docs.gitlab.com/api/epic_issues/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/epic_issues/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/epic_issues/)
    * [18.8](https://docs.gitlab.com/18.8/api/epic_issues/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/epic_issues/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/epic_issues/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/epic_issues.html)
...
/
  ...
  5. [Issues (epic) (deprecated)](https://docs.gitlab.com/api/epic_issues/)


* * *
# Epic Issues API (deprecated)
...
Epics are available only in GitLab [Premium and Ultimate](https://about.gitlab.com/pricing/). If the Epics feature is not available, a `403` status code is returned.
## List all issues for an epic[](https://docs.gitlab.com/api/epic_issues/#list-all-issues-for-an-epic "Permalink")
...
## Assign an issue to an epic[](https://docs.gitlab.com/api/epic_issues/#assign-an-issue-to-an-epic "Permalink")
...
The `assignee` column is deprecated. It is now a single-sized `assignees` array.
## Remove an issue from an epic[](https://docs.gitlab.com/api/epic_issues/#remove-an-issue-from-an-epic "Permalink")
...
The `assignee` column is deprecated. It is now a single-sized `assignees` array.
## Update an epic-issue association[](https://docs.gitlab.com/api/epic_issues/#update-an-epic-issue-association "Permalink")
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/epic_issues.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/epic_issues.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [List all issues for an epic](https://docs.gitlab.com/api/epic_issues/#list-all-issues-for-an-epic)
  * [Assign an issue to an epic](https://docs.gitlab.com/api/epic_issues/#assign-an-issue-to-an-epic)
  * [Remove an issue from an epic](https://docs.gitlab.com/api/epic_issues/#remove-an-issue-from-an-epic)
  * [Update an epic-issue association](https://docs.gitlab.com/api/epic_issues/#update-an-epic-issue-association)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/epic_issues.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/epic_issues.md)
...
![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fepics%2F&_biz_t=1771981512301&_biz_i=Epics%20API%20\(deprecated\)%20%7C%20GitLab%20Docs&_biz_n=40&rnd=896853&cdn_o=a&_biz_z=1771981512426)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fepic_links%2F&_biz_t=1771981512313&_biz_i=Epic%20Links%20API%20\(deprecated\)%20%7C%20GitLab%20Docs&_biz_n=41&rnd=562863&cdn_o=a&_biz_z=1771981512426)![](https://cdn.bizible.com/ipv?_biz_r=&_biz_h=800054037&_biz_u=6cd0908ec84a42fec9a17ce4b3f900fc&_biz_l=https%3A%2F%2Fdocs.gitlab.com%2Fapi%2Fepic_issues%2F&_biz_t=1771981512425&_biz_i=Epic%20Issues%20API%20\(deprecated\)%20%7C%20GitLab%20Docs&_biz_n=42&rnd=319839&cdn_o=a&_biz_z=1771981512426)
