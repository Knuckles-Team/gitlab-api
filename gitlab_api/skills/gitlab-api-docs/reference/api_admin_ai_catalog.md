[Skip to main content](https://docs.gitlab.com/api/admin/ai_catalog/#skipTarget) [Go to GitLab Docs homepage](https://docs.gitlab.com/)
`/`
...
v18.10
  *     * [18.10 (not yet released)](https://docs.gitlab.com/api/admin/ai_catalog/)
  *     * [18.9 (recently released)](https://docs.gitlab.com/18.9/api/admin/ai_catalog/)
    * [18.8](https://docs.gitlab.com/18.8/api/admin/ai_catalog/)
    * [18.7](https://archives.docs.gitlab.com/18.7/api/admin/ai_catalog/)
  *     * [17.11](https://archives.docs.gitlab.com/17.11/api/admin/ai_catalog/)
    * [16.11](https://archives.docs.gitlab.com/16.11/ee/api/admin/ai_catalog.html)
...
/
  ...
  5. [AI Catalog admin](https://docs.gitlab.com/api/admin/ai_catalog/)
...
## Seed GitLab-managed external agents[](https://docs.gitlab.com/api/admin/ai_catalog/#seed-gitlab-managed-external-agents "Permalink")
  * Status: Experiment
...
Use this API to seed the AI Catalog with [GitLab-managed external agents](https://docs.gitlab.com/user/duo_agent_platform/agents/external/).
This feature is an [experiment](https://docs.gitlab.com/policy/development_stages_support/) and may change or be removed in future releases.
Prerequisites:
...
Edit this page
  *     * [ Open in Web IDE`.`Quickly and easily edit multiple files. ](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/admin/ai_catalog.md)
    * [ View page sourceEdit this file only. ](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/admin/ai_catalog.md)
    * [ Create an issueSuggest improvements. ](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=Documentation)


  * [Seed GitLab-managed external agents](https://docs.gitlab.com/api/admin/ai_catalog/#seed-gitlab-managed-external-agents)
...
Feedback
  * [View page source](https://gitlab.com/gitlab-org/gitlab/-/blob/master/doc/api/admin/ai_catalog.md)
  * [Edit in Web IDE](https://gitlab.com/-/ide/project/gitlab-org/gitlab/edit/master/-/doc/api/admin/ai_catalog.md)
