...
def gitlab_mcp() -> None:
    ...
    """
    parser = argparse.ArgumentParser(add_help=False, description="GitLab MCP Server")
    parser.add_argument(
        "-t",
        "--transport",
...
def usage():
    print(
        f"Gitlab Api ({__version__}): GitLab MCP Server\n\n"
        "Usage:\n"
        ...
        "--required-scopes                  [ Comma-separated list of required scopes (e.g., gitlab.read,gitlab.write). ]\n"
