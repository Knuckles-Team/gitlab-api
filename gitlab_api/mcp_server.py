...
def register_commits_tools(mcp: FastMCP):
    ...
    def get_commit_diff(
        ...
        if ctx:
            ctx.info("Diff retrieval complete")
        return response
    ...
    def revert_commit(
        ...
        if not dry_run and ctx:
            ...
            result = ctx.elicit(message, response_type=bool)
    ...
    def get_commit_comments(
        ...
        if ctx:
            ctx.info("Comments retrieval complete")
        return response
    ...
    def create_commit_comment(
        ...
        if ctx:
            ctx.info("Comment creation complete")
        return response
    ...
    def get_commit_discussions(
        ...
        if ctx:
            ctx.info("Discussions retrieval complete")
        return response
    ...
    def get_commit_statuses(
        ...
        if ctx:
            ctx.info("Statuses retrieval complete")
        return response
    ...
    def post_build_status_to_commit(
        ...
        _target_url: Optional[str] = Field(
        ...
        _coverage: Optional[float] = Field(
        ...
        if ctx:
            ctx.info("Build status posted successfully")
        return response
    ...
    def get_commit_merge_requests(
        ...
        if ctx:
            ctx.info("Merge requests retrieval complete")
        return response
...
def register_environments_tools(mcp: FastMCP):
    ...
    def stop_stale_environments(
        ...
        _older_than: Optional[str] = Field(
        ...
        if ctx:
            ctx.info("Stale environments stopped")
        return response
    ...
    def delete_stopped_environments(
        ...
        if ctx:
            ctx.info("Stopped review apps deleted")
        return response
    ...
    def protect_environment(
        ...
        if ctx:
            ctx.info("Environment protected")
        return response
    ...
    def update_protected_environment(
        ...
        if ctx:
            ctx.info("Protected environment updated")
        return response
...
def register_groups_tools(mcp: FastMCP):
    ...
    def get_group_projects(
        ...
        group_id: Union[int, str] = Field(description="Group ID or path", default=None),
        _include_subgroups: Optional[bool] = Field(
...
def register_jobs_tools(mcp: FastMCP):
    ...
    def get_project_jobs(
        ...
        _include_retried: Optional[bool] = Field(
            description="Include retried jobs", default=None
        ),
        _include_invisible: Optional[bool] = Field(
...
def register_members_tools(mcp: FastMCP):
    ...
    def get_group_members(
        ...
        _skip_users: Optional[List[int]] = Field(
            description="Exclude specified user IDs", default=None
        ),
        _show_seat_info: Optional[bool] = Field(
...
def register_merge_requests_tools(mcp: FastMCP):
    ...
    def create_merge_request(
        ...
        _reviewer_ids: Optional[List[int]] = Field(
...
def register_merge_rules_tools(mcp: FastMCP):
    ...
    def create_project_level_rule(
        ...
        if ctx:
            ctx.info("Approval rule created")
        return response
    ...
    def update_project_level_rule(
        ...
        if ctx:
            ctx.info("Approval rule updated")
        return response
    ...
    def delete_project_level_rule(
        ...
        if ctx:
            ctx.info("Approval rule deleted")
        return response
    ...
    def approve_merge_request(
        ...
        if ctx:
            ctx.info("Merge request approved")
        return response
    ...
    def unapprove_merge_request(
        ...
        if ctx:
            ctx.info("Merge request unapproved")
        return response
...
def register_packages_tools(mcp: FastMCP):
    ...
    def get_repository_packages(
        ...
        _package_type: Optional[str] = Field(
...
def register_pipeline_schedules_tools(mcp: FastMCP):
    ...
    def create_pipeline_schedule(
        ...
        if ctx:
            ctx.info("Pipeline schedule created")
        return response
    ...
    def edit_pipeline_schedule(
        ...
        if ctx:
            ctx.info("Pipeline schedule edited")
        return response
    ...
    def delete_pipeline_schedule(
        ...
        if ctx:
            ctx.info("Pipeline schedule deleted")
        return response
    ...
    def run_pipeline_schedule(
        ...
        if ctx:
            ctx.info("Pipeline schedule run started")
        return response
...
def register_projects_tools(mcp: FastMCP):
    ...
    def get_project_groups(
        ...
        _skip_groups: Optional[List[int]] = Field(
...
def register_releases_tools(mcp: FastMCP):
    ...
    def get_releases(
        ...
        _include_html_description: Optional[bool] = Field(
    ...
    def create_release_evidence(
        ...
        if ctx:
            ctx.info("Release evidence created")
        return response
...
def register_runners_tools(mcp: FastMCP):
    ...
    def pause_runner(
        ...
        if ctx:
            ctx.info("Runner status updated")
        return response
    ...
    def verify_runner_authentication(
        ...
        if ctx:
            ctx.info("Runner authentication verified")
        return response
    ...
    def reset_project_runner_token(
        ...
        if ctx:
            ctx.info("Project runner token reset")
        return response
    ...
    def reset_group_runner_token(
        ...
        if ctx:
            ctx.info("Group runner token reset")
        return response
...
def register_tags_tools(mcp: FastMCP):
    ...
    def create_tag(
        ...
        _release_description: Optional[str] = Field(
