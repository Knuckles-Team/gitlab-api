...
if __name__ == "__main__":
    ...
    for project in project_response.data.projects:
        ...
        job_response = client.get_project_jobs(project_id=49)
        if pipeline_job_response and hasattr(pipeline_job_response, "data"):
